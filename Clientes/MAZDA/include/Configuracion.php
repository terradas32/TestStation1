<?php
	...
	define("HTTP_SERVER", "http://" . $_SERVER["HTTP_HOST"] . "/Clientes/MAZDA/");	//Siempre terminar en "/"
	define("HTTPS_SERVER", "https://" . $_SERVER["HTTP_HOST"] . "/Clientes/MAZDA/");	//Siempre terminar en "/"
//	define("DIR_WS_GESTOR", "Admin/");
	...
	//Directorios físicos
	define("DIR_FS_DOCUMENT_ROOT", $_SERVER["DOCUMENT_ROOT"] . "/Clientes/MAZDA/"); //Siempre terminar en "/"
	//Fichero de log
