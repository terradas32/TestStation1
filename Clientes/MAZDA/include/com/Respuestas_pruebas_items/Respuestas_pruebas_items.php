...
class Respuestas_pruebas_items
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idProceso,idCandidato,idPrueba,codIdiomaIso2,idItem,orden,idOpcion,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id  Empresa,Id  Proceso,Id  Candidato,Id  Prueba,Idioma,Id  Item,Orden,Id Opción,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
