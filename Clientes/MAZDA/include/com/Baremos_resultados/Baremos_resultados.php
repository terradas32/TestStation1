...
class Baremos_resultados
{
	...
	**/
	function __construct()
	{
		...
		$this->DESCListaExcel	=	"Id  Resultado,Id  Baremo,Id  Prueba,Punt Min,Punt Max,Punt Baremada,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
