...
* los valores de la entidad de clase Correos_proceso.
**/
class Correos_proceso
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idProceso,idTipoCorreo,idCorreo,nombre,descripcion,asunto,cuerpo,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id  Empresa,Id  Proceso,Id  Tipo Correo,Id  Correo,Nombre,Descripción,Asunto,Cuerpo,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Correos_proceso
?>