...
* los valores de la entidad de clase Wi_paises.
**/
class Wi_paises
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idPais,codIdiomaIso2,codPaisIso3,codPaisIso2,descripcion,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id  País,Idioma,Cod. País Iso3,Cod. País Iso2,Descripción,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad codPaisIso3
	* @return char(3)
	*/
	function getCodPaisIso3(){
		return $this->codPaisIso3;
	}
	/**
	* Fija el contenido de la propiedad codPaisIso3
	* @param codPaisIso3
	* @return void
	*/
	function setCodPaisIso3($sCadena){
		$this->codPaisIso3 = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad codPaisIso2
	* @return char(2)
	*/
	function getCodPaisIso2(){
		return $this->codPaisIso2;
	}
	/**
	* Fija el contenido de la propiedad codPaisIso2
	* @param codPaisIso2
	* @return void
	*/
	function setCodPaisIso2($sCadena){
		$this->codPaisIso2 = $sCadena;
	}
	/**
