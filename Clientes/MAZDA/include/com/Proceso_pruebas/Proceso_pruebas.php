...
class Proceso_pruebas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idProceso,idEmpresa,idPrueba,codIdiomaIso2,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id  Proceso,Id  Empresa,Id  Prueba,Idioma,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
