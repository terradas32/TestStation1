...
class Instrucciones_pruebas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idInstruccion,codIdiomaIso2,idPrueba,texto,fecAlta,fecMod";
		$this->DESCListaExcel	=	"Id,Idioma,Prueba,Texto,Fecha de Alta,Fecha de Modificación";
	}
