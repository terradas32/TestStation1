...
class Modo_realizacion
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idModoRealizacion,descripcion,observaciones,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Modo Realización,Descripción,Observaciones,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
