...
class Items
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"codIdiomaIso2,idPrueba,idItem,enunciado,descripcion,path1,path2,path3,path4,correcto,orden,bajaLog,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Idioma,Prueba,Id Item,Enunciado,Descripción,Path1,Path2,Path3,Path4,Correcto,Orden,Baja Log,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
