	...
	function casuisticasEspeciales($sTablaMySQL){
		...
		switch ($sTablaMySQL)
		{
			...
			case "wi_usuarios":
				...
				$sql .=" (1, 0, 'jsola', '" . md5("jsola") . "', 'Juan', 'Solá', 'jsola@azulpomodoro.com', now(), now());";
...
//					echo "<br />3::" . $sql;
	...
	function cargaEmk_charsets(){
		...
		$DescriptorFichero = fopen(constant("DIR_FS_DOCUMENT_ROOT_ADMIN") . "sqls/emk_charsets.sql","r");
		$content="";
		while(!feof($DescriptorFichero)){
	    	$content .= fgets($DescriptorFichero,4096);
		}
	...
	function cargaModo_realizacion(){
		...
		$DescriptorFichero = fopen(constant("DIR_FS_DOCUMENT_ROOT_ADMIN") . "sqls/modo_realizacion.sql","r");
		$content="";
		while(!feof($DescriptorFichero)){
	    	$content .= fgets($DescriptorFichero,4096);
		}
	...
	function cargaBaremosResultados(){
		...
		$DescriptorFichero = fopen(constant("DIR_FS_DOCUMENT_ROOT_ADMIN") . "sqls/baremos_resultados.sql","r");
		$content="";
		while(!feof($DescriptorFichero)){
	    	$content .= fgets($DescriptorFichero,4096);
		}
