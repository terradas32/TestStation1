...
* los valores de la entidad de clase Municipios.
**/
class Municipios
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idMunicipio,codIdiomaIso2,descripcion,idPais,idComunidad,idProvincia,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Municipio,Idioma,Descripción,País,Comunidad,Provincía,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad idComunidad
	* @return char(2)
	*/
	function getIdComunidad(){
		return $this->idComunidad;
	}
	/**
	* Fija el contenido de la propiedad idComunidad
	* @param idComunidad
	* @return void
	*/
	function setIdComunidad($sCadena){
		$this->idComunidad = $sCadena;
	}
	/**
