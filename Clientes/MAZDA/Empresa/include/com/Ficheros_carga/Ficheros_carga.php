...
class Ficheros_carga
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idFichero,fichero,tipo,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id,Fichero,Tipo,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad tipo
	* @return varchar(255)
	*/
	function getTipo(){
		return $this->tipo;
	...
	/**
	* Fija el contenido de la propiedad tipo
	* @param tipo
	* @return void
	*/
