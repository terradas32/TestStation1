...
* los valores de la entidad de clase Paises.
**/
class Paises
{
	...
	**/
	function __construct()
	{
		...
		$this->DESCListaExcel	=	"Id País,Idioma,Código País Iso3,Código País Iso2,Descripción,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
