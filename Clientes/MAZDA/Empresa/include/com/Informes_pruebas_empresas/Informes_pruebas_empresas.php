...
class Informes_pruebas_empresas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idPrueba,codIdiomaIso2,idTipoInforme,tarifa,nVecesDescargado,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Empresa,Id Prueba,Idioma,Id Tipo Informe,Tarifa,N Veces Descargado,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
	/**
