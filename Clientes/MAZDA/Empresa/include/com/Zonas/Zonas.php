...
* los valores de la entidad de clase Zonas.
**/
class Zonas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idZona,codIdiomaIso2,idProvincia,idMunicipio,descripcion,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Zona,Idioma,Provincía,Municipio,Descripción,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
