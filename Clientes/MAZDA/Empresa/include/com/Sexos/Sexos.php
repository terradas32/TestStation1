...
* los valores de la entidad de clase Sexos.
**/
class Sexos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idSexo,codIdiomaIso2,nombre,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Sexo,Idioma,Nombre,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
