...
* los valores de la entidad de clase Baremos.
**/
class Baremos_competencias
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idBaremo,idPrueba,idTipoCompetencia,idCompetencianombre,descripcion,observaciones,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Baremo,Prueba,Bloque,Escala,Nombre,Descripción,Observaciones,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
