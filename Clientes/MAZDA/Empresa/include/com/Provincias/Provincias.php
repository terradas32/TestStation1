...
* los valores de la entidad de clase Provincias.
**/
class Provincias
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idProvincia,codIdiomaIso2,descripcion,idPais,idComunidad,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Província,Idioma,Descripción,País,Comunidad,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
