...
* los valores de la entidad de clase Escalas_items.
**/
class Escalas_items
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idBloque,idEscala,idPrueba,idItem,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Bloque,Escala,Prueba,Item,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
