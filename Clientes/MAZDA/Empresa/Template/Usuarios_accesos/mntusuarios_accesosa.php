...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vString("IP:",f.fIP.value,255,true);
	msg +=vString("Login:",f.fLogin.value,255,true);
if (msg != "") {
...
include (constant("DIR_WS_INCLUDE") . 'cabecera.php');?>
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><input type="text" name="fIP" value="<?php echo $cEntidad->getIP();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Login&nbsp;</td>
					<td><input type="text" name="fLogin" value="<?php echo $cEntidad->getLogin();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
	...
	<input type="hidden" name="fIdAcceso" value="<?php echo $cEntidad->getIdAcceso();?>" />
