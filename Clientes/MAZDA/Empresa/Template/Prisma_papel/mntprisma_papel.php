...
function validaForm()
{
	...
	if(f.fCarga.value!=""){
		...
		alert("Debe escoger una carga a importar.");
		return false;
	}
}
	...
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr><td colspan="3" align="center" class="naranjab">&nbsp;</td></tr>
				<tr><td colspan="3"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="1" height="10" border="0" alt="" /></td></tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fCarga">Seleccione qué carga quiere importar: </label>&nbsp;</td>
					<td>
						<select name="fCarga" id="fCarga">
							<option value=""><?php echo constant('SLC_OPCION')?></option>
						<?php if($listaCargas->recordCount()>0){
							while(!$listaCargas->EOF){?>
							<option value="<?php echo $listaCargas->fields['carga']?>">Carga Nº <?php echo $listaCargas->fields['carga']?></option>
						<?php 
						 		$listaCargas->MoveNext();
							}
			...
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					<td><input type="submit" class="botones" id="bid-ok" name="fBtnAdd" value="Volcar" /></td>
				</tr>
			</table>
	</div>
</div>
	<input type="hidden" name="ORIGEN" value="<?php echo constant("MNT_BUSCAR");?>" />
	<input type="hidden" name="prisma_papel_next_page" value="1" />
