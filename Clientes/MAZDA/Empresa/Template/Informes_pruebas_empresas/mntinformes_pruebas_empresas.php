...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
    msg +=vNumber("<?php echo constant("STR_ID_EMPRESA");?>:", f.LSTIdEmpresa.value, 11, false);
	...
	msg +=vNumber("<?php echo constant("STR_ID_TIPO_INFORME");?>:",f.elements['LSTIdTipoInforme'].value, 11, false);
	msg +=vNumber("<?php echo constant("STR_TARIFA");?>:", f.LSTTarifa.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_TARIFA");?> <?php echo constant("STR_HASTA");?>:", f.LSTTarifaHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_N_VECES_DESCARGADO");?>:", f.LSTNVecesDescargado.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_N_VECES_DESCARGADO");?> <?php echo constant("STR_HASTA");?>:", f.LSTNVecesDescargadoHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdEmpresa"><?php echo constant("STR_ID_EMPRESA");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoInforme"><?php echo constant("STR_ID_TIPO_INFORME");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTTarifa"><?php echo constant("STR_TARIFA");?></label>&nbsp;</td>
					<td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTNVecesDescargado"><?php echo constant("STR_N_VECES_DESCARGADO");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTNVecesDescargado" name="LSTNVecesDescargado" value="<?php echo $cEntidad->getNVecesDescargado();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTNVecesDescargadoHast" name="LSTNVecesDescargadoHast" value="<?php echo $cEntidad->getNVecesDescargadoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='tarifa' <?php echo (!empty($sOrderBy) && $sOrderBy == 'tarifa') ? "selected='selected'" : "";?>><?php echo constant("STR_TARIFA");?></option>
							<option style='color:#000000;' value='nVecesDescargado' <?php echo (!empty($sOrderBy) && $sOrderBy == 'nVecesDescargado') ? "selected='selected'" : "";?>><?php echo constant("STR_N_VECES_DESCARGADO");?></option>
	...
	<input type="hidden" name="informes_pruebas_empresas_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdTipoInforme").show().load("jQuery.php",{sPG:"combotipos_informes",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdTipoInforme",fJSProp:"cambiaIdTipoInforme",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdTipoInforme();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
