...
function enviar()
{
	...
	if (validaForm()){
		...
		f.fSectorMB.disabled=false;
		f.fConcesionMB.disabled=false;
		f.fBaseMB.disabled=false;
		f.fFecNacimientoMB.disabled=false;
		f.fEspecialidadMB.disabled=false;
        f.fNivelConocimientoMB.disabled=false;
		...
		<div style="width: 100%">
				...
				<?php }?>
					...
					<tr>
						...
						<td><?php $comboWI_PAISES->setNombre("fIdPais");?><?php echo $comboWI_PAISES->getHTMLCombo("1","cajatexto",$cEntidad->getIdPais()," ","");?></td>
					</tr>
					<tr>
						<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					<tr>
						...
						<td><input type="text" name="fPersonaContacto" value="<?php echo $cEntidad->getPersonaContacto();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
					</tr>
					<tr>
						<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
						<td nowrap="nowrap" width="140" class="negrob" valign="top">Tlf. Contacto&nbsp;</td>
						<td><input type="text" name="fTlfContacto" value="<?php echo $cEntidad->getTlfContacto();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
					</tr>
...
?>
					...
					<tr>
						...
						<td>
							<table border =1>
								<tr>
									<td style="padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getNombreCan() != "" && strtoupper($cEntidad->getNombreCan()) == "ON") ? "checked=\"checked\"" : "";?> id="fNombreCan" name="fNombreCan" type="checkbox"><label for="fNombreCan" title="<?php echo constant("STR_NOMBRE");?>"><?php echo constant("STR_NOMBRE");?></label></td>
									<td style="padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getApellido1() != "" && strtoupper($cEntidad->getApellido1()) == "ON") ? "checked=\"checked\"" : "";?> id="fApellido1" name="fApellido1" type="checkbox"><label for="fApellido1" title="<?php echo constant("STR_APELLIDO1");?>"><?php echo constant("STR_APELLIDO1");?></label></td>
									<td style="padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getApellido2() != "" && strtoupper($cEntidad->getApellido2()) == "ON") ? "checked=\"checked\"" : "";?> id="fApellido2" name="fApellido2" type="checkbox"><label for="fApellido2" title="<?php echo constant("STR_APELLIDO2");?>"><?php echo constant("STR_APELLIDO2");?></label></td>
									<td style="padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getMailCan() != "" && strtoupper($cEntidad->getMailCan()) == "ON") ? "checked=\"checked\"" : "";?> id="fMailCan" name="fMailCan" type="checkbox"><label for="fMailCan" title="<?php echo constant("STR_MAIL");?>"><?php echo constant("STR_MAIL");?></label></td>
									...
									<td style="padding-right:20px"><input disabled="disabled" <?php echo ($cEntidad->getEdad() != "" && strtoupper($cEntidad->getEdad()) == "ON") ? "checked=\"checked\"" : "";?> id="fEdad" name="fEdad" type="checkbox"><label for="fEdad" title="<?php echo constant("STR_EDAD");?>"><?php echo constant("STR_EDAD");?></label></td>
									<td style="padding-right:20px"><input disabled="disabled" <?php echo ($cEntidad->getSexo() != "" && strtoupper($cEntidad->getSexo()) == "ON") ? "checked=\"checked\"" : "";?> id="fSexo" name="fSexo" type="checkbox"><label for="fSexo" title="<?php echo constant("STR_SEXO");?>:"><?php echo constant("STR_SEXO");?>:</label></td>
									<td style="padding-right:20px"><input disabled="disabled" <?php echo ($cEntidad->getNivel() != "" && strtoupper($cEntidad->getNivel()) == "ON") ? "checked=\"checked\"" : "";?> id="fNivel" name="fNivel" type="checkbox"><label for="fNivel" title="<?php echo constant("STR_NIVEL");?>"><?php echo constant("STR_NIVEL");?></label></td>
<!--
								</tr>
								<tr>
 -->
									<td style="padding-right:20px"><input disabled="disabled" <?php echo ($cEntidad->getFormacion() != "" && strtoupper($cEntidad->getFormacion()) == "ON") ? "checked=\"checked\"" : "";?> id="fFormacion" name="fFormacion" type="checkbox"><label for="fFormacion" title="<?php echo constant("STR_FORMACION");?>"><?php echo constant("STR_FORMACION");?></label></td>
									<td style="padding-right:20px"><input disabled="disabled" <?php echo ($cEntidad->getArea() != "" && strtoupper($cEntidad->getArea()) == "ON") ? "checked=\"checked\"" : "";?> id="fArea" name="fArea" type="checkbox"><label for="fArea" title="<?php echo constant("STR_AREA");?>"><?php echo constant("STR_AREA");?></label></td>
									<td style="padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getTelefono() != "" && strtoupper($cEntidad->getTelefono()) == "ON") ? "checked=\"checked\"" : "";?> id="fTelefono" name="fTelefono" type="checkbox"><label for="fTelefono" title="<?php echo constant("STR_TELEFONO");?>"><?php echo constant("STR_TELEFONO");?></label></td>
								</tr>
							</table>
						</td>
					</tr>
					<tr style="display:none;">
						<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
						<td width="140" class="negrob" valign="top"><?php echo constant("STR_DATOS_MB");?>&nbsp;<br /><font style="font-size:8px;color:orange;">&nbsp;</font> </td>
						<td>
							<table border =1>
								<tr>
									<td style="display: none;padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getSectorMB() != "" && strtoupper($cEntidad->getSectorMB()) == "ON") ? "checked=\"checked\"" : "";?> id="fSectorMB" name="fSectorMB" type="checkbox"><label for="fSectorMB" title="<?php echo constant("STR_SECTOR");?>"><?php echo constant("STR_SECTOR");?></label></td>
									<td style="padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getConcesionMB() != "" && strtoupper($cEntidad->getConcesionMB()) == "ON") ? "checked=\"checked\"" : "";?> id="fConcesionMB" name="fConcesionMB" type="checkbox"><label for="fConcesionMB" title="<?php echo constant("STR_DATOS_MB");?>">Concesión / Talleres Autorizados</label></td>
									<td style="padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getBaseMB() != "" && strtoupper($cEntidad->getBaseMB()) == "ON") ? "checked=\"checked\"" : "";?> id="fBaseMB" name="fBaseMB" type="checkbox"><label for="fBaseMB" title="<?php echo constant("STR_DATOS_MB");?>">Base</label></td>

									<td style="padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getFecNacimientoMB() != "" && strtoupper($cEntidad->getFecNacimientoMB()) == "ON") ? "checked=\"checked\"" : "";?> id="fFecNacimientoMB" name="fFecNacimientoMB" type="checkbox"><label for="fFecNacimientoMB" title="<?php echo constant("STR_DATOS_MB");?>">Fecha Nacimiento</label></td>
									<td style="display:none;padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getEspecialidadMB() != "" && strtoupper($cEntidad->getEspecialidadMB()) == "ON") ? "checked=\"checked\"" : "";?> id="fEspecialidadMB" name="fEspecialidadMB" type="checkbox"><label for="fEspecialidadMB" title="<?php echo constant("STR_DATOS_MB");?>">Especialidad</label></td>
                                    <td style="padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getNivelConocimientoMB() != "" && strtoupper($cEntidad->getNivelConocimientoMB()) == "ON") ? "checked=\"checked\"" : "";?> id="fNivelConocimientoMB" name="fNivelConocimientoMB" type="checkbox"><label for="fNivelConocimientoMB" title="<?php echo constant("STR_DATOS_MB");?>">Nivel conocimiento técnico</label></td>
								</tr>
							</table>
						</td>
					</tr>
