...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdValor" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdValor() : $_POST['fIdValor'];?>" />
	...
	<input type="hidden" name="opciones_valores_next_page" value="<?php echo (isset($_POST['opciones_valores_next_page'])) ? $cUtilidades->validaXSS($_POST['opciones_valores_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdItem(){
								var f= document.forms[0];
								$("#comboIdOpcion").show().load("jQuery.php",{sPG:"comboopciones",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdOpcion",fJSProp:"cambiaIdOpcion",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPrueba:f.fIdItem.value,fIdItem:f.fIdItem.value,vSelected:"<?php echo $cEntidad->getIdOpcion();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
