...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_PERFIL");?>:", f.LSTIdPerfil.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_FUNCIONALIDAD");?>:", f.LSTIdFuncionalidad.value, 11, false);
	msg +=vString("<?php echo constant("STR_MODIFICAR");?>:",f.LSTModificar.value,2, false);
	msg +=vString("<?php echo constant("STR_BORRAR");?>:",f.LSTBorrar.value,2, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdPerfil"><?php echo constant("STR_PERFIL");?></label>&nbsp;</td>
					<td><?php $comboEMP_PERFILES->setNombre("LSTIdPerfil");?><?php echo $comboEMP_PERFILES->getHTMLCombo("1","cajatexto",$cEntidad->getIdPerfil()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdFuncionalidad"><?php echo constant("STR_FUNCIONALIDAD");?></label>&nbsp;</td>
					<td><?php $comboWI_FUNCIONALIDADES->setNombre("LSTIdFuncionalidad");?><?php echo $comboWI_FUNCIONALIDADES->getHTMLCombo("1","cajatexto",$cEntidad->getIdFuncionalidad()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTModificar"><?php echo constant("STR_MODIFICAR");?></label>&nbsp;</td>
					<td><input type="checkbox" id="LSTModificar" name="LSTModificar" <?php echo ($cEntidad->getModificar() != "" && strtoupper($cEntidad->getModificar()) == "ON") ? "checked=\"checked\"" : "";?> /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTBorrar"><?php echo constant("STR_BORRAR");?></label>&nbsp;</td>
					<td><input type="checkbox" id="LSTBorrar" name="LSTBorrar" <?php echo ($cEntidad->getBorrar() != "" && strtoupper($cEntidad->getBorrar()) == "ON") ? "checked=\"checked\"" : "";?> /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='modificar' <?php echo (!empty($sOrderBy) && $sOrderBy == 'modificar') ? "selected='selected'" : "";?>><?php echo constant("STR_MODIFICAR");?></option>
							<option style='color:#000000;' value='borrar' <?php echo (!empty($sOrderBy) && $sOrderBy == 'borrar') ? "selected='selected'" : "";?>><?php echo constant("STR_BORRAR");?></option>
	...
	<input type="hidden" name="empresas_perfiles_funcionalidades_next_page" value="1" />
