...
<?php ob_start();?>
	<table cellspacing="1" cellpadding="2" border="0" width="100%">
		<tr>
			...
			?>
			<td class="tdnaranjab" align="center" valign="top"><?php echo constant("STR_PERFIL");?></td>
			<td class="tdnaranjab" align="center" valign="top"><?php echo constant("STR_FUNCIONALIDAD");?></td>
			<?
			$sPinta = "";
			$sOrden = "ASC";
		...
		<tr onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER");?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT");?>'" bgcolor="<?php echo constant("ONMOUSEOUT");?>">
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idPerfil']);?>','<?php echo addslashes($lista->fields['idFuncionalidad']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idPerfil']);?>"><?php echo $comboEMP_PERFILES->getDescripcionCombo($lista->fields['idPerfil']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idPerfil']);?>','<?php echo addslashes($lista->fields['idFuncionalidad']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idFuncionalidad']);?>"><?php echo $comboWI_FUNCIONALIDADES->getDescripcionCombo($lista->fields['idFuncionalidad']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idPerfil']);?>','<?php echo addslashes($lista->fields['idFuncionalidad']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['modificar']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['modificar'], "<b><i><u><strong><br><br />")),0,2);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idPerfil']);?>','<?php echo addslashes($lista->fields['idFuncionalidad']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['borrar']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['borrar'], "<b><i><u><strong><br><br />")),0,2);?></td>
			<td class="tddatoslista" valign="top" align="center" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idPerfil']);?>','<?php echo addslashes($lista->fields['idFuncionalidad']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['fecAlta']);?>"><script language="javascript" type="text/javascript">document.write(formatThisDate('<?php echo $lista->fields['fecAlta'];?>'));</script></td>
			...
			<td class="negro" align="center" valign="middle"><?php if($_bBorrar) {?><a href="#" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idPerfil']);?>','<?php echo addslashes($lista->fields['idFuncionalidad']);?>');confBorrar(<?php echo constant("MNT_BORRAR");?>,'<?php echo constant("DEL_GENERICO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>menos.gif" width="9" height="9" border="0" alt="<?php echo constant("STR_BORRAR");?>" /></a><?php } ?></td>
		</tr>
		<?php $i++;
		$lista->MoveNext();
		} ?>
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
			<td width="100%" colspan="2" class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"),str_replace('_', ' ', constant("STR_EMPRESASPERFILESFUNCIONALIDADES")));?><a href="sqlToExcel.php?fSQLtoEXCEL=<?php echo base64_encode($sql . constant("CHAR_SEPARA") . "empresas_perfiles_funcionalidades");?>"><img src="<?php echo constant('DIR_WS_GRAF');?>excel.gif" width="34" height="35" align="right" border="0" alt="<?php echo constant("STR_EXPORTAR_A_EXCEL");?>" /></a></td>
		</tr>
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
	...
	<input type="hidden" name="LSTIdPerfilHast" value="<?php echo (isset($_POST['LSTIdPerfilHast'])) ? $cUtilidades->validaXSS($_POST['LSTIdPerfilHast']) : "";?>" />
	<input type="hidden" name="LSTIdPerfil" value="<?php echo (isset($_POST['LSTIdPerfil'])) ? $cUtilidades->validaXSS($_POST['LSTIdPerfil']) : "";?>" />
	<input type="hidden" name="LSTIdFuncionalidadHast" value="<?php echo (isset($_POST['LSTIdFuncionalidadHast'])) ? $cUtilidades->validaXSS($_POST['LSTIdFuncionalidadHast']) : "";?>" />
	<input type="hidden" name="LSTIdFuncionalidad" value="<?php echo (isset($_POST['LSTIdFuncionalidad'])) ? $cUtilidades->validaXSS($_POST['LSTIdFuncionalidad']) : "";?>" />
	<input type="hidden" name="LSTModificar" value="<?php echo (isset($_POST['LSTModificar'])) ? $cUtilidades->validaXSS($_POST['LSTModificar']) : "";?>" />
	<input type="hidden" name="LSTBorrar" value="<?php echo (isset($_POST['LSTBorrar'])) ? $cUtilidades->validaXSS($_POST['LSTBorrar']) : "";?>" />
	...
	<input type="hidden" name="empresas_perfiles_funcionalidades_next_page" value="<?php echo (isset($_POST['empresas_perfiles_funcionalidades_next_page'])) ? $cUtilidades->validaXSS($_POST['empresas_perfiles_funcionalidades_next_page']) : "1";?>" /></div>
