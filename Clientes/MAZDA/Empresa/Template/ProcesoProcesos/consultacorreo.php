...
<!--  cambiado por nacho para que no se vea ni se pueda cambiar el nombre de la plantilla seleccionada -->
	<tr style="">
		...
		<td><input readonly type="text" name="fNombreNew" value="<?php echo $cCorreos->getNombre()?>" class="obliga"  onchange="javascript:trim(this);" /></td>
	</tr>
	<tr style="">
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" class="negrob" valign="top"><?php echo constant("STR_ASUNTO");?>&nbsp;</td>
		<td><input readonly type="text" name="fAsuntoNew" value="<?php echo $cCorreos->getAsunto();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
	</tr>
	<tr style="">
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" class="negrob" valign="top"><?php echo constant("STR_CUERPO");?>&nbsp;</td>
		<td style="display:none;"><textarea cols="1" id="fCuerpoNew" data-id="fCuerpoNew" name="fCuerpoNew" rows="6" class="obliga tinymce"  onchange="javascript:trim(this);"><?php echo $cCorreos->getCuerpo()?></textarea></td>
	</tr>
  <tr >
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td>
      <div id="divCuerpoNew" style="border: #5f5f5f 1px solid;padding-right: 10px;padding-top: 10px;"><?php echo $cCorreos->getCuerpo()?></div>
    </td>
	</tr>
<!--
	<tr>
