...
<table cellspaging="0" cellpadding="0" border="0" width="100%">
	<tr>
		...
		<td nowrap="nowrap" width="137" class="negrob" valign="top"><?php echo constant("STR_IDIOMA_PRUEBA");?>&nbsp;</td>
		<td>
...
?>
	...
	<tr>
		<td width="1"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="2" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" width="137" class="negrob" valign="top"><?php echo constant("STR_IDIOMA_INFORME");?>&nbsp;</td>
		<td>
