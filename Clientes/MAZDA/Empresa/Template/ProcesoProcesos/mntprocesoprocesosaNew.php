...
<!--
	 			<tr>
					...
					<td><textarea id="fObservaciones" name="fObservaciones" rows="6" cols="1" class="cajatexto"  onchange="javascript:trim(this);"><?php echo $cEntidad->getObservaciones();?></textarea></td>
				</tr>
 -->
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdModoRealizacion"><?php echo constant("STR_MODO_REALIZACION");?></label>&nbsp;</td>
