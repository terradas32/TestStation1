...
function aniadecandidato(){
	...
	if (msg != "") {
		...
		var paginacargada = "ProcesoProcesos.php";
		$("div#listadecandidatos").hide().load(paginacargada,{fIdProceso: f.fIdProceso.value,fIdEmpresa: f.fIdEmpresa.value,fNombre: f.fNombre.value, fApellido1: f.fApellido1.value, fApellido2: f.fApellido2.value, fDni: f.fDni.value, fMail: f.fMail.value,fAniade:"1",MODO:"<?php echo constant('MNT_LISTACANDIDATOS')?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken()?>" },function(){var f = document.forms[0];f.fNombre.value="";f.fApellido1.value="";f.fApellido2.value="";f.fDni.value="";f.fMail.value="";}).fadeIn("slow");
	}
}
function volcar(){
	var f = document.forms[0];
...
function cargaalta(){
	...
	if(f.fTipoAlta.value==""){
		...
		$("div#carga").hide().load(paginacargada, {fIdEmpresa:f.fIdEmpresa.value,fIdProceso:f.fIdProceso.value,fTipoAlta:f.fTipoAlta.value, MODO:"<?php echo constant('MNT_ANIADECANDIDATOS')?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken()?>" }).fadeIn("slow");
	}
}
...
<body onload="_body_onload();listacandidato();block('<?php echo ($_POST["_block"] != "") ? $_POST["_block"] : "-1";?>');setClicado('<?php echo $_POST["_clicado"];?>');cargaalta();" onunload="_body_onunload();">
				...
				<tr>
					...
					<td width="100%" style="border-bottom: 1px solid #000000; height:35px">
						<ul class="listaProceso">
							...
							<li class="mArrow">&nbsp;</li>
							<li class="mActivo"><span><img src="./graf/iconsMenu/User.png" title="Candidatos" alt="Candidatos" /></span><b style="color:#0086d3"><?php echo constant("STR_CANDIDATOS");?></b></li>
							<li class="mArrow">&nbsp;</li>
							...
							<tr>
								...
								<td colspan="2" align="center">
									<select name="fTipoAlta" onchange="javascript:cargaalta();">
										...
										<option style="display:none;" value="1" ><?php echo constant("STR_CARGA_MASIVA");?></option>
										<option selected value="2"><?php echo constant("STR_ALTA_MANUAL");?></option>
									</select>
								</td>
							</tr>
							<tr>
