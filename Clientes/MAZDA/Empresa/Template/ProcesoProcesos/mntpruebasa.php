...
function cambiaidiomas(){
	...
	$("div#checkidiomas").load(paginacargada,{fIdPrueba: f.fIdPrueba.value,MODO:"<?php echo constant('MNT_LISTAIDIOMAS')?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken()?>" });
}
...
function aniadepruebas(){
	...
	if (f.fPintaBaremo.value ==""){
		...
		if(f.fIdioma.value=="" || f.fIdPrueba.value=="" || f.fIdiomaInforme.value == "" || !chequeado){
			bEnvio = false;
			alert("<?php echo constant("ERR_FORM_ASIG_PRUEBA");?>");
		}else{
			bEnvio = true;
		}
	}else{
		...
		if(f.fIdioma.value=="" || f.fIdPrueba.value=="" || f.fIdBaremo.value=="" || f.fIdiomaInforme.value == "" || !chequeado){
			bEnvio = false;
			alert("<?php echo constant("ERR_FORM_ASIG_PRUEBA_BAREMO");?>");
		}else{
			bEnvio = true;
		}
	}
				...
				<tr>
					...
					<td width="100%" style="border-bottom: 1px solid #000000;">
						<ul class="listaProceso">
							...
							<li class="mArrow">&nbsp;</li>
							<li  class="mActivo"><span><img src="./graf/iconsMenu/Folder.png" title="Pruebas" alt="Pruebas" /></span><b style="color:#0086d3"><?php echo constant("STR_PRUEBAS");?></b></li>
							<li class="mArrow">&nbsp;</li>
									...
									<div id="prueba" >
										<table cellspacing="0" cellpadding="0" border="0" width="100%">
											<tr>
												...
												<![endif]-->
												<td class="anchoS" >
												<?php $comboBATERIAS->setNombre("fIdBateria");?>
												<?php echo $comboBATERIAS->getHTMLCombo("1","obliga",""," onchange=\"javascript:if (this.value==1){document.forms[0].fIdPrueba.value=115;cambiaidiomas();}else{document.forms[0].fIdPrueba.value=118;cambiaidiomas();}\"","");?>
												<?php $comboPRUEBASGROUP->setNombre("fIdPrueba");?>
												<?php echo $comboPRUEBASGROUP->getHTMLCombo("1","obliga",""," onchange=\"javascript:cambiaidiomas();\" style=\"display:none;\"","");?>
