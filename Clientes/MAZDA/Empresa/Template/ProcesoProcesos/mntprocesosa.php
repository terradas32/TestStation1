				...
				<tr>
					...
					<td width="100%" style="border-bottom: 1px solid #000000;">
						<ul class="listaProceso">
							<li class="mActivo"><span><img src="./graf/iconsMenu/Tools.png" title="Datos proceso" alt="Datos proceso" /></span><b style="color:#0086d3"><?php echo constant("STR_DATOS_PROCESO");?></b></li>
							<li class="mArrow">&nbsp;</li>
 ...
 -->
								...
								<td>
									...
									if($_POST['MODO'] == constant('MNT_MODIFICAR')){
										if($listaInformados->recordCount()>0){?>
											<input type="text" readonly="readonly" name="fFechaInicio" value="<?php echo $cEntidad->getFechaInicio();?>" class="obliga" style="width:75px;" onchange="javascript:trim(this);" />&nbsp;<input type="text" readonly="readonly" name="fHoraInicio" value="<?php echo $sHoraInicio;?>" class="obliga" style="width:35px;" onchange="javascript:trim(this);" />&nbsp;&nbsp;&nbsp;<input style="display:none;" type="checkbox" checked="checked" name="fCheckHi" disabled="disabled"/>
									<?php
										}else{?>
											<input type="text" readonly name="fFechaInicio" value="<?php echo $cEntidad->getFechaInicio();?>" class="obliga" style="width:75px;" onchange="javascript:trim(this);" />&nbsp;<input readonly type="text" name="fHoraInicio" value="<?php echo $sHoraInicio;?>" class="obliga" style="width:35px;" onchange="javascript:trim(this);" />&nbsp;&nbsp;&nbsp;<input style="display:none;" type="checkbox" name="fCheckHi" checked="checked" />
									<?php
										}
									}else{?>
										<input type="text" readonly name="fFechaInicio" value="<?php echo $cEntidad->getFechaInicio();?>" class="obliga" style="width:75px;" onchange="javascript:trim(this);" />&nbsp;<input readonly type="text" name="fHoraInicio" value="<?php echo $sHoraInicio;?>" class="obliga" style="width:35px;" onchange="javascript:trim(this);" />&nbsp;&nbsp;&nbsp;<input style="display:none;" type="checkbox" name="fCheckHi" />
							...
							<tr>
								...
								if ($cEntidad->getFechaFin() != "" && $cEntidad->getFechaFin() != "0000-00-00" && $cEntidad->getFechaFin() != "0000-00-00 00:00:00"){
									...
									$date = date('Y-m-d 23:59:59', strtotime('+1 month'));
								...
								?>
								<td>
                  <input readonly type="text" name="fFechaFin" value="<?php echo $cEntidad->getFechaFin();?>" class="obliga" style="width:75px;" onchange="javascript:trim(this);" />&nbsp;<input readonly type="text" name="fHoraFin" value="<?php echo $sHoraFin;?>" class="obliga" style="width:35px;" onchange="javascript:trim(this);" /></td>
							</tr>
