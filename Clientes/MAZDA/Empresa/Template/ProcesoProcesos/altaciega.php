...
<table cellspacing="0" cellpadding="0" border="0" width="75%">
	<tr><td colspan="3" align="center" class="naranjab"><?php echo constant("STR_ALTAS_ANONIMAS");?></td></tr>
	<tr><td colspan="3"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="1" height="10" border="0" alt="" /></td></tr>
	<tr>
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_N_DE_ALTAS");?>&nbsp;</td>
