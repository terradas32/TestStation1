...
//	msg +=vString("<?php echo constant("STR_OBSERVACIONES");?>:",f.LSTObservaciones.value,4000, false);
	...
	msg +=vNumber("<?php echo constant("STR_MODO_REALIZACION");?>:", f.LSTIdModoRealizacion.value, 11, false);
...
<!-- 
 ...
 -->
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdModoRealizacion"><?php echo constant("STR_MODO_REALIZACION");?></label>&nbsp;</td>
