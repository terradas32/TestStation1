...
include_once ('include/conexion.php');
	...
	if (session_is_registered("_cEntidadUsuarioTK" . constant("NOMBRE_SESSION"))){
	...
	if ($_cEntidadUsuarioTK->getUsuario() == ""){
		$_SESSION['mensaje' . constant("NOMBRE_SESSION")] = constant("CONF_SESSION");
        echo '<script language="javascript" type="text/javascript">top.location.replace("' . constant("HTTP_SERVER") . 'msg.php");</script>';
		exit;
    }
    ...
    echo $comboDESPUESDE->getHTMLCombo($lineas, $sObliga, $sValor, $sComboProp, $sOption);
