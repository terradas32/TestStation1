...
<?php ob_start();?>
	<table cellspacing="1" cellpadding="0" border="0" width="100%">
		...
		<tr onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER");?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT");?>'" bgcolor="<?php echo constant("ONMOUSEOUT");?>">
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>','<?php echo $lista->fields['idFuncionalidad'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['idPerfil']));?>"><?php echo substr($comboPERFILES->getDescripcionCombo($lista->fields['idPerfil']),0,25);?></td>
...
<div id="contenedor">
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width='10'><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="10" height="1" border="0" alt="" /></td>
			<td width="100%" colspan="2" align='left' class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"),str_replace('_', ' ', 'perfiles_funcionalidades'));?></td>
		</tr>
		<tr>
			<td width='10'><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="10" height="1" border="0" alt="" /></td>
	...
	<input type="hidden" name="perfiles_funcionalidades_next_page" value="<?php echo (isset($_POST['perfiles_funcionalidades_next_page'])) ? $cUtilidades->validaXSS($_POST['perfiles_funcionalidades_next_page']) : "1";?>" />
</div>
