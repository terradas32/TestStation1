...
function enviar()
{
	...
	if (validaForm()){
		lon();
		f.LSTFechaInicio.value=cFechaFormat(f.LSTFechaInicio.value);
		f.LSTFechaInicioHast.value=cFechaFormat(f.LSTFechaInicioHast.value);
		f.LSTFechaFin.value=cFechaFormat(f.LSTFechaFin.value);
		f.LSTFechaFinHast.value=cFechaFormat(f.LSTFechaFinHast.value);
...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_PROCESO");?>:", f.LSTIdProceso.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_PROCESO");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdProcesoHast.value, 11, false);
	...
	msg +=vDate("Fecha de Inicio:",f.LSTFechaInicio.value,10,false);
	msg +=vDate("Fecha de Inicio <?php echo constant("STR_HASTA");?>:",f.LSTFechaInicioHast.value,10,false);
	msg +=vDate("Fecha de Fin:",f.LSTFechaFin.value,10,false);
	msg +=vDate("Fecha de Fin <?php echo constant("STR_HASTA");?>:",f.LSTFechaFinHast.value,10,false);
	msg +=vNumber("<?php echo constant("STR_MODO_REALIZACION_PRUEBAS");?>:", f.LSTIdModoRealizacion.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdProceso"><?php echo constant("STR_ID_PROCESO");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdProceso" name="LSTIdProceso" value="<?php echo $cEntidad->getIdProceso();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdProcesoHast" name="LSTIdProcesoHast" value="<?php echo $cEntidad->getIdProcesoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTObservaciones"><?php echo constant("STR_OBSERVACIONES");?></label>&nbsp;</td>
					<td><input type="text" id="LSTObservaciones" name="LSTObservaciones" value="<?php echo $cEntidad->getObservaciones();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTFechaInicio"><?php echo constant("STR_FECHA_DE_INICIO");?></label>&nbsp;</td>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><a href="#" onclick="javascript:abrirCalendario('calendario.php?openerNombre=LSTFechaInicio','<?php echo constant("STR_CALENDARIO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>icon_calendario.gif" width="22" height="18" border="0" alt="<?php echo constant("STR_CALENDARIO");?>" align="bottom" /></a>&nbsp;<input type="text" id="LSTFechaInicio" name="LSTFechaInicio" value="<?php echo $cEntidad->getFechaInicio();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<?php if ($cEntidad->getFechaInicioHast() != "" && $cEntidad->getFechaInicioHast() != "0000-00-00" && $cEntidad->getFechaInicioHast() != "0000-00-00 00:00:00"){
								$cEntidad->setFechaInicioHast($conn->UserDate($cEntidad->getFechaInicioHast(),constant("USR_FECHA"),false));
								}else{
								$cEntidad->setFechaInicio("");
								}
								?>
								<td><a href="#" onclick="javascript:abrirCalendario('calendario.php?openerNombre=LSTFechaInicioHast','<?php echo constant("STR_CALENDARIO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>icon_calendario.gif" width="22" height="18" border="0" alt="<?php echo constant("STR_CALENDARIO");?>" align="bottom" /></a>&nbsp;<input type="text" id="LSTFechaInicioHast" name="LSTFechaInicioHast" value="<?php echo $cEntidad->getFechaInicioHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTFechaFin"><?php echo constant("STR_FECHA_DE_FIN");?></label>&nbsp;</td>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><a href="#" onclick="javascript:abrirCalendario('calendario.php?openerNombre=LSTFechaFin','<?php echo constant("STR_CALENDARIO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>icon_calendario.gif" width="22" height="18" border="0" alt="<?php echo constant("STR_CALENDARIO");?>" align="bottom" /></a>&nbsp;<input type="text" id="LSTFechaFin" name="LSTFechaFin" value="<?php echo $cEntidad->getFechaFin();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<?php if ($cEntidad->getFechaFinHast() != "" && $cEntidad->getFechaFinHast() != "0000-00-00" && $cEntidad->getFechaFinHast() != "0000-00-00 00:00:00"){
								$cEntidad->setFechaFinHast($conn->UserDate($cEntidad->getFechaFinHast(),constant("USR_FECHA"),false));
								}else{
								$cEntidad->setFechaFin("");
								}
								?>
								<td><a href="#" onclick="javascript:abrirCalendario('calendario.php?openerNombre=LSTFechaFinHast','<?php echo constant("STR_CALENDARIO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>icon_calendario.gif" width="22" height="18" border="0" alt="<?php echo constant("STR_CALENDARIO");?>" align="bottom" /></a>&nbsp;<input type="text" id="LSTFechaFinHast" name="LSTFechaFinHast" value="<?php echo $cEntidad->getFechaFinHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdModoRealizacion"><?php echo constant("STR_MODO_REALIZACION_PRUEBAS");?></label>&nbsp;</td>
					<td><?php $comboMODO_REALIZACION->setNombre("LSTIdModoRealizacion");?><?php echo $comboMODO_REALIZACION->getHTMLCombo("1","cajatexto",$cEntidad->getIdModoRealizacion()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idProceso' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idProceso') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_PROCESO");?></option>
							...
							<option style='color:#000000;' value='observaciones' <?php echo (!empty($sOrderBy) && $sOrderBy == 'observaciones') ? "selected='selected'" : "";?>><?php echo constant("STR_OBSERVACIONES");?></option>
							<option style='color:#000000;' value='fechaInicio' <?php echo (!empty($sOrderBy) && $sOrderBy == 'fechaInicio') ? "selected='selected'" : "";?>><?php echo constant("STR_FECHA_DE_INICIO");?></option>
							<option style='color:#000000;' value='fechaFin' <?php echo (!empty($sOrderBy) && $sOrderBy == 'fechaFin') ? "selected='selected'" : "";?>><?php echo constant("STR_FECHA_DE_FIN");?></option>
	...
	<input type="hidden" name="procesos_next_page" value="1" />
