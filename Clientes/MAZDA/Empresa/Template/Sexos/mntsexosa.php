...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdSexo" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdSexo() : $_POST['fIdSexo'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="sexos_next_page" value="<?php echo (isset($_POST['sexos_next_page'])) ? $cUtilidades->validaXSS($_POST['sexos_next_page']) : "1";?>" />