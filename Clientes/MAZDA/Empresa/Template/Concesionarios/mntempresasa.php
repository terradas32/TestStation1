...
function validaForm()
{
  ...
  msg +=vString("Razón Social:",f.fRazonSocial.value,255,true);


	if (!f.fCifOK.checked){
		msg +=vCif("<?php echo constant("STR_CIF");?>:",f.fCif.value,255,true);
	}
		...
		<div style="width: 100%">
				...
				<table cellspacing="0" cellpadding="5" width="100%" border="0">
					<tr>
						...
						<td colspan="5" nowrap="nowrap" class="negro" valign="top"><?php echo constant("STR_LOS_CAMPOS_MARCADOS_CON");?> <input type="text" name="--" value="" class="obliga" style="width:25px;height:10px;" onfocus="blur();" /> <?php echo constant("STR_OBLIGATORIOS");?></td>
					</tr>
					<tr><td colspan="6" align="center" class="naranjab"><?php if (isset($_POST['MODO']) && ($_POST['MODO'] == constant("MNT_ALTA"))){echo(constant("STR_ANIADIR"));}else{echo(constant("STR_MODIFICAR"));}?></td></tr>
					<tr><td colspan="6"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="1" height="1" border="0" alt="" /></td></tr>
            ...
            <td colspan="3">
              <fieldset>
                <legend>Datos del concesionario</legend>
                  <table cellspacing="0" cellpadding="5" width="100%" border="0">
                    <tr>
          						<td width="180" nowrap="nowrap" class="negrob" valign="top"><?php echo constant("STR_NOMBRE");?> del Concesionario&nbsp;</td>
          						<td ><input type="text" name="fNombre" value="<?php echo $cEntidad->getNombre();?>" class="obliga" style="" onchange="javascript:trim(this);" /></td>
          					</tr>
                    <tr>
          						<td width="180" nowrap="nowrap" class="negrob" valign="top">Razón social&nbsp;</td>
          						<td ><input type="text" name="fRazonSocial" value="<?php echo $cEntidad->getRazonSocial();?>" class="obliga" style="" onchange="javascript:trim(this);" /></td>
          					</tr>
                    <tr>
                      <td nowrap="nowrap" class="negrob" valign="top"><?php echo constant("STR_CIF");?>&nbsp;</td>
                      <td nowrap="nowrap" ><input type="text" name="fCif" value="<?php echo $cEntidad->getCif();?>" class="obliga"  style='width:20%;' onchange="javascript:trim(this);" /><input type="checkbox" name="fCifOK" /><?php echo constant("STR_VERIFICADO");?></td>
                    </tr>
                    <tr>
          						<td nowrap="nowrap" class="negrob" valign="top"><?php echo constant("STR_DIRECCION");?>&nbsp;</td>
          						<td nowrap="nowrap" ><input type="text" name="fDireccion" value="<?php echo $cEntidad->getDireccion();?>" class="obliga" style=""  onchange="javascript:trim(this);" /></td>
                    </tr>
                    <tr>
                <?php
                ...
                ?>
                      <td nowrap="nowrap" class="negrob" valign="top"><?php echo constant("STR_PAIS");?>&nbsp;</td>
                      <td nowrap="nowrap" ><?php $comboWI_PAISES->setNombre("fIdPais");?><?php echo $comboWI_PAISES->getHTMLCombo("1","cajatexto",$cEntidad->getIdPais(),"style='width: 30%;' ","");?></td>
          					</tr>
          					<tr>
          						<td nowrap="nowrap" class="negrob" valign="top">Nº Cuenta corriente&nbsp;/ IBAN</td>
          						<td class="negro" >
          							<input type="text" class="cajatexto" style="background-color: #ececec; border: 1px solid #5f5f5f;" size="19" name="fCuenta" value="<?php echo $cEntidad->getCuenta();?>"   onchange="javascript:trim(this);" />
          						</td>
          					</tr>
                  </table>
               </fieldset>
...
<!--
 ...
 -->
					<input type="hidden" name="fDongles" value="0" />
<!--
					<tr>
						<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
...
<input type="hidden" name="fIdsPruebas" value="115,116,117,118,119,120,121" />
...
<input type="hidden" id="fSectorMB" name="fSectorMB" value="">
<input type="hidden" id="fConcesionMB" name="fConcesionMB" value="">
<input type="hidden" id="fBaseMB" name="fBaseMB" value="">
<input type="hidden" id="fFecNacimientoMB" name="fFecNacimientoMB" value="">
<input type="hidden" id="fEspecialidadMB" name="fEspecialidadMB" value="">
<input type="hidden" id="fNivelConocimientoMB" name="fNivelConocimientoMB" value="">
...
<?php				if(isset($_POST['MODO']) && ($_POST['MODO'] == constant("MNT_MODIFICAR"))){?>
          ...
          <tr>
            <td colspan="3">
              <fieldset>
                <legend>Datos de la persona que gestiona la plataforma</legend>
                  <table cellspacing="0" cellpadding="5" width="100%" border="0">
                    <tr>
                      <td width="120" nowrap="nowrap" class="negrob" valign="top">Persona Contacto&nbsp;</td>
                      <td><input type="text" name="fPersonaContacto" value="<?php echo $cEntidad->getPersonaContacto();?>" class="obliga" style=""  onchange="javascript:trim(this);" /></td>
                    </tr>
                    <tr>
                      <td nowrap="nowrap" class="negrob" valign="top">Tlf. Contacto&nbsp;</td>
                      <td><input type="text" name="fTlfContacto" value="<?php echo $cEntidad->getTlfContacto();?>" class="obliga" style="width:50%;"  onchange="javascript:trim(this);" /></td>
                    </tr>
                    <tr>
                      <td nowrap="nowrap" class="negrob" valign="top">email&nbsp;</td>
                      <td nowrap="nowrap" ><input type="text" name="fMail" value="<?php echo $cEntidad->getMail();?>" class="obliga" style="" onchange="javascript:trim(this);" /></td>
                    </tr>
                    <tr>
                      <td nowrap="nowrap" class="negrob" valign="top">email 2&nbsp;</td>
                      <td nowrap="nowrap" ><input type="text" name="fMail2" value="<?php echo $cEntidad->getMail2();?>" class="cajatexto" style="" onchange="javascript:trim(this);" /></td>
                    </tr>
                    <tr>
                      <td nowrap="nowrap" class="negrob" valign="top">email 3&nbsp;</td>
                      <td><input type="text" name="fMail3" value="<?php echo $cEntidad->getMail3();?>" class="cajatexto" style="" onchange="javascript:trim(this);" /></td>
                    </tr>
                  </table>
               </fieldset>
            </td>
