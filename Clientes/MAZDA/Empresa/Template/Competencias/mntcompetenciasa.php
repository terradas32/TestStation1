...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_TIPO_DE_COMPETENCIA");?>:",f.elements['fIdTipoCompetencia'].value,11,true);
	msg +=vString("<?php echo constant("STR_NOMBRE");?>:",f.fNombre.value,255,true);
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.fDescripcion.value,1000,false);
if (msg != "") {
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdTipoCompetencia"><?php echo constant("STR_TIPO_DE_COMPETENCIA");?></label>&nbsp;</td>
				...
				<tr>
					...
					<td><?php $comboPRUEBASGROUP->setNombre("fIdPrueba");?><?php echo $comboPRUEBASGROUP->getHTMLCombo("1","obliga",$cEntidad->getIdPrueba()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="fIdCompetencia" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdCompetencia() : $_POST['fIdCompetencia'];?>" />
	...
	<input type="hidden" name="competencias_next_page" value="<?php echo (isset($_POST['competencias_next_page'])) ? $cUtilidades->validaXSS($_POST['competencias_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdTipoCompetencia").show().load("jQuery.php",{sPG:"combotipos_competencias",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdTipoCompetencia",fJSProp:"cambiaIdTipoCompetencia",fCodIdiomaIso2:f.fCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdTipoCompetencia();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
