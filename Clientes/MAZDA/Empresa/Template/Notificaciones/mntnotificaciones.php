...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID");?>:", f.LSTIdNotificacion.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdNotificacionHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_TIPO_DE_NOTIFICACION");?>:", f.LSTIdTipoNotificacion.value, 11, false);
	msg +=vString("<?php echo constant("STR_ASUNTO");?>:",f.LSTAsunto.value,255, false);
	msg +=vString("<?php echo constant("STR_CUERPO");?>:",f.LSTCuerpo.value,16777215, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdNotificacion"><?php echo constant("STR_ID");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdNotificacion" name="LSTIdNotificacion" value="<?php echo $cEntidad->getIdNotificacion();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdNotificacionHast" name="LSTIdNotificacionHast" value="<?php echo $cEntidad->getIdNotificacionHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoNotificacion"><?php echo constant("STR_TIPO_DE_NOTIFICACION");?></label>&nbsp;</td>
					<td><?php $comboNOTIFICACIONES_TIPOS->setNombre("LSTIdTipoNotificacion");?><?php echo $comboNOTIFICACIONES_TIPOS->getHTMLCombo("1","cajatexto",$cEntidad->getIdTipoNotificacion()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTAsunto"><?php echo constant("STR_ASUNTO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTAsunto" name="LSTAsunto" value="<?php echo $cEntidad->getAsunto();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTCuerpo"><?php echo constant("STR_CUERPO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTCuerpo" name="LSTCuerpo" value="<?php echo $cEntidad->getCuerpo();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idNotificacion' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idNotificacion') ? "selected='selected'" : "";?>><?php echo constant("STR_ID");?></option>
							<option style='color:#000000;' value='asunto' <?php echo (!empty($sOrderBy) && $sOrderBy == 'asunto') ? "selected='selected'" : "";?>><?php echo constant("STR_ASUNTO");?></option>
							<option style='color:#000000;' value='cuerpo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'cuerpo') ? "selected='selected'" : "";?>><?php echo constant("STR_CUERPO");?></option>
	...
	<input type="hidden" name="notificaciones_next_page" value="1" />
