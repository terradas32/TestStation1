...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_EJEMPLO");?>:", f.LSTIdEjemplo.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_EJEMPLO");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdEjemploHast.value, 11, false);
	...
	msg +=vString("<?php echo constant("STR_ENUNCIADO");?>:",f.LSTEnunciado.value,2500, false);
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.LSTDescripcion.value,2500, false);
	msg +=vString("<?php echo constant("STR_IMAGEN_1");?>:",f.LSTPath1.value,255, false);
	msg +=vString("<?php echo constant("STR_IMAGEN_2");?>:",f.LSTPath2.value,255, false);
	msg +=vString("<?php echo constant("STR_IMAGEN_3");?>:",f.LSTPath3.value,255, false);
	msg +=vString("<?php echo constant("STR_IMAGEN_4");?>:",f.LSTPath4.value,255, false);
	msg +=vString("<?php echo constant("STR_CORRECTO");?>:",f.LSTCorrecto.value,255, false);
	msg +=vNumber("<?php echo constant("STR_ORDEN");?>:", f.LSTOrden.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ORDEN");?> <?php echo constant("STR_HASTA");?>:", f.LSTOrdenHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_BAJA_LOGICA");?>:", f.LSTBajaLog.value, 1, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdEjemplo"><?php echo constant("STR_ID_EJEMPLO");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdEjemplo" name="LSTIdEjemplo" value="<?php echo $cEntidad->getIdEjemplo();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdEjemploHast" name="LSTIdEjemploHast" value="<?php echo $cEntidad->getIdEjemploHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTEnunciado"><?php echo constant("STR_ENUNCIADO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTEnunciado" name="LSTEnunciado" value="<?php echo $cEntidad->getEnunciado();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPath1"><?php echo constant("STR_IMAGEN_1");?></label>&nbsp;</td>
					<td><input type="text" id="LSTPath1" name="LSTPath1" value="<?php echo $cEntidad->getPath1();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPath2"><?php echo constant("STR_IMAGEN_2");?></label>&nbsp;</td>
					<td><input type="text" id="LSTPath2" name="LSTPath2" value="<?php echo $cEntidad->getPath2();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPath3"><?php echo constant("STR_IMAGEN_3");?></label>&nbsp;</td>
					<td><input type="text" id="LSTPath3" name="LSTPath3" value="<?php echo $cEntidad->getPath3();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPath4"><?php echo constant("STR_IMAGEN_4");?></label>&nbsp;</td>
					<td><input type="text" id="LSTPath4" name="LSTPath4" value="<?php echo $cEntidad->getPath4();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTCorrecto"><?php echo constant("STR_CORRECTO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTCorrecto" name="LSTCorrecto" value="<?php echo $cEntidad->getCorrecto();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTOrden"><?php echo constant("STR_ORDEN");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTOrden" name="LSTOrden" value="<?php echo $cEntidad->getOrden();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTOrdenHast" name="LSTOrdenHast" value="<?php echo $cEntidad->getOrdenHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTBajaLog"><?php echo constant("STR_BAJA_LOGICA");?></label>&nbsp;</td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idEjemplo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idEjemplo') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_EJEMPLO");?></option>
							...
							<option style='color:#000000;' value='path1' <?php echo (!empty($sOrderBy) && $sOrderBy == 'path1') ? "selected='selected'" : "";?>><?php echo constant("STR_IMAGEN_1");?></option>
							<option style='color:#000000;' value='path2' <?php echo (!empty($sOrderBy) && $sOrderBy == 'path2') ? "selected='selected'" : "";?>><?php echo constant("STR_IMAGEN_2");?></option>
							<option style='color:#000000;' value='path3' <?php echo (!empty($sOrderBy) && $sOrderBy == 'path3') ? "selected='selected'" : "";?>><?php echo constant("STR_IMAGEN_3");?></option>
							<option style='color:#000000;' value='path4' <?php echo (!empty($sOrderBy) && $sOrderBy == 'path4') ? "selected='selected'" : "";?>><?php echo constant("STR_IMAGEN_4");?></option>
							...
							<option style='color:#000000;' value='bajaLog' <?php echo (!empty($sOrderBy) && $sOrderBy == 'bajaLog') ? "selected='selected'" : "";?>><?php echo constant("STR_BAJA_LOGICA");?></option>
	...
	<input type="hidden" name="ejemplos_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdPrueba").show().load("jQuery.php",{sPG:"combopruebas",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdPrueba",fJSProp:"cambiaIdPrueba",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdPrueba();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
