...
function enviar()
{
	...
	if (validaForm()){
		...
		f.fIdOpcion.value=f.elements['fIdOpcion'].value;
		return true;
	}else	return false;
}
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_OPCION");?>:",f.elements['fIdOpcion'].value,11,true);
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><?php $comboEMPRESAS->setNombre("fIdEmpresa");?><?php echo $comboEMPRESAS->getHTMLComboMenu("1","obliga",$cEntidad->getIdEmpresa(),"disabled=\"disabled\" onchange=\"javascript:cambiaIdEmpresa()\"","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdCandidato"><?php echo constant("STR_CANDIDATO");?></label>&nbsp;</td>
						<td><div id="comboIdCandidato"><?php $comboCANDIDATOS->setNombre("fIdCandidato");?><?php echo $comboCANDIDATOS->getHTMLComboNull("1","obliga",$cEntidad->getIdCandidato(),"disabled=\"disabled\" onchange=\"javascript:cambiaIdCandidato()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fCodIdiomaIso2"><?php echo constant("STR_IDIOMA");?></label>&nbsp;</td>
					<td><?php $comboWI_IDIOMAS->setNombre("fCodIdiomaIso2");?><?php echo $comboWI_IDIOMAS->getHTMLCombo("1","obliga",$cEntidad->getCodIdiomaIso2(),"disabled=\"disabled\" onchange=\"javascript:cambiaCodIdiomaIso2()\"","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdPrueba"><?php echo constant("STR_PRUEBA");?></label>&nbsp;</td>
						<td><div id="comboIdPrueba"><?php $comboPRUEBAS->setNombre("fIdPrueba");?><?php echo $comboPRUEBAS->getHTMLComboNull("1","obliga",$cEntidad->getIdPrueba(),"disabled=\"disabled\" onchange=\"javascript:cambiaIdPrueba()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdItem"><?php echo constant("STR_ITEM");?></label>&nbsp;</td>
						<td><div id="comboIdItem"><?php $comboITEMS->setNombre("fIdItem");?><?php echo $comboITEMS->getHTMLComboNull("1","obliga",$cEntidad->getIdItem(),"disabled=\"disabled\" onchange=\"javascript:cambiaIdItem()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdOpcion"><?php echo constant("STR_OPCION");?></label>&nbsp;</td>
						<td><div id="comboIdOpcion"><?php $comboOPCIONES->setNombre("fIdOpcion");?><?php echo $comboOPCIONES->getHTMLComboNull("1","obliga",$cEntidad->getIdOpcion(),"disabled=\"disabled\" onchange=\"javascript:cambiaIdOpcion()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fOrden"><?php echo constant("STR_ORDEN");?></label>&nbsp;</td>
					<td><input type="text" disabled="disabled" id="fOrden" name="fOrden" value="<?php echo $cEntidad->getOrden();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
	...
	<input type="hidden" name="respuestas_pruebas_items_next_page" value="<?php echo (isset($_POST['respuestas_pruebas_items_next_page'])) ? $cUtilidades->validaXSS($_POST['respuestas_pruebas_items_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdEmpresa(){
								var f= document.forms[0];
								$("#comboIdProceso").show().load("jQuery.php",{sPG:"comboprocesos",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdProceso",fJSProp:"cambiaIdProceso",fIdEmpresa:f.fIdEmpresa.value,vSelected:"<?php echo $cEntidad->getIdProceso();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdCandidato").show().load("jQuery.php",{sPG:"combocandidatos",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdCandidato",fJSProp:"cambiaIdCandidato",fIdEmpresa:f.fIdEmpresa.value,fIdProceso:f.fIdProceso.value,vSelected:"<?php echo $cEntidad->getIdCandidato();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdProceso(){
								var f= document.forms[0];
								$("#comboIdCandidato").show().load("jQuery.php",{sPG:"combocandidatos",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdCandidato",fJSProp:"cambiaIdCandidato",fIdEmpresa:f.fIdEmpresa.value,fIdProceso:f.fIdProceso.value,vSelected:"<?php echo $cEntidad->getIdCandidato();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdPrueba").show().load("jQuery.php",{sPG:"combopruebas",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdPrueba",fJSProp:"cambiaIdPrueba",fCodIdiomaIso2:f.fCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdPrueba();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdItem").show().load("jQuery.php",{sPG:"comboitems",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdItem",fJSProp:"cambiaIdItem",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPrueba:f.fIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdItem();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdOpcion").show().load("jQuery.php",{sPG:"comboopciones",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdOpcion",fJSProp:"cambiaIdOpcion",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPrueba:f.fIdPrueba.value,fIdItem:f.fIdItem.value,vSelected:"<?php echo $cEntidad->getIdOpcion();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdPrueba(){
								var f= document.forms[0];
								$("#comboIdItem").show().load("jQuery.php",{sPG:"comboitems",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdItem",fJSProp:"cambiaIdItem",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPrueba:f.fIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdItem();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdOpcion").show().load("jQuery.php",{sPG:"comboopciones",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdOpcion",fJSProp:"cambiaIdOpcion",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPrueba:f.fIdPrueba.value,fIdItem:f.fIdItem.value,vSelected:"<?php echo $cEntidad->getIdOpcion();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdItem(){
								var f= document.forms[0];
								$("#comboIdOpcion").show().load("jQuery.php",{sPG:"comboopciones",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdOpcion",fJSProp:"cambiaIdOpcion",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPrueba:f.fIdPrueba.value,fIdItem:f.fIdItem.value,vSelected:"<?php echo $cEntidad->getIdOpcion();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
