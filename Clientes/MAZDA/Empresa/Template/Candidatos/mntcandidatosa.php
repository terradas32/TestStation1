...
if (!f.fDniOK.checked){
  var required = false;
  var contratado = document.getElementsByName("fCertificada");
  if (contratado[0].checked == true) {
    required=true;
    if (f.fFinalizado.value != "1"){
      msg +="Contratado:" + "\n\tPara marcar el campo “Contratado” con “Si” es requisito\n\timprescindible que el candidato haya finalizado la batería\n\tde pruebas asignada.\n";
    }
  }
	msg +=vString("<?php echo constant("STR_NIF");?>:",f.fDni.value,255,required);
}
	msg +=vEmail("<?php echo constant("STR_EMAIL");?>:",f.fMail.value,255,true);
	msg +=vNumber("<?php echo constant("STR_TRATAMIENTO");?>:",f.fIdTratamiento.value,11,false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><?php $comboEMPRESAS->setNombre("fIdEmpresa");?><?php echo $comboEMPRESAS->getHTMLCombo("1","obliga",$cEntidad->getIdEmpresa(),"disabled=\"disabled\" onchange=\"javascript:cambiaIdEmpresa()\"","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdProceso"><?php echo constant("STR_PROCESO");?></label>&nbsp;</td>
						<td><div id="comboIdProceso"><?php $comboPROCESOS->setNombre("fIdProceso");?><?php echo $comboPROCESOS->getHTMLComboNull("1","obliga",$cEntidad->getIdProceso(),"disabled=\"disabled\" onchange=\"javascript:cambiaIdProceso()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fNombre"><?php echo constant("STR_NOMBRE");?></label>&nbsp;</td>
					<td><input type="text" disabled="disabled" id="fNombre" name="fNombre" value="<?php echo $cEntidad->getNombre();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><input type="text" disabled="disabled" id="fApellido2" name="fApellido2" value="<?php echo $cEntidad->getApellido2();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fDni"><?php echo constant("STR_NIF");?></label>&nbsp;</td>
					<td><input type="text" id="fDni" name="fDni" value="<?php echo $cEntidad->getDni();?>" class="cajatexto"  style='width:75%;' onchange="javascript:trim(this);" /><input type="checkbox" style="display:none;" name="fDniOK" /><?php //echo constant("STR_VERIFICADO");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><?php $comboTRATAMIENTOS->setNombre("fIdTratamiento");?><?php echo $comboTRATAMIENTOS->getHTMLCombo("1","cajatexto",$cEntidad->getIdTratamiento(),"disabled=\"disabled\" ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdSexo"><?php echo constant("STR_SEXO");?></label>&nbsp;</td>
					<td><?php $comboSEXOS->setNombre("fIdSexo");?><?php echo $comboSEXOS->getHTMLCombo("1","cajatexto",$cEntidad->getIdSexo(),"disabled=\"disabled\" ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdEdad"><?php echo constant("STR_EDAD");?></label>&nbsp;</td>
					<td><?php $comboEDADES->setNombre("fIdEdad");?><?php echo $comboEDADES->getHTMLCombo("1","cajatexto",$cEntidad->getIdEdad(),"disabled=\"disabled\" ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					<?php
					if ($cEntidad->getFechaNacimiento() != "" && $cEntidad->getFechaNacimiento() != "0000-00-00" && $cEntidad->getFechaNacimiento() != "0000-00-00 00:00:00"){
					...
					?>
					<td><input type="text" id="fFechaNacimiento" disabled="disabled" name="fFechaNacimiento" value="<?php echo $cEntidad->getFechaNacimiento();?>" class=cajatexto style="width:75px;" onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdMunicipio"><?php echo constant("STR_MUNICIPIO");?></label>&nbsp;</td>
						<td><div id="comboIdMunicipio"><?php $comboWI_MUNICIPIOS->setNombre("fIdMunicipio");?><?php echo $comboWI_MUNICIPIOS->getHTMLComboNull("1","cajatexto",$cEntidad->getIdMunicipio(),"disabled=\"disabled\" onchange=\"javascript:cambiaIdMunicipio()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdZona"><?php echo constant("STR_ZONA");?></label>&nbsp;</td>
						<td><div id="comboIdZona"><?php $comboWI_ZONAS->setNombre("fIdZona");?><?php echo $comboWI_ZONAS->getHTMLComboNull("1","cajatexto",$cEntidad->getIdZona(),"disabled=\"disabled\" onchange=\"javascript:cambiaIdZona()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fDireccion"><?php echo constant("STR_DIRECCION");?></label>&nbsp;</td>
					<td><input type="text" disabled="disabled" id="fDireccion" name="fDireccion" value="<?php echo $cEntidad->getDireccion();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fCodPostal"><?php echo constant("STR_CODIGO_POSTAL");?></label>&nbsp;</td>
					<td><input type="text" disabled="disabled" id="fCodPostal" name="fCodPostal" value="<?php echo $cEntidad->getCodPostal();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdFormacion"><?php echo constant("STR_FORMACION");?></label>&nbsp;</td>
					<td><?php $comboFORMACIONES->setNombre("fIdFormacion");?><?php echo $comboFORMACIONES->getHTMLCombo("1","cajatexto",$cEntidad->getIdFormacion(),"disabled=\"disabled\" ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><input type="text" disabled="disabled" id="fTelefono" name="fTelefono" value="<?php echo $cEntidad->getTelefono();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fEstadoCivil"><?php echo constant("STR_ESTADO_CIVIL");?></label>&nbsp;</td>
					<td><input type="text" disabled="disabled" id="fEstadoCivil" name="fEstadoCivil" value="<?php echo $cEntidad->getEstadoCivil();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fNacionalidad"><?php echo constant("STR_NACIONALIDAD");?></label>&nbsp;</td>
					<td><input type="text" disabled="disabled" id="fNacionalidad" name="fNacionalidad" value="<?php echo $cEntidad->getNacionalidad();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
        <?php
				if ($_cEntidadUsuarioTK->getIdEmpresa() == "3788")
				{
				?>
        <tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Acepta Mazda:&nbsp;</td>
					<td>
            <input type="hidden" name="fAceptaMazda" id="fAceptaMazda1" value="<?php echo $cEntidad->getAceptaMazda();?>" />
            <?php
              $sAceptaMazda = "";
              if ($cEntidad->getAceptaMazda() == "1" ){
                $sAceptaMazda = constant("STR_SI");
              }
              if ($cEntidad->getAceptaMazda() == "0" ){
                $sAceptaMazda = constant("STR_NO");
              }
              echo $sAceptaMazda;
            ?>
					</td>
        ...
        <tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Contratado:&nbsp;</td>
					<td>
						<input type="radio" name="fCertificada" id="fCertificada1" value="1"  <?php echo ($cEntidad->getCertificada() != "" && strtoupper($cEntidad->getCertificada()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fCertificada1"><?php echo constant("STR_SI");?></label>&nbsp;<input type="radio" name="fCertificada" id="fCertificada0" value="0"  <?php echo ($cEntidad->getCertificada() != "" && strtoupper($cEntidad->getCertificada()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fCertificada0"><?php echo constant("STR_NO");?></label></td>
				</tr>
				<?php
				if ($_cEntidadUsuarioTK->getIdEmpresa() == "*PEdro")
				{
				?>

				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Enviado Diploma:&nbsp;</td>
					<td>
						<input type="radio" name="fEnvDiploma" id="fEnvDiploma1" value="1"  <?php echo ($cEntidad->getEnvDiploma() != "" && strtoupper($cEntidad->getEnvDiploma()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fEnvDiploma1"><?php echo constant("STR_SI");?></label>&nbsp;<input type="radio" name="fEnvDiploma" id="fEnvDiploma0" value="0"  <?php echo ($cEntidad->getEnvDiploma() != "" && strtoupper($cEntidad->getEnvDiploma()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fEnvDiploma0"><?php echo constant("STR_NO");?></label></td>
				</tr>
				<?php
				}else
				{
				?>
					<input type="hidden" name="fEnvDiploma" id="fEnvDiploma1" value="<?php echo $cEntidad->getEnvDiploma();?>" />
				<?php
				}
				?>
        <input type="hidden" name="fFinalizado" id="fFinalizado" value="<?php echo $cEntidad->getFinalizado();?>" />
	...
	<input type="hidden" name="candidatos_next_page" value="<?php echo (isset($_POST['candidatos_next_page'])) ? $cUtilidades->validaXSS($_POST['candidatos_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdEmpresa(){
								var f= document.forms[0];
								$("#comboIdProceso").show().load("jQuery.php",{sPG:"comboprocesos",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdProceso",fJSProp:"cambiaIdProceso",fIdEmpresa:f.fIdEmpresa.value,vSelected:"<?php echo $cEntidad->getIdProceso();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdProvincia(){
								var f= document.forms[0];
								$("#comboIdMunicipio").show().load("jQuery.php",{sPG:"combowi_municipios",bBus:"0",multiple:"0",nLineas:"1",bObliga:"0",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdMunicipio",fJSProp:"cambiaIdMunicipio",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdProvincia:f.fIdProvincia.value,vSelected:"<?php echo $cEntidad->getIdMunicipio();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdZona").show().load("jQuery.php",{sPG:"combowi_zonas",bBus:"0",multiple:"0",nLineas:"1",bObliga:"0",fDisabled:"disabled",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdZona",fJSProp:"cambiaIdZona",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdMunicipio:f.fIdMunicipio.value,vSelected:"<?php echo $cEntidad->getIdZona();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
