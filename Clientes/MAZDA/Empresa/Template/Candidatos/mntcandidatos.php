...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
        ...
        <tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTAceptaMazda"><?php echo "Acepta Mazda";?></label>&nbsp;</td>
					<td><input type="radio" name="LSTAceptaMazda" id="LSTAceptaMazda1" value="1"  <?php echo ($cEntidad->getAceptaMazda() != "" && strtoupper($cEntidad->getAceptaMazda()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTAceptaMazda1"><?php echo constant("STR_SI");?></label>&nbsp;<input type="radio" name="LSTAceptaMazda" id="LSTAceptaMazda0" value="0"  <?php echo ($cEntidad->getAceptaMazda() != "" && strtoupper($cEntidad->getAceptaMazda()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTAceptaMazda0"><?php echo constant("STR_NO");?></label>&nbsp;<input type="hidden" name="LSTAceptaMazdaHast" value="<?php echo $cEntidad->getAceptaMazda();?>" /></td>
        </tr>
        <?php
        }
        ?>
