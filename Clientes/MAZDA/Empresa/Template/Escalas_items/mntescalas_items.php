...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_BLOQUE");?>:", f.LSTIdBloque.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ESCALA");?>:",f.elements['LSTIdEscala'].value, 11, false);
...
<body onload="_body_onload();cambiaIdBloque();cambiaIdPrueba();block('<?php echo ($_POST["_block"] != "") ? $_POST["_block"] : "-1";?>');setClicado('<?php echo $_POST["_clicado"];?>');" onunload="_body_onunload();">
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdBloque"><?php echo constant("STR_BLOQUE");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdEscala"><?php echo constant("STR_ESCALA");?></label>&nbsp;</td>
	...
	<input type="hidden" name="escalas_items_next_page" value="1" />
