...
if (!defined ("DIR_FS_DOCUMENT_ROOT")){
	...
	$cEntidadFuncionalidadesDB	= new FuncionalidadesDB($conn);  // Entidad DB
	...
	if (isset($_POST[$sPrefijo . "DentroDe"]) && $_POST[$sPrefijo . "DentroDe"] != ""){
		$cEntidadFuncionalidades->setOrden($_POST[$sPrefijo . "DentroDe"]);
		$cEntidadFuncionalidades = $cEntidadFuncionalidadesDB->readEntidadOrden($cEntidadFuncionalidades);
		$sWhere.=(empty($sWhere) ? " " : " AND ") . "idPadre=" . $conn->qstr($cEntidadFuncionalidades->getIdFuncionalidad(), false);
	}
	if (empty($sWhere)){
