...
<?php ob_start();?>
	<table cellspacing="1" cellpadding="0" border="0" width="100%">
		<tr>
			...
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "idPerfil"){
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo htmlentities(constant("STR_ID_PERFIL"), ENT_COMPAT, "UTF-8");?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='idPerfil';document.forms[0].LSTOrder.value='<?php echo $sOrden;?>';enviar('<?php echo constant("MNT_LISTAR");?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo addslashes(constant("STR_ID_PERFIL"));?>';return true"><?php echo constant("STR_ID_PERFIL");?><?php echo $sPinta;?></a></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
		...
		<tr onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER");?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT");?>'" bgcolor="<?php echo constant("ONMOUSEOUT");?>">
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['idPerfil']));?>"><?php echo substr(str_replace("\n","<br />",strip_tags(html_entity_decode($lista->fields['idPerfil']), "<b><i><u><strong><br><br />")),0,25);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['descripcion']));?>"><?php echo substr(str_replace("\n","<br />",strip_tags(html_entity_decode($lista->fields['descripcion']), "<b><i><u><strong><br><br />")),0,250);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['fecAlta']));?>"><script language="javascript" type="text/javascript">document.write(formatThisDate('<?php echo $lista->fields['fecAlta'];?>'));</script></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['fecMod']));?>"><script language="javascript" type="text/javascript">document.write(formatThisDate('<?php echo $lista->fields['fecMod'];?>'));</script></td>
			<td class="tddatoslista" align="center"><?php if ($lista->fields['idPerfil'] > 1){?><a href="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>');confBorrar(<?php echo constant("MNT_BORRAR");?>,'<?php echo constant("DEL_GENERICO");?>');"><?php echo ($_bBorrar) ? "<img src='" . constant("DIR_WS_GRAF") . "menos.gif' width='9' height='9' border='0' alt=\"" . constant("STR_BORRAR") . "\">" : "";?></a><?php }else{echo("&nbsp;");}?></td>
		</tr>
		<?php $i++;
		$lista->MoveNext();
		} ?>
...
<?php $aBuscador= $cEntidad->getBusqueda();?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width='10'><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width='10' height="1" border="0" alt="" /></td>
			<td width="100%" colspan="2" align='left' class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"),str_replace('_', ' ', 'perfiles'));?></td>
		</tr>
		<tr>
			<td width='10'><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width='10' height="1" border="0" alt="" /></td>
	...
	<table cellspacing="0" cellpadding="0" border="0">
		<tr>
			...
			<td align="center" class="negro"><input type="submit" class="botones" <?php echo ($_bModificar) ? "" : "disabled";?> id="bid-alta" name="btnAdd" value="<?php echo constant("STR_ALTA");?>" onclick="document.forms[0].MODO.value=<?php echo constant("MNT_NUEVO");?>" /></td>
		</tr>
	</table>
	<br />
