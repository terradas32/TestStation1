...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_PATH1");?>:",f.fPath1.value,255,false);
	msg +=vString("<?php echo constant("STR_PATH2");?>:",f.fPath2.value,255,false);
	msg +=vString("<?php echo constant("STR_PATH3");?>:",f.fPath3.value,255,false);
	msg +=vString("<?php echo constant("STR_PATH4");?>:",f.fPath4.value,255,false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><input type="text" id="fEnunciado" name="fEnunciado" value="<?php echo $cEntidad->getEnunciado();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPath1"><?php echo constant("STR_PATH1");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPath2"><?php echo constant("STR_PATH2");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPath3"><?php echo constant("STR_PATH3");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPath4"><?php echo constant("STR_PATH4");?></label>&nbsp;</td>
	...
	<input type="hidden" name="fIdItem" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdItem() : $_POST['fIdItem'];?>" />
