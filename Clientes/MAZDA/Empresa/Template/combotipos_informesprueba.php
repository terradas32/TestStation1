...
//inicio de HERRAMIENTAS -->
		...
		{
			if ($k%2 == 0){
				$sTIPOS_INFORMES1 .= '<p><span><input id="' . $sPrefijo . 'IdTipoInforme' . $i . '" name="' . $sPrefijo . 'IdTipoInforme' . $i . '" type="checkbox" checked value="' . $rsTIPOS_INFORMES->fields[$sAsIdTIPOS_INFORMES] . '"><label for="' . $sPrefijo . 'IdTipoInforme' . $i . '">' . $rsTIPOS_INFORMES->fields[$sAsTIPOS_INFORMES] . '</label>';
				$sTIPOS_INFORMES1 .= '</span></p>';
			}else{
				$sTIPOS_INFORMES2 .= '<p><span><input id="' . $sPrefijo . 'IdTipoInforme' . $i . '" name="' . $sPrefijo . 'IdTipoInforme' . $i . '" type="checkbox" checked value="' . $rsTIPOS_INFORMES->fields[$sAsIdTIPOS_INFORMES] . '"><label for="' . $sPrefijo . 'IdTipoInforme' . $i . '">' . $rsTIPOS_INFORMES->fields[$sAsTIPOS_INFORMES] . '</label>';
				$sTIPOS_INFORMES2 .= '</span></p>';
			}
			$k++;
			$i++;
...
//FIN de HERRAMIENTAS -->
echo '<table cellspacing="3" cellpadding="0" width="100%" border="0">';
echo '	<tr>';
echo '		<td>' . $sTIPOS_INFORMES1 . '</td>';
echo '		<td>' . $sTIPOS_INFORMES2 . '</td>';
echo '	</tr>';
echo '</table>';
