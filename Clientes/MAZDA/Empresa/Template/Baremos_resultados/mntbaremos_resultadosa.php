...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_BAREMO");?>:",f.elements['fIdBaremo'].value,11,true);
	msg +=vNumber("<?php echo constant("STR_PRUEBA");?>:",f.fIdPrueba.value,11,true);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MINIMA");?>:",f.fPuntMin.value,11,true);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MAXIMA");?>:",f.fPuntMax.value,11,true);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_BAREMADA");?>:",f.fPuntBaremada.value,11,true);
if (msg != "") {
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdBaremo"><?php echo constant("STR_BAREMO");?></label>&nbsp;</td>
						<td><div id="comboIdBaremo"><?php $comboBAREMOS->setNombre("fIdBaremo");?><?php echo $comboBAREMOS->getHTMLComboNull("1","obliga",$cEntidad->getIdBaremo(),"onchange=\"javascript:cambiaIdBaremo()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPuntMin"><?php echo constant("STR_PUNTUACION_MINIMA");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPuntMax"><?php echo constant("STR_PUNTUACION_MAXIMA");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPuntBaremada"><?php echo constant("STR_PUNTUACION_BAREMADA");?></label>&nbsp;</td>
					<td><input type="text" id="fPuntBaremada" name="fPuntBaremada" value="<?php echo $cEntidad->getPuntBaremada();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
	...
	<input type="hidden" name="fIdResultado" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdResultado() : $_POST['fIdResultado'];?>" />
	...
	<input type="hidden" name="baremos_resultados_next_page" value="<?php echo (isset($_POST['baremos_resultados_next_page'])) ? $cUtilidades->validaXSS($_POST['baremos_resultados_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
