...
function setPK(codIdiomaIso2,idPrueba,idTipoInforme,idIr,idIp)
{
	var f=document.forms[0];
...
<?php ob_start();?>
	<table cellspacing="1" cellpadding="2" border="0" width="100%">
		<tr>
			...
			<td class="tdnaranjab" align="center" valign="top"><?php echo constant("STR_TIPO_INFORME");?></td>
			<td class="tdnaranjab" align="center" valign="top"><?php echo constant("STR_IR");?></td>
			<td class="tdnaranjab" align="center" valign="top"><?php echo constant("STR_IP");?></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
		...
		<tr onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER");?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT");?>'" bgcolor="<?php echo constant("ONMOUSEOUT");?>">
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoInforme']);?>','<?php echo addslashes($lista->fields['idIr']);?>','<?php echo addslashes($lista->fields['idIp']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['codIdiomaIso2']);?>"><?php echo $comboWI_IDIOMAS->getDescripcionCombo($lista->fields['codIdiomaIso2']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoInforme']);?>','<?php echo addslashes($lista->fields['idIr']);?>','<?php echo addslashes($lista->fields['idIp']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idPrueba']);?>"><?php echo $comboPRUEBAS->getDescripcionCombo($lista->fields['idPrueba']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoInforme']);?>','<?php echo addslashes($lista->fields['idIr']);?>','<?php echo addslashes($lista->fields['idIp']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idTipoInforme']);?>"><?php echo $comboINFORMES_PRUEBAS->getDescripcionCombo($lista->fields['idTipoInforme']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoInforme']);?>','<?php echo addslashes($lista->fields['idIr']);?>','<?php echo addslashes($lista->fields['idIp']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idIr']);?>"><?php echo $comboRANGOS_IR->getDescripcionCombo($lista->fields['idIr']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoInforme']);?>','<?php echo addslashes($lista->fields['idIr']);?>','<?php echo addslashes($lista->fields['idIp']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idIp']);?>"><?php echo $comboRANGOS_IP->getDescripcionCombo($lista->fields['idIp']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoInforme']);?>','<?php echo addslashes($lista->fields['idIr']);?>','<?php echo addslashes($lista->fields['idIp']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['texto']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['texto'], "<b><i><u><strong><br><br />")),0,11);?></td>
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
			<td width="100%" colspan="2" class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"),str_replace('_', ' ', constant("STR_RANGOSTEXTOS")));?><a href="sqlToExcel.php?fSQLtoEXCEL=<?php echo base64_encode($sql . constant("CHAR_SEPARA") . "rangos_textos");?>"><img src="<?php echo constant('DIR_WS_GRAF');?>excel.gif" width="34" height="35" align="right" border="0" alt="<?php echo constant("STR_EXPORTAR_A_EXCEL");?>" /></a></td>
		</tr>
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
	...
	<input type="hidden" name="fIdIr" value="" />
	<input type="hidden" name="fIdIp" value="" />
	...
	<input type="hidden" name="rangos_textos_next_page" value="<?php echo (isset($_POST['rangos_textos_next_page'])) ? $cUtilidades->validaXSS($_POST['rangos_textos_next_page']) : "1";?>" /></div>
