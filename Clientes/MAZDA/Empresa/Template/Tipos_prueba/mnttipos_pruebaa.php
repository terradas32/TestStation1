...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdTipoPrueba" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdTipoPrueba() : $_POST['fIdTipoPrueba'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="tipos_prueba_next_page" value="<?php echo (isset($_POST['tipos_prueba_next_page'])) ? $cUtilidades->validaXSS($_POST['tipos_prueba_next_page']) : "1";?>" />