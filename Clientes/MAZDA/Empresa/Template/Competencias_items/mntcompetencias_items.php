...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_TIPO_COMPETENCIA");?>:", f.LSTIdTipoCompetencia.value, 11, false);
...
<body onload="_body_onload();cambiaIdTipoCompetencia();cambiaIdPrueba();block('<?php echo ($_POST["_block"] != "") ? $_POST["_block"] : "-1";?>');setClicado('<?php echo $_POST["_clicado"];?>');" onunload="_body_onunload();">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><?php $comboTIPOS_COMPETENCIAS->setNombre("LSTIdTipoCompetencia");?><?php echo $comboTIPOS_COMPETENCIAS->getHTMLCombo("1","cajatexto",$cEntidad->getIdTipoCompetencia()," onchange=\"javascript:cambiaIdTipoCompetencia()\"","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
