...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.fDescripcionItem.value,1500,false);
	...
	<table cellspacing="0" cellpadding="0" border="0">
		<tr>
			...
			<?php if($_POST['MODO']== constant('MNT_MODIFICAR')){?>
				<td><input type="button" class="botonesgrandes" id="" name="btnGestionaOpciones" value="Gestionar opciones" onclick="document.forms[0].MODO.value=<?php echo constant('MNT_LISTAR')?>;document.forms[0].fOpcion.value=1;document.forms[0].submit();"/></td>
			<?php } ?>
		</tr>
	</table>
	</div>
