...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_ITEM");?>:", f.LSTIdItem.value, 11, false);
	...
	msg +=vNumber("<?php echo constant("STR_BAJA_LOG");?> <?php echo constant("STR_HASTA");?>:", f.LSTBajaLogHast.value, 2, false);
	...
	msg +=vDate("Fecha de  Mod:",f.LSTFecMod.value,10,false);
	msg +=vDate("Fecha de  Mod <?php echo constant("STR_HASTA");?>:",f.LSTFecModHast.value,10,false);
	if (msg != "") {
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_ID_OPCION");?>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" name="LSTIdOpcion" value="<?php echo $cEntidad->getIdOpcion();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" name="LSTIdOpcionHast" value="<?php echo $cEntidad->getIdOpcionHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_ITEM");?>&nbsp;</td>
					<td><?php $comboITEMS->setNombre("LSTIdItem");?><?php echo $comboITEMS->getHTMLCombo("1","cajatexto",$cEntidad->getIdItem()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><input type="text" name="LSTCodigo" value="<?php echo $cEntidad->getCodigo();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" name="LSTBajaLog" value="<?php echo $cEntidad->getBajaLog();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" name="LSTBajaLogHast" value="<?php echo $cEntidad->getBajaLogHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_FECHA_MODIFICACION");?>&nbsp;</td>
				...
				<tr>
					...
					<td>
						<select name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='fecMod' <?php echo (!empty($sOrderBy) && $sOrderBy == 'fecMod') ? "selected='selected'" : "";?>><?php echo constant("STR_FECHA_MODIFICACION");?></option>
						</select>
					</td>
				</tr>
				<tr>
	...
	<input type="hidden" name="opciones_next_page" value="1" /></div>
