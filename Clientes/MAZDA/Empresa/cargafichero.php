...
include_once ('include/conexion.php');
	...
	}else 
	{
		...
		$cFicheros_carga->setUsuAlta($_cEntidadUsuarioTK->getUsuario());
...
//		@move_uploaded_file($_FILES['fFichero']['tmp_name'], constant("DIR_FS_DOCUMENT_ROOT_ADMIN") . "ficheros/".$_FILES['fFichero']['name']);		
	}		
//	echo "{";
//	echo				"error: '" . $error . "',\n";
//	echo				"msg: '" . $msg . "'\n";
