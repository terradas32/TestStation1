	...
	switch ($cPruebas->getIdTIpoPrueba())
	{
		...
		case "7":	//7 -->Personalidad
			...
			if ($cPruebas->getIdPrueba() == "11" ||
				...
				$cPruebas->getIdPrueba() == "117" ||
				$cPruebas->getIdPrueba() == "123" ||
				$cPruebas->getIdPrueba() == "121" ){
...
<?php include('include/metatags.php');?>
    ...
    <script language="javascript" type="text/javascript" src="codigo/jquery.dateformat.min.js"></script>
    <script language="javascript" type="text/javascript" src="codigo/jquery.epiclock.min.js"></script>
    <script language="javascript" type="text/javascript" src="codigo/epiclock.retro-countdown.min.js"></script>
...
function guardarespuestaTXT(idItem,idOpcion,orden,nOpciones,obj){
	lon();
	var f = document.forms[0];
	var sValor = obj.value;
	var paginacargada = "guardarespuestaTXT.php";
	$("div#guardarespuesta").load(paginacargada,{
		fOrden:"1",
		fPaginaSel:f.fPaginaSel.value,
		fIdEmpresa:f.fIdEmpresa.value,
