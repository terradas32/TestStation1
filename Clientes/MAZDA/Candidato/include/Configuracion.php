<?php
	...
	define("HTTP_SERVER", "http://" . $_SERVER["HTTP_HOST"] . "/Clientes/MAZDA/Candidato/");	//Siempre terminar en "/"
	define("HTTPS_SERVER", "https://" . $_SERVER["HTTP_HOST"] . "/Clientes/MAZDA/Candidato/");	//Siempre terminar en "/"
	define("HTTP_SERVER_FRONT", "http://" . $_SERVER["HTTP_HOST"] . "/Clientes/MAZDA/");	//Siempre terminar en "/"
	define("DIR_WS_GESTOR", "http://" . $_SERVER["HTTP_HOST"] . "/Admin/");
	...
	//Directorios físicos
	define("DIR_FS_DOCUMENT_ROOT", $_SERVER["DOCUMENT_ROOT"] . "/Clientes/MAZDA/Candidato/"); //Siempre terminar en "/"
