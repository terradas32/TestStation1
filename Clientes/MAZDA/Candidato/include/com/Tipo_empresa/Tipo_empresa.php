...
* los valores de la entidad de clase Tipo_empresa.
**/
class Tipo_empresa
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idTipoEmpresa,descripcion,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id,Descripción,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}


	/**
	* Devuelve el contenido de la propiedad idTipoEmpresa
	* @return int(11)
	*/
	...
	/**
	* Fija el contenido de la propiedad idTipoEmpresa
	* @param idTipoEmpresa
	* @return void
	*/
	function setIdTipoEmpresa($sCadena){
		$this->idTipoEmpresa = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idTipoEmpresaHast
	* @return int(11)
	*/
	function getIdTipoEmpresaHast(){
		return $this->idTipoEmpresaHast;
	}
	/**
	* Fija el contenido de la propiedad idTipoEmpresaHast
	* @param idTipoEmpresa
	* @return void
	*/
	function setIdTipoEmpresaHast($sCadena){
		$this->idTipoEmpresaHast = $sCadena;
	}
	/**
