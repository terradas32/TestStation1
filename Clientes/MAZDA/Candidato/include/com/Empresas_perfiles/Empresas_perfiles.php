...
* los valores de la entidad de clase Empresas_perfiles.
**/
class Empresas_perfiles
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idPerfil,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Empresa,Perfil,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Empresas_perfiles
?>