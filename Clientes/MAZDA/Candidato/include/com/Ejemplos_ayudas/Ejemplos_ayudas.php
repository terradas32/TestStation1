...
* los valores de la entidad de clase Ejemplos_ayudas.
**/
class Ejemplos_ayudas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idAyuda,codIdiomaIso2,idPrueba,texto,orden,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Ayuda,Idioma,Prueba,Texto,Orden,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}


	/**
	* Devuelve el contenido de la propiedad idAyuda
	* @return int(11)
	*/
	function getIdAyuda(){
		return $this->idAyuda;
	...
	/**
	* Fija el contenido de la propiedad idAyuda
	* @param idAyuda
	* @return void
	*/
	function setIdAyuda($sCadena){
		$this->idAyuda = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idAyudaHast
	* @return int(11)
	*/
	function getIdAyudaHast(){
		return $this->idAyudaHast;
	}
	/**
	* Fija el contenido de la propiedad idAyudaHast
	* @param idAyuda
	* @return void
	*/
	function setIdAyudaHast($sCadena){
		$this->idAyudaHast = $sCadena;
	}
	/**
...
}//Fin de la Clase Ejemplos_ayudas
?>