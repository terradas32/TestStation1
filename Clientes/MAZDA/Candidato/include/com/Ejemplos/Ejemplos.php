...
* los valores de la entidad de clase Ejemplos.
**/
class Ejemplos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEjemplo,codIdiomaIso2,idPrueba,enunciado,descripcion,path1,path2,path3,path4,correcto,orden,bajaLog,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Ejemplo,Idioma,Prueba,Enunciado,Descripción,Imagen 1,Imagen 2,Imagen 3,Imagen 4,Correcto,Orden,Baja Lógica,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
