...
* los valores de la entidad de clase Proceso_pruebas_candidato.
**/
class Proceso_pruebas_candidato
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idProceso,codIdiomaIso2,idPrueba,idCandidato,orden,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Empresa,Proceso,Idioma,Prueba,Candidato,orden,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Proceso_pruebas_candidato
?>