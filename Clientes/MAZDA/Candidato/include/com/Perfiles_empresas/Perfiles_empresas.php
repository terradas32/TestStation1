...
* los valores de la entidad de clase Perfiles_funcionalidades.
**/
class Perfiles_funcionalidades
{
	...
	* @param $conn			Conexión
	**/
	function Perfiles_funcionalidades()
	{
		$this->iCont			= 0;
...
}//Fin de la Clase Perfiles_funcionalidades
?>