...
* los valores de la entidad de clase Proceso_baremos.
**/
class Proceso_baremos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idProceso,idPrueba,codIdiomaIso2,idBaremo,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id  Empresa,Id  Proceso,Id  Prueba,Idioma,Id  Baremo,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Proceso_baremos
?>