...
class Candidatos
{
	...
	**/
	function __construct()
	{
		...
		$this->ultimaAcc			= "";
		$this->ultimaAccHast			= "";
		$this->PKListaExcel		=	"idCandidato,idEmpresa,idProceso,nombre,aceptaMazda,apellido1,apellido2,dni,mail,idTratamiento,idSexo,idEdad,fechaNacimiento,idPais,idProvincia,idMunicipio,idZona,direccion,codPostal,idFormacion,idNivel,idArea,telefono,codIso2PaisProcedencia,estadoCivil,nacionalidad,certificada,informado,finalizado,fechaFinalizado,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Candidato,Empresa,Proceso,Nombre,acepta Mazda,Apellido 1,Apellido 2,DNI/ N. ID,EMail,Tratamiento,Sexo,Edad,Fecha de Nacimiento,País,Provincía,Municipio,Zona,Dirección,Código Postal,Formación,Nivel,Área,Teléfono,País Procedencia,Estado Civil,Nacionalidad,Contratado,Informado,Finalizado,Fecha de Finalizado,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}

	/**
	* Devuelve el contenido de la propiedad idCandidatoIN
	* @return int(11)
	*/
	function getIdCandidatoIN(){
		return $this->idCandidatoIN;
	}
	/**
	* Fija el contenido de la propiedad idCandidatoIN
	* @param idCandidatoIN
	* @return void
	*/
	function setIdCandidatoIN($sCadena){
		$this->idCandidatoIN = $sCadena;
	}
	/**
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad aceptaMazda
	* @return varchar(255)
	*/
	function getAceptaMazda(){
		return $this->aceptaMazda;
	}
	/**
	* Fija el contenido de la propiedad aceptaMazda
	* @param aceptaMazda
	* @return void
	*/
	function setAceptaMazda($sCadena){
		$this->aceptaMazda = $sCadena;
	}
	/**
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad idTratamiento
	* @return int(11)
	*/
	...
	/**
	* Fija el contenido de la propiedad idTratamiento
	* @param idTratamiento
	* @return void
	*/
	function setIdTratamiento($sCadena){
		$this->idTratamiento = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idTratamientoHast
	* @return int(11)
	*/
	function getIdTratamientoHast(){
		return $this->idTratamientoHast;
	}
	/**
	* Fija el contenido de la propiedad idTratamientoHast
	* @param idTratamiento
	* @return void
	*/
	function setIdTratamientoHast($sCadena){
		$this->idTratamientoHast = $sCadena;
	}
	/**
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad idMunicipio
	* @return varchar(5)
	*/
	...
	/**
	* Fija el contenido de la propiedad idMunicipio
	* @param idMunicipio
	* @return void
	*/
	function setIdMunicipio($sCadena){
		$this->idMunicipio = $sCadena;
	}
	/**
	...
	*/
	...
	/**
	 * Devuelve el contenido de la propiedad codIso2PaisProcedencia
	 * @return varchar(255)
	 */
	...
	/**
	 * Fija el contenido de la propiedad codIso2PaisProcedencia
	 * @param codIso2PaisProcedencia
	 * @return void
	 */
	...
	*/
	...
	/**
	 * Devuelve el contenido de la propiedad sectorMB
	 * @return varchar(255)
	 */
	...
	/**
	 * Fija el contenido de la propiedad sectorMB
	 * @param sectorMB
	 * @return void
	 */
	...
	/**
	 * Devuelve el contenido de la propiedad concesionMB
	 * @return varchar(255)
	 */
	...
	/**
	 * Fija el contenido de la propiedad concesionMB
	 * @param concesionMB
	 * @return void
	 */
	...
	/**
	 * Devuelve el contenido de la propiedad baseMB
	 * @return varchar(255)
	 */
	function getBaseMB(){
		return $this->baseMB;
	...
	/**
	 * Fija el contenido de la propiedad baseMB
	 * @param baseMB
	 * @return void
	 */
	...
	/**
	 * Devuelve el contenido de la propiedad especialidadMB
	 * @return varchar(255)
	 */
	...
	/**
	 * Fija el contenido de la propiedad especialidadMB
	 * @param especialidadMB
	 * @return void
	 */
	...
	/**
	* Devuelve el contenido de la propiedad nivelConocimientoMB
	* @return varchar(255)
	*/
	...
	/**
	* Fija el contenido de la propiedad nivelConocimientoMB
	* @param nivelConocimientoMB
	* @return void
	*/
	...
	/**
	 * Devuelve el contenido de la propiedad puestoEvaluar
	 * @return varchar(255)
	 */
	...
	/**
	 * Fija el contenido de la propiedad puestoEvaluar
	 * @param puestoEvaluar
	 * @return void
	 */
	...
	/**
	 * Devuelve el contenido de la propiedad responsableDirecto
	 * @return varchar(255)
	 */
	...
	/**
	 * Fija el contenido de la propiedad responsableDirecto
	 * @param responsableDirecto
	 * @return void
	 */
	...
	/**
	 * Devuelve el contenido de la propiedad categoriaForjanor
	 * @return varchar(255)
	 */
	...
	/**
	 * Fija el contenido de la propiedad categoriaForjanor
	 * @param categoriaForjanor
	 * @return void
	 */
	...
	/**
	 * Devuelve el contenido de la propiedad localizadorTpv
	 * @return int(11)
	 */
	function getLocalizadorTpv(){
		return $this->localizadorTpv;
	}
	/**
	 * Fija el contenido de la propiedad localizadorTpv
	 * @param localizadorTpv
	 * @return void
	 */
	function setLocalizadorTpv($sCadena){
		$this->localizadorTpv = $sCadena;
	}
