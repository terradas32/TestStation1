...
//		echo $sqlBusc;
		...
		if($listaBuscar->recordCount() > 0){
			while(!$listaBuscar->EOF){
				if ($listaBuscar->fields['idPrueba'] == 24){
...
//				echo "<br />iSinResponder:-:" . $iSinResponder;
					if ($_POST['fIdPrueba'] == 24){
						 ...
						 */
						$cItems->setOrden(($iTamaniolistaItems-$sPreguntasPorPagina));?>
						<script>
							document.forms[0].fPreguntas.selectedIndex = <?php echo $iPaginas?>-1;
							document.forms[0].fPaginaSel.value=<?php echo $iPaginas?>;
							document.forms[0].fOrden.value=<?php echo $iTamaniolistaItems-$sPreguntasPorPagina?>;
