...
function ocultomuestro(atras, siguiente, fin){
	...
	if ("82" == "<?php echo $_POST["fIdPrueba"];?>" || "116" == "<?php echo $_POST["fIdPrueba"];?>"){
		$.epiclock('#countdown-retro').toggle();
	}
	<?php }?>
...
?>
<div id="contenedor">
	<div id="lequedan" class="blanco" style="<?php echo $sDisplay;?>position:absolute;top:75px;left:60%;"><?php echo constant("STR_LE_QUEDAN");?>:&nbsp;
