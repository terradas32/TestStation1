...
* los valores de la entidad de clase Rangos_ir.
**/
class Rangos_ir
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idRangoIr,rangoSup,rangoInf,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Rango Ir,Rango Superior,Rango Inferior,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
