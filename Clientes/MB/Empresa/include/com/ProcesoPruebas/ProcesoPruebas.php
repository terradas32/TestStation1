...
* los valores de la entidad de clase ProcesoPruebas.
**/
class ProcesoPruebas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"codIdiomaIso2,idPrueba,codigo,nombre,descripcion,idTipoPrueba,observaciones,duracion,logoPrueba,capturaPantalla,cabecera,bajaLog,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Idioma,Id Prueba,Código,Nombre,Descripción,Tipo Prueba,Observaciones,Duración,Logo Prueba,Captura Pantalla,Cabecera,Baja Lógica,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase ProcesoPruebas
?>