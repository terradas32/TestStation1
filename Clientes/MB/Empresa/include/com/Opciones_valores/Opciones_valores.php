...
* los valores de la entidad de clase Opciones_valores.
**/
class Opciones_valores
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"codIdiomaIso2,idPrueba,idItem,idOpcion,idValor,descripcion,bajaLog,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Idioma,Prueba,Item,Opción,Id Valor,Descripción,Baja Log,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad idValor
	* @return int(11)
	*/
	function getIdValor(){
		return $this->idValor;
	...
	/**
	* Fija el contenido de la propiedad idValor
	* @param idValor
	* @return void
	*/
	function setIdValor($sCadena){
		$this->idValor = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idValorHast
	* @return int(11)
	*/
	function getIdValorHast(){
		return $this->idValorHast;
	}
	/**
	* Fija el contenido de la propiedad idValorHast
	* @param idValor
	* @return void
	*/
	function setIdValorHast($sCadena){
		$this->idValorHast = $sCadena;
	}
	/**
...
}//Fin de la Clase Opciones_valores
?>