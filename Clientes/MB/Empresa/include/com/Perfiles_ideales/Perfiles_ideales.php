...
* los valores de la entidad de clase Perfiles_ideales.
**/
class Perfiles_ideales
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"codIdiomaIso2,idPrueba,idTipoCompetencia,idCompetencia,idEmpresa,nombre,puntuacionMin,puntuacionMax,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Idioma,Prueba,Tipo Competencía,Competencía,Empresa,Nombre,Puntuación Min,Puntuación Max,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Perfiles_ideales
?>