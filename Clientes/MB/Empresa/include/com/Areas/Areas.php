...
* los valores de la entidad de clase Areas.
**/
class Areas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idArea,codIdiomaIso2,nombre,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Area,Idioma,Nombre,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
