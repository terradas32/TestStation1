...
* los valores de la entidad de clase Edades.
**/
class Edades
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEdad,codIdiomaIso2,nombre,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Edad,Idioma,Nombre,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
