...
* los valores de la entidad de clase Baremos_empresas.
**/
class Baremos_empresas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idPrueba,idBaremo,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Empresa,Prueba,Baremo,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Baremos_empresas
?>