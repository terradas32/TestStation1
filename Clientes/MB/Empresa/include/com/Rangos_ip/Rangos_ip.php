...
* los valores de la entidad de clase Rangos_ip.
**/
class Rangos_ip
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idRangoIp,idRangoIr,rangoSup,rangoInf,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Rango Ip,Rango Ir,Rango Superior,Rango Inferior,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}


	/**
	* Devuelve el contenido de la propiedad idRangoIp
	* @return int(11)
	*/
	function getIdRangoIp(){
		return $this->idRangoIp;
	}
	/**
	* Fija el contenido de la propiedad idRangoIp
	* @param idRangoIp
	* @return void
	*/
	function setIdRangoIp($sCadena){
		$this->idRangoIp = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idRangoIpHast
	* @return int(11)
	*/
	function getIdRangoIpHast(){
		return $this->idRangoIpHast;
	}
	/**
	* Fija el contenido de la propiedad idRangoIpHast
	* @param idRangoIp
	* @return void
	*/
	function setIdRangoIpHast($sCadena){
		$this->idRangoIpHast = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idRangoIr
	* @return int(11)
	*/
	function getIdRangoIr(){
		return $this->idRangoIr;
	}
	/**
	* Fija el contenido de la propiedad idRangoIr
	* @param idRangoIr
	* @return void
	*/
	function setIdRangoIr($sCadena){
		$this->idRangoIr = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idRangoIrHast
	* @return int(11)
	*/
	function getIdRangoIrHast(){
		return $this->idRangoIrHast;
	}
	/**
	* Fija el contenido de la propiedad idRangoIrHast
	* @param idRangoIr
	* @return void
	*/
	function setIdRangoIrHast($sCadena){
		$this->idRangoIrHast = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad rangoSup
	* @return varchar(255)
	*/
	...
	/**
	* Fija el contenido de la propiedad rangoSup
	* @param rangoSup
	* @return void
	*/
	function setRangoSup($sCadena){
		$this->rangoSup = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad rangoInf
	* @return varchar(255)
	*/
	...
	/**
	* Fija el contenido de la propiedad rangoInf
	* @param rangoInf
	* @return void
	*/
	function setRangoInf($sCadena){
		$this->rangoInf = $sCadena;
	}
	/**
