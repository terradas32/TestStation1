...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vString("<?php echo constant("STR_ID_ZONA");?>:",f.fIdZona.value,255,true);
	...
	msg +=vString("<?php echo constant("STR_MUNICIPIO");?>:",f.elements['fIdMunicipio'].value,5,true);
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdZona"><?php echo constant("STR_ID_ZONA");?></label>&nbsp;</td><td><input type="text" id="fIdZona" name="fIdZona" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdZona() : $_POST['fIdZona'];?>" class="obliga" onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdMunicipio"><?php echo constant("STR_MUNICIPIO");?></label>&nbsp;</td>
						<td><div id="comboIdMunicipio"><?php $comboWI_MUNICIPIOS->setNombre("fIdMunicipio");?><?php echo $comboWI_MUNICIPIOS->getHTMLComboNull("1","obliga",$cEntidad->getIdMunicipio(),"onchange=\"javascript:cambiaIdMunicipio()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="wi_zonas_next_page" value="<?php echo (isset($_POST['wi_zonas_next_page'])) ? $cUtilidades->validaXSS($_POST['wi_zonas_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							...
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdProvincia").show().load("jQuery.php",{sPG:"combowi_provincias",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdProvincia",fJSProp:"cambiaIdProvincia",fCodIdiomaIso2:f.fCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdProvincia();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdMunicipio").show().load("jQuery.php",{sPG:"combowi_municipios",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdMunicipio",fJSProp:"cambiaIdMunicipio",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdProvincia:f.fIdProvincia.value,vSelected:"<?php echo $cEntidad->getIdMunicipio();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdProvincia(){
								var f= document.forms[0];
								$("#comboIdMunicipio").show().load("jQuery.php",{sPG:"combowi_municipios",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdMunicipio",fJSProp:"cambiaIdMunicipio",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdProvincia:f.fIdProvincia.value,vSelected:"<?php echo $cEntidad->getIdMunicipio();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
