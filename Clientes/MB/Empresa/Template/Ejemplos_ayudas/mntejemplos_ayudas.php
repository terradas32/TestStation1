...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_AYUDA");?>:", f.LSTIdAyuda.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_AYUDA");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdAyudaHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdAyuda"><?php echo constant("STR_ID_AYUDA");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdAyuda" name="LSTIdAyuda" value="<?php echo $cEntidad->getIdAyuda();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdAyudaHast" name="LSTIdAyudaHast" value="<?php echo $cEntidad->getIdAyudaHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idAyuda' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idAyuda') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_AYUDA");?></option>
	...
	<input type="hidden" name="ejemplos_ayudas_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
