...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><?php $comboEMP_PERFILES->setNombre("LSTIdPerfil");?><?php echo $comboEMP_PERFILES->getHTMLCombo("4","cajatexto",$cEntidad->getIdPerfil(),"  multiple=\"multiple\" ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="empresas_perfiles_next_page" value="1" />
