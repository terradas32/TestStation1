...
function setPK(idPerfil,idUsuario)
{
...
<?php ob_start();?>
	<table cellspacing="1" cellpadding="0" border="0" width="100%">
		<tr>
			...
			<td class="tdnaranjab" align="center"><?php echo constant("STR_USU_ALTA");?></td>
			<td class="tdnaranjab" align="center"><?php echo constant("STR_USU_MOD");?></td>
		...
		<tr onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER");?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT");?>'" bgcolor="<?php echo constant("ONMOUSEOUT");?>">
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>','<?php echo $lista->fields['idUsuario'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['idUsuario']));?>"><?php echo substr($comboUSUARIOS->getDescripcionCombo($lista->fields['idUsuario']),0,25);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>','<?php echo $lista->fields['idUsuario'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['idPerfil']));?>"><?php echo substr($comboPERFILES->getDescripcionCombo($lista->fields['idPerfil']),0,25);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>','<?php echo $lista->fields['idUsuario'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['fecAlta']));?>"><script language="javascript" type="text/javascript">document.write(formatThisDate('<?php echo $lista->fields['fecAlta'];?>'));</script></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>','<?php echo $lista->fields['idUsuario'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['fecMod']));?>"><script language="javascript" type="text/javascript">document.write(formatThisDate('<?php echo $lista->fields['fecMod'];?>'));</script></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>','<?php echo $lista->fields['idUsuario'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['usuAlta']));?>"><?php echo substr($comboUSUARIOS->getDescripcionCombo($lista->fields['usuAlta']),0,25);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>','<?php echo $lista->fields['idUsuario'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['usuMod']));?>"><?php echo substr($comboUSUARIOS->getDescripcionCombo($lista->fields['usuMod']),0,25);?></td>
			<td class="tddatoslista" align="center"><?php if (!empty($lista->fields['idUsuario'])){;?><a href="javascript:setPK('<?php echo $lista->fields['idPerfil'];?>','<?php echo $lista->fields['idUsuario'];?>');confBorrar(<?php echo constant("MNT_BORRAR");?>,'<?php echo constant("DEL_GENERICO");?>');"><?php echo ($_bBorrar) ? "<img src='" . constant("DIR_WS_GRAF") . "menos.gif' width='9' height='9' border='0' alt=\"" . constant("STR_BORRAR") . "\">" : "";?></a><?php }else{echo("&nbsp;");};?></td>
		</tr>
		<?php $i++;
		$lista->MoveNext();
		} ?>
...
<div id="contenedor">
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		...
		<tr><td><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="10" height="1" alt="" /></td>
			<td colspan="3" bgcolor="#036"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="1" height="1" alt="" /></td>
		</tr>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width='10'><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="10" height="1" border="0" alt="" /></td>
			<td width="100%" colspan="2" align='left' class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"),str_replace('_', ' ', 'usuarios_perfiles'));?></td>
		</tr>
		<tr>
			<td width='10'><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="10" height="1" border="0" alt="" /></td>
