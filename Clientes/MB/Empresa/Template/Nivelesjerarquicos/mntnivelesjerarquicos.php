...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_ID_NIVEL");?>:", f.LSTIdNivel.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_NIVEL");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdNivelHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdNivel"><?php echo constant("STR_ID_NIVEL");?></label>&nbsp;</td>
					<td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idNivel' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idNivel') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_NIVEL");?></option>
	...
	<input type="hidden" name="nivelesjerarquicos_next_page" value="1" /></div>
