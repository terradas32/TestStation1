...
function enviar()
{
	...
	if (validaForm()){
		...
		f.LSTIdEjemplo.value=f.elements['LSTIdEjemplo'].value;
...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_EJEMPLO");?>:",f.elements['LSTIdEjemplo'].value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_OPCION");?>:", f.LSTIdOpcion.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_OPCION");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdOpcionHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdEjemplo"><?php echo constant("STR_EJEMPLO");?></label>&nbsp;</td>
						<td><div id="comboIdEjemplo"><?php $comboEJEMPLOS->setNombre("LSTIdEjemplo");?><?php echo $comboEJEMPLOS->getHTMLComboNull("1","cajatexto",$cEntidad->getIdEjemplo(),"onchange=\"javascript:cambiaIdEjemplo()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdOpcion"><?php echo constant("STR_ID_OPCION");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdOpcion" name="LSTIdOpcion" value="<?php echo $cEntidad->getIdOpcion();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdOpcionHast" name="LSTIdOpcionHast" value="<?php echo $cEntidad->getIdOpcionHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idOpcion' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idOpcion') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_OPCION");?></option>
	...
	<input type="hidden" name="opciones_ejemplos_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdPrueba").show().load("jQuery.php",{sPG:"combopruebas",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdPrueba",fJSProp:"cambiaIdPrueba",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdPrueba();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdEjemplo").show().load("jQuery.php",{sPG:"comboejemplos",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdEjemplo",fJSProp:"cambiaIdEjemplo",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdPrueba:f.LSTIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdEjemplo();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
