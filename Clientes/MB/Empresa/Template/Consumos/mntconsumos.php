		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><?php $comboWI_IDIOMAS->setNombre("LSTCodIdiomaInforme");?><?php echo $comboWI_IDIOMAS->getHTMLCombo("1","cajatexto",$cEntidad->getCodIdiomaInforme()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoInforme"><?php echo constant("STR_INFORME");?></label>&nbsp;</td>
					<td><?php $comboTIPOS_INFORMES->setNombre("LSTIdTipoInforme");?><?php echo $comboTIPOS_INFORMES->getHTMLCombo("1","cajatexto",$cEntidad->getIdTipoInforme()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
