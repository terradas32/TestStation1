...
/* if ($_POST['fIdTipoInforme'] != 11 && $_POST['fIdTipoInforme'] != 71 || $_POST['fIdTipoInforme'] == 3) {
	$sHtmlInicio .= 		'<link rel="stylesheet" type="text/css" href="' . constant("DIR_WS_GESTOR") . 'estilosInformes/prisma/style_old.css"/>';
...
$sHtml .= '
				...
				<div id="copy">
					<h2>Copyright 2011, PSICÓLOGOS EMPRESARIALES S.A.</h2>
				</div>
			</div>
			<!--FIN DIV PAGINA-->
      <hr>
...
function informeCompetencias_FIT($aPuntuaciones, $sHtmlCab, $idIdioma)
{
	...
	$sHtml .= '<tr>
                        <td colspan="3" bgcolor="#ffffff" style="border-bottom:3px solid #93b1d3;">
                        <h2 class="subtitulo" style="line-height:32px; color:#475464">COMPETENCIAS</h2></td>
                      </tr>	';
	$sHtml .= '<tr>
	...
	if ($_POST['fIdTipoInforme'] == 71) {
		...
		$sHtml .= '<tr>
					<td bgcolor="#949398"><h2 class="titCab" style="color:#fff">Escalas/Competencias</h2></td>
					<td bgcolor="#949398"><h2 class="titCab" style="color:#fff">Descripción</h2></td>
					<td bgcolor="#949398"><h2 class="titCab" style="color:#fff">Porcentaje</h2></td>
					<td bgcolor="#949398"><h2 class="titCab" style="color:#fff">Puntuación</h2></td>
				</tr>	';
		...
		if (count($arrBloqItem) > 0) {
			...
			foreach ($arrBloqItem as $key => $arr) {
				...
				$sHtml .= '<tr class="desgloseTit">
					<td class="desgloseTitTd" colspan="3">
						<p>' . $arr['nomMatching'] . '</p>
					</td>
