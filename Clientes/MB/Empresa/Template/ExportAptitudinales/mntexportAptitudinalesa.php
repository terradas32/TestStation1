...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vString("<?php echo constant("STR_SIGNO");?>:",f.fSigno.value,255,true);
if (msg != "") {
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fSigno"><?php echo constant("STR_SIGNO");?></label>&nbsp;</td>
					<td><input type="text" id="fSigno" name="fSigno" value="<?php echo $cEntidad->getSigno();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
	...
	<input type="hidden" name="fIdSigno" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdSigno() : $_POST['fIdSigno'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="signos_next_page" value="<?php echo (isset($_POST['signos_next_page'])) ? $cUtilidades->validaXSS($_POST['signos_next_page']) : "1";?>" />