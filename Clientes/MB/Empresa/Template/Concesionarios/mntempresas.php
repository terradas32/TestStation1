...
<div id="contenedor">
		...
		<div id="contenido">
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0" >
				...
				<tr>
					...
					<td><input type="text" name="LSTCif" value="<?php echo $cEntidad->getCif();?>" class="cajatexto"  style='width:75%;' onchange="javascript:trim(this);" /><input type="checkbox" name="LSTCifOK" /><?php echo constant("STR_VERIFICADO");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_USUARIO");?>&nbsp;</td>
					<td><input type="text" name="LSTUsuario" value="<?php echo $cEntidad->getUsuario();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_PASSWORD");?>&nbsp;</td>
					<td><input type="text" name="LSTPassword" value="<?php echo $cEntidad->getPassword();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_LOGO");?>&nbsp;</td>
					<td><input type="text" name="LSTPathLogo" value="<?php echo $cEntidad->getPathLogo();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_EMAIL");?>&nbsp;</td>
					<td><input type="text" name="LSTMail" value="<?php echo $cEntidad->getMail();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_EMAIL_2");?>&nbsp;</td>
					<td><input type="text" name="LSTMail2" value="<?php echo $cEntidad->getMail2();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_EMAIL_3");?>&nbsp;</td>
					<td><input type="text" name="LSTMail3" value="<?php echo $cEntidad->getMail3();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_DISTRIBUIDOR");?>&nbsp;</td>
					<td><input type="radio" name="LSTDistribuidor" id="LSTDistribuidor1" value="1"  <?php echo ($cEntidad->getDistribuidor() != "" && strtoupper($cEntidad->getDistribuidor()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTDistribuidor1"><?php echo constant("STR_SI");?></label>&nbsp;<input type="radio" name="LSTDistribuidor" id="LSTDistribuidor0" value="0"  <?php echo ($cEntidad->getDistribuidor() != "" && strtoupper($cEntidad->getDistribuidor()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTDistribuidor0"><?php echo constant("STR_NO");?></label>&nbsp;<input type="hidden" name="LSTDistribuidorHast" value="<?php echo $cEntidad->getDistribuidor();?>" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_PREPAGO");?>&nbsp;</td>
					<td><input type="radio" name="LSTPrepago" id="LSTPrepago1" value="1"  <?php echo ($cEntidad->getPrepago() != "" && strtoupper($cEntidad->getPrepago()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTPrepago1"><?php echo constant("STR_PREPAGO");?></label>&nbsp;<input type="radio" name="LSTPrepago" id="LSTPrepago0" value="0"  <?php echo ($cEntidad->getPrepago() != "" && strtoupper($cEntidad->getPrepago()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTPrepago0"><?php echo constant("STR_CONTRATO");?></label>&nbsp;<input type="hidden" name="LSTPrepagoHast" value="<?php echo $cEntidad->getPrepago();?>" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								...
								<td><input type="text" name="LSTNcandidatos" value="<?php echo $cEntidad->getNcandidatos();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" name="LSTNcandidatosHast" value="<?php echo $cEntidad->getNcandidatosHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" name="LSTDongles" value="<?php echo $cEntidad->getDongles();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" name="LSTDonglesHast" value="<?php echo $cEntidad->getDonglesHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					...
					<td><?php $comboWI_PAISES->setNombre("LSTIdPais");?><?php echo $comboWI_PAISES->getHTMLCombo("1","cajatexto",$cEntidad->getIdPais()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_DIRECCION");?>&nbsp;</td>
					<td><input type="text" name="LSTDireccion" value="<?php echo $cEntidad->getDireccion();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" name="LSTUmbral_aviso" value="<?php echo $cEntidad->getUmbral_aviso();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" name="LSTUmbral_avisoHast" value="<?php echo $cEntidad->getUmbral_avisoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select name='LSTOrderBy' size='1' class="cajatexto">
							...
							<option style='color:#000000;' value='idEmpresa' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idEmpresa') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_FUNCIONALIDAD");?></option>
	...
	<input type="hidden" name="empresas_next_page" value="1" />
