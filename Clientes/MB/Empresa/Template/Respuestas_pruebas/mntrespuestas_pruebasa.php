		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><input type="radio" name="fFinalizado" disabled="disabled" id="fFinalizado1" value="1"  <?php echo ($cEntidad->getFinalizado() != "" && strtoupper($cEntidad->getFinalizado()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fFinalizado1"><?php echo constant("STR_SI");?></label>&nbsp;<input type="radio" name="fFinalizado" id="fFinalizado0" value="0"  <?php echo ($cEntidad->getFinalizado() != "" && strtoupper($cEntidad->getFinalizado()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fFinalizado0"><?php echo constant("STR_NO");?></label>&nbsp;<input type="hidden" name="fFinalizadoHast" value="<?php echo $cEntidad->getFinalizado();?>" /></td>
				</tr>
