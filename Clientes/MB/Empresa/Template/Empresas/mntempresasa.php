 ...
 -->
					...
					<tr>
						...
						<td>
							<table border =1>
								<tr>
									<td style="padding-right:20px"><input disabled="disabled" <?php echo $sChecked;?> <?php echo ($cEntidad->getSectorMB() != "" && strtoupper($cEntidad->getSectorMB()) == "ON") ? "checked=\"checked\"" : "";?> id="fSectorMB" name="fSectorMB" type="checkbox"><label for="fSectorMB" title="<?php echo constant("STR_DATOS_MB");?>"><?php echo constant("STR_DATOS_MB");?></label></td>
