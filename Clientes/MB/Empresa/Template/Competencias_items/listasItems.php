...
<table cellpadding="10" cellspacing="10">
	...
	<tr>
		...
		<td>
			<select multiple="multiple" name="fItems" size="20" style="width:300px;">
			
			<?php 
				if($bPinta){
					if($listaCompItems->recordCount()>0){
					 
						while(!$listaCompItems->EOF){
							
							$cItem = new Items();
							$cItem->setIdPrueba($listaCompItems->fields['idPrueba']);
							$cItem->setIdItem($listaCompItems->fields['idItem']);
