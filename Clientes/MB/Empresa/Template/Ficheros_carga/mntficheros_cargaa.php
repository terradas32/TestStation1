...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_TIPO");?>:",f.fTipo.value,255,true);
if (msg != "") {
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fTipo"><?php echo constant("STR_TIPO");?></label>&nbsp;</td>
					<td><input type="text" id="fTipo" name="fTipo" value="<?php echo $cEntidad->getTipo();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
	...
	<input type="hidden" name="fIdFichero" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdFichero() : $_POST['fIdFichero'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="ficheros_carga_next_page" value="<?php echo (isset($_POST['ficheros_carga_next_page'])) ? $cUtilidades->validaXSS($_POST['ficheros_carga_next_page']) : "1";?>" />