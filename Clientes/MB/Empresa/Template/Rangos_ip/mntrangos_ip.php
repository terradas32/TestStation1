...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_RANGO_IP");?>:", f.LSTIdRangoIp.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_RANGO_IP");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdRangoIpHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_RANGO_IR");?>:", f.LSTIdRangoIr.value, 11, false);
	msg +=vString("<?php echo constant("STR_RANGO_SUPERIOR");?>:",f.LSTRangoSup.value,255, false);
	msg +=vString("<?php echo constant("STR_RANGO_INFERIOR");?>:",f.LSTRangoInf.value,255, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdRangoIp"><?php echo constant("STR_ID_RANGO_IP");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdRangoIp" name="LSTIdRangoIp" value="<?php echo $cEntidad->getIdRangoIp();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdRangoIpHast" name="LSTIdRangoIpHast" value="<?php echo $cEntidad->getIdRangoIpHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdRangoIr"><?php echo constant("STR_RANGO_IR");?></label>&nbsp;</td>
					<td><?php $comboRANGOS_IR->setNombre("LSTIdRangoIr");?><?php echo $comboRANGOS_IR->getHTMLCombo("1","cajatexto",$cEntidad->getIdRangoIr()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTRangoSup"><?php echo constant("STR_RANGO_SUPERIOR");?></label>&nbsp;</td>
					<td><input type="text" id="LSTRangoSup" name="LSTRangoSup" value="<?php echo $cEntidad->getRangoSup();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTRangoInf"><?php echo constant("STR_RANGO_INFERIOR");?></label>&nbsp;</td>
					<td><input type="text" id="LSTRangoInf" name="LSTRangoInf" value="<?php echo $cEntidad->getRangoInf();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idRangoIp' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idRangoIp') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_RANGO_IP");?></option>
							<option style='color:#000000;' value='rangoSup' <?php echo (!empty($sOrderBy) && $sOrderBy == 'rangoSup') ? "selected='selected'" : "";?>><?php echo constant("STR_RANGO_SUPERIOR");?></option>
							<option style='color:#000000;' value='rangoInf' <?php echo (!empty($sOrderBy) && $sOrderBy == 'rangoInf') ? "selected='selected'" : "";?>><?php echo constant("STR_RANGO_INFERIOR");?></option>
	...
	<input type="hidden" name="rangos_ip_next_page" value="1" />
