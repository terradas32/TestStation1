				...
				<tr>
					...
					<td width="100%" style="border-bottom: 1px solid #000000;">
						<ul class="listaProceso">
							...
							<li class="mArrow">&nbsp;</li>
							<li  class="mActivo"><span><img src="./graf/iconsMenu/Folder.png" title="Pruebas" alt="Pruebas" /></span><b style="color:#00adef"><?php echo constant("STR_PRUEBAS");?></b></li>
							<li class="mArrow">&nbsp;</li>
									...
									<div id="prueba" >
										<table cellspacing="0" cellpadding="0" border="0" width="100%">
											<tr>
												...
												<?php echo $comboBATERIAS->getHTMLCombo("1","obliga",""," onchange=\"javascript:if (this.value==1){document.forms[0].fIdPrueba.value=81;cambiaidiomas();}else{document.forms[0].fIdPrueba.value=84;cambiaidiomas();}\"","");?>
