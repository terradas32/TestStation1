...
//	msg +=vNumber("<?php echo constant("STR_MODO_REALIZACION_PRUEBAS");?>:",f.fIdTipoProceso.value,11,true);
			...
			<table cellspacing="3" cellpadding="0" width="100%" border="0">
				<tr>
					<td colspan="2" width="100%" style="border-bottom: 1px solid #000000; height:35px">
						<b style="color:#00adef">1. Datos del proceso</b> ---> 2. Asignación de pruebas y baremos ---> 3. Candidatos ---> 4. Asignación de correos
					</td>
				</tr>
				<tr>
					<td width="100%">
