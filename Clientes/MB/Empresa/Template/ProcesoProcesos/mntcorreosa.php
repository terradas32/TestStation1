...
function cargaplantilla()
{
    ...
    $("div#DatosCorreo").hide().load(paginacargada,{fConsulta:"1",fIdTipoCorreo:f.fIdTipoCorreo.value,fIdCorreo:f.fIdCorreo.value,MODO:"<?php echo constant('MNT_NUEVOCORREO')?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken()?>" }, function() {
				...
				<tr>
					...
					<td width="100%" style="border-bottom: 1px solid #000000; height:35px">
						<ul class="listaProceso">
							...
							<li class="mArrow">&nbsp;</li>
							<li class="mActivo"><span><img src="./graf/iconsMenu/mail.png" title="Comunicación" alt="Comunicación" /></span><b style="color:#00adef"><?php echo constant("STR_COMUNICACION");?></b></li>
						</ul>
					</td>
				</tr>
				<tr>
