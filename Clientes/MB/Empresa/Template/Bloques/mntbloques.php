...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_ID_BLOQUE");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdBloqueHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								...
								<td><input type="text" id="LSTIdBloque" name="LSTIdBloque" value="<?php echo $cEntidad->getIdBloque();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdBloqueHast" name="LSTIdBloqueHast" value="<?php echo $cEntidad->getIdBloqueHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idBloque' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idBloque') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_BLOQUE");?></option>
	...
	<input type="hidden" name="bloques_next_page" value="1" /></div>
