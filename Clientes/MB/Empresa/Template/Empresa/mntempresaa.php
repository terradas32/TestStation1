		...
		<div style="width: 100%">
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					...
					<tr>
						...
						<td><input type="text" name="fNombre" disabled="disabled" value="<?php echo $cEntidad->getNombre();?>" class="obliga" onchange="javascript:trim(this);" /></td>
					</tr>
					<tr>
						<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
						<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_DENTRO_DE");?> ...&nbsp;</td>
						<td><?php $comboDENTRO_DE->setNombre("fDentroDe");?><?php echo $comboDENTRO_DE->getHTMLComboMenu("1","cajatexto",$cEntidad->getDentroDe(),"disabled onchange=\"javascript:cambiadentrode()\"","");?></td>
					</tr>
					<tr>
						<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					<tr>
						...
						<td><input type="text" name="fCif" disabled="disabled" value="<?php echo $cEntidad->getCif();?>" class="cajatexto"  style='width:75%;' onchange="javascript:trim(this);" /><input type="checkbox" name="fCifOK" /><?php echo constant("STR_VERIFICADO");?></td>
					</tr>
					<tr>
						<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
						<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_USUARIO");?>&nbsp;</td>
						<td><input type="text" name="fUsuario" disabled="disabled" value="<?php echo $cEntidad->getUsuario();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
					</tr>
				...
				<?php }?>
					...
					<tr>
						...
						<td>
							<input type="radio" name="fDistribuidor" id="fDistribuidor1" value="1" disabled="disabled" <?php echo ($cEntidad->getDistribuidor() != "" && strtoupper($cEntidad->getDistribuidor()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fDistribuidor1"><?php echo constant("STR_SI");?></label>&nbsp;<input type="radio" name="fDistribuidor" id="fDistribuidor0" value="0" disabled="disabled" <?php echo ($cEntidad->getDistribuidor() != "" && strtoupper($cEntidad->getDistribuidor()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fDistribuidor0"><?php echo constant("STR_NO");?></label></td>
					</tr>
					<tr>
						<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
						<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_PREPAGO");?>&nbsp;</td>
						<td><input type="radio" name="fPrepago" id="fPrepago1" value="1" disabled="disabled" <?php echo ($cEntidad->getPrepago() != "" && strtoupper($cEntidad->getPrepago()) == "1") ? "checked=\"checked\"" : "";?> onclick="javascript:chkPrepago(this);" />&nbsp;<label for="fPrepago1"><?php echo constant("STR_PREPAGO");?></label>&nbsp;<input type="radio" name="fPrepago" id="fPrepago0" value="0" disabled="disabled" <?php echo ($cEntidad->getPrepago() != "" && strtoupper($cEntidad->getPrepago()) == "0") ? "checked=\"checked\"" : "";?> onclick="javascript:chkPrepago(this);" /><label for="fPrepago0"><?php echo constant("STR_CONTRATO");?></label></td>
					</tr>
					<tr>
						<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
						<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_NU_CANDIDATOS");?>&nbsp;</td>
						<td><input type="text" name="fNcandidatos" value="<?php echo $cEntidad->getNcandidatos();?>" disabled="disabled" class="cajatexto"  onchange="javascript:trim(this);" /></td>
					</tr>
					<tr>
						<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
						<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_DONGLES");?>&nbsp;</td>
						<td><input type="text" name="fDongles" value="<?php echo $cEntidad->getDongles();?>" disabled="disabled" class="cajatexto"  onchange="javascript:trim(this);" /></td>
					</tr>
					<tr>
						<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
						<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_DATOS_BANCARIOS");?>&nbsp;</td>
						<td class="negro">
							<?php echo constant("STR_ENTIDAD");?>: <input type="text" class="cajatextoCuenta" maxlength="4" size="2" name="fEntidad" disabled="disabled" value="<?php echo $cEntidad->getEntidad();?>"  onchange="javascript:trim(this);" /> &nbsp;&nbsp;
							<?php echo constant("STR_OFICINA");?>: <input type="text" class="cajatextoCuenta" maxlength="4" size="2" name="fOficina" disabled="disabled" value="<?php echo $cEntidad->getOficina();?>"   onchange="javascript:trim(this);" />&nbsp;&nbsp;
							<?php echo constant("STR_DC");?>: <input type="text" class="cajatextoCuenta" maxlength="2" size="1" name="fDc" disabled="disabled" value="<?php echo $cEntidad->getDc();?>"   onchange="javascript:trim(this);" />&nbsp;&nbsp;
							<?php echo constant("STR_CUENTA");?>: <input type="text" class="cajatextoCuenta" maxlength="10" size="9" name="fCuenta" disabled="disabled" value="<?php echo $cEntidad->getCuenta();?>"   onchange="javascript:trim(this);" />&nbsp;&nbsp;
						</td>
					</tr>
					<tr>
						<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
...
<?php				if(isset($_POST['MODO']) && ($_POST['MODO'] == constant("MNT_MODIFICAR"))){?>
					...
					<tr>
						...
						<td><input type="button" value="<?php echo constant("STR_CAMBIAR_CONTRASENA");?>" id="fCrea" class="botonesbig" onclick="javascript:cargalapagina('Empresas/cambia_pass','contrasenia');"/></td>
					</tr>
					<tr>
					    <td colspan="3">
				...
				<table cellspacing="0" cellpadding="0" border="0">
					<tr>
						<td ><input type="submit" class="botones" id="bid-ok" name="fBtnOk" value="<?php echo constant("STR_GUARDAR");?>" /></td>
					</tr>
				</table>
	...
	<script language="javascript" type="text/javascript">
		...
		function cambiadentrode(){
			var f= document.forms[0];								
			$("#combodespuesde").show().load("jQuery.php",{sPG:"combodespuesdeEmpresas",bBus:"0",multiple:"0",nLineas:"1",bObliga:"0",fDisabled:"disabled",fDentroDe:f.fDentroDe.value,vSelected:"<?php echo $cEntidad->getDespuesDe();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
		}
		//]]>
	</script>
	<script language="javascript" type="text/javascript">
