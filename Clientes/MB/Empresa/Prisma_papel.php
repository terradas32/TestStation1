...
//					$usuario = $aUsuario[0]."-".substr($aUsuario[1],3,strlen($aUsuario[1]));
					...
					if(($sLCadena < 192) || (sizeof($aConEspacios) > 1) || (sizeof($aConInterrogantes) > 1)){
						...
						$sqlUsuarios.= "('SR' ,'". $codigo ."','". $codigo ."','jsola@azulpomodoro.com','".$usuario."','".$sSexo."','0','".date('d/m/Y H:i:s')."','".date('dmY').$sCarga."','0','".$sEmpresa."','1','es','25/05/2011 0:00:00','1','C','1','gsm@psicologosempresariales.es','".date('d/m/Y H:i:s')."');";
