...
//		global $comboDESC_CANDIDATOS;
		...
		$comboDESC_CANDIDATOS	= new Combo($conn,"fIdCandidato","idCandidato",$conn->Concat("nombre", "' '", "apellido1", "apellido2", "' ('", "mail" , "')'"),"Descripcion","candidatos","","","idEmpresa=" . $conn->qstr($sIdEmpresa, false) . " AND idProceso=" . $conn->qstr($sIdProceso, false). " AND idCandidato=" . $conn->qstr($sIdCandidato, false),"","fecMod");
