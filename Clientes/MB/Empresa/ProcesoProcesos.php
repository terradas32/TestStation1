...
include_once ('include/conexion.php');
	...
	$comboMODO_REALIZACION	= new Combo($conn,"fIdModoRealizacion","idModoRealizacion","descripcion","Descripcion","modo_realizacion","",constant("SLC_OPCION"),"","","fecMod");
	$comboWI_USUARIOS	= new Combo($conn,"fUsuAlta","idUsuario","nombre","Descripcion","wi_usuarios","",constant("SLC_OPCION"),"","","");
	$comboBATERIAS	= new Combo($conn,"fIdBateria","idBateria","nombre","Descripcion","baterias","",constant("SLC_OPCION"), "cliente='MB' AND visible=1","","","");
