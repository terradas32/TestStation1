...
class Candidatos_back
{
	...
	**/
	function __construct()
	{
		...
		$this->DESCListaExcel	=	"Id  Empresa,Id  Proceso,Id  Candidato,Nombre,Apellido1,Apellido2,Dni,Mail,Password,Sexo,Fecha de Nacimiento,Id  País,Id  Provincía,Id  Ciudad,Id  Zona,Dirección,Cod Postal,Id Formación,Id  Nivel,Id  Area,Id  Tipo Teléfono,Teléfono,Estado Civil,Nacionalidad,Informado,Finalizado,Fecha de Finalizado,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
