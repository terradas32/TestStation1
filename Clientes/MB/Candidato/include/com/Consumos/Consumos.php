...
class Consumos
{
	...
	**/
	function __construct()
	{
		...
		$this->DESCListaExcel	=	"Empresa,Proceso,Candidato,Idioma Prueba,Prueba,Idioma Informe,Informe,Baremo,Nombre Empresa,Nombre Proceso,Nombre Candidato,Apellido1,Apellido2,Dni,Mail,Prueba,Informe,Baremo,Concepto,Unidades,Fecha de Alta,Fecha de Modificación";
	}
