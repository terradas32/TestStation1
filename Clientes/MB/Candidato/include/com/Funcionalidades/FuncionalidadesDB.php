...
//****************************
	...
	*************************************************************************/
	...
	{
		$aux			= $this->conn;
		$sql = "SELECT  idFuncionalidad, nombre, descripcion, idPadre, url, popUp, orden, indentacion, bgFile, bgColor, modoDefecto, iconosMenu, publico, fecAlta, fecMod, usuAlta, usuMod FROM wi_funcionalidades WHERE ";
		$sql  .="idFuncionalidad=" . $aux->qstr($cEntidad->getIdFuncionalidad(), false) . " ";
		$rs = $aux->Execute($sql);
		if ($rs){
			while ($arr = $rs->FetchRow()){
...
//			$cEntidadPadre = $cEntidad;
	...
	*************************************************************************/
	function readLista($cEntidad)
	{
		...
		$this->sSQL=$sql;
		$_SESSION['SQLFuncionalidadesDB'] = $sql;
		return $sql;
	}
	...
	*************************************************************************/
	...
	{
		$this->sSQL = $_SESSION['SQLFuncionalidadesDB'];
		return $this->sSQL;
	}
			...
			if ($lista->fields['indentacion'] == 0)
			{
				...
				$sMenus .= '
					<table cellspacing="0" cellpadding="0" border="0">
						<tr>
							<td><img src="graf/sp.gif" width="1" height="5" border="0" alt="" /></td>
					    </tr>
					</table>
				...
				$sMenus .= ' title="' . $lista->fields['descripcion'] . '">
								<table cellspacing="0" cellpadding="0" border="0" width="100%">
									<tr>
										<td valign="top" onclick="javascript:cambia(\'' . $i . '\',2);block(\'' . $iBlock . '\');setTitulo(\'' . addslashes($lista->fields['nombre']) . '\');enviarMenu(\'' . $sUrl . '\',\'' . $sModo . '\');"><img src="graf/sp.gif" width="10" height="10" name="a' . $i . '" border="0" alt="" /></td>
										';
										if (empty($lista->fields['popUp']))
										{
				$sMenus .= '			<td onclick="javascript:cambia(\'' . $i . '\',2);block(\'' . $iBlock . '\');setTitulo(\'' . addslashes($lista->fields['nombre']) . '\');enviarMenu(\'' . $sUrl . '\',\'' . $sModo . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . addslashes($lista->fields['nombre']) . '\';return true" class="negrob" width="100%">' . $lista->fields['nombre'] . '</td>
										<td onclick="javascript:cambia(\'' . $i . '\',2);block(\'' . $iBlock . '\');setTitulo(\'' . addslashes($lista->fields['nombre']) . '\');enviarMenu(\'' . $sUrl . '\',\'' . $sModo . '\');"><img src="graf/sp.gif" width="9" height="9" border="0" alt="" /></td>';
										}else{
				$sMenus .= '			<td onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . addslashes($lista->fields['nombre']) . '\';return true" class="negrob" width="100%">' . $lista->fields['nombre'] . '</td>
										<td ><img src="graf/sp.gif" width="9" height="9" border="0" alt="" /></td>';
										}
				...
				$sMenus .= '
						<tr onmouseover="javascript:overTR(this,\'#EFEFEF\');cambia(' . $i . ',1);" onmouseout ="javascript:outTR(this,\'\');cambia(' . $i . ',0)">
							<td ' . $sPopUp . ' valign="top" style="background:transparent;"><img src="graf/sp.gif" width="10" height="10" name="a' . $i . '" border="0" alt="" /></td>
							';
				if (empty($lista->fields['popUp'])){
					$sMenus .= '
							<td class="submenu" width="100%" bgcolor="' . $bgColor . '" onclick="javascript:cambia(' . $i . ',2);setTitulo(\'' . addslashes($comboFUNCIONALIDADES->getDescripcionCombo($lista->fields['idPadre']) . ' - ' . $lista->fields['nombre']) . '\');enviarMenu(\'' . $sUrl . '\',\'' . $sModo . '\',\'' . $lista->fields['bgColor'] . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . addslashes($lista->fields['nombre']) . '\';return true" title="' . $lista->fields['descripcion'] . '"><img src="graf/sp.gif" width="' . 5*$lista->fields['indentacion'] . '" height="5" border="0" alt="" />' . $lista->fields['nombre'] . '</td>
							<td onclick="javascript:cambia(' . $i . ',2);enviarMenu(\'' . $sUrl . '\',\'' . $sModo . '\');"><img src="graf/sp.gif" width="1" height="1.5" border="0" alt="" /></td>';
					$aIconosMenu = explode(',', $lista->fields['iconosMenu']);
					...
					{
						case '1':
							$sMenus .= '<td colspan="2" onclick="javascript:cambia(' . $i . ',2);enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_NUEVO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_NUEVO") . ' >>> ' . addslashes($lista->fields['nombre']) . '\';return true"><img src="graf/mas.gif" width="9" hspace="1" height="9" border="0" alt="' . constant("STR_NUEVO") . '" /></td>';
							break;
						case '12':
							$sMenus .= '<td onclick="javascript:cambia(' . $i . ',2);enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_NUEVO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_NUEVO") . ' >>> ' . addslashes($lista->fields['nombre']) . '\';return true"><img src="graf/mas.gif" width="9" hspace="1" height="9" border="0" alt="' . constant("STR_NUEVO") . '" /></td>';
							$sMenus .= '<td onclick="javascript:cambia(' . $i . ',2);enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_INICIO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_BUSCADOR") . ' >>> ' . addslashes($lista->fields['nombre']) . '\';return true"><img src="graf/buscar.gif" width="9" hspace="1" height="9" border="0" alt="' . constant("STR_BUSCAR") . '" /></td>';
							break;
						case '2':
							$sMenus .= '<td onclick="javascript:cambia(' . $i . ',2);enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_INICIO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_BUSCADOR") . ' >>> ' . addslashes($lista->fields['nombre']) . '\';return true"><img src="graf/buscar.gif" width="9" hspace="1" height="9" border="0" alt="' . constant("STR_BUSCAR") . '" /></td>';
							break;
					...
					$sMenus .= '
							<td class="submenu" width="100%" bgcolor="' . $bgColor . '" onclick="javascript:expandingWindow(\'' . $sUrl . '\');"><img src="graf/sp.gif" width="' . 5*$lista->fields['indentacion'] . '" height="5" border="0" alt="" /><a href="#" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . addslashes($lista->fields['nombre']) . '\';return true" title="' . $lista->fields['descripcion'] . '">' . $lista->fields['nombre'] . '</a></td>
							';
				}
				$sMenus .= '
						</tr>
