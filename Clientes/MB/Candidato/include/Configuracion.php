<?php
	...
	define("HTTP_SERVER", "http://" . $_SERVER["HTTP_HOST"] . "/Clientes/MB/Candidato/");	//Siempre terminar en "/"
	define("HTTPS_SERVER", "https://" . $_SERVER["HTTP_HOST"] . "/Clientes/MB/Candidato/");	//Siempre terminar en "/"
	define("HTTP_SERVER_FRONT", "http://" . $_SERVER["HTTP_HOST"] . "/Clientes/MB/");	//Siempre terminar en "/"
	...
	//Directorios físicos
	define("DIR_FS_DOCUMENT_ROOT", $_SERVER["DOCUMENT_ROOT"] . "/Clientes/MB/Candidato/"); //Siempre terminar en "/"
