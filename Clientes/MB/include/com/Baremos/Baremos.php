...
class Baremos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idBaremo,idPrueba,nombre,descripcion,observaciones,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Baremo,Id  Prueba,Nombre,Descripción,Observaciones,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
