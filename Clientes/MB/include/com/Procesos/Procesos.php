...
* los valores de la entidad de clase Procesos.
**/
class Procesos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idProceso,idEmpresa,nombre,descripcion,observaciones,fechaInicio,fechaFin,idTipoProceso,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id  Proceso,Id  Empresa,Nombre,Descripción,Observaciones,Fecha de Inicio,Fecha de Fin,Id  Tipo Proceso,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad idTipoProceso
	* @return int(11)
	*/
	function getIdTipoProceso(){
		return $this->idTipoProceso;
	}
	/**
	* Fija el contenido de la propiedad idTipoProceso
	* @param idTipoProceso
	* @return void
	*/
	function setIdTipoProceso($sCadena){
		$this->idTipoProceso = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idTipoProcesoHast
	* @return int(11)
	*/
	function getIdTipoProcesoHast(){
		return $this->idTipoProcesoHast;
	}
	/**
	* Fija el contenido de la propiedad idTipoProcesoHast
	* @param idTipoProceso
	* @return void
	*/
	function setIdTipoProcesoHast($sCadena){
		$this->idTipoProcesoHast = $sCadena;
	}
	/**
