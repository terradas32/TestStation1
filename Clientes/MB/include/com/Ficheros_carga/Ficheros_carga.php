...
* los valores de la entidad de clase Ficheros_carga.
**/
class Ficheros_carga
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idFichero,idEmpresa,idProceso,fichero,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id  Fichero,Id  Empresa,Id  Proceso,Fichero,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}


	/**
	* Devuelve el contenido de la propiedad idFichero
	* @return int(11)
	*/
	function getIdFichero(){
		return $this->idFichero;
	}
	/**
	* Fija el contenido de la propiedad idFichero
	* @param idFichero
	* @return void
	*/
	function setIdFichero($sCadena){
		$this->idFichero = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idFicheroHast
	* @return int(11)
	*/
	function getIdFicheroHast(){
		return $this->idFicheroHast;
	}
	/**
	* Fija el contenido de la propiedad idFicheroHast
	* @param idFichero
	* @return void
	*/
	function setIdFicheroHast($sCadena){
		$this->idFicheroHast = $sCadena;
	}
	/**
...
}//Fin de la Clase Ficheros_carga
?>