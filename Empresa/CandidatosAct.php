...
include_once ('include/conexion.php');
	...
	$comboEMPRESAS	= new Combo($conn,"fIdEmpresa","idEmpresa","nombre","Descripcion","empresas","",constant("SLC_OPCION"),"idEmpresa=" . $conn->qstr($_cEntidadUsuarioTK->getIdEmpresa(), false),"","orden");
	...
	*/
	function readEntidad($cEntidad){
		...
		$cEntidad->setIdEmpresa((isset($_POST["fIdEmpresa"])) ? $_POST["fIdEmpresa"] : $_cEntidadUsuarioTK->getIdEmpresa());
	...
	*/
	function readLista($cEntidad){
		...
		$cEntidad->setIdEmpresa((isset($_POST["LSTIdEmpresa"]) && $_POST["LSTIdEmpresa"] != "") ? $_POST["LSTIdEmpresa"] : $_cEntidadUsuarioTK->getIdEmpresa());	$cEntidad->setBusqueda(constant("STR_EMPRESA"), (isset($_POST["LSTIdEmpresa"]) && $_POST["LSTIdEmpresa"] != "" ) ? $comboEMPRESAS->getDescripcionCombo($_POST["LSTIdEmpresa"]) : $comboEMPRESAS->getDescripcionCombo($_cEntidadUsuarioTK->getIdEmpresa()));
