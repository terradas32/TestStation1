...
include_once ('include/conexion.php');
	...
	$cEntidadDB	= new Tipos_competenciasDB($conn);  // Entidad DB
	$cEntidad	= new Tipos_competencias();  // Entidad
	...
	switch ($_POST['MODO'])
	{
		case constant("MNT_ALTA"):
			...
			?><script language="javascript" type="text/javascript">jAlert("<?php echo constant("CONF_ALTA") . $newId;?>\n<?php echo $cEntidadDB->ver_errores();?>","<?php echo constant("STR_NOTIFICACION");?>");</script><?php 
				...
				{
					if (!empty($_POST['tipos_competencias_next_page']) && $_POST['tipos_competencias_next_page'] > 1 ){
						$bInit=false;
					...
					$pager = new ADODB_Pager($conn,$sql,'tipos_competencias');
					...
					$lista=$pager->getRS();
					include('Template/Tipos_competencias/mnttipos_competenciasl.php');
				}else{
					$cEntidad	= new Tipos_competencias();  // inicializamos la Entidad
					$_POST['MODO']    = constant("MNT_ALTA");
					include('Template/Tipos_competencias/mnttipos_competenciasa.php');
				}
			}else{
		...
		case constant("MNT_BUSCAR"):
			...
			include('Template/Tipos_competencias/mnttipos_competencias.php');
			break;
	...
	*/
	function readLista($cEntidad){
		...
		$cEntidad->setIdTipoCompetencia((isset($_POST["LSTIdTipoCompetencia"]) && $_POST["LSTIdTipoCompetencia"] != "") ? $_POST["LSTIdTipoCompetencia"] : "");	$cEntidad->setBusqueda(constant("STR_ID_TIPO_COMPETENCIA"), (isset($_POST["LSTIdTipoCompetencia"]) && $_POST["LSTIdTipoCompetencia"] != "" ) ? $_POST["LSTIdTipoCompetencia"] : "");
		$cEntidad->setIdTipoCompetenciaHast((isset($_POST["LSTIdTipoCompetenciaHast"]) && $_POST["LSTIdTipoCompetenciaHast"] != "") ? $_POST["LSTIdTipoCompetenciaHast"] : "");	$cEntidad->setBusqueda(constant("STR_ID_TIPO_COMPETENCIA") . " " . constant("STR_HASTA"), (isset($_POST["LSTIdTipoCompetenciaHast"]) && $_POST["LSTIdTipoCompetenciaHast"] != "" ) ? $_POST["LSTIdTipoCompetenciaHast"] : "");
