...
include_once ('include/conexion.php');
	...
	$_POST["fIdUsuario"] = $_cEntidadUsuarioTK->getIdUsuario();
	$_POST["LSTIdUsuario"] = $_cEntidadUsuarioTK->getIdUsuario();
	...
	*/
	function readLista($cEntidad){
		...
		$cEntidad->setIdEmpresa((!empty($_POST["LSTIdEmpresa"])) ? $_POST["LSTIdEmpresa"] : "");	$cEntidad->setBusqueda(constant("STR_TIPO_DE_USUARIO"), (!empty($_POST["LSTIdEmpresa"])) ? $comboEMPRESAS->getDescripcionCombo($_POST["LSTIdEmpresa"]) : "");
