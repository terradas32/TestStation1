...
include_once ('include/conexionECases.php');
	...
	switch ($_POST['MODO'])
	{
		...
		case constant("MNT_MODIFICAR"):
            ...
            //echo "<br />Proceso_informes::" . $sqlProceso_informes;
...
// 								error_log($sTypeError . "\n", 3, constant("DIR_FS_PATH_NAME_CORREO"));
			...
			if (empty($newId))
			{
				if ($iTotalEnviados >= $iTotalCandidatosInicio)
				{
					$bReenviar = "0";
			?>
 				<script language="javascript" type="text/javascript">alert("<?php echo $iTotalCandidatosInicio-sizeof($aMailsNOEnviados);?> <?php echo constant("STR_DE");?> <?php echo $iTotalCandidatosInicio;?> <?php echo constant("STR_ENVIADOS_CORRECTAMENTE");?>. \n<?php echo $cEntidadDB->ver_errores();?>");</script>
			<?php
					$_POST['fiTotalCandidatosInicio']=0;
					$_POST['fiTotalEnviados']=0;
					$_POST['fMailsNOEnviados']="";
