<<<<<<< HEAD
<?php
	$_HTTP_HOST = (empty($_SERVER["HTTP_HOST"])) ? "local.teststation.com" : $_SERVER["HTTP_HOST"];
	$_DOCUMENT_ROOT = (empty($_SERVER["DOCUMENT_ROOT"])) ? "C:\\xampp56\\htdocs" : $_SERVER["DOCUMENT_ROOT"];

	// Define the webserver and path parameters
	// * DIR_FS_* Directorio físico (local/physical)
	// * DIR_WS_* Directorio del servidor Web (virtual/URL)
	define("HTTP_SERVER", "https://" . $_HTTP_HOST . "/Empresa/");	//Siempre terminar en "/"
	define("HTTPS_SERVER", "https://" . $_HTTP_HOST . "/Empresa/");	//Siempre terminar en "/"
	...
	//Directorios físicos
	define("DIR_FS_DOCUMENT_ROOT", $_DOCUMENT_ROOT . "/Empresa/"); //Siempre terminar en "/"
	...
	define("DIR_FS_PATH_NAME_CORREO", constant("DIR_FS_DOCUMENT_ROOT") . "correos.log");
  	...
  	define("APP_KEY", base64_encode("lVMVMewESftxI1KQSYSExVkcecBFvLvLLJK80u7Di7U="));
	...
	define("MNT_PROGRAMAR_ENVIO",699);
...
<?php
	...
	// * DIR_FS_* Directorio físico (local/physical)
	// * DIR_WS_* Directorio del servidor Web (virtual/URL)
	define("HTTP_SERVER", "http://" . $_HTTP_HOST . "/Empresa/");	//Siempre terminar en "/"
	define("HTTPS_SERVER", "https://" . $_HTTP_HOST . "/Empresa/");	//Siempre terminar en "/"
