...
* los valores de la entidad de clase Ccaa.
**/
class Ccaa
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idComunidad,codIdiomaIso2,descripcion,idPais,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Comunidad,Idioma,Descripción,País,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
