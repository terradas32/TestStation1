...
//			$cEntidadPadre = $cEntidad;
	...
	*************************************************************************/
	function getMenus($sSQL)
	{
		...
		while (!$lista->EOF)
		{
			$str_menu = (defined("STR_MENU_" . $lista->fields['idFuncionalidad'])) ? constant("STR_MENU_" . $lista->fields['idFuncionalidad']) : $lista->fields['nombre'];
			$str_desc_menu = (defined("STR_DESC_MENU_" . $lista->fields['idFuncionalidad'])) ? constant("STR_DESC_MENU_" . $lista->fields['idFuncionalidad']) : $lista->fields['descripcion'];
			...
			if ($lista->fields['indentacion'] == 0)
			{
				...
				$sMenus .= '
					...
					if (empty($lista->fields['popUp'])){
						...
						if($lista->fields['idFuncionalidad'] == '110')
						$sMenus .= '
							<tr onclick="javascript:expandingWindow(\'ayuda/'.$_REQUEST['lang'].'/' . $sUrl . '?fLang=' . $_REQUEST['lang'] . '\');" onmouseover="javascript:overTR(this,\'White\');cambia(' . $i . ',1);" onmouseout ="javascript:outTR(this,\'' . $lista->fields['bgColor'] . '\');cambia(' . $i . ',0)" bgcolor="' . $lista->fields['bgColor'] . '">
							';
							else{
								$sMenus .= '
							<tr onclick="javascript:expandingWindow(\'' . $sUrl . '?fLang=' . $_REQUEST['lang'] . '\');" onmouseover="javascript:overTR(this,\'White\');cambia(' . $i . ',1);" onmouseout ="javascript:outTR(this,\'' . $lista->fields['bgColor'] . '\');cambia(' . $i . ',0)" bgcolor="' . $lista->fields['bgColor'] . '">
							';
							}
						// $sMenus .= '
						// 	<tr onclick="javascript:expandingWindow(\'' . $sUrl . '?fLang=' . $_REQUEST['lang'] . '\');" onmouseover="javascript:overTR(this,\'White\');cambia(' . $i . ',1);" onmouseout ="javascript:outTR(this,\'' . $lista->fields['bgColor'] . '\');cambia(' . $i . ',0)" bgcolor="' . $lista->fields['bgColor'] . '">
				...
				$sMenus .= ' title="' . $str_desc_menu . '">
								<table cellspacing="0" cellpadding="0" border="0" width="100%">
									<tr>
										<td valign="top" onclick="javascript:cambia(\'' . $i . '\',2);block(\'' . $iBlock . '\');setTitulo(\'' . addslashes($str_menu) . '\');enviarMenu(\'' . $sUrl . '\',\'' . $sModo . '\');"><img src="graf/sp.gif" width="10" style="height:10px" name="a' . $i . '" border="0" alt="" /></td>
										';
										if (empty($lista->fields['popUp']))
										{
				$sMenus .= '			<td onclick="javascript:cambia(\'' . $i . '\',2);block(\'' . $iBlock . '\');setTitulo(\'' . addslashes($str_menu) . '\');enviarMenu(\'' . $sUrl . '\',\'' . $sModo . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . addslashes($str_menu) . '\';return true" class="negrob" width="100%">' . $str_menu . '</td>
										<td onclick="javascript:cambia(\'' . $i . '\',2);block(\'' . $iBlock . '\');setTitulo(\'' . addslashes($str_menu) . '\');enviarMenu(\'' . $sUrl . '\',\'' . $sModo . '\');"><img src="graf/sp.gif" width="9" style="height:9px" border="0" alt="" /></td>';
										}else{
											if($lista->fields['idFuncionalidad'] == '110'){
												$sMenus .= '			<td onmouseout="window.status=\'\';return true" onmouseover="window.status=\''. $_REQUEST['lang'] .'/' . addslashes($str_menu) . '\';return true" class="negrob" width="100%">' . $str_menu . '</td>
												<td ><img src="graf/sp.gif" width="9" style="height:9px" border="0" alt="" /></td>';
											}
											else{
												$sMenus .= '			<td onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . addslashes($str_menu) . '\';return true" class="negrob" width="100%">' . $str_menu . '</td>
																		<td ><img src="graf/sp.gif" width="9" style="height:9px" border="0" alt="" /></td>';
											}
										}
				...
				{
					case '1':
						$sMenus .= '<td colspan="2" onclick="javascript:cambia(\'' . $i . '\',2);block(\'' . $iBlock . '\');setTitulo(\'' . addslashes($str_menu) . '\');enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_NUEVO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_NUEVO") . ' >>> ' . addslashes($str_menu) . '\';return true"><img src="graf/mas.gif" width="9" hspace="3" style="height:9px" border="0" alt="' . constant("STR_NUEVO") . '" /></td>';
						break;
					case '12':
						$sMenus .= '<td onclick="javascript:cambia(\'' . $i . '\',2);block(\'' . $iBlock . '\');setTitulo(\'' . addslashes($str_menu) . '\');enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_NUEVO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_NUEVO") . ' >>> ' . addslashes($str_menu) . '\';return true"><img src="graf/mas.gif" width="9" hspace="3" style="height:9px" border="0" alt="' . constant("STR_NUEVO") . '" /></td>';
						$sMenus .= '<td onclick="javascript:cambia(\'' . $i . '\',2);block(\'' . $iBlock . '\');setTitulo(\'' . addslashes($str_menu) . '\');enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_INICIO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_BUSCADOR") . ' >>> ' . addslashes($str_menu) . '\';return true"><img src="graf/buscar.gif" width="9" hspace="3" style="height:9px" border="0" alt="' . constant("STR_BUSCAR") . '" /></td>';
						break;
					case '2':
						$sMenus .= '<td onclick="javascript:cambia(\'' . $i . '\',2);block(\'' . $iBlock . '\');setTitulo(\'' . addslashes($str_menu) . '\');enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_INICIO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_BUSCADOR") . ' >>> ' . addslashes($str_menu) . '\';return true"><img src="graf/buscar.gif" width="9" hspace="3" style="height:9px" border="0" alt="' . constant("STR_BUSCAR") . '" /></td>';
						break;
				...
				$sMenus .= '
						<tr onmouseover="javascript:overTR(this,\'#EFEFEF\');cambia(' . $i . ',1);" onmouseout ="javascript:outTR(this,\'\');cambia(' . $i . ',0)">
							...
							';
				if (empty($lista->fields['popUp'])){
					$str_menu2 = (defined("STR_MENU_" . $lista->fields['idPadre'])) ? constant("STR_MENU_" . $lista->fields['idPadre']) : $comboFUNCIONALIDADES->getDescripcionCombo($lista->fields['idPadre']);
					$sMenus .= '
							<td class="submenu" width="100%" bgcolor="' . $bgColor . '" onclick="javascript:cambia(' . $i . ',2);setTitulo(\'' . addslashes($str_menu2 . ' - ' . $str_menu) . '\');enviarMenu(\'' . $sUrl . '\',\'' . $sModo . '\',\'' . $lista->fields['bgColor'] . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . addslashes($str_menu) . '\';return true" title="' . $str_desc_menu . '"><img src="graf/sp.gif" width="' . 5*$lista->fields['indentacion'] . '" style="height:5px" border="0" alt="" />' . $str_menu . '</td>
					...
					{
						case '1':
							$sMenus .= '<td colspan="2" onclick="javascript:cambia(' . $i . ',2);enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_NUEVO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_NUEVO") . ' >>> ' . addslashes($str_menu) . '\';return true"><img src="graf/mas.gif" width="9" hspace="1" style="height:9px" border="0" alt="' . constant("STR_NUEVO") . '" /></td>';
							break;
						case '12':
							$sMenus .= '<td onclick="javascript:cambia(' . $i . ',2);enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_NUEVO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_NUEVO") . ' >>> ' . addslashes($str_menu) . '\';return true"><img src="graf/mas.gif" width="9" hspace="1" style="height:9px" border="0" alt="' . constant("STR_NUEVO") . '" /></td>';
							$sMenus .= '<td onclick="javascript:cambia(' . $i . ',2);enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_INICIO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_BUSCADOR") . ' >>> ' . addslashes($str_menu) . '\';return true"><img src="graf/buscar.gif" width="9" hspace="1" style="height:9px" border="0" alt="' . constant("STR_BUSCAR") . '" /></td>';
							break;
						case '2':
							$sMenus .= '<td onclick="javascript:cambia(' . $i . ',2);enviarMenu(\'' . $sUrl . '\',\'' . constant("MNT_INICIO") . '\');" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . constant("STR_BUSCADOR") . ' >>> ' . addslashes($str_menu) . '\';return true"><img src="graf/buscar.gif" width="9" hspace="1" style="height:9px" border="0" alt="' . constant("STR_BUSCAR") . '" /></td>';
							break;
					...
					$sMenus .= '
							<td class="submenu" width="100%" bgcolor="' . $bgColor . '" onclick="javascript:expandingWindow(\'' . $sUrl . '?fLang=' . $_REQUEST['lang'] . '\');"><img src="graf/sp.gif" width="' . 5*$lista->fields['indentacion'] . '" style="height:5px" border="0" alt="" /><a href="#" onmouseout="window.status=\'\';return true" onmouseover="window.status=\'' . addslashes($str_menu) . '\';return true" title="' . $str_desc_menu . '">' . $str_menu . '</a></td>
							';
				}
				$sMenus .= '
						</tr>
