...
class Respuestas_pruebas
{
	...
	**/
	function __construct()
	{
		...
		$this->DESCListaExcel	=	CONSTANT("STR_EMPRESA") . "," . CONSTANT("STR_PROCESO") . "," . CONSTANT("STR_CANDIDATO") . "," . CONSTANT("STR_IDIOMA") . "," . CONSTANT("STR_PRUEBA") . "," . CONSTANT("STR_FINALIZADO") . "," . CONSTANT("STR_LEIDO_INSTRUCCIONES") . "," . CONSTANT("STR_LEIDO_EJEMPLOS") . "," . CONSTANT("STR_MINUTOS_TEST") . "," . CONSTANT("STR_SEGUNDOS_TEST") . "," . CONSTANT("STR_FECHA_DE_ALTA") . "," . CONSTANT("STR_FECHA_DE_MODIFICACION") . "," . CONSTANT("STR_USUARIO_DE_ALTA") . "," . CONSTANT("STR_USUARIO_DE_MODIFICACION") . "";
	}
