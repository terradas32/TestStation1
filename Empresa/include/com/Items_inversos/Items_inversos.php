...
* los valores de la entidad de clase Items_inversos.
**/
class Items_inversos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idPrueba,idItem,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Prueba,Item,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Items_inversos
?>