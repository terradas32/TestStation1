...
* los valores de la entidad de clase Recomendaciones.
**/
class Recomendaciones
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idRecomendacion,codIdiomaIso2,titulo,descripcion,zonaPublicacion,orden,publicar,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id,Idioma,Título,Descripción,Zona Publicación,Orden,Publicar,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}


	/**
	* Devuelve el contenido de la propiedad idRecomendacion
	* @return int(11)
	*/
	function getIdRecomendacion(){
		return $this->idRecomendacion;
	}
	/**
	* Fija el contenido de la propiedad idRecomendacion
	* @param idRecomendacion
	* @return void
	*/
	function setIdRecomendacion($sCadena){
		$this->idRecomendacion = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idRecomendacionHast
	* @return int(11)
	*/
	function getIdRecomendacionHast(){
		return $this->idRecomendacionHast;
	}
	/**
	* Fija el contenido de la propiedad idRecomendacionHast
	* @param idRecomendacion
	* @return void
	*/
	function setIdRecomendacionHast($sCadena){
		$this->idRecomendacionHast = $sCadena;
	}
	/**
