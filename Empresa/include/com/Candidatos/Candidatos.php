...
class Candidatos
{
	...
	**/
	function __construct()
	{
		...
		$this->ultimaAcc			= "";
		$this->ultimaAccHast			= "";
		$this->PKListaExcel		=	"idCandidato,idEmpresa,idProceso,nombre,apellido1,apellido2,dni,mail,idTratamiento,idSexo,idEdad,fechaNacimiento,idPais,idProvincia,idMunicipio,idZona,direccion,codPostal,idFormacion,idNivel,idArea,telefono,estadoCivil,nacionalidad,informado,ultimoLogin,finalizado,fechaFinalizado,fecAlta,fecMod,usuAlta,usuMod";
		//$this->DESCListaExcel	=	"Id Candidato,Empresa,Proceso,Nombre,Apellido 1,Apellido 2,Nif,EMail,Tratamiento,Sexo,Edad,Fecha de Nacimiento,País,Provincía,Municipio,Zona,Dirección,Código Postal,Formación,Nivel,Área,Teléfono,Estado Civil,Nacionalidad,Informado,Último login,Finalizado,Fecha de Finalizado,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
		$this->DESCListaExcel	=	CONSTANT("STR_ID_CANDIDATO") . "," . CONSTANT("STR_EMPRESA") . "," . CONSTANT("STR_PROCESO") . "," . CONSTANT("STR_NOMBRE") . "," . CONSTANT("STR_APELLIDO_1") . "," . CONSTANT("STR_APELLIDO_2") . "," . CONSTANT("STR_NIF") . "," . CONSTANT("STR_EMAIL") . "," . CONSTANT("STR_TRATAMIENTO") . "," . CONSTANT("STR_SEXO") . "," . CONSTANT("STR_EDAD") . "," . CONSTANT("STR_FECHA_DE_NACIMIENTO") . "," . CONSTANT("STR_PAIS") . "," . CONSTANT("STR_PROVINCIA") . "," . CONSTANT("STR_MUNICIPIO") . "," . CONSTANT("STR_ZONA") . "," . CONSTANT("STR_DIRECCION") . "," . CONSTANT("STR_CODIGO_POSTAL") . "," . CONSTANT("STR_FORMACION") . "," . CONSTANT("STR_NIVEL") . "," . CONSTANT("STR_AREA") . "," . CONSTANT("STR_TELEFONO") . "," . CONSTANT("STR_ESTADO_CIVIL") . "," . CONSTANT("STR_NACIONALIDAD") . "," . CONSTANT("STR_INFORMADO") . "," . CONSTANT("STR_ULTIMO_LOGIN") . "," . CONSTANT("STR_FINALIZADO") . "," . CONSTANT("STR_FECHA_DE_FINALIZADO") . "," . CONSTANT("STR_FECHA_DE_ALTA") . "," . CONSTANT("STR_FECHA_DE_MODIFICACION") . "," . CONSTANT("STR_USUARIO_DE_ALTA") . "," . CONSTANT("STR_USUARIO_DE_MODIFICACION") . "";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad certificada
	* @return varchar(255)
	*/
	function getCertificada(){
		return $this->certificada;
	}
	/**
	* Fija el contenido de la propiedad certificada
	* @param certificada
	* @return void
	*/
	function setCertificada($sCadena){
		$this->certificada = $sCadena;
	}
	
	/**
	* Devuelve el contenido de la propiedad envDiploma
	* @return varchar(255)
	*/
	function getEnvDiploma(){
		return $this->envDiploma;
	}
	/**
	* Fija el contenido de la propiedad envDiploma
	* @param envDiploma
	* @return void
	*/
	function setEnvDiploma($sCadena){
		$this->envDiploma = $sCadena;
	}
	
	/**
	 * Devuelve el contenido de la propiedad pagoTpv
	 * @return varchar(255)
	 */
	function getPagoTpv(){
		return $this->pagoTpv;
	...
	/**
	 * Fija el contenido de la propiedad pagoTpv
	 * @param pagoTpv
	 * @return void
	 */
	function setPagoTpv($sCadena){
		$this->pagoTpv = $sCadena;
	}
