...
//		echo $sql;
	...
	*****************************************************************************************/
	function decuentaConsumoXAdministracion($cCandidato)
	{
		...
		require_once(constant("DIR_FS_DOCUMENT_ROOT") . constant("DIR_WS_COM") . "Pruebas_empresas/Pruebas_empresasDB.php");
		require_once(constant("DIR_FS_DOCUMENT_ROOT") . constant("DIR_WS_COM") . "Pruebas_empresas/Pruebas_empresas.php");
		...
		while (!$rsProceso_pruebas->EOF)
		{
			...
			while(!$rsProceso_informes->EOF)
			{
				...
				$_CodIdiomaInforme = $cInformes_pruebas->getCodIdiomaIso2();
			...
			$cConsumos->setCodIdiomaInforme($_CodIdiomaInforme);
			$cConsRead->setCodIdiomaInforme($_CodIdiomaInforme);
