...
* los valores de la entidad de clase Usuarios.
**/
class Usuarios
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idUsuario,idUsuarioTipo,login,password,nombre,apellido1,apellido2,email,loginCorreo,passwordCorreo,fecBaja,bajaLog,ultimoLogin,token,ultimaAcc,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Usuario,Id UsuarioTipo,Login,Password,Nombre,Apellido1,Apellido2,Email,LoginCorreo,PasswordCorreo,Fec. Baja,BajaLog,UltimoLogin,Token,UltimaAcc,Fec. Alta,Fec. Mod,Usu. Alta,Usu. Mod";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad idUsuarioTipoHast
	* @return int(11)
	*/
	function getIdUsuarioTipoHast(){
		return $this->idUsuarioTipoHast;
	}
	/**
	* Fija el contenido de la propiedad idUsuarioTipoHast
	* @param idUsuarioTipo
	* @return void
	*/
	function setIdUsuarioTipoHast($sCadena){
		$this->idUsuarioTipoHast = $sCadena;
	}
	/**
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad loginCorreo
	* @return varchar(255)
	*/
	function getLoginCorreo(){
		return $this->loginCorreo;
	}
	/**
	* Fija el contenido de la propiedad loginCorreo
	* @param loginCorreo
	* @return void
	*/
	function setLoginCorreo($sCadena){
		$this->loginCorreo = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad passwordCorreo
	* @return varchar(255)
	*/
	function getPasswordCorreo(){
		return $this->passwordCorreo;
	}
	/**
	* Fija el contenido de la propiedad passwordCorreo
	* @param passwordCorreo
	* @return void
	*/
	function setPasswordCorreo($sCadena){
		$this->passwordCorreo = $sCadena;
	}
	/**
