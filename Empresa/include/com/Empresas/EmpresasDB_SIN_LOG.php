...
class EmpresasDB
{
	...
	***********************************************************************/
	function insertar($cEntidad)
	{
		...
		$sql .= "umbral_aviso" . ",";
		$sql .= "idsPruebas" . ",";
		$sql .= (trim($cEntidad->getIdsPruebasAleatorias()) != "") ? "idsPruebasAleatorias" . "," : "";
    ...
    $sql .= (trim($cEntidad->getPassword()) != "") ? $aux->qstr(password_hash($cEntidad->getPassword(), PASSWORD_BCRYPT), false) . "," : "";
		...
		$sql .= $aux->qstr((empty($cEntidad->getDongles())) ? "0" : $cEntidad->getDongles(), false) . ",";
		...
		$sql .= $aux->qstr((empty($cEntidad->getUmbral_aviso())) ? "100" : $cEntidad->getUmbral_aviso(), false) . ",";
		$sql .= $aux->qstr($cEntidad->getIdsPruebas(), false) . ",";
		$sql .= (trim($cEntidad->getIdsPruebasAleatorias()) != "") ? $aux->qstr($cEntidad->getIdsPruebasAleatorias(), false) . "," : "";
		...
		$cEmpPerfil->setUsuAlta($cEntidad->getUsuAlta());
...
**************************************************************************************************/
	function modificar($cEntidad)
	{
			...
			($cEntidad->getDespuesDe() == $cEntidadBack->getOrden()) )
		{
			...
			$sql .= (trim($cEntidad->getIdsPruebasAleatorias()) != "") ? "idsPruebasAleatorias=" . $aux->qstr($cEntidad->getIdsPruebasAleatorias(), false) . "," : "";
