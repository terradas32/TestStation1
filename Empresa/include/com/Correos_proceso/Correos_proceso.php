...
class Correos_proceso
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idProceso,idTipoCorreo,idCorreo,nombre,asunto,cuerpo,descripcion,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Empresa,Proceso,Tipo Correo,Correo,Nombre,Asunto,Cuerpo,Descripción,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
