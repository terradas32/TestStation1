...
* los valores de la entidad de clase Pruebas_empresas.
**/
class Pruebas_empresas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idPrueba,codIdiomaIso2,tarifa,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Empresa,Id Prueba,Idioma,Id Tipo Informe,Tarifa,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
	/**
...
}//Fin de la Clase Pruebas_empresas
?>