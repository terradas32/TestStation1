...
* los valores de la entidad de clase Proceso_informes.
**/
class Proceso_informes
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idProceso,codIdiomaIso2,idPrueba,idBaremo,codIdiomaInforme,idTipoInforme,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Empresa,Proceso,Idioma,Prueba,Baremo,Idioma Informe,Tipo Informe,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Proceso_informes
?>
