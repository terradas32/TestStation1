...
class Peticiones_dongles
{
	...
	**/
	function __construct()
	{
		...
		$this->DESCListaExcel	=	constant("STR_IDPETICION") . "," . constant("STR_EMPRESA") . "," . constant("STR_EMPRESA_RECEPTORA") . "," . constant("STR_NUMERO_DE_DONGLES") . "," . constant("STR_ESTADO") . "," . constant("STR_FECHA_DE_ALTA") . "," . constant("STR_FECHA_DE_MODIFICACION") . "," . constant("STR_USUARIO_DE_ALTA") . "," . constant("STR_USUARIO_DE_MODIFICACION") . "";
	}
