...
* los valores de la entidad de clase Notificaciones.
**/
class Notificaciones
{
	...
	**/
		...
		var $idNotificacion;
		var $idNotificacionHast;
		var $idTipoNotificacion;
		var $idTipoNotificacionHast;
		var $asunto;
		var $cuerpo;
		var $fecAlta;
		var $fecAltaHast;
	...
	**/
	function __construct()
	{
		...
		$this->idNotificacion			= "";
		$this->idNotificacionHast			= "";
		$this->idTipoNotificacion			= "";
		$this->idTipoNotificacionHast			= "";
		$this->asunto			= "";
		$this->cuerpo			= "";
		$this->fecAlta			= "";
		$this->fecAltaHast			= "";
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idNotificacion,idTipoNotificacion,asunto,cuerpo,fecAlta,fecMod";
		$this->DESCListaExcel	=	"Id,Tipo de Notificación,Asunto,Cuerpo,Fecha de Alta,Fecha de Modificación";
	}


	/**
	* Devuelve el contenido de la propiedad idNotificacion
	* @return int(11)
	*/
	...
	/**
	* Fija el contenido de la propiedad idNotificacion
	* @param idNotificacion
	* @return void
	*/
	function setIdNotificacion($sCadena){
		$this->idNotificacion = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idNotificacionHast
	* @return int(11)
	*/
	function getIdNotificacionHast(){
		return $this->idNotificacionHast;
	}
	/**
	* Fija el contenido de la propiedad idNotificacionHast
	* @param idNotificacion
	* @return void
	*/
	function setIdNotificacionHast($sCadena){
		$this->idNotificacionHast = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idTipoNotificacion
	* @return int(11)
	*/
	function getIdTipoNotificacion(){
		return $this->idTipoNotificacion;
	}
	/**
	* Fija el contenido de la propiedad idTipoNotificacion
	* @param idTipoNotificacion
	* @return void
	*/
	function setIdTipoNotificacion($sCadena){
		$this->idTipoNotificacion = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idTipoNotificacionHast
	* @return int(11)
	*/
	function getIdTipoNotificacionHast(){
		return $this->idTipoNotificacionHast;
	}
	/**
	* Fija el contenido de la propiedad idTipoNotificacionHast
	* @param idTipoNotificacion
	* @return void
	*/
	function setIdTipoNotificacionHast($sCadena){
		$this->idTipoNotificacionHast = $sCadena;
	}
	/**
