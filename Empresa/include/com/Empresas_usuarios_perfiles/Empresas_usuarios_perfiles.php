...
* los valores de la entidad de clase Empresas_usuarios_perfiles.
**/
class Empresas_usuarios_perfiles
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idUsuario,idPerfil,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Empresa,Usuario,Perfil,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad idPerfilHast
	* @return int(11)
	*/
	function getIdPerfilHast(){
		return $this->idPerfilHast;
	}
	/**
	* Fija el contenido de la propiedad idPerfilHast
	* @param idPerfil
	* @return void
	*/
	function setIdPerfilHast($sCadena){
		$this->idPerfilHast = $sCadena;
	}
	/**
...
}//Fin de la Clase Empresas_usuarios_perfiles
?>