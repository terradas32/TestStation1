...
class Textos_escalas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idTexto,idPrueba,idBloque,idEscala,puntMin,puntMax,texto,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Texto,Id Prueba,Id Bloque,Id Escala,Punt Min,Punt Max,Texto,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
