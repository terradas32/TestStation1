...
* los valores de la entidad de clase Rangos_textos.
**/
class Rangos_textos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"codIdiomaIso2,idPrueba,idTipoInforme,idIr,idIp,texto,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Idioma,Prueba,Tipo Informe,IR,IP,Texto,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad idIr
	* @return int(11)
	*/
	function getIdIr(){
		return $this->idIr;
	...
	/**
	* Fija el contenido de la propiedad idIr
	* @param idIr
	* @return void
	*/
	function setIdIr($sCadena){
		$this->idIr = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idIrHast
	* @return int(11)
	*/
	function getIdIrHast(){
		return $this->idIrHast;
	}
	/**
	* Fija el contenido de la propiedad idIrHast
	* @param idIr
	* @return void
	*/
	function setIdIrHast($sCadena){
		$this->idIrHast = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idIp
	* @return int(11)
	*/
	function getIdIp(){
		return $this->idIp;
	...
	/**
	* Fija el contenido de la propiedad idIp
	* @param idIp
	* @return void
	*/
	function setIdIp($sCadena){
		$this->idIp = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idIpHast
	* @return int(11)
	*/
	function getIdIpHast(){
		return $this->idIpHast;
	}
	/**
	* Fija el contenido de la propiedad idIpHast
	* @param idIp
	* @return void
	*/
	function setIdIpHast($sCadena){
		$this->idIpHast = $sCadena;
	}
	/**
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad textoHast
	* @return int(11)
	*/
	function getTextoHast(){
		return $this->textoHast;
	}
	/**
	* Fija el contenido de la propiedad textoHast
	* @param texto
	* @return void
	*/
	function setTextoHast($sCadena){
		$this->textoHast = $sCadena;
	}
	/**
