...
<div id="contenedor">
	...
	<div id="envoltura">
		<div id="contenido">
			...
			{
				$sIframe2 = '
				<iframe title="PowerBI" width="100%" height="541.25" src="https://app.powerbi.com/view?r=' . $_cEntidadUsuarioTK->getpower_bi_token_fit() . '" frameborder="0" allowFullScreen="true"></iframe>
				';
			}
			if (empty($sIframe1) && empty($sIframe2))
            {
			?>		
