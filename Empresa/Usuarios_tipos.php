...
ob_start();
	...
	require_once(constant("DIR_WS_COM") . "Usuarios_tipos/Usuarios_tiposDB.php");
	require_once(constant("DIR_WS_COM") . "Usuarios_tipos/Usuarios_tipos.php");
...
include_once ('include/conexion.php');
	...
	$cEntidadDB	= new Usuarios_tiposDB($conn);  // Entidad DB
	$cEntidad	= new Usuarios_tipos();  // Entidad
	...
	switch ($_POST['MODO'])
	{
		case constant("MNT_ALTA"):
			...
			?><script language="javascript" type="text/javascript">jAlert("<?php echo constant("CONF_ALTA") . $newId;?>\n<?php echo $cEntidadDB->ver_errores();?>","<?php echo constant("STR_NOTIFICACION");?>");</script><?php 
				...
				{
					if (!empty($_POST['usuarios_tipos_next_page']) && $_POST['usuarios_tipos_next_page'] > 1 ){
						$bInit=false;
					...
					$pager = new ADODB_Pager($conn,$sql,'usuarios_tipos');
					...
					$lista=$pager->getRS();
					include('Template/Usuarios_tipos/mntusuarios_tiposl.php');
				}else{
					$cEntidad	= new Usuarios_tipos();  // inicializamos la Entidad
					$_POST['MODO']    = constant("MNT_ALTA");
					include('Template/Usuarios_tipos/mntusuarios_tiposa.php');
				}
			}else{
		...
		case constant("MNT_BUSCAR"):
			...
			include('Template/Usuarios_tipos/mntusuarios_tipos.php');
			break;
	...
	*/
	function readLista($cEntidad){
		global $conn;
		global $cUtilidades;
		$cEntidad->setIdUsuarioTipo((isset($_POST["LSTIdUsuarioTipo"]) && $_POST["LSTIdUsuarioTipo"] != "") ? $_POST["LSTIdUsuarioTipo"] : "");	$cEntidad->setBusqueda(constant("STR_ID_USUARIO_TIPO"), (isset($_POST["LSTIdUsuarioTipo"]) && $_POST["LSTIdUsuarioTipo"] != "" ) ? $_POST["LSTIdUsuarioTipo"] : "");
		$cEntidad->setIdUsuarioTipoHast((isset($_POST["LSTIdUsuarioTipoHast"]) && $_POST["LSTIdUsuarioTipoHast"] != "") ? $_POST["LSTIdUsuarioTipoHast"] : "");	$cEntidad->setBusqueda(constant("STR_ID_USUARIO_TIPO") . " " . constant("STR_HASTA"), (isset($_POST["LSTIdUsuarioTipoHast"]) && $_POST["LSTIdUsuarioTipoHast"] != "" ) ? $_POST["LSTIdUsuarioTipoHast"] : "");
