...
include_once ('include/conexion.php');
	...
	$cEntidadDB	= new EjemplosDB($conn);  // Entidad DB
	$cEntidad	= new Ejemplos();  // Entidad
	...
	switch ($_POST['MODO'])
	{
		case constant("MNT_ALTA"):
			...
			?><script language="javascript" type="text/javascript">alert("<?php echo constant("CONF_ALTA") . $newId;?>\n<?php echo $cEntidadDB->ver_errores();?>","<?php echo constant("STR_NOTIFICACION");?>");</script><?php
				if ($_POST['ORIGEN'] == constant("MNT_LISTAR"))
				{
					...
					$lista=$pager->getRS();
					include('Template/Ejemplos/mntejemplosl.php');
				}else{
					$cEntidad	= new Ejemplos();  // inicializamos la Entidad
					$_POST['MODO']    = constant("MNT_ALTA");
					include('Template/Ejemplos/mntejemplosa.php');
				}
			}else{
		...
		case constant("MNT_BUSCAR"):
			...
			include('Template/Ejemplos/mntejemplos.php');
			break;
	...
	*/
	function readEntidad($cEntidad){
		...
		global $cUtilidades;
		$cEntidad->setIdEjemplo((isset($_POST["fIdEjemplo"])) ? $_POST["fIdEjemplo"] : "");
	...
	*/
	function readLista($cEntidad){
		global $conn;
		global $cUtilidades;
		$cEntidad->setIdEjemplo((isset($_POST["LSTIdEjemplo"]) && $_POST["LSTIdEjemplo"] != "") ? $_POST["LSTIdEjemplo"] : "");	$cEntidad->setBusqueda(constant("STR_ID_EJEMPLO"), (isset($_POST["LSTIdEjemplo"]) && $_POST["LSTIdEjemplo"] != "" ) ? $_POST["LSTIdEjemplo"] : "");
		$cEntidad->setIdEjemploHast((isset($_POST["LSTIdEjemploHast"]) && $_POST["LSTIdEjemploHast"] != "") ? $_POST["LSTIdEjemploHast"] : "");	$cEntidad->setBusqueda(constant("STR_ID_EJEMPLO") . " " . constant("STR_HASTA"), (isset($_POST["LSTIdEjemploHast"]) && $_POST["LSTIdEjemploHast"] != "" ) ? $_POST["LSTIdEjemploHast"] : "");
		...
		$cEntidad->setPath1((isset($_POST["LSTPath1"]) && $_POST["LSTPath1"] != "") ? $_POST["LSTPath1"] : "");	$cEntidad->setBusqueda(constant("STR_IMAGEN_1"), (isset($_POST["LSTPath1"]) && $_POST["LSTPath1"] != "" ) ? $_POST["LSTPath1"] : "");
		$cEntidad->setPath2((isset($_POST["LSTPath2"]) && $_POST["LSTPath2"] != "") ? $_POST["LSTPath2"] : "");	$cEntidad->setBusqueda(constant("STR_IMAGEN_2"), (isset($_POST["LSTPath2"]) && $_POST["LSTPath2"] != "" ) ? $_POST["LSTPath2"] : "");
		$cEntidad->setPath3((isset($_POST["LSTPath3"]) && $_POST["LSTPath3"] != "") ? $_POST["LSTPath3"] : "");	$cEntidad->setBusqueda(constant("STR_IMAGEN_3"), (isset($_POST["LSTPath3"]) && $_POST["LSTPath3"] != "" ) ? $_POST["LSTPath3"] : "");
		$cEntidad->setPath4((isset($_POST["LSTPath4"]) && $_POST["LSTPath4"] != "") ? $_POST["LSTPath4"] : "");	$cEntidad->setBusqueda(constant("STR_IMAGEN_4"), (isset($_POST["LSTPath4"]) && $_POST["LSTPath4"] != "" ) ? $_POST["LSTPath4"] : "");
		...
		$cEntidad->setBajaLog((isset($_POST["LSTBajaLog"]) && $_POST["LSTBajaLog"] != "") ? $_POST["LSTBajaLog"] : "");	$cEntidad->setBusqueda(constant("STR_BAJA_LOGICA"), (isset($_POST["LSTBajaLog"]) && $_POST["LSTBajaLog"] != "" ) ? $_POST["LSTBajaLog"] : "");
		$cEntidad->setBajaLogHast((isset($_POST["LSTBajaLogHast"]) && $_POST["LSTBajaLogHast"] != "") ? $_POST["LSTBajaLogHast"] : "");	$cEntidad->setBusqueda(constant("STR_BAJA_LOGICA") . " " . constant("STR_HASTA"), (isset($_POST["LSTBajaLogHast"]) && $_POST["LSTBajaLogHast"] != "" ) ? $_POST["LSTBajaLogHast"] : "");
