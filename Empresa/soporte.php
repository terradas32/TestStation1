...
$comboRECOMENDACIONES	= new Combo($conn,"fIdRecomendacion","idRecomendacion","titulo","Descripcion","recomendaciones","",constant("SLC_OPCION"),"codIdiomaIso2=" . $conn->qstr($sLang, false) . " AND zonaPublicacion=0 AND publicar=0","","orden");
$comboFAQS	= new Combo($conn,"fIdFaq","idFaq","pregunta","Descripcion","faqs","",constant("SLC_OPCION"),"codIdiomaIso2=" . $conn->qstr($sLang, false) . " AND zonaPublicacion=0 AND publicar=0","","orden");
...
$cFaqs->setZonaPublicacion("0");
$cFaqs->setZonaPublicacionHast("0");
$cFaqs->setPublicar("0");
...
$cRecomendaciones->setZonaPublicacion("0");
$cRecomendaciones->setZonaPublicacionHast("0");
...
if (!empty($_POST["fEnviar"])){
	...
	{
		$strMensaje= constant("STR_NO_ENVIAR_CORREO_INTENTELO_MAS_TARDE");
		...
		if (!enviaEmail($_POST["fEmail"], $_POST["fName"], $_POST["fSubject"], $_POST["fMsg"])){
			...
			$strMensaje= constant("STR_CORREO_ENVIADO_CORRECTAMENTE");
		}
	}else{
		$strMensaje= constant("STR_TODOS_LOS_DATOS_SON_OBLIGATORIOS");
  }
}
?>
...
<div >
		<div id="head" style="background:none;" class="empresa">
				<div class="logo">
		...
		<div id="cuerpo">
				<div id="aviso" class="acc_cand" style="width: 100%;">
						<h2 style="padding-left: 3%;"><?php echo constant("STR_AYUDA_A_LA_EMPRESA");?></h2>
