...
include_once ('include/conexion.php');
	...
	$cEntidadDB	= new Usuarios_accesosDB($conn);  // Entidad DB
	$cEntidad	= new Usuarios_accesos();  // Entidad
	...
	switch ($_POST['MODO'])
	{
		case constant("MNT_ALTA"):
			...
			if (!empty($newId)){
			?><script language="javascript" type="text/javascript">jAlert("<?php echo constant("CONF_ALTA") . $newId;?>\n<?php echo $cEntidadDB->ver_errores();?>","<?php echo constant("STR_NOTIFICACION");?>");</script><?php 
				if ($_POST['ORIGEN'] == constant("MNT_LISTAR"))
				{
					if (!empty($_POST['usuarios_accesos_next_page']) && $_POST['usuarios_accesos_next_page'] > 1 ){
						$bInit=false;
					...
					$pager = new ADODB_Pager($conn,$sql,'usuarios_accesos');
					if ($bInit)	$pager->curr_page=1;
					$pager->showPageLinks = true;
					$lista=$pager->getRS();
					include('Template/Usuarios_accesos/mntusuarios_accesosl.php');
				}else{
					$cEntidad	= new Usuarios_accesos();  // inicializamos la Entidad
					$_POST['MODO']    = constant("MNT_ALTA");
					include('Template/Usuarios_accesos/mntusuarios_accesosa.php');
				}
			}else{
		...
		case constant("MNT_BUSCAR"):
			...
			include('Template/Usuarios_accesos/mntusuarios_accesos.php');
			break;
	...
	*/
	function readEntidad($cEntidad){
        ...
        global $cUtilidades;
		$cEntidad->setIdAcceso((isset($_POST["fIdAcceso"])) ? $_POST["fIdAcceso"] : "");
	...
	*/
	function readLista($cEntidad){
        global $conn;
        global $cUtilidades;
		$cEntidad->setIdAcceso((isset($_POST["LSTIdAcceso"]) && $_POST["LSTIdAcceso"] != "") ? $_POST["LSTIdAcceso"] : "");	$cEntidad->setBusqueda("Id Acceso", (isset($_POST["LSTIdAcceso"]) && $_POST["LSTIdAcceso"] != "" ) ? $_POST["LSTIdAcceso"] : "");
		$cEntidad->setIdAccesoHast((isset($_POST["LSTIdAccesoHast"]) && $_POST["LSTIdAccesoHast"] != "") ? $_POST["LSTIdAccesoHast"] : "");	$cEntidad->setBusqueda("Id Acceso" . constant("STR_HASTA"), (isset($_POST["LSTIdAccesoHast"]) && $_POST["LSTIdAccesoHast"] != "" ) ? $_POST["LSTIdAccesoHast"] : "");
		$cEntidad->setIP((isset($_POST["LSTIP"]) && $_POST["LSTIP"] != "") ? $_POST["LSTIP"] : "");	$cEntidad->setBusqueda("IP", (isset($_POST["LSTIP"]) && $_POST["LSTIP"] != "" ) ? $_POST["LSTIP"] : "");
		$cEntidad->setLogin((isset($_POST["LSTLogin"]) && $_POST["LSTLogin"] != "") ? $_POST["LSTLogin"] : "");	$cEntidad->setBusqueda("Login", (isset($_POST["LSTLogin"]) && $_POST["LSTLogin"] != "" ) ? $_POST["LSTLogin"] : "");
		$cEntidad->setFecAlta((isset($_POST["LSTFecAlta"]) && $_POST["LSTFecAlta"] != "") ? $_POST["LSTFecAlta"] : "");	$cEntidad->setBusqueda("Fec. Alta", (isset($_POST["LSTFecAlta"]) && $_POST["LSTFecAlta"] != "" ) ? $conn->UserDate($_POST["LSTFecAlta"],constant("USR_FECHA"),false) : "");
		$cEntidad->setFecAltaHast((isset($_POST["LSTFecAltaHast"]) && $_POST["LSTFecAltaHast"] != "") ? $_POST["LSTFecAltaHast"] : "");	$cEntidad->setBusqueda("Fec. Alta" . constant("STR_HASTA"), (isset($_POST["LSTFecAltaHast"]) && $_POST["LSTFecAltaHast"] != "" ) ? $conn->UserDate($_POST["LSTFecAltaHast"],constant("USR_FECHA"),false) : "");
		$cEntidad->setFecMod((isset($_POST["LSTFecMod"]) && $_POST["LSTFecMod"] != "") ? $_POST["LSTFecMod"] : "");	$cEntidad->setBusqueda("Fec. Mod", (isset($_POST["LSTFecMod"]) && $_POST["LSTFecMod"] != "" ) ? $conn->UserDate($_POST["LSTFecMod"],constant("USR_FECHA"),false) : "");
		$cEntidad->setFecModHast((isset($_POST["LSTFecModHast"]) && $_POST["LSTFecModHast"] != "") ? $_POST["LSTFecModHast"] : "");	$cEntidad->setBusqueda("Fec. Mod" . constant("STR_HASTA"), (isset($_POST["LSTFecModHast"]) && $_POST["LSTFecModHast"] != "" ) ? $conn->UserDate($_POST["LSTFecModHast"],constant("USR_FECHA"),false) : "");
		global $comboUSUARIOS;
		$cEntidad->setUsuAlta((isset($_POST["LSTUsuAlta"]) && $_POST["LSTUsuAlta"] != "") ? $_POST["LSTUsuAlta"] : "");	$cEntidad->setBusqueda("Usu. Alta", (isset($_POST["LSTUsuAlta"]) && $_POST["LSTUsuAlta"] != "" ) ? $comboUSUARIOS->getDescripcionCombo($_POST["LSTUsuAlta"]) : "");
		$cEntidad->setUsuMod((isset($_POST["LSTUsuMod"]) && $_POST["LSTUsuMod"] != "") ? $_POST["LSTUsuMod"] : "");	$cEntidad->setBusqueda("Usu. Mod", (isset($_POST["LSTUsuMod"]) && $_POST["LSTUsuMod"] != "" ) ? $comboUSUARIOS->getDescripcionCombo($_POST["LSTUsuMod"]) : "");
