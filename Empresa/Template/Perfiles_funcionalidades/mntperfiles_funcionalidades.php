...
<div id="contenedor">
		...
		<div id="contenido">
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0" >
				...
				<tr>
					...
					<td ><?php $comboPERFILES->setNombre("LSTIdPerfil");?><?php echo $comboPERFILES->getHTMLCombo("1","cajatexto",$cEntidad->getIdPerfil()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="perfiles_funcionalidades_next_page" value="1" />
</div>
