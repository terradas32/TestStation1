...
<?php
        ...
        // Miramos la empresa que va a solicitar a quíen tiene configurado para solicitar
        if(!empty($cEmpresaLogada->getSolicitarUnidadesA())){
          $sIdEmpresaReceptora = $cEmpresaLogada->getSolicitarUnidadesA();
        }else{
...
?>
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdEmpresaReceptora"><?php echo constant("STR_TRAMITA");?></label>&nbsp;</td>
					<td><input type="hidden" id="fIdEmpresaReceptora" name="fIdEmpresaReceptora" value="<?php echo $sIdEmpresaReceptora;?>" /><?php echo $comboEMPRESAS_TODAS->getDescripcionCombo($sIdEmpresaReceptora);?></td>
				</tr>
<?php
			if($_POST['MODO'] != constant("MNT_ALTA")){
...
?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdEmpresa"><?php echo constant("STR_SOLICITA");?></label>&nbsp;</td>
					<td><input type="hidden" id="fIdEmpresa" name="fIdEmpresa" value="<?php echo $sIdEmpresaSolicita;?>" /><?php echo $comboEMPRESAS_TODAS->getDescripcionCombo($sIdEmpresaSolicita);?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fNDongles"><?php echo constant("STR_NUMERO_DE_DONGLES");?></label>&nbsp;</td>
...
<?php		$sDis="";
			if($_POST['MODO'] != constant("MNT_ALTA")){
                ...
                if ($cEmpresaLogada->getIdEmpresa() != $sIdEmpresaReceptora){
                  $sDis='disabled="disabled"';
                }else{
				          $sDis="";
                }
...
?>
					<tr>
						...
						<td><input type="radio" name="fEstado" id="fEstado2" value="2" <?php echo $sDis?> <?php echo ($cEntidad->getEstado() != "" && strtoupper($cEntidad->getEstado()) == "2") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fEstado2"><?php echo constant("STR_RECHAZADA");?></label>&nbsp;<input type="radio" name="fEstado" id="fEstado1" value="1" <?php echo $sDis?> <?php echo ($cEntidad->getEstado() != "" && strtoupper($cEntidad->getEstado()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fEstado1"><?php echo constant("STR_ACEPTADA");?></label>&nbsp;<input type="radio" name="fEstado" id="fEstado0" value="0" <?php echo $sDis?> <?php echo ($cEntidad->getEstado() != "" && strtoupper($cEntidad->getEstado()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fEstado0"><?php echo constant("STR_PENDIENTE");?></label>&nbsp;<input type="hidden" name="fEstadoHast" value="<?php echo $cEntidad->getEstado();?>" /></td>
					</tr>
<?php
				}
?>
