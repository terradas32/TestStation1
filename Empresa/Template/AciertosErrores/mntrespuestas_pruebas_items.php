        ...
        <tr>
                  ...
                  if (!empty($_POST['LSTFecMod'])){
                    ...
                    $_POST['LSTFecMod'] = $conn->UserDate($date,constant("USR_FECHA"),false);
								...
								?>
                <td><input type="text" readonly id="LSTFecMod" name="LSTFecMod" value="<?php echo (!empty($_POST['LSTFecMod'])) ? $_POST['LSTFecMod'] : "";?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
