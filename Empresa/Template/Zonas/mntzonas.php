...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vString("<?php echo constant("STR_ID_ZONA");?>:",f.LSTIdZona.value,255, false);
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdZona"><?php echo constant("STR_ID_ZONA");?></label>&nbsp;</td>
					<td><input type="text" id="LSTIdZona" name="LSTIdZona" value="<?php echo $cEntidad->getIdZona();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idZona' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idZona') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_ZONA");?></option>
