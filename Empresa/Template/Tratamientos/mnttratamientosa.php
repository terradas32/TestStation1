...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdTratamiento" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdTratamiento() : $_POST['fIdTratamiento'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="tratamientos_next_page" value="<?php echo (isset($_POST['tratamientos_next_page'])) ? $cUtilidades->validaXSS($_POST['tratamientos_next_page']) : "1";?>" />