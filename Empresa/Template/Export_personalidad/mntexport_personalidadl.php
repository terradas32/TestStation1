...
<body onload="_body_onload();block('<?php echo ($_POST["_block"] != "") ? $_POST["_block"] : "-1"; ?>');setClicado('<?php echo $_POST["_clicado"]; ?>');" onunload="_body_onunload();">
			...
			<td id="loaderContainerWH">
				<div id="loader">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td>
								<p><img src="estilos/icons/loading.gif" height="32" width="32" border="0" alt="" /><strong><?php echo constant("MSG_POR_FAVOR_ESPERE_CARGANDO"); ?></strong></p>
							</td>
						</tr>
					</table>
				</div>
	...
	<table cellspacing="1" cellpadding="2" border="0" width="100%">
		<tr>
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR"); ?> >>> <?php echo htmlentities(constant("STR_TIPO_INFORME"), ENT_COMPAT, "UTF-8"); ?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='descTipoInforme';document.forms[0].LSTOrder.value='<?php echo $sOrden; ?>';enviar('<?php echo constant("MNT_LISTAR"); ?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR"); ?> >>> <?php echo addslashes(constant("STR_TIPO_INFORME")); ?>';return true"><?php echo constant("STR_TIPO_INFORME"); ?><?php echo $sPinta; ?></a></td>
			<?php
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "fecPrueba") {
		...
		//if ($_Dongles > 0 || $_Prepago == "0") {
			while (!$lista->EOF) {
				...
				<tr onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER"); ?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT"); ?>'" bgcolor="<?php echo constant("ONMOUSEOUT"); ?>">
					...
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['descEmpresa']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['descEmpresa'], "<b><i><u><strong><br><br />")), 0, 500); ?></td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['descProceso']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['descProceso'], "<b><i><u><strong><br><br />")), 0, 500); ?></td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['nombre']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['nombre'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['apellido1']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['apellido1'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['apellido2']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['apellido2'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['email']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['email'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['descPrueba']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['descPrueba'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['descTipoInforme']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['descTipoInforme'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
					<td class="tddatoslista" valign="top" align="center" title="<?php echo strip_tags($lista->fields['fecPrueba']); ?>">
						<script language="javascript" type="text/javascript">
							document.write(formatThisDate('<?php echo $lista->fields['fecPrueba']; ?>'));
						</script>
					</td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['descBaremo']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['descBaremo'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
					<td class="tddatoslista" valign="top" align="center" title="<?php echo strip_tags($lista->fields['fecAltaProceso']); ?>">
						<script language="javascript" type="text/javascript">
							document.write(formatThisDate('<?php echo $lista->fields['fecAltaProceso']; ?>'));
						</script>
					</td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['descSexo']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['descSexo'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['descEdad']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['descEdad'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['descFormacion']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['descFormacion'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['descNivel']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['descNivel'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
					<td class="tddatoslista" valign="top" title="<?php echo strip_tags($lista->fields['descArea']); ?>"><?php echo substr(str_replace("\n", "<br />", strip_tags($lista->fields['descArea'], "<b><i><u><strong><br><br />")), 0, 255); ?></td>
		...
		/* } else {	?>
			<tr>
				<td colspan="22" align="center">
					<strong><?php echo constant("STR_NO_DISPONE_DE_SUFICIENTES_UNIDADES_PARA_EFECTUAR_LA_OPERACION"); ?></strong>
				</td>
			</tr>
		<?php
		} */
	...
	<form name="form" id="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		...
		<div id="contenedor">
			...
			<div id="envoltura">
				<div id="contenido">
					<div style="width: 100%">
						<table cellspacing="0" cellpadding="0" border="0" width="100%">
							...
							<tr>
								<td colspan="4"><img src="<?php echo constant('DIR_WS_GRAF'); ?>sp.gif" width="10" height="1" border="0" alt="" /></td>
							</tr>
							<tr>
								<td><img src="<?php echo constant('DIR_WS_GRAF'); ?>sp.gif" width="10" height="1" border="0" alt="" /></td>
							...
							<tr>
								<td colspan="4"><img src="<?php echo constant('DIR_WS_GRAF'); ?>sp.gif" width="1" height="10" border="0" alt="" /></td>
							</tr>
						</table>
						<table class="paginadorLista" style="disabled" cellspacing="0" cellpadding="0" border="0" width="100%">
							<tr>
								<td width="10"><img src="<?php echo constant('DIR_WS_GRAF'); ?>sp.gif" width="10" height="1" border="0" alt="" /></td>
								<td width="100%" colspan="2" class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"), str_replace('_', ' ', constant("STR_EXPORTPERSONALIDAD"))); ?>
									<?php
									if ($lista->NumRows() > 0) {
										//if ($_Dongles > 0 || $_Prepago == "0") {
									?>
											<a href="#_" onclick="javascript:document.forms[0].action='sqlToExcelPersonalidad.php';document.forms[0].submit();document.forms[0].action='<?php echo $_SERVER['PHP_SELF']; ?>';">
											<?php
										/* } else {
											?>
												<a href="#_" onclick="javascript:jAlert('<?php echo constant("STR_NO_DISPONE_DE_SUFICIENTES_UNIDADES_PARA_EFECTUAR_LA_OPERACION"); ?>','<?php echo constant("STR_NOTIFICACION"); ?>');;">
												<?php
											}
 										*/
												?>
												<img src="<?php echo constant('DIR_WS_GRAF'); ?>excel.gif" width="34" height="35" align="right" border="0" alt="<?php echo constant("STR_EXPORTAR_A_EXCEL"); ?>" /></a>
								</td>
							<?php
									}
							?>
							...
							<tr>
								...
								<td width="85%" class="azul" align="left"><?php //echo $pager->getHeader();
																			?></td>
							</tr>
						</table>
						<br />
						...
						<br />
						<table class="paginadorLista" cellspacing="0" width="100%" cellpadding="0" border="0">
							<tr>
								<td width="10"><img src="<?php echo constant('DIR_WS_GRAF'); ?>sp.gif" width="10" height="1" border="0" alt="" /></td>
								<td nowrap="nowrap" width="15%" class="azul" align="left">(<font class="naranja"><?php echo $pager->getFooter(); ?></font>)</td>
								<td width="85%" class="azul" align="left"><?php //echo $pager->getHeader();
				...
				<input type="hidden" name="fSQLtoEXCEL" value="<?php echo base64_encode($sql . constant("CHAR_SEPARA") . "export_personalidad"); ?>" />
				...
				<input type="hidden" name="LSTDescPrueba" value="<?php echo (isset($_POST['LSTDescPrueba'])) ? $cUtilidades->validaXSS(implode(",", $_POST['LSTDescPrueba'])) : ""; ?>" />
				<input type="hidden" name="LSTTipoInforme" value="<?php echo (isset($_POST['fIdTipoInforme'])) ? $cUtilidades->validaXSS($_POST['fIdTipoInforme']) : ""; ?>" />
