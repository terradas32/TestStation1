...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vString("<?php echo constant("STR_ID_COMUNIDAD");?>:",f.LSTIdComunidad.value,2, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdComunidad"><?php echo constant("STR_ID_COMUNIDAD");?></label>&nbsp;</td>
					<td><input type="text" id="LSTIdComunidad" name="LSTIdComunidad" value="<?php echo $cEntidad->getIdComunidad();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idComunidad' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idComunidad') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_COMUNIDAD");?></option>
	...
	<input type="hidden" name="wi_ccaa_next_page" value="1" /></div>
