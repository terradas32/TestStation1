...
<?php ob_start();?>
	<table cellspacing="1" cellpadding="2" border="0" width="99%">
		...
		<tr  onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER");?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT");?>'" bgcolor="<?php echo constant("ONMOUSEOUT");?>">
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['nombre']));?>"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="<?php echo $lista->fields['indentacion']*14;?>" height="1" border="0" alt="" /><?php echo str_replace("\n","<br />",strip_tags(html_entity_decode($lista->fields['nombre']), "<b><i><u><strong><br /><br />"));?></td>
...
<div id="contenedor">
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width='10'><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="1" border="0" alt="" /></td>
			<td width="100%" colspan="2" align='left' class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"),str_replace('_', ' ', constant("STR_EMPRESAS")));?></td>
		</tr>
		<tr>
			<td width='10'><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="1" border="0" alt="" /></td>
