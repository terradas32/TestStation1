...
function enviar()
{
	...
	if (validaForm()){
		...
		f.LSTIdTipoInforme.value=f.elements['LSTIdTipoInforme'].value;
		f.LSTIdIp.value=f.elements['LSTIdIp'].value;
...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_TIPO_INFORME");?>:",f.elements['LSTIdTipoInforme'].value, 11, false);
	msg +=vNumber("<?php echo constant("STR_IR");?>:", f.LSTIdIr.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_IP");?>:",f.elements['LSTIdIp'].value, 11, false);
	msg +=vNumber("<?php echo constant("STR_TEXTO");?>:", f.LSTTexto.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_TEXTO");?> <?php echo constant("STR_HASTA");?>:", f.LSTTextoHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoInforme"><?php echo constant("STR_TIPO_INFORME");?></label>&nbsp;</td>
						<td><div id="comboIdTipoInforme"><?php $comboINFORMES_PRUEBAS->setNombre("LSTIdTipoInforme");?><?php echo $comboINFORMES_PRUEBAS->getHTMLComboNull("1","cajatexto",$cEntidad->getIdTipoInforme(),"onchange=\"javascript:cambiaIdTipoInforme()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdIr"><?php echo constant("STR_IR");?></label>&nbsp;</td>
					<td><?php $comboRANGOS_IR->setNombre("LSTIdIr");?><?php echo $comboRANGOS_IR->getHTMLCombo("1","cajatexto",$cEntidad->getIdIr()," onchange=\"javascript:cambiaIdIr()\"","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdIp"><?php echo constant("STR_IP");?></label>&nbsp;</td>
						<td><div id="comboIdIp"><?php $comboRANGOS_IP->setNombre("LSTIdIp");?><?php echo $comboRANGOS_IP->getHTMLComboNull("1","cajatexto",$cEntidad->getIdIp(),"onchange=\"javascript:cambiaIdIp()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="rangos_textos_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdPrueba").show().load("jQuery.php",{sPG:"combopruebas",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdPrueba",fJSProp:"cambiaIdPrueba",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdPrueba();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdTipoInforme").show().load("jQuery.php",{sPG:"comboinformes_pruebas",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdTipoInforme",fJSProp:"cambiaIdTipoInforme",LSTIdPrueba:f.LSTIdPrueba.value,LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdTipoInforme();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdPrueba(){
								var f= document.forms[0];
								$("#comboIdTipoInforme").show().load("jQuery.php",{sPG:"comboinformes_pruebas",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdTipoInforme",fJSProp:"cambiaIdTipoInforme",LSTIdPrueba:f.LSTIdPrueba.value,LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdTipoInforme();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdIr(){
								var f= document.forms[0];
								$("#comboIdIp").show().load("jQuery.php",{sPG:"comborangos_ip",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdIp",fJSProp:"cambiaIdIp",LSTIdRangoIr:f.LSTIdIr.value,vSelected:"<?php echo $cEntidad->getIdIp();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
