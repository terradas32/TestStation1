...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_SIGNO");?>:", f.LSTIdSigno.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_SIGNO");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdSignoHast.value, 11, false);
	msg +=vString("<?php echo constant("STR_SIGNO");?>:",f.LSTSigno.value,255, false);
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdSigno"><?php echo constant("STR_ID_SIGNO");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdSigno" name="LSTIdSigno" value="<?php echo $cEntidad->getIdSigno();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdSignoHast" name="LSTIdSignoHast" value="<?php echo $cEntidad->getIdSignoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTSigno"><?php echo constant("STR_SIGNO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTSigno" name="LSTSigno" value="<?php echo $cEntidad->getSigno();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idSigno' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idSigno') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_SIGNO");?></option>
							<option style='color:#000000;' value='signo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'signo') ? "selected='selected'" : "";?>><?php echo constant("STR_SIGNO");?></option>
