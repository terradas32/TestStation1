...
function enviar()
{
	...
	if (validaForm()){
		...
		seleccionarMultiple('LSTDescPrueba[]');
...
function setOptions(obj, name, id){
	...
	sCall = "autosuggest.php?json=true&limit=50&list=export_aptitudinales&vName=" + name + "&idName=" + id + "&";
...
function cambiaPruebas(){
	...
	if (seleccionarMultiple('LSTIdEmpresa[]')){
		if (seleccionarMultiple('LSTIdProceso[]')){
			...
			f.LSTFecPrueba.value=cFechaFormat(f.LSTFecPrueba.value);
			f.LSTFecPruebaHast.value=cFechaFormat(f.LSTFecPruebaHast.value);
			$("#pruebas").hide().load("pruebasAptitudinales.php",$("form").serializeArray(),function(){
						...
						<table cellspacing="0" cellpadding="0" width="99%" border="0">
							...
							<?php $sOption		= "<option value=' '>" . constant("STR_TODOS") . "</option>";?>
								...
								<td width="50" valign="top">
									<table cellspacing="0" cellpadding="0" width="100%" border="0" >
										<tr>
											<td align="center"><input type="button" class="botoncuadrado" style="color:Red;" onclick="javascript:validaAniadirEmpresa('LSTIdEmpresa[]');" name="btnAddTIT" value=">" /></td>
										</tr>
										<tr>
											<td align="center"><input type="button" class="botoncuadrado" style="color:Red;" onclick="javascript:quitarEmpresa('LSTIdEmpresa[]',document.forms[0].elements['LSTIdEmpresa[]'].value,document.forms[0].elements['LSTIdEmpresa[]'].value);" name="fBtnDelTIT" value="<" /></td>
										</tr>
									</table>
								</td>
								<td width="49%">
...
<!--
 ...
 -->
				...
				<tr><td colspan="3" width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="1" height="10" border="0" alt="" /></td></tr>
				<tr><td colspan="3" ><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="1" height="1" border="0" alt="" /></td></tr>
				<tr><td colspan="3" ><?php echo constant("MSG_ANTIGUEDAD_EXPORT_INFO_APTITUDINAL");?> </td></tr>
				<tr><td colspan="3" ><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="1" height="1" border="0" alt="" /></td></tr>
				<tr><td colspan="3" width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="1" height="10" border="0" alt="" /></td></tr>
			</table>
			<table cellspacing="0" cellpadding="0" border="0">
