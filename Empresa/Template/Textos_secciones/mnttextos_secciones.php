...
function enviar()
{
	...
	if (validaForm()){
		...
		f.LSTIdSeccion.value=f.elements['LSTIdSeccion'].value;
...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_SECCION");?>:",f.elements['LSTIdSeccion'].value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdSeccion"><?php echo constant("STR_SECCION");?></label>&nbsp;</td>
						<td><div id="comboIdSeccion"><?php $comboSECCIONES_INFORMES->setNombre("LSTIdSeccion");?><?php echo $comboSECCIONES_INFORMES->getHTMLComboNull("1","cajatexto",$cEntidad->getIdSeccion(),"onchange=\"javascript:cambiaIdSeccion()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="textos_secciones_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdPrueba").show().load("jQuery.php",{sPG:"combopruebas",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdPrueba",fJSProp:"cambiaIdPrueba",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdPrueba();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdTipoInforme").show().load("jQuery.php",{sPG:"combotipos_informes",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdTipoInforme",fJSProp:"cambiaIdTipoInforme",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdTipoInforme();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdSeccion").show().load("jQuery.php",{sPG:"combosecciones_informes",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdSeccion",fJSProp:"cambiaIdSeccion",LSTIdTipoInforme:f.LSTIdTipoInforme.value,vSelected:"<?php echo $cEntidad->getIdSeccion();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdTipoInforme(){
								var f= document.forms[0];
								$("#comboIdSeccion").show().load("jQuery.php",{sPG:"combosecciones_informes",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdSeccion",fJSProp:"cambiaIdSeccion",LSTIdTipoInforme:f.LSTIdTipoInforme.value,vSelected:"<?php echo $cEntidad->getIdSeccion();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
