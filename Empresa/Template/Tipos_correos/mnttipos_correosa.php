...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdTipoCorreo" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdTipoCorreo() : $_POST['fIdTipoCorreo'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="tipos_correos_next_page" value="<?php echo (isset($_POST['tipos_correos_next_page'])) ? $cUtilidades->validaXSS($_POST['tipos_correos_next_page']) : "1";?>" />