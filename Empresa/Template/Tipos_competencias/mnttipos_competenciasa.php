...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="tipos_competencias_next_page" value="<?php echo (isset($_POST['tipos_competencias_next_page'])) ? $cUtilidades->validaXSS($_POST['tipos_competencias_next_page']) : "1";?>" />