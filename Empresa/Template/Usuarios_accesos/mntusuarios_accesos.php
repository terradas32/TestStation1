...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("Id Acceso:", f.LSTIdAcceso.value, 11, false);
	msg +=vNumber("Id Acceso <?php echo constant("STR_HASTA")?>:", f.LSTIdAccesoHast.value, 11, false);
	msg +=vString("IP:",f.LSTIP.value,255, false);
	msg +=vString("Login:",f.LSTLogin.value,255, false);
	msg +=vDate("Fec. Alta:",f.LSTFecAlta.value,10,false);
	msg +=vDate("Fec. Alta <?php echo constant("STR_HASTA");?>:",f.LSTFecAltaHast.value,10,false);
	msg +=vDate("Fec. Mod:",f.LSTFecMod.value,10,false);
	msg +=vDate("Fec. Mod <?php echo constant("STR_HASTA");?>:",f.LSTFecModHast.value,10,false);
	if (msg != "") {
...
include (constant("DIR_WS_INCLUDE") . 'cabecera.php');?>
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Id Acceso&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" name="LSTIdAcceso" value="<?php echo $cEntidad->getIdAcceso();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" name="LSTIdAccesoHast" value="<?php echo $cEntidad->getIdAccesoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">IP&nbsp;</td>
					<td><input type="text" name="LSTIP" value="<?php echo $cEntidad->getIP();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Login&nbsp;</td>
					<td><input type="text" name="LSTLogin" value="<?php echo $cEntidad->getLogin();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Fec. Alta&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Fec. Mod&nbsp;</td>
				...
				<tr>
					...
					<td>
						<select name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idAcceso' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idAcceso') ? "selected='selected'" : "";?>>Id Acceso</option>
							<option style='color:#000000;' value='IP' <?php echo (!empty($sOrderBy) && $sOrderBy == 'IP') ? "selected='selected'" : "";?>>IP</option>
							<option style='color:#000000;' value='login' <?php echo (!empty($sOrderBy) && $sOrderBy == 'login') ? "selected='selected'" : "";?>>Login</option>
							<option style='color:#000000;' value='fecAlta' <?php echo (!empty($sOrderBy) && $sOrderBy == 'fecAlta') ? "selected='selected'" : "";?>>Fec. Alta</option>
							<option style='color:#000000;' value='fecMod' <?php echo (!empty($sOrderBy) && $sOrderBy == 'fecMod') ? "selected='selected'" : "";?>>Fec. Mod</option>
						</select>
					</td>
				</tr>
				<tr>
	...
	<input type="hidden" name="usuarios_accesos_next_page" value="1" />
</form>
<!-- Fin -->
