...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vString("<?php echo constant("STR_ID_PROVINCIA");?>:",f.fIdProvincia.value,2,true);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdProvincia"><?php echo constant("STR_ID_PROVINCIA");?></label>&nbsp;</td><td><input type="text" id="fIdProvincia" name="fIdProvincia" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdProvincia() : $_POST['fIdProvincia'];?>" class="obliga" onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="wi_provincias_next_page" value="<?php echo (isset($_POST['wi_provincias_next_page'])) ? $cUtilidades->validaXSS($_POST['wi_provincias_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
