...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_ENUNCIADO");?>:",f.fEnunciado.value,2500,false);
	...
	<input type="hidden" name="ejemplos_next_page" value="<?php echo (isset($_POST['ejemplos_next_page'])) ? $cUtilidades->validaXSS($_POST['ejemplos_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							...
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdPrueba").show().load("jQuery.php",{sPG:"combopruebas",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdPrueba",fJSProp:"cambiaIdPrueba",fCodIdiomaIso2:f.fCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdPrueba();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
