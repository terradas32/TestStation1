...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_ENUNCIADO");?>:",f.fEnunciado.value,255,false);
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.fDescripcionItem.value,255,false);
	msg +=vString("<?php echo constant("STR_CORRECTO");?>:",f.fCorrecto.value,255,true);
		...
		<div style="width: 100%">
			<table cellspacing="2" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><input type="text" name="fEnunciado" value="<?php echo $cEjemplos->getEnunciado();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_DESCRIPCION");?>&nbsp;</td>
					<td><input type="text" name="fDescripcionItem" value="<?php echo $cEjemplos->getDescripcion();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Path1&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Path2&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Path3&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top">Path4&nbsp;</td>
				...
				<tr>
					...
					<td><input type="text" name="fCorrecto" value="<?php echo $cEjemplos->getCorrecto();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
