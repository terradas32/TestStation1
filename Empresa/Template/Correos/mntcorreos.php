...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_CORREO");?>:", f.LSTIdCorreo.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_CORREO");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdCorreoHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_TIPO_CORREO");?>:", f.LSTIdTipoCorreo.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdCorreo"><?php echo constant("STR_ID_CORREO");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdCorreo" name="LSTIdCorreo" value="<?php echo $cEntidad->getIdCorreo();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdCorreoHast" name="LSTIdCorreoHast" value="<?php echo $cEntidad->getIdCorreoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoCorreo"><?php echo constant("STR_TIPO_CORREO");?></label>&nbsp;</td>
					<td><?php $comboTIPOS_CORREOS->setNombre("LSTIdTipoCorreo");?><?php echo $comboTIPOS_CORREOS->getHTMLCombo("1","cajatexto",$cEntidad->getIdTipoCorreo()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idCorreo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idCorreo') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_CORREO");?></option>
	...
	<input type="hidden" name="correos_next_page" value="1" />
