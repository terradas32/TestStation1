...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_ID_PERFIL");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdPerfilHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdPerfil"><?php echo constant("STR_ID_PERFIL");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdPerfil" name="LSTIdPerfil" value="<?php echo $cEntidad->getIdPerfil();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdPerfilHast" name="LSTIdPerfilHast" value="<?php echo $cEntidad->getIdPerfilHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
	...
	<input type="hidden" name="emp_perfiles_next_page" value="1" />
