...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_USUARIO");?>:",f.LSTUsuario.value,255, false);
...
<div id="contenedor">
		...
		<div id="contenido">
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0" >
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_FECHA_DE_MODIFICACION");?>&nbsp;</td>
					<?php if ($cEntidad->getFecBaja() != "" && $cEntidad->getFecBaja() != "0000-00-00" && $cEntidad->getFecBajaFecBaja() != "0000-00-00 00:00:00"){
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><a href="#" onclick="javascript:abrirCalendario('calendario.php?openerNombre=LSTFecBaja','<?php echo constant("STR_CALENDARIO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>icon_calendario.gif" width="22" height="18" border="0" alt="<?php echo constant("STR_CALENDARIO");?>" align="bottom" /></a>&nbsp;<input type="text" name="LSTFecBaja" value="<?php echo $cEntidad->getFecBaja();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								...
								?>
								<td><a href="#" onclick="javascript:abrirCalendario('calendario.php?openerNombre=LSTFecBajaHast','<?php echo constant("STR_CALENDARIO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>icon_calendario.gif" width="22" height="18" border="0" alt="<?php echo constant("STR_CALENDARIO");?>" align="bottom" /></a>&nbsp;<input type="text" name="LSTFecBajaHast" value="<?php echo $cEntidad->getFecBajaHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td >
						<select name='LSTOrderBy' size='1' class='cajatexto'>
							...
							<option style='color:#000000;' value='idEmpresa' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idEmpresa') ? "selected=\"selected\"" : "";?>><?php echo constant("STR_EMPRESA");?></option>
							...
							<option style='color:#000000;' value='usuario' <?php echo (!empty($sOrderBy) && $sOrderBy == 'usuario') ? "selected=\"selected\"" : "";?>><?php echo constant("STR_USUARIO");?></option>
	...
	<input type="hidden" name="empresas_usuarios_next_page" value="1" />
</div>
