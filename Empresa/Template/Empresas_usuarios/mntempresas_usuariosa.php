			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0" >
				...
				<tr>
					...
					if (isset($_POST['MODO']) && ($_POST['MODO'] == constant("MNT_MODIFICAR"))){
						$_disa = "disabled=\"disabled\"";
					}
					?>
					<td ><?php $comboEMPRESAS->setNombre("fIdEmpresa");?><?php echo $comboEMPRESAS->getHTMLCombo("1","obliga",$cEntidad->getIdEmpresa(),$_disa,"");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_USUARIO");?>&nbsp;</td>
					<td ><input type="text" name="fUsuario" value="<?php echo $cEntidad->getUsuario();?>" class="obliga" <?php if (isset($_POST['MODO']) && ($_POST['MODO'] == constant("MNT_MODIFICAR"))){echo("disabled=\"disabled\"");};?> onchange="javascript:trim(this);" /></td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" alt="" /></td>
					<td width="90" class="negrob" valign="top"><?php echo constant("STR_BAJA");?></td>
					<td>
						<select name="fBajaLog" <?php echo ($cEntidad->getIdUsuario() == 0) ? "disabled=\"disabled\"" : "";?>>
							<option value="0" <?php echo ($cEntidad->getBajaLog() == 0) ? "selected=\"selected\"" : "";?>><?php echo constant("STR_NO");?></option>
							<option value="1" <?php echo ($cEntidad->getBajaLog() == 1) ? "selected=\"selected\"" : "";?>><?php echo constant("STR_SI");?></option>
						</select>
					</td>
				</tr>
				...
				<?php if(isset($_POST['MODO']) && ($_POST['MODO'] == constant("MNT_MODIFICAR"))){?>
					...
					<tr>
						...
						<td><input type="button" value="<?php echo constant("STR_CAMBIAR_CONTRASENA");?>" id="fCrea" class="botonesgrandes" onclick="javascript:cargalapagina('Empresas_usuarios/cambia_pass','contrasenia');"/></td>
					</tr>
					<tr>
					    <td colspan="3">
