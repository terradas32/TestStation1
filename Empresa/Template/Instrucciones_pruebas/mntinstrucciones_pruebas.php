...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID");?>:", f.LSTIdInstruccion.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdInstruccionHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdInstruccion"><?php echo constant("STR_ID");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdInstruccion" name="LSTIdInstruccion" value="<?php echo $cEntidad->getIdInstruccion();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdInstruccionHast" name="LSTIdInstruccionHast" value="<?php echo $cEntidad->getIdInstruccionHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idInstruccion' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idInstruccion') ? "selected='selected'" : "";?>><?php echo constant("STR_ID");?></option>
	...
	<input type="hidden" name="instrucciones_pruebas_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
