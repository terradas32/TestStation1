...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdTipoNotificacion" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdTipoNotificacion() : $_POST['fIdTipoNotificacion'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="notificaciones_tipos_next_page" value="<?php echo (isset($_POST['notificaciones_tipos_next_page'])) ? $cUtilidades->validaXSS($_POST['notificaciones_tipos_next_page']) : "1";?>" />