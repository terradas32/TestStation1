		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><?php $comboPROCESOS->setNombre("LSTIdProceso");?><?php echo $comboPROCESOS->getHTMLCombo("1","cajatexto",$cEntidad->getIdProceso()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><input type="radio" name="LSTInformado" id="LSTInformado1" value="1"  <?php echo ($cEntidad->getInformado() != "" && strtoupper($cEntidad->getInformado()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTInformado1"><?php echo constant("STR_SI");?></label>&nbsp;<input type="radio" name="LSTInformado" id="LSTInformado0" value="0"  <?php echo ($cEntidad->getInformado() != "" && strtoupper($cEntidad->getInformado()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTInformado0"><?php echo constant("STR_NO");?></label>&nbsp;<input type="hidden" name="LSTInformadoHast" value="<?php echo $cEntidad->getInformado();?>" /></td>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTFinalizado"><?php echo constant("STR_FINALIZADO");?></label>&nbsp;</td>
					<td><input type="radio" name="LSTFinalizado" id="LSTFinalizado1" value="1"  <?php echo ($cEntidad->getFinalizado() != "" && strtoupper($cEntidad->getFinalizado()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTFinalizado1"><?php echo constant("STR_SI");?></label>&nbsp;<input type="radio" name="LSTFinalizado" id="LSTFinalizado0" value="0"  <?php echo ($cEntidad->getFinalizado() != "" && strtoupper($cEntidad->getFinalizado()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTFinalizado0"><?php echo constant("STR_NO");?></label>&nbsp;<input type="hidden" name="LSTFinalizadoHast" value="<?php echo $cEntidad->getFinalizado();?>" /></td>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="LSTCodIdiomaIso2" value="<?php echo constant("LENGUAJEDEFECTO");?>" />
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdPais(){
								var f= document.forms[0];
								$("#comboIdProvincia").show().load("jQuery.php",{sPG:"combowi_provincias",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdProvincia",fJSProp:"cambiaIdProvincia",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdPais:f.LSTIdPais.value,vSelected:"<?php echo $cEntidad->getIdProvincia();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdMunicipio").show().load("jQuery.php",{sPG:"combowi_municipios",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdMunicipio",fJSProp:"cambiaIdMunicipio",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdProvincia:f.LSTIdProvincia.value,vSelected:"<?php echo $cEntidad->getIdMunicipio();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdZona").show().load("jQuery.php",{sPG:"combowi_zonas",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdZona",fJSProp:"cambiaIdZona",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdMunicipio:f.LSTIdMunicipio.value,vSelected:"<?php echo $cEntidad->getIdZona();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdProvincia(){
								var f= document.forms[0];
								$("#comboIdMunicipio").show().load("jQuery.php",{sPG:"combowi_municipios",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdMunicipio",fJSProp:"cambiaIdMunicipio",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdProvincia:f.LSTIdProvincia.value,vSelected:"<?php echo $cEntidad->getIdMunicipio();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdZona").show().load("jQuery.php",{sPG:"combowi_zonas",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdZona",fJSProp:"cambiaIdZona",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdMunicipio:f.LSTIdMunicipio.value,vSelected:"<?php echo $cEntidad->getIdZona();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdMunicipio(){
								var f= document.forms[0];
								$("#comboIdZona").show().load("jQuery.php",{sPG:"combowi_zonas",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdZona",fJSProp:"cambiaIdZona",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdMunicipio:f.LSTIdMunicipio.value,vSelected:"<?php echo $cEntidad->getIdZona();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
