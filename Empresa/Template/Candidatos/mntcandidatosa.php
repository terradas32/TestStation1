		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><input type="text" disabled="disabled" id="fDni" name="fDni" value="<?php echo $cEntidad->getDni();?>" class="cajatexto"  style='width:75%;' onchange="javascript:trim(this);" /><input type="checkbox" name="fDniOK" disabled="disabled" /><?php echo constant("STR_VERIFICADO");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><?php $comboWI_PAISES->setNombre("fIdPais");?><?php echo $comboWI_PAISES->getHTMLCombo("1","cajatexto",$cEntidad->getIdPais(),"disabled=\"disabled\" onchange=\"javascript:cambiaIdPais()\"","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdProvincia"><?php echo constant("STR_PROVINCIA");?></label>&nbsp;</td>
					<td><div id="comboIdProvincia"><?php $comboWI_PROVINCIAS->setNombre("fIdProvincia");?><?php echo $comboWI_PROVINCIAS->getHTMLComboNull("1","cajatexto",$cEntidad->getIdProvincia(),"disabled=\"disabled\" onchange=\"javascript:cambiaIdProvincia()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><?php $comboNIVELESJERARQUICOS->setNombre("fIdNivel");?><?php echo $comboNIVELESJERARQUICOS->getHTMLCombo("1","cajatexto",$cEntidad->getIdNivel(),"disabled=\"disabled\" ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdArea"><?php echo constant("STR_AREA");?></label>&nbsp;</td>
					<td><?php $comboAREAS->setNombre("fIdArea");?><?php echo $comboAREAS->getHTMLCombo("1","cajatexto",$cEntidad->getIdArea(),"disabled=\"disabled\" ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
