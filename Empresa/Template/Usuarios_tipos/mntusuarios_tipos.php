...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_ID_USUARIO_TIPO");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdUsuarioTipoHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								...
								<td><input type="text" id="LSTIdUsuarioTipo" name="LSTIdUsuarioTipo" value="<?php echo $cEntidad->getIdUsuarioTipo();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdUsuarioTipoHast" name="LSTIdUsuarioTipoHast" value="<?php echo $cEntidad->getIdUsuarioTipoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idUsuarioTipo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idUsuarioTipo') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_USUARIO_TIPO");?></option>
	...
	<input type="hidden" name="wi_usuarios_tipos_next_page" value="1" />
