...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdUsuarioTipo" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdUsuarioTipo() : $_POST['fIdUsuarioTipo'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="wi_usuarios_tipos_next_page" value="<?php echo (isset($_POST['wi_usuarios_tipos_next_page'])) ? $cUtilidades->validaXSS($_POST['wi_usuarios_tipos_next_page']) : "1";?>" />