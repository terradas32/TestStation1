		...
		<div id="contenido">
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td ><?php $comboUSUARIOS_TIPOS->setNombre("fIdUsuarioTipo");?><?php echo $comboUSUARIOS_TIPOS->getHTMLCombo("1","obliga",$cEntidad->getIdUsuarioTipo()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" alt="" /></td>
				...
				<?php if(isset($_POST['MODO']) && ($_POST['MODO'] == constant("MNT_MODIFICAR"))){?>
					...
					<tr>
						...
						<td><input type="button" value="<?php echo constant("STR_CAMBIAR_CONTRASENA");?>" id="fCrea" class="botonesgrandes" onclick="javascript:cargalapagina('Usuarios/cambia_pass','contrasenia');"/></td>
					</tr>
					<tr>
					    <td colspan="3">
