...
//inicio de HERRAMIENTAS -->
		...
		while (!$rsTIPOS_INFORMES->EOF)
		{
			if ($k%2 == 0){
				...
				$sTIPOS_INFORMES2 .= '<p><span><input id="' . $sPrefijo . 'IdTipoInforme' . $i . '" name="' . $sPrefijo . 'IdTipoInforme' . $i . '" type="checkbox" value="' . $rsTIPOS_INFORMES->fields[$sAsIdTIPOS_INFORMES] . '"><label for="' . $sPrefijo . 'IdTipoInforme' . $i . '">' . $rsTIPOS_INFORMES->fields[$sAsTIPOS_INFORMES] . '</label>';
