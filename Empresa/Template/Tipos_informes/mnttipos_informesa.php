...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.fDescripcion.value,1000,true);
if (msg != "") {
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdTipoInforme" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdTipoInforme() : $_POST['fIdTipoInforme'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="tipos_informes_next_page" value="<?php echo (isset($_POST['tipos_informes_next_page'])) ? $cUtilidades->validaXSS($_POST['tipos_informes_next_page']) : "1";?>" />