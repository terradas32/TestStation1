	...
	<input type="hidden" name="respuestas_pruebas_items_next_page" value="<?php echo (isset($_POST['respuestas_pruebas_items_next_page'])) ? $cUtilidades->validaXSS($_POST['respuestas_pruebas_items_next_page']) : "1";?>" />
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdPrueba(){
								var f= document.forms[0];
								$("#comboIdItem").show().load("jQuery.php",{sPG:"comboitems",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdItem",fJSProp:"cambiaIdItem",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPrueba:f.fIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdItem();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdOpcion").show().load("jQuery.php",{sPG:"comboopciones",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdOpcion",fJSProp:"cambiaIdOpcion",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPrueba:f.fIdPrueba.value,fIdItem:f.fIdItem.value,vSelected:"<?php echo $cEntidad->getIdOpcion();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdItem(){
								var f= document.forms[0];
								$("#comboIdOpcion").show().load("jQuery.php",{sPG:"comboopciones",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdOpcion",fJSProp:"cambiaIdOpcion",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPrueba:f.fIdPrueba.value,fIdItem:f.fIdItem.value,vSelected:"<?php echo $cEntidad->getIdOpcion();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
