	...
	<input type="hidden" name="proceso_baremos_next_page" value="<?php echo (isset($_POST['proceso_baremos_next_page'])) ? $cUtilidades->validaXSS($_POST['proceso_baremos_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdEmpresa(){
								var f= document.forms[0];
								$("#comboIdProceso").show().load("jQuery.php",{sPG:"comboprocesos",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdProceso",fJSProp:"cambiaIdProceso",fIdEmpresa:f.fIdEmpresa.value,vSelected:"<?php echo $cEntidad->getIdProceso();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdPrueba").show().load("jQuery.php",{sPG:"comboproceso_pruebas",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdPrueba",fJSProp:"cambiaIdPrueba",fCodIdiomaIso2:f.fCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdPrueba();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdBaremo").show().load("jQuery.php",{sPG:"combobaremos",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdBaremo",fJSProp:"cambiaIdBaremo",fIdPrueba:f.fIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdBaremo();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdPrueba(){
								var f= document.forms[0];
								$("#comboIdBaremo").show().load("jQuery.php",{sPG:"combobaremos",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdBaremo",fJSProp:"cambiaIdBaremo",fIdPrueba:f.fIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdBaremo();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
