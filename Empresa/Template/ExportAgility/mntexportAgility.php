...
-->
			...
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					<td><input type="button" class="botones" id="bid-ok" name="fBtnAdd" value="<?php echo constant("STR_GENERAR");?>" onclick="javascript:enviar();" /></td>
