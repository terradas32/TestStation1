...
if (!defined ("DIR_FS_DOCUMENT_ROOT")){
  ...
  $sDisplayProcesoConfidencial="none";
  if ($cEmpresas->getProcesoConfidencial() != ""){
    $sDisplayProcesoConfidencial="block";
  }else{
    $sDisplayProcesoConfidencial="none";
  }
?>
<script>document.getElementById('ProcesoConfidencial').style.display = '<?php echo $sDisplayProcesoConfidencial;?>';</script>
