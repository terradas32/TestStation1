...
function setPK(idRangoIp,idRangoIr)
{
	var f=document.forms[0];
	f.fIdRangoIp.value=idRangoIp;
	f.fIdRangoIr.value=idRangoIr;
}
...
<?php ob_start();?>
	<table cellspacing="1" cellpadding="2" border="0" width="100%">
		<tr>
			...
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "idRangoIp"){
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo htmlentities(constant("STR_ID_RANGO_IP"), ENT_COMPAT, "UTF-8");?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='idRangoIp';document.forms[0].LSTOrder.value='<?php echo $sOrden;?>';enviar('<?php echo constant("MNT_LISTAR");?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo addslashes(constant("STR_ID_RANGO_IP"));?>';return true"><?php echo constant("STR_ID_RANGO_IP");?><?php echo $sPinta;?></a></td>
			<td class="tdnaranjab" align="center" valign="top"><?php echo constant("STR_RANGO_IR");?></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "rangoSup"){
				if ($cEntidad->getOrder() == "ASC"){
					$sOrden = "DESC";
					$sPinta = $strOrderASC;
				}else{
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo htmlentities(constant("STR_RANGO_SUPERIOR"), ENT_COMPAT, "UTF-8");?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='rangoSup';document.forms[0].LSTOrder.value='<?php echo $sOrden;?>';enviar('<?php echo constant("MNT_LISTAR");?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo addslashes(constant("STR_RANGO_SUPERIOR"));?>';return true"><?php echo constant("STR_RANGO_SUPERIOR");?><?php echo $sPinta;?></a></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "rangoInf"){
				if ($cEntidad->getOrder() == "ASC"){
					$sOrden = "DESC";
					$sPinta = $strOrderASC;
				}else{
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo htmlentities(constant("STR_RANGO_INFERIOR"), ENT_COMPAT, "UTF-8");?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='rangoInf';document.forms[0].LSTOrder.value='<?php echo $sOrden;?>';enviar('<?php echo constant("MNT_LISTAR");?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo addslashes(constant("STR_RANGO_INFERIOR"));?>';return true"><?php echo constant("STR_RANGO_INFERIOR");?><?php echo $sPinta;?></a></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
		...
		<tr onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER");?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT");?>'" bgcolor="<?php echo constant("ONMOUSEOUT");?>">
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRangoIp']);?>','<?php echo addslashes($lista->fields['idRangoIr']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idRangoIp']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['idRangoIp'], "<b><i><u><strong><br><br />")),0,11);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRangoIp']);?>','<?php echo addslashes($lista->fields['idRangoIr']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idRangoIr']);?>"><?php echo $comboRANGOS_IR->getDescripcionCombo($lista->fields['idRangoIr']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRangoIp']);?>','<?php echo addslashes($lista->fields['idRangoIr']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo $lista->fields['rangoSup']?>"><?php echo $lista->fields['rangoSup']?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRangoIp']);?>','<?php echo addslashes($lista->fields['idRangoIr']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo $lista->fields['rangoInf']?>"><?php echo $lista->fields['rangoInf']?></td>
			<td class="tddatoslista" valign="top" align="center" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRangoIp']);?>','<?php echo addslashes($lista->fields['idRangoIr']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['fecAlta']);?>"><script language="javascript" type="text/javascript">document.write(formatThisDate('<?php echo $lista->fields['fecAlta'];?>'));</script></td>
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRangoIp']);?>','<?php echo addslashes($lista->fields['idRangoIr']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['usuAlta']);?>"><?php echo $comboWI_USUARIOS->getDescripcionCombo($lista->fields['usuAlta']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRangoIp']);?>','<?php echo addslashes($lista->fields['idRangoIr']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['usuMod']);?>"><?php echo $comboWI_USUARIOS->getDescripcionCombo($lista->fields['usuMod']);?></td>
			<td class="negro" align="center" valign="middle"><?php if($_bBorrar) {?><a href="#" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRangoIp']);?>','<?php echo addslashes($lista->fields['idRangoIr']);?>');confBorrar(<?php echo constant("MNT_BORRAR");?>,'<?php echo constant("DEL_GENERICO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>menos.gif" width="9" height="9" border="0" alt="<?php echo constant("STR_BORRAR");?>" /></a><?php } ?></td>
		</tr>
		<?php $i++;
		$lista->MoveNext();
		} ?>
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
			<td width="100%" colspan="2" class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"),str_replace('_', ' ', constant("STR_RANGOSIP")));?><a href="sqlToExcel.php?fSQLtoEXCEL=<?php echo base64_encode($sql . constant("CHAR_SEPARA") . "rangos_ip");?>"><img src="<?php echo constant('DIR_WS_GRAF');?>excel.gif" width="34" height="35" align="right" border="0" alt="<?php echo constant("STR_EXPORTAR_A_EXCEL");?>" /></a></td>
		</tr>
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
	...
	<br />
	<input type="hidden" name="fIdRangoIp" value="" />
	<input type="hidden" name="fIdRangoIr" value="" />
	<input type="hidden" name="ORIGEN" value="<?php echo constant("MNT_LISTAR");?>" />
	<input type="hidden" name="fReordenar" value="" />
	<input type="hidden" name="LSTIdRangoIpHast" value="<?php echo (isset($_POST['LSTIdRangoIpHast'])) ? $cUtilidades->validaXSS($_POST['LSTIdRangoIpHast']) : "";?>" />
	<input type="hidden" name="LSTIdRangoIp" value="<?php echo (isset($_POST['LSTIdRangoIp'])) ? $cUtilidades->validaXSS($_POST['LSTIdRangoIp']) : "";?>" />
	<input type="hidden" name="LSTIdRangoIrHast" value="<?php echo (isset($_POST['LSTIdRangoIrHast'])) ? $cUtilidades->validaXSS($_POST['LSTIdRangoIrHast']) : "";?>" />
	<input type="hidden" name="LSTIdRangoIr" value="<?php echo (isset($_POST['LSTIdRangoIr'])) ? $cUtilidades->validaXSS($_POST['LSTIdRangoIr']) : "";?>" />
	<input type="hidden" name="LSTRangoSup" value="<?php echo (isset($_POST['LSTRangoSup'])) ? $cUtilidades->validaXSS($_POST['LSTRangoSup']) : "";?>" />
	<input type="hidden" name="LSTRangoInf" value="<?php echo (isset($_POST['LSTRangoInf'])) ? $cUtilidades->validaXSS($_POST['LSTRangoInf']) : "";?>" />
	...
	<input type="hidden" name="rangos_ip_next_page" value="<?php echo (isset($_POST['rangos_ip_next_page'])) ? $cUtilidades->validaXSS($_POST['rangos_ip_next_page']) : "1";?>" /></div>
