...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_RANGO_IR");?>:",f.fIdRangoIr.value,11,true);
	msg +=vString("<?php echo constant("STR_SIGNO");?>:",f.fIdSignoSup.value,255,true);
	msg +=vString("<?php echo constant("STR_RANGO_SUPERIOR");?>:",f.fRangoSup.value,255,true);
	msg +=vString("<?php echo constant("STR_SIGNO");?>:",f.fIdSignoInf.value,255,true);
	msg +=vString("<?php echo constant("STR_RANGO_INFERIOR");?>:",f.fRangoInf.value,255,true);
if (msg != "") {
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdRangoIr"><?php echo constant("STR_RANGO_IR");?></label>&nbsp;</td>
					<td><?php $comboRANGOS_IR->setNombre("fIdRangoIr");?><?php echo $comboRANGOS_IR->getHTMLCombo("1","obliga",$cEntidad->getIdRangoIr()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fRangoSup"><?php echo constant("STR_RANGO_SUPERIOR");?></label>&nbsp;</td>
					<td>
					<?php $comboSIGNOS->setNombre("fIdSignoSup");?><?php echo $comboSIGNOS->getHTMLCombo("1","",$idsS," ","");?>
					<input type="text" id="fRangoSup" name="fRangoSup" value="<?php echo $cEntidad->getRangoSup();?>" class=""  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fRangoInf"><?php echo constant("STR_RANGO_INFERIOR");?></label>&nbsp;</td>
					<td>
						<?php $comboSIGNOS->setNombre("fIdSignoInf");?><?php echo $comboSIGNOS->getHTMLCombo("1","",$idsI," ","");?>
						<input type="text" id="fRangoInf" name="fRangoInf" value="<?php echo $cEntidad->getRangoInf();?>" class=""  onchange="javascript:trim(this);" />
					</td>
				</tr>
	...
	<input type="hidden" name="fIdRangoIp" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdRangoIp() : $_POST['fIdRangoIp'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="rangos_ip_next_page" value="<?php echo (isset($_POST['rangos_ip_next_page'])) ? $cUtilidades->validaXSS($_POST['rangos_ip_next_page']) : "1";?>" />