	...
	<div id="envoltura">
        ...
        <?php
          // La empresa que TRAMITA es la logada que efectua los movimientos, desde la administración es EMPRESA_PE
  				$sIdEmpresaTramita = $_cEntidadUsuarioTK->getIdEmpresa();
        ?>
      <!--
				<tr>
      ...
      -->
          ...
          <td>
      -->
            <input type="hidden" id="fIdEmpresaTramita" name="fIdEmpresaTramita" value="<?php echo $sIdEmpresaTramita;?>" />
      <!--
            <?php echo $comboEMPRESAS_TODAS->getDescripcionCombo($sIdEmpresaTramita);?></td>
      -->
			<!-- </tr>
				<tr><td colspan="3"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="1" height="10" border="0" alt="" /></td></tr>
      -->
...
?>
          ...
          <td><?php $comboEMPRESAS->setNombre("fIdEmpresa");?><?php echo $comboEMPRESAS->getHTMLCombo("1","obliga",""," onchange=\"javascript:setViewUnidadesDestino()\"","");?></td>
				</tr>
        <tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
