...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_IDIOMA_PRUEBA");?>:",f.LSTCodIdiomaIso2.value,2, false);
	msg +=vNumber("<?php echo constant("STR_PRUEBA");?>:", f.LSTIdPrueba.value, 11, false);
	msg +=vString("<?php echo constant("STR_IDIOMA_INFORME");?>:",f.LSTCodIdiomaInforme.value,2, false);
	msg +=vNumber("<?php echo constant("STR_INFORME");?>:", f.LSTIdTipoInforme.value, 11, false);
//	msg +=vNumber("<?php echo constant("STR_BAREMO");?>:", f.LSTIdBaremo.value, 11, false);
	msg +=vString("<?php echo constant("STR_NOMBRE_EMPRESA");?>:",f.LSTNomEmpresa.value,255, false);
	msg +=vString("<?php echo constant("STR_NOMBRE_PROCESO");?>:",f.LSTNomProceso.value,255, false);
	msg +=vString("<?php echo constant("STR_NOMBRE_CANDIDATO");?>:",f.LSTNomCandidato.value,255, false);
...
//	msg +=vString("<?php echo constant("STR_DNI");?>:",f.LSTDni.value,255, false);
	msg +=vString("<?php echo constant("STR_MAIL");?>:",f.LSTMail.value,255, false);
	msg +=vString("<?php echo constant("STR_PRUEBA");?>:",f.LSTNomPrueba.value,255, false);
	msg +=vString("<?php echo constant("STR_INFORME");?>:",f.LSTNomInforme.value,255, false);
	msg +=vString("<?php echo constant("STR_BAREMO");?>:",f.LSTNomBaremo.value,255, false);
//	msg +=vString("<?php echo constant("STR_CONCEPTO");?>:",f.LSTConcepto.value,255, false);
	msg +=vNumber("<?php echo constant("STR_UNIDADES");?>:", f.LSTUnidades.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_UNIDADES");?> <?php echo constant("STR_HASTA");?>:", f.LSTUnidadesHast.value, 11, false);
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><?php $comboEMPRESAS->setNombre("LSTIdEmpresa");?><?php echo $comboEMPRESAS->getHTMLComboMenu("1","cajatexto",$cEntidad->getIdEmpresa()," onchange=\"javascript:cambiaIdEmpresa()\"","<option value=''>" . constant("STR_TODOS") . "</option>");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTCodIdiomaIso2"><?php echo constant("STR_IDIOMA_PRUEBA");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTCodIdiomaInforme"><?php echo constant("STR_IDIOMA_INFORME");?></label>&nbsp;</td>
          <td><?php $comboWI_IDIOMAS->setNombre("LSTCodIdiomaInforme");?><?php echo $comboWI_IDIOMAS->getHTMLCombo("1","cajatexto",$cEntidad->getCodIdiomaInforme()," onchange=\"javascript:cambiaCodIdiomaIso2()\"","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoInforme"><?php echo constant("STR_INFORME");?></label>&nbsp;</td>
					<td><div id="comboIdTipoInforme"><?php $comboTIPOS_INFORMES->setNombre("LSTIdTipoInforme");?><?php echo $comboTIPOS_INFORMES->getHTMLComboNull("1","cajatexto",$cEntidad->getIdTipoInforme(),"onchange=\"javascript:cambiaIdTipoInforme()\" ","");?></div></td>
				</tr>
<!--
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdBaremo"><?php echo constant("STR_BAREMO");?></label>&nbsp;</td>
					<td><?php $comboBAREMOS->setNombre("LSTIdBaremo");?><?php echo $comboBAREMOS->getHTMLCombo("1","cajatexto",$cEntidad->getIdBaremo()," ","");?></td>
				</tr>
-->
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTNomEmpresa"><?php echo constant("STR_NOMBRE_EMPRESA");?></label>&nbsp;</td>
					<td><input type="text" id="LSTNomEmpresa" name="LSTNomEmpresa" value="<?php echo $cEntidad->getNomEmpresa();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTNomProceso"><?php echo constant("STR_NOMBRE_PROCESO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTNomProceso" name="LSTNomProceso" value="<?php echo $cEntidad->getNomProceso();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTNomCandidato"><?php echo constant("STR_NOMBRE_CANDIDATO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTNomCandidato" name="LSTNomCandidato" value="<?php echo $cEntidad->getNomCandidato();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
...
<!--
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTDni"><?php echo constant("STR_DNI");?></label>&nbsp;</td>
					<td><input type="text" id="LSTDni" name="LSTDni" value="<?php echo $cEntidad->getDni();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
 -->
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTMail"><?php echo constant("STR_MAIL");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTNomPrueba"><?php echo constant("STR_PRUEBA");?></label>&nbsp;</td>
					<td><input type="text" id="LSTNomPrueba" name="LSTNomPrueba" value="<?php echo $cEntidad->getNomPrueba();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTNomInforme"><?php echo constant("STR_INFORME");?></label>&nbsp;</td>
					<td><input type="text" id="LSTNomInforme" name="LSTNomInforme" value="<?php echo $cEntidad->getNomInforme();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTNomBaremo"><?php echo constant("STR_BAREMO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTNomBaremo" name="LSTNomBaremo" value="<?php echo $cEntidad->getNomBaremo();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
<!--
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTConcepto"><?php echo constant("STR_CONCEPTO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTConcepto" name="LSTConcepto" value="<?php echo $cEntidad->getConcepto();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
 -->
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTUnidades"><?php echo constant("STR_UNIDADES");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTUnidades" name="LSTUnidades" value="<?php echo $cEntidad->getUnidades();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTUnidadesHast" name="LSTUnidadesHast" value="<?php echo $cEntidad->getUnidadesHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='nomEmpresa' <?php echo (!empty($sOrderBy) && $sOrderBy == 'nomEmpresa') ? "selected='selected'" : "";?>><?php echo constant("STR_NOMBRE_EMPRESA");?></option>
							<option style='color:#000000;' value='nomProceso' <?php echo (!empty($sOrderBy) && $sOrderBy == 'nomProceso') ? "selected='selected'" : "";?>><?php echo constant("STR_NOMBRE_PROCESO");?></option>
							<option style='color:#000000;' value='nomCandidato' <?php echo (!empty($sOrderBy) && $sOrderBy == 'nomCandidato') ? "selected='selected'" : "";?>><?php echo constant("STR_NOMBRE_CANDIDATO");?></option>
...
<!-- 							<option style='color:#000000;' value='dni' <?php echo (!empty($sOrderBy) && $sOrderBy == 'dni') ? "selected='selected'" : "";?>><?php echo constant("STR_DNI");?></option> -->
							<option style='color:#000000;' value='mail' <?php echo (!empty($sOrderBy) && $sOrderBy == 'mail') ? "selected='selected'" : "";?>><?php echo constant("STR_MAIL");?></option>
							<option style='color:#000000;' value='nomPrueba' <?php echo (!empty($sOrderBy) && $sOrderBy == 'nomPrueba') ? "selected='selected'" : "";?>><?php echo constant("STR_PRUEBA");?></option>
							<option style='color:#000000;' value='nomInforme' <?php echo (!empty($sOrderBy) && $sOrderBy == 'nomInforme') ? "selected='selected'" : "";?>><?php echo constant("STR_INFORME");?></option>
							<option style='color:#000000;' value='nomBaremo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'nomBaremo') ? "selected='selected'" : "";?>><?php echo constant("STR_BAREMO");?></option>
<!-- 							<option style='color:#000000;' value='concepto' <?php echo (!empty($sOrderBy) && $sOrderBy == 'concepto') ? "selected='selected'" : "";?>><?php echo constant("STR_CONCEPTO");?></option> -->
							<option style='color:#000000;' value='unidades' <?php echo (!empty($sOrderBy) && $sOrderBy == 'unidades') ? "selected='selected'" : "";?>><?php echo constant("STR_UNIDADES");?></option>
	...
	<input type="hidden" name="consumos_next_page" value="1" />
  <script language="javascript" type="text/javascript">
    //<![CDATA[
    function cambiaCodIdiomaIso2(){
      var f= document.forms[0];
      $("#comboIdTipoInforme").show().load("jQuery.php",{sPG:"combotipos_informes",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdTipoInforme",fJSProp:"cambiaIdTipoInforme",LSTCodIdiomaIso2:f.LSTCodIdiomaInforme.value,vSelected:"<?php echo $cEntidad->getIdTipoInforme();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
    }
    //]]>
  </script>
  <script language="javascript" type="text/javascript">
