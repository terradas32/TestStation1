	...
	<div id="envoltura">
		<div id="contenido">
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0" >
				...
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob"><?php echo constant("STR_FUNCIONALIDAD");?>&nbsp;</td>
					<td ><?php $comboFUNCIONALIDADES->setNombre("LSTIdFuncionalidad");?><?php echo $comboFUNCIONALIDADES->getHTMLComboMenu("1","cajatexto",$cEntidad->getIdFuncionalidad()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob"><?php echo constant("STR_MODIFICAR");?>&nbsp;</td>
					<td ><input type="checkbox" name="LSTModificar" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob"><?php echo constant("STR_BORRAR");?>&nbsp;</td>
					<td ><input type="checkbox" name="LSTBorrar" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
