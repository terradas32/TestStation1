...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_PERFIL");?>:",f.fIdPerfil.value,11,true);
	msg +=vNumber("<?php echo constant("STR_FUNCIONALIDAD");?>:",f.fIdFuncionalidad.value,11,true);
	if(f.borrar.checked == true){
		f.fBorrar.value="on";
	}
	if(f.modificar.checked == true){
		f.fModificar.value="on";
	}
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdPerfil"><?php echo constant("STR_PERFIL");?></label>&nbsp;</td>
					<td><?php $comboEMP_PERFILES->setNombre("fIdPerfil");?><?php echo $comboEMP_PERFILES->getHTMLCombo("1","obliga",$cEntidad->getIdPerfil()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdFuncionalidad"><?php echo constant("STR_FUNCIONALIDAD");?></label>&nbsp;</td>
					<td><?php $comboWI_FUNCIONALIDADES->setNombre("fIdFuncionalidad");?><?php echo $comboWI_FUNCIONALIDADES->getHTMLCombo("1","obliga",$cEntidad->getIdFuncionalidad()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="modificar"><?php echo constant("STR_MODIFICAR");?></label>&nbsp;</td>
					<td><input type="checkbox" id="modificar" name="modificar" <?php echo ($cEntidad->getModificar() != "" && strtoupper($cEntidad->getModificar()) == "ON") ? "checked=\"checked\"" : "";?> /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="borrar"><?php echo constant("STR_BORRAR");?></label>&nbsp;</td>
					<td><input type="checkbox" id="borrar" name="borrar" <?php echo ($cEntidad->getBorrar() != "" && strtoupper($cEntidad->getBorrar()) == "ON") ? "checked=\"checked\"" : "";?> /></td>
				</tr>
...
<input type="hidden" name="fBorrar" value="" />
<input type="hidden" name="fModificar" value="" />
