...
<table cellpadding="5" cellspacing="5">
	<tr>
		...
		<td>
			<select name="fIdTipoCompetencia" class="obliga" style="width: 200px;" onchange="javascript:cambiaIdCompetencia();">
	...
	<tr>
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdEscala"><?php echo constant("STR_COMPETENCIA");?></label>&nbsp;</td>
