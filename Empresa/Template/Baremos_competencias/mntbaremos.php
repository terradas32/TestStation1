...
function cambiaIdCompetencia(){
	var f= document.forms[0];
	$("#comboIdCompetencia").show().load("jQuery.php",{sPG:"combocompetencias2",vSelected:escala,bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdCompetencia",fJSProp:"",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdTipoCompetencia:f.fIdTipoCompetencia.value,fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
}
