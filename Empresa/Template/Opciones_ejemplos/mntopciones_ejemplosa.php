...
function enviar()
{
	...
	if (validaForm()){
		...
		f.fIdEjemplo.value=f.elements['fIdEjemplo'].value;
		return true;
	}else	return false;
}
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_EJEMPLO");?>:",f.elements['fIdEjemplo'].value,11,true);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdEjemplo"><?php echo constant("STR_EJEMPLO");?></label>&nbsp;</td>
						<td><div id="comboIdEjemplo"><?php $comboEJEMPLOS->setNombre("fIdEjemplo");?><?php echo $comboEJEMPLOS->getHTMLComboNull("1","obliga",$cEntidad->getIdEjemplo(),"onchange=\"javascript:cambiaIdEjemplo()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="opciones_ejemplos_next_page" value="<?php echo (isset($_POST['opciones_ejemplos_next_page'])) ? $cUtilidades->validaXSS($_POST['opciones_ejemplos_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdPrueba").show().load("jQuery.php",{sPG:"combopruebas",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdPrueba",fJSProp:"cambiaIdPrueba",fCodIdiomaIso2:f.fCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdPrueba();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdEjemplo").show().load("jQuery.php",{sPG:"comboejemplos",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdEjemplo",fJSProp:"cambiaIdEjemplo",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPrueba:f.fIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdEjemplo();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
