...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_SEXO");?>:", f.LSTIdSexo.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_SEXO");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdSexoHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdSexo"><?php echo constant("STR_ID_SEXO");?></label>&nbsp;</td>
					<td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idSexo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idSexo') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_SEXO");?></option>
	...
	<input type="hidden" name="sexos_next_page" value="1" /></div>
