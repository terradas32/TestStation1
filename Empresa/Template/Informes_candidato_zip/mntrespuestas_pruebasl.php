...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			...
			<td width="100%" colspan="2" class="naranjab"><?php echo constant("STR_RESUMEN");?></td>
		</tr>
		<tr>
			<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="1" border="0" alt="" /></td>
			<td nowrap="nowrap" width="15%" class="azul" align="left"><?php echo constant("STR_INFORMES_AGREGADOS_AL_FICHERO_ZIP");?>:&nbsp;</td>
			<td width="85%" class="azul" align="left"><font class="naranja"><?php echo count($valid_files); ?></font>
<?php
if(count($valid_files) > 0){
?>
			<a href="#_" onclick="abrirVentana('0','<?php echo base64_encode(constant("DIR_WS_GESTOR") . $GETzip_name);?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>zip.gif" width="34" height="35" align="center" border="0" alt="Descargar ZIP" title="Descargar ZIP" /></a> (Pulse la imágen para descargar)
<?php
}
?>
			</td>
...
<?php
if(count($NO_valid_files) > 0){
?>
		<tr>
			<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="1" border="0" alt="" /></td>
			<td nowrap="nowrap" width="15%" class="azul" align="left"><?php echo constant("STR_INFORMES_NO_AGREGADOS_AL_FICHERO_ZIP");?>:&nbsp;</td>
			<td width="85%" class="azul" align="left"><font class="naranja"><?php echo count($NO_valid_files); ?></font></td>
		</tr>
<?php
}
if(!empty($error)){
?>
		<tr>
			<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="1" border="0" alt="" /></td>
			<td nowrap="nowrap" width="15%" class="azul" align="left"><?php echo constant("STR_ERRORES");?>:&nbsp;</td>
			<td width="85%" class="azul" align="left"><font class="naranja">
			<?php echo $error; ?>
			</font></td>
		</tr>
<?php
