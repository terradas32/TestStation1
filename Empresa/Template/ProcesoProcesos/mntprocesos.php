...
<title><?php echo constant("NOMBRE_SITE");?></title>
	...
	<!--[if lte IE 6]>
	<link rel="stylesheet" href="estilos/ie.css" type="text/css" />
	<![endif]-->
...
//	msg +=vNumber("<?php echo constant("STR_MODO_REALIZACION_PRUEBAS");?>:", f.LSTIdTipoProceso.value, 11, false);
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_ID_PROCESO");?>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" name="LSTIdProceso" value="<?php echo $cEntidad->getIdProceso();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" name="LSTIdProcesoHast" value="<?php echo $cEntidad->getIdProcesoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_VISIBLE");?>&nbsp;</td>
					<?php
					// modificado para que ponga por defecto el valor Continuo en el combo
					if ($cEntidad->getBajaLog() == ""){
						$cEntidad->setBajaLog("0");	
					}
					?>
					<td>
						<select size="1" name="LSTBajaLog">
							<option style="color:#000000;" value="" <?php echo ($cEntidad->getBajaLog() == "") ? "selected" : "";?>><?php echo constant("STR_TODOS");?></option>
							<option style="color:#000000;" value="0" <?php echo ($cEntidad->getBajaLog() == 0) ? "selected" : "";?>><?php echo constant("STR_SI");?></option>
							<option style="color:#000000;" value="1" <?php echo ($cEntidad->getBajaLog() == 1) ? "selected" : "";?>><?php echo constant("STR_NO");?></option>
						</select>
					</td>
				</tr>
<!-- 
				<tr>
					...
					<td><input type="text" name="LSTObservaciones" value="<?php echo $cEntidad->getObservaciones();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
 -->
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><a href="#" onclick="javascript:abrirCalendario('calendario.php?openerNombre=LSTFechaInicio','<?php echo constant("STR_CALENDARIO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>icon_calendario.gif" width="22" height="18" border="0" alt="<?php echo constant("STR_CALENDARIO");?>" align="bottom" /></a>&nbsp;<input type="text" name="LSTFechaInicio" value="<?php echo $cEntidad->getFechaInicio();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								...
								?>
								<td><a href="#" onclick="javascript:abrirCalendario('calendario.php?openerNombre=LSTFechaInicioHast','<?php echo constant("STR_CALENDARIO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>icon_calendario.gif" width="22" height="18" border="0" alt="<?php echo constant("STR_CALENDARIO");?>" align="bottom" /></a>&nbsp;<input type="text" name="LSTFechaInicioHast" value="<?php echo $cEntidad->getFechaInicioHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><a href="#" onclick="javascript:abrirCalendario('calendario.php?openerNombre=LSTFechaFin','<?php echo constant("STR_CALENDARIO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>icon_calendario.gif" width="22" height="18" border="0" alt="<?php echo constant("STR_CALENDARIO");?>" align="bottom" /></a>&nbsp;<input type="text" name="LSTFechaFin" value="<?php echo $cEntidad->getFechaFin();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								...
								?>
								<td><a href="#" onclick="javascript:abrirCalendario('calendario.php?openerNombre=LSTFechaFinHast','<?php echo constant("STR_CALENDARIO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>icon_calendario.gif" width="22" height="18" border="0" alt="<?php echo constant("STR_CALENDARIO");?>" align="bottom" /></a>&nbsp;<input type="text" name="LSTFechaFinHast" value="<?php echo $cEntidad->getFechaFinHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
...
<!-- 						<option style='color:#000000;' value='observaciones' <?php echo (!empty($sOrderBy) && $sOrderBy == 'observaciones') ? "selected='selected'" : "";?>><?php echo constant("STR_OBSERVACIONES");?></option> -->
	...
	<input type="hidden" name="procesos_next_page" value="1" /></div>
