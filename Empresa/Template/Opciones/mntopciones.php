	...
	<input type="hidden" name="opciones_next_page" value="1" />
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdPrueba(){
								var f= document.forms[0];
								$("#comboIdItem").show().load("jQuery.php",{sPG:"comboitems",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdItem",fJSProp:"cambiaIdItem",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdPrueba:f.LSTIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdItem();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
