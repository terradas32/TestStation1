...
function enviar()
{
	...
	if (validaForm()){
		lon();
		f.fIdComunidad.value=f.elements['fIdComunidad'].value;
...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vString("<?php echo constant("STR_ID_MUNICIPIO");?>:",f.fIdMunicipio.value,5,true);
	...
	msg +=vString("<?php echo constant("STR_COMUNIDAD");?>:",f.elements['fIdComunidad'].value,2,true);
	msg +=vString("<?php echo constant("STR_PROVINCIA");?>:",f.elements['fIdProvincia'].value,2,true);
if (msg != "") {
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdMunicipio"><?php echo constant("STR_ID_MUNICIPIO");?></label>&nbsp;</td><td><input type="text" id="fIdMunicipio" name="fIdMunicipio" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdMunicipio() : $_POST['fIdMunicipio'];?>" class="obliga" onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><?php $comboWI_PAISES->setNombre("fIdPais");?><?php echo $comboWI_PAISES->getHTMLCombo("1","obliga",$cEntidad->getIdPais()," onchange=\"javascript:cambiaIdPais()\"","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdComunidad"><?php echo constant("STR_COMUNIDAD");?></label>&nbsp;</td>
						<td><div id="comboIdComunidad"><?php $comboWI_CCAA->setNombre("fIdComunidad");?><?php echo $comboWI_CCAA->getHTMLComboNull("1","obliga",$cEntidad->getIdComunidad(),"onchange=\"javascript:cambiaIdComunidad()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdProvincia"><?php echo constant("STR_PROVINCIA");?></label>&nbsp;</td>
						<td><div id="comboIdProvincia"><?php $comboWI_PROVINCIAS->setNombre("fIdProvincia");?><?php echo $comboWI_PROVINCIAS->getHTMLComboNull("1","obliga",$cEntidad->getIdProvincia(),"onchange=\"javascript:cambiaIdProvincia()\" ","");?></div></td>
				</tr>
	...
	<input type="hidden" name="wi_municipios_next_page" value="<?php echo (isset($_POST['wi_municipios_next_page'])) ? $cUtilidades->validaXSS($_POST['wi_municipios_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaIdPais(){
								var f= document.forms[0];
								$("#comboIdComunidad").show().load("jQuery.php",{sPG:"combowi_ccaa",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdComunidad",fJSProp:"cambiaIdComunidad",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPais:f.fIdPais.value,vSelected:"<?php echo $cEntidad->getIdComunidad();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdProvincia").show().load("jQuery.php",{sPG:"combowi_provincias",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdProvincia",fJSProp:"cambiaIdProvincia",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdComunidad:f.fIdComunidad.value,vSelected:"<?php echo $cEntidad->getIdProvincia();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaIdComunidad(){
								var f= document.forms[0];
