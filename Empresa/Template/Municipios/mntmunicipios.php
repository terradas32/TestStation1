...
function enviar()
{
	...
	if (validaForm()){
		lon();
		f.LSTIdComunidad.value=f.elements['LSTIdComunidad'].value;
...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vString("<?php echo constant("STR_ID_MUNICIPIO");?>:",f.LSTIdMunicipio.value,5, false);
	...
	msg +=vString("<?php echo constant("STR_COMUNIDAD");?>:",f.elements['LSTIdComunidad'].value,2, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdMunicipio"><?php echo constant("STR_ID_MUNICIPIO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTIdMunicipio" name="LSTIdMunicipio" value="<?php echo $cEntidad->getIdMunicipio();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdComunidad"><?php echo constant("STR_COMUNIDAD");?></label>&nbsp;</td>
						<td><div id="comboIdComunidad"><?php $comboWI_CCAA->setNombre("LSTIdComunidad");?><?php echo $comboWI_CCAA->getHTMLComboNull("1","cajatexto",$cEntidad->getIdComunidad(),"onchange=\"javascript:cambiaIdComunidad()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idMunicipio' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idMunicipio') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_MUNICIPIO");?></option>
	...
	<input type="hidden" name="wi_municipios_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaIdPais(){
								var f= document.forms[0];
								$("#comboIdComunidad").show().load("jQuery.php",{sPG:"combowi_ccaa",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdComunidad",fJSProp:"cambiaIdComunidad",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdPais:f.LSTIdPais.value,vSelected:"<?php echo $cEntidad->getIdComunidad();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdProvincia").show().load("jQuery.php",{sPG:"combowi_provincias",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdProvincia",fJSProp:"cambiaIdProvincia",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdComunidad:f.LSTIdComunidad.value,vSelected:"<?php echo $cEntidad->getIdProvincia();?>", fLang:"<?php echo $sLang;?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
