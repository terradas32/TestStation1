...
include_once ('include/conexion.php');
	...
	$cEntidadDB	= new Tipos_informesDB($conn);  // Entidad DB
	$cEntidad	= new Tipos_informes();  // Entidad
	...
	switch ($_POST['MODO'])
	{
		case constant("MNT_ALTA"):
			...
			?><script language="javascript" type="text/javascript">jAlert("<?php echo constant("CONF_ALTA") . $newId;?>\n<?php echo $cEntidadDB->ver_errores();?>","<?php echo constant("STR_NOTIFICACION");?>");</script><?php 
				...
				{
					if (!empty($_POST['tipos_informes_next_page']) && $_POST['tipos_informes_next_page'] > 1 ){
						$bInit=false;
					...
					$pager = new ADODB_Pager($conn,$sql,'tipos_informes');
					...
					$lista=$pager->getRS();
					include('Template/Tipos_informes/mnttipos_informesl.php');
				}else{
					$cEntidad	= new Tipos_informes();  // inicializamos la Entidad
					$_POST['MODO']    = constant("MNT_ALTA");
					include('Template/Tipos_informes/mnttipos_informesa.php');
				}
			}else{
		...
		case constant("MNT_BUSCAR"):
			...
			include('Template/Tipos_informes/mnttipos_informes.php');
			break;
	...
	*/
	function readLista($cEntidad){
		...
		$cEntidad->setIdTipoInforme((isset($_POST["LSTIdTipoInforme"]) && $_POST["LSTIdTipoInforme"] != "") ? $_POST["LSTIdTipoInforme"] : "");	$cEntidad->setBusqueda(constant("STR_ID_TIPO_INFORME"), (isset($_POST["LSTIdTipoInforme"]) && $_POST["LSTIdTipoInforme"] != "" ) ? $_POST["LSTIdTipoInforme"] : "");
		$cEntidad->setIdTipoInformeHast((isset($_POST["LSTIdTipoInformeHast"]) && $_POST["LSTIdTipoInformeHast"] != "") ? $_POST["LSTIdTipoInformeHast"] : "");	$cEntidad->setBusqueda(constant("STR_ID_TIPO_INFORME") . " " . constant("STR_HASTA"), (isset($_POST["LSTIdTipoInformeHast"]) && $_POST["LSTIdTipoInformeHast"] != "" ) ? $_POST["LSTIdTipoInformeHast"] : "");
