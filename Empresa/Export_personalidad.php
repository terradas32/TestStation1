...
//		$cEntidad->setDescProceso((isset($_POST["LSTDescProceso"]) && $_POST["LSTDescProceso"] != "") ? $_POST["LSTDescProceso"] : "");	$cEntidad->setBusqueda(constant("STR_PROCESO"), (isset($_POST["LSTDescProceso"]) && $_POST["LSTDescProceso"] != "" ) ? $_POST["LSTDescProceso"] : "");
		...
		$cEntidad->setIdTipoInforme((isset($_POST["fIdTipoInforme"]) && $_POST["fIdTipoInforme"] != "") ? $_POST["fIdTipoInforme"] : "");	$cEntidad->setBusqueda(constant("STR_ID_TIPO_INFORME"), (isset($_POST["fIdTipoInforme"]) && $_POST["fIdTipoInforme"] != "" ) ? $comboPRUEBAS->getDescripcionCombo($_POST["fIdTipoInforme"]) : "");
		$_Pruebas = "";
