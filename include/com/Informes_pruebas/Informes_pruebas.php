...
* los valores de la entidad de clase Informes_pruebas.
**/
class Informes_pruebas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idPrueba,codIdiomaIso2,idTipoInforme,tarifa,precio,nVecesDescargado,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Prueba,Idioma,Id Tipo Informe,Tarifa,Precio,N Veces Descargado,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Informes_pruebas
?>