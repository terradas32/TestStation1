...
class Respuestas_pruebas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idProceso,idCandidato,idPrueba,codIdiomaIso2,finalizado,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id  Empresa,Id  Proceso,Id  Candidato,Id  Prueba,Idioma,Finalizado,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
