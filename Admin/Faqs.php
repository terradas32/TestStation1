...
include_once ('include/conexion.php');
	...
	$cEntidadDB	= new FaqsDB($conn);  // Entidad DB
	$cEntidad	= new Faqs();  // Entidad
	...
	switch ($_POST['MODO'])
	{
		case constant("MNT_ALTA"):
			...
			?><script language="javascript" type="text/javascript">alert("<?php echo constant("CONF_ALTA") . $newId;?>\n<?php echo $cEntidadDB->ver_errores();?>");</script><?php
				...
				{
					if (!empty($_POST['faqs_next_page']) && $_POST['faqs_next_page'] > 1 ){
						$bInit=false;
					...
					$pager = new ADODB_Pager($conn,$sql,'faqs');
					...
					$lista=$pager->getRS();
					include('Template/Faqs/mntfaqsl.php');
				}else{
					$cEntidad	= new Faqs();  // inicializamos la Entidad
					$_POST['MODO']    = constant("MNT_ALTA");
					include('Template/Faqs/mntfaqsa.php');
				}
			}else{
		...
		case constant("MNT_BUSCAR"):
			...
			include('Template/Faqs/mntfaqs.php');
			break;
	...
	*/
	function readEntidad($cEntidad){
		...
		global $cUtilidades;
		$cEntidad->setIdFaq((isset($_POST["fIdFaq"])) ? $_POST["fIdFaq"] : "");
		$cEntidad->setCodIdiomaIso2((isset($_POST["fCodIdiomaIso2"])) ? $_POST["fCodIdiomaIso2"] : "");
		$cEntidad->setPregunta((isset($_POST["fPregunta"])) ? $_POST["fPregunta"] : "");
		$cEntidad->setRespuesta((isset($_POST["fRespuesta"])) ? $_POST["fRespuesta"] : "");
		$cEntidad->setZonaPublicacion((isset($_POST["fZonaPublicacion"])) ? $_POST["fZonaPublicacion"] : "");
		$cEntidad->setOrden((isset($_POST["fOrden"])) ? $_POST["fOrden"] : "");
		$cEntidad->setPublicar((isset($_POST["fPublicar"])) ? $_POST["fPublicar"] : "");
	...
	*/
	function readLista($cEntidad){
		global $conn;
		global $cUtilidades;
		$cEntidad->setIdFaq((isset($_POST["LSTIdFaq"]) && $_POST["LSTIdFaq"] != "") ? $_POST["LSTIdFaq"] : "");	$cEntidad->setBusqueda(constant("STR_ID"), (isset($_POST["LSTIdFaq"]) && $_POST["LSTIdFaq"] != "" ) ? $_POST["LSTIdFaq"] : "");
		$cEntidad->setIdFaqHast((isset($_POST["LSTIdFaqHast"]) && $_POST["LSTIdFaqHast"] != "") ? $_POST["LSTIdFaqHast"] : "");	$cEntidad->setBusqueda(constant("STR_ID") . " " . constant("STR_HASTA"), (isset($_POST["LSTIdFaqHast"]) && $_POST["LSTIdFaqHast"] != "" ) ? $_POST["LSTIdFaqHast"] : "");
		...
		$cEntidad->setPregunta((isset($_POST["LSTPregunta"]) && $_POST["LSTPregunta"] != "") ? $_POST["LSTPregunta"] : "");	$cEntidad->setBusqueda(constant("STR_PREGUNTA"), (isset($_POST["LSTPregunta"]) && $_POST["LSTPregunta"] != "" ) ? $_POST["LSTPregunta"] : "");
		$cEntidad->setRespuesta((isset($_POST["LSTRespuesta"]) && $_POST["LSTRespuesta"] != "") ? $_POST["LSTRespuesta"] : "");	$cEntidad->setBusqueda(constant("STR_RESPUESTA"), (isset($_POST["LSTRespuesta"]) && $_POST["LSTRespuesta"] != "" ) ? $_POST["LSTRespuesta"] : "");
		$cEntidad->setZonaPublicacion((isset($_POST["LSTZonaPublicacion"]) && $_POST["LSTZonaPublicacion"] != "") ? $_POST["LSTZonaPublicacion"] : "");	$cEntidad->setBusqueda(constant("STR_ZONA_PUBLICACION"), (isset($_POST["LSTZonaPublicacion"]) && $_POST["LSTZonaPublicacion"] != "" ) ? $_POST["LSTZonaPublicacion"] : "");
		//$cEntidad->setZonaPublicacionHast((isset($_POST["LSTZonaPublicacionHast"]) && $_POST["LSTZonaPublicacionHast"] != "") ? $_POST["LSTZonaPublicacionHast"] : "");	$cEntidad->setBusqueda(constant("STR_ZONA_PUBLICACION") . " " . constant("STR_HASTA"), (isset($_POST["LSTZonaPublicacionHast"]) && $_POST["LSTZonaPublicacionHast"] != "" ) ? $_POST["LSTZonaPublicacionHast"] : "");
		...
		$cEntidad->setPublicar((isset($_POST["LSTPublicar"]) && $_POST["LSTPublicar"] != "") ? $_POST["LSTPublicar"] : "");	$cEntidad->setBusqueda(constant("STR_PUBLICAR"), (isset($_POST["LSTPublicar"]) && $_POST["LSTPublicar"] != "" ) ? $_POST["LSTPublicar"] : "");
		$cEntidad->setPublicarHast((isset($_POST["LSTPublicarHast"]) && $_POST["LSTPublicarHast"] != "") ? $_POST["LSTPublicarHast"] : "");	$cEntidad->setBusqueda(constant("STR_PUBLICAR") . " " . constant("STR_HASTA"), (isset($_POST["LSTPublicarHast"]) && $_POST["LSTPublicarHast"] != "" ) ? $_POST["LSTPublicarHast"] : "");
