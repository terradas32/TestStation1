				...
				if($conn->Execute($sSQL) === false){
					...
					if ($bEncontrada){
						if ($bPrepago){
							...
							if ($iRresto >= 0){
								$bExportar=true;
//								$sMensaje = "<br />Se exportaran " . $i . " Registros con un consumo de " . $iConsumos . " dongles.";
//								$sMensaje .= "<br />Le quedaran: " . $iRresto . " dongles.";
...
//								$bExportar=false;
//								$sMensaje = "<br />No tiene dongles suficientes par realizar la descarga.";
//								$sMensaje .= "<br />Se exportarían " . $i . " Registros con un consumo de " . $iConsumos . " dongles.";
//								$sMensaje .= "<br />Ud. sólo dispone de: " . $iDonglesEmpresa . " dongles.";
//								$sMensaje .= "<br />Realice una Recarga de dongles y vuelva a efectuar la operación.";
//								$sMensaje .= "<br /><br />Gracias.";
							...
							$bExportar=true;
//							$sMensaje = "<br />Se exportaran " . $i . " Registros su consumo es por contrato.";
//							$sMensaje .= "<br />Esta operación puede durar varios minutos.";
//							$sMensaje .= "<br /><br />Pulse Exportar si está seguro.";
