<?php
	...
	define("DIR_WS_JPGRAPH", $_DOCUMENT_ROOT . "/jpgraph/");
	...
	//Directorios físicos
	define("DIR_FS_DOCUMENT_ROOT", $_DOCUMENT_ROOT . "Admin/"); //Siempre terminar en "/"
	//Fichero de log
	...
	//Nombre de SESSION
	define("NOMBRE_SESSION", "Admintest-station");
