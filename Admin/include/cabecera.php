...
<div id="cabecera">			
		<div id="cabecera-envoltura">
			<div id="cabecera-contenido">
                ...
                <div id="cabecera-botones">
            		...
            		<li class="misDatos"><a href="#" onclick="javascript:block('-1');setClicado('Z');setTitulo('<?php echo constant("STR_MIS_DATOS");?>');enviarMenu('Usuario.php', '<?php echo constant("MNT_BUSCAR");?>');" title="<?php echo constant("STR_MIS_DATOS");?>">&nbsp;</a></li>
				...
				<div id="cabecera-contenido-inferior">
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr style="height:10px">	            		    
			            	<td colspan="2" nowrap="nowrap" class="blanco dataUsr"><?php echo constant("STR_USUARIO");?>:&nbsp;<font class="blancob dataUsr"><?php echo $_cEntidadUsuarioTK->getLogin();?></font>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo constant("STR_NOMBRE");?>:&nbsp;<font class="blancob dataUsr"><?php echo $_cEntidadUsuarioTK->getNombre();?></font>&nbsp;&nbsp;&nbsp;&nbsp;<font class="blanco dataUsr"><?php echo constant("STR_APELLIDO");?>:&nbsp;</font><font class="blancob dataUsr"><?php echo $_cEntidadUsuarioTK->getApellido1();?></font></td>
							<td nowrap="nowrap" align="right" class="blanco dataUsr"><?php echo constant("STR_ULTIMA_CONEXION");?>:&nbsp;<font class="blancob dataUsr"><?php echo (is_null($_cEntidadUsuarioTK->getUltimoLogin())) ? constant("STR_NUNCA") : convertir_fecha($_cEntidadUsuarioTK->getUltimoLogin());?></font></td>
	                        <td nowrap="nowrap" align="right" valign="bottom dataUsr" class="blanco dataUsr"></td>
	            		</tr>
					</table>	
				</div>
			</div>
		...
		<div id="cabecera-izquierda">
			<div id="cabecera-logo">
				<img alt="<?php echo constant("NOMBRE_EMPRESA");?>" src="<?php echo constant("DIR_WS_GRAF");?>logo.jpg" />
			</div>
		</div>
