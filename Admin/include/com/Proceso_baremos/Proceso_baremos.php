...
class Proceso_baremos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idProceso,codIdiomaIso2,idPrueba,idBaremo,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Empresa,Proceso,Idioma,Prueba,Baremo,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
