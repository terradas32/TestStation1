...
* la tabla sec_factores_motivacionales
**/
class Sec_factoresmotivacionalesDB
{
	...
	***********************************************************************/
	function insertar($cEntidad)
	{
		...
		$sql = "INSERT INTO sec_factores_motivacionales (";
		$sql .= "IDFACTOR" . ",";
		$sql .= "CODIGO" . ",";
		$sql .= "DESCRIPCION" . ",";
		$sql .= "IDTIPOPRUEBA" . ",";
	...
	*****************************************************************************************/
	function getSiguienteId($cEntidad)
	{
		...
		$sql = "SELECT MAX(IDFACTOR) AS Max FROM sec_factores_motivacionales ";
		$sql .="";
		$newId=0;
		if ($rs){
	...
	************************************************************************/
	function modificar($cEntidad)
	{
		...
		$sql = "UPDATE sec_factores_motivacionales SET ";
	...
	************************************************************************/
	function borrar($cEntidad)
	{
		...
		$retorno			= true;
			...
			$sql ="DELETE FROM sec_factores_motivacionales ";
			$sql .=" WHERE ";
	...
	*************************************************************************/
	function readEntidad($cEntidad)
	{
		...
		$aux			= $this->conn;
		$sql = "SELECT IDFACTOR,CODIGO,DESCRIPCION,IDTIPOPRUEBA," . "fecAlta" . "," . "fecMod" . ",usuAlta,usuMod FROM sec_factores_motivacionales WHERE ";
		$sql .="IDFACTOR=" . $aux->qstr($cEntidad->getIDFACTOR(), false) . " ";
		$rs = $aux->Execute($sql);
		if ($rs){
			while ($arr = $rs->FetchRow()){
	...
	*************************************************************************/
	function readLista($cEntidad)
	{
		...
		$sql="";
		$and = false;
		$sql.="SELECT * FROM sec_factores_motivacionales ";
...
}//Fin de la Clase Sec_factoresmotivacionalesDB
?>