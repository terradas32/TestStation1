...
* los valores de la entidad de clase Formaciones.
**/
class Formaciones
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"codIdiomaIso2,idFormacion,nombre,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Idioma,Id Formación,Nombre,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
