...
* los valores de la entidad de clase Sec_respuestasfa.
**/
class Sec_respuestasfa
{
	...
	**/
		...
		var $CODFACTOR;
		var $DESCFACTOR;
		var $PUNTUACIONDIRECTA;
		var $PUNTUACIONDIRECTAHast;
		var $PUNTSOBRE10;
		var $PUNTSOBRE10Hast;
		var $MEDIAPONDERADA;
	...
	**/
	function __construct()
	{
		...
		$this->CODFACTOR			= "";
		$this->DESCFACTOR			= "";
		$this->PUNTUACIONDIRECTA			= "";
		$this->PUNTUACIONDIRECTAHast			= "";
		$this->PUNTSOBRE10			= "";
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"IDRESPUESTA,IDCANDIDATO,IDPROCESO,IDFACTOR,CODFACTOR,DESCFACTOR,PUNTUACIONDIRECTA,PUNTSOBRE10,MEDIAPONDERADA,INTELIGENCIA,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id respuesta,Id candidato,Id proceso,Id factor,Codfactor,Descfactor,Puntuaciondirecta,Puntsobre10,Mediaponderada,Inteligencia,Fec. alta,Fec. mod,Usu. alta,Usu. mod";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad DESCFACTOR
	* @return varchar(255)
	*/
	function getDESCFACTOR(){
		return $this->DESCFACTOR;
	}
	/**
	* Fija el contenido de la propiedad DESCFACTOR
	* @param DESCFACTOR
	* @return void
	*/
	function setDESCFACTOR($sCadena){
		$this->DESCFACTOR = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad PUNTUACIONDIRECTA
	* @return int(11)
	*/
	function getPUNTUACIONDIRECTA(){
		return $this->PUNTUACIONDIRECTA;
	}
	/**
	...
	* @return void
	*/
	function setPUNTUACIONDIRECTA($sCadena){
		$this->PUNTUACIONDIRECTA = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad PUNTUACIONDIRECTAHast
	* @return int(11)
	*/
	function getPUNTUACIONDIRECTAHast(){
		return $this->PUNTUACIONDIRECTAHast;
	}
	/**
	...
	* @return void
	*/
	function setPUNTUACIONDIRECTAHast($sCadena){
		$this->PUNTUACIONDIRECTAHast = $sCadena;
	}
	/**
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad INTELIGENCIA
	* @return varchar(2)
	*/
	...
	/**
	* Fija el contenido de la propiedad INTELIGENCIA
	* @param INTELIGENCIA
	* @return void
	*/
	function setINTELIGENCIA($sCadena){
		$this->INTELIGENCIA = $sCadena;
	}
	/**
...
}//Fin de la Clase Sec_respuestasfa
?>