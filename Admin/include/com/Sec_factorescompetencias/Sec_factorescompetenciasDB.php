...
* la tabla sec_factores_competencias
**/
class Sec_factorescompetenciasDB 
{
	...
	***********************************************************************/
	function insertar($cEntidad) 
	{
		...
		$sql = "INSERT INTO sec_factores_competencias (";
		$sql .= "IDFACTOR" . ",";
		$sql .= "CODIGO" . ",";
		$sql .= "DESCRIPCION" . ",";
		$sql .= "IDTIPOPRUEBA" . ",";
	...
	*****************************************************************************************/
	function getSiguienteId($cEntidad)
	{
		...
		$sql  = "SELECT MAX(IDFACTOR) AS Max FROM sec_factores_competencias ";
		$sql  .="";
		$newId=0;
		if ($rs){
	...
	************************************************************************/
	function modificar($cEntidad)
	{
		...
		$sql = "UPDATE sec_factores_competencias SET ";
	...
	************************************************************************/
	function borrar($cEntidad)
	{
		...
		$retorno			= true;
			...
			$sql  ="DELETE FROM sec_factores_competencias ";
			$sql  .=" WHERE ";
	...
	*************************************************************************/
	function readEntidad($cEntidad)
	{
		...
		$sql = "SELECT IDFACTOR,CODIGO,DESCRIPCION,IDTIPOPRUEBA," . "fecAlta" . "," . "fecMod" . ",usuAlta,usuMod FROM sec_factores_competencias WHERE ";
		$sql  .="IDFACTOR=" . $aux->qstr($cEntidad->getIDFACTOR(), false) . "";
	...
	*************************************************************************/
	function readLista($cEntidad) 
	{
		...
		$sql="";
		$and = false;
		$sql.="SELECT * FROM sec_factores_competencias ";
...
}//Fin de la Clase Sec_factorescompetenciasDB
?>