...
* los valores de la entidad de clase Bloques.
**/
class Bloques
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"codIdiomaIso2,idBloque,nombre,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Idioma,Id Bloque,Nombre,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
