...
* los valores de la entidad de clase Correos_literales.
**/
class Correos_literales
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idLiteral,codIdiomaIso2,literal,descripcion,sistema,visible,fecAlta,fecMod";
		$this->DESCListaExcel	=	"Id,Idioma,Literal,Descripción,Sistema,Visible,Fecha de Alta,Fecha de Modificación";
	}


	/**
	* Devuelve el contenido de la propiedad idLiteral
	* @return int(11)
	*/
	function getIdLiteral(){
		return $this->idLiteral;
	}
	/**
	* Fija el contenido de la propiedad idLiteral
	* @param idLiteral
	* @return void
	*/
	function setIdLiteral($sCadena){
		$this->idLiteral = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idLiteralHast
	* @return int(11)
	*/
	function getIdLiteralHast(){
		return $this->idLiteralHast;
	}
	/**
	* Fija el contenido de la propiedad idLiteralHast
	* @param idLiteral
	* @return void
	*/
	function setIdLiteralHast($sCadena){
		$this->idLiteralHast = $sCadena;
	}
	/**
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad literal
	* @return varchar(255)
	*/
	function getLiteral(){
		return $this->literal;
	...
	/**
	* Fija el contenido de la propiedad literal
	* @param literal
	* @return void
	*/
	function setLiteral($sCadena){
		$this->literal = $sCadena;
	}
	/**
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad sistema
	* @return int(1)
	*/
	function getSistema(){
		return $this->sistema;
	...
	/**
	* Fija el contenido de la propiedad sistema
	* @param sistema
	* @return void
	*/
	function setSistema($sCadena){
		$this->sistema = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad sistemaHast
	* @return int(1)
	*/
	function getSistemaHast(){
		return $this->sistemaHast;
	}
	/**
	* Fija el contenido de la propiedad sistemaHast
	* @param sistema
	* @return void
	*/
	function setSistemaHast($sCadena){
		$this->sistemaHast = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad visible
	* @return int(1)
	*/
	function getVisible(){
		return $this->visible;
	...
	/**
	* Fija el contenido de la propiedad visible
	* @param visible
	* @return void
	*/
	function setVisible($sCadena){
		$this->visible = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad visibleHast
	* @return int(1)
	*/
	function getVisibleHast(){
		return $this->visibleHast;
	}
	/**
	* Fija el contenido de la propiedad visibleHast
	* @param visible
	* @return void
	*/
	function setVisibleHast($sCadena){
		$this->visibleHast = $sCadena;
	}
	/**
...
}//Fin de la Clase Correos_literales
?>