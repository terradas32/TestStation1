...
class Procesos
{
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad procesoConfidencial
	* @return int(11)
	*/
	...
	/**
	* Fija el contenido de la propiedad procesoConfidencial
	* @param procesoConfidencial
	* @return void
	*/
	...
	*/
	...
	/**
	 * Devuelve el contenido de la propiedad fecEnvioProgramado
	 * @return int(11)
	 */
	function getFecEnvioProgramado(){
		return $this->fecEnvioProgramado;
	}
	/**
	 * Fija el contenido de la propiedad fecEnvioProgramado
	 * @param fecEnvioProgramado
	 * @return void
	 */
	function setFecEnvioProgramado($sCadena){
		$this->fecEnvioProgramado = $sCadena;
	}
	/**
