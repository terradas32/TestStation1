...
* los valores de la entidad de clase Usuarios_tipos.
**/
class Usuarios_tipos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idUsuarioTipo,descripcion,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Usuario Tipo,Descripción,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Usuarios_tipos
?>