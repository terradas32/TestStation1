...
* los valores de la entidad de clase Sec_factoresactitudinales.
**/
class Sec_factoresactitudinales
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"IDFACTOR,CODIGO,DESCRIPCION,IDCOMPETENCIA,IDTIPOPRUEBA,INTELIGENCIA,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id factor,Codigo,Descripci�n,Id competencia,Id tipoprueba,Inteligencia,Fec. alta,Fec. mod,Usu. alta,Usu. mod";
	}
...
}//Fin de la Clase Sec_factoresactitudinales
?>