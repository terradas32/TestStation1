...
* los valores de la entidad de clase Idiomas.
**/
class Idiomas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"codIdiomaIso2,nombre,pathImagen,orden,activoFront,activoBack,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Cód. Iso2,Nombre,Imagen,Orden,Activo en el Front,Activo en el Back,Fec. Alta,Fec. Mod,Usu. Alta,Usu. Mod";
	}
	...
	* @return void
	*/
	function setPathImagen($sCadena){
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad activoFront
	* @return varchar(2)
	*/
	function getActivoFront(){
		return $this->activoFront;
	}
	/**
	* Fija el contenido de la propiedad activoFront
	* @param activoFront
	* @return void
	*/
	function setActivoFront($sCadena){
		$this->activoFront = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad activoBack
	* @return varchar(2)
	*/
	function getActivoBack(){
		return $this->activoBack;
	}
	/**
	* Fija el contenido de la propiedad activoBack
	* @param activoBack
	* @return void
	*/
	function setActivoBack($sCadena){
		$this->activoBack = $sCadena;
	}
	/**
