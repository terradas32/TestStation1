...
* los valores de la entidad de clase Sec_ponderaciones.
**/
 class Sec_ponderaciones
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"IDPERFILPUESTO,IDCOMPETENCIA,DESCPERFILPUESTO,CODCOMPETENCIA,DESCCOMPETENCIA,PONDERACION,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id perfilpruesto,Id competencia,Desc. Perfilpuesto,Cod. Competencia,Desc. Competencia,Ponderaci�n,Fec. alta,Fec. mod,Usu. alta,Usu. mod";
	}
	...
	* @return void
	*/
	function setIDTIPOPRUEBAAHast($sCadena){
...
}//Fin de la Clase Sec_ponderaciones
?>