...
* los valores de la entidad de clase Sec_respuestascompetencias.
**/
 class Sec_respuestascompetencias
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"IDRESPUESTA,IDCANDIDATO,IDPROCESO,IDCOMPETENCIA,CODCOMPETENCIA,DESCCOMPETENCIA,PUNTUACIONDIRECTA,PUNTSOBRE10,MEDIAPONDERADA,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id respuesta,Id candidato,Id proceso,Id competencia,Codcompetencia,Desccompetencia,Puntuaciondirecta,Puntsobre10,Mediaponderada,Fec. alta,Fec. mod,Usu. alta,Usu. mod";
	}
...
}//Fin de la Clase Sec_respuestascompetencias
