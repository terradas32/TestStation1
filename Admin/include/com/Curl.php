	...
	**/
	function __construct($sUrl)
	{
		...
		if (!function_exists('curl_init')) {
			echo "<br />NO ESTÁ INTALADA LA LIBRERIA <b>CURL.</b><br />";
			exit;
		}
		$options = array(
		...
		$this->headers = @get_headers($sUrl);
	}
	/**
	* Devuelve el array con las headers
	* @return Array	String q contiene los datos
	**/	
	function getHeaders(){
		return $this->headers;
	}
