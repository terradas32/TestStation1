...
* los valores de la entidad de clase Notificaciones_tipos.
**/
class Notificaciones_tipos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idTipoNotificacion,nombre,fecAlta,fecMod";
		$this->DESCListaExcel	=	"Id,Nombre,Fecha de Alta,Fecha de Modificación";
	}
...
}//Fin de la Clase Notificaciones_tipos
?>