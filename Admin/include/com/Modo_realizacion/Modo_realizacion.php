...
* los valores de la entidad de clase Modo_realizacion.
**/
class Modo_realizacion
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idModoRealizacion,codIdiomaIso2,descripcion,observaciones,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Modo Realización,Idioma,Descripción,Observaciones,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Modo_realizacion
?>