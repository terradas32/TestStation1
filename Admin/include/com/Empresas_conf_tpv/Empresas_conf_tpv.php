...
class Empresas_conf_tpv
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idTipoTpv,BUSINESS_NAME,BUSINESS_CODE,BUSINESS_PASS,BUSINESS_COINC,fecAlta,fecMod";
		$this->DESCListaExcel	=	"Empresa,Tipo Tpv,BUSINESS NAME,BUSINESS CODE,BUSINESS PASS,BUSINESS COINC,Fecha de Alta,Fecha de Modificación";
	}
