...
//				$sql.= "cabecera='imgPruebas/16/es/cabecera.jpg', ";
	...
	*/
	...
	function cargaOpciones_ItemsESP(){
		...
		$DescriptorFichero = fopen(constant("DIR_FS_DOCUMENT_ROOT") . "sqls/insertsOpcionesVipsEsp.sql","r");
		$content=""; 
		while(!feof($DescriptorFichero)){ 
	    	$content .= fgets($DescriptorFichero,4096);
		}
		...
		$DescriptorFichero = fopen(constant("DIR_FS_DOCUMENT_ROOT") . "sqls/itemsVipsEsp.sql","r");
		$content=""; 
		while(!feof($DescriptorFichero)){ 
	    	$content .= fgets($DescriptorFichero,4096);
		}
