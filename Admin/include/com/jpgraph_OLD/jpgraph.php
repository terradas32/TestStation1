...
class Text {
    ...
    var $font_family=FF_FONT1,$font_style="",$font_size=12;
...
// PUBLIC METHODS
    ...
    // Specify font
    function SetFont($aFamily,$aStyle="",$aSize=10) {
    	global $FS_NORMAL;
    	if (empty($aStyle))
    		$aStyle=$FS_NORMAL;
...
class SuperScriptText extends Text {
    ...
    function SetSuperFont($aFontFam,$aFontStyle="",$aFontSize=8) {
		global $FS_NORMAL;
    	if (empty($aFontStyle))
    		$aFontStyle=$FS_NORMAL;
...
class Axis {
    ...
    var $font_family=FF_FONT1,$font_style="",$font_size=12,$label_angle=0;
...
class ImageJP {
    ...
    var $obs_list=array();
    var $font_size=12,$font_family=FF_FONT1, $font_style="";
    var $font_file='';
...
//===================================================
class RotImage extends ImageJP {
    var $m=array();
    var $a=0;
...
class ImgStreamCache {
    ...
    //---------------
    // CONSTRUCTOR
    function ImgStreamCache(&$aImg, $aCacheDir="") {
    global $CACHE_DIR;
    $aCacheDir = $CACHE_DIR;
	$this->img = &$aImg;
...
// PUBLIC METHODS
	...
	foreach($this->txtcol as $p) {
		...
		if( $p[3] < -100 ) {
		    ...
		    $prect->SetPos(new RectangleJP($x1,$ym,$boxsize,$boxsize));
		    $prect->Stroke($aImg);
		    $prect=null;
		}
		else {
...
class DisplayValue {
    ...
    function SetFont($aFontFamily,$aFontStyle="",$aFontSize=10) {
    	global $FS_NORMAL;
    	if(empty($aFontStyle))
    		$aFontStyle=$FS_NORMAL;
	$this->ff=$aFontFamily;
