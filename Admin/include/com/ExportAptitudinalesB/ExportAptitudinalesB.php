...
* los valores de la entidad de clase ExportAptitudinalesB.
**/
class ExportAptitudinalesB
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idSigno,signo,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Signo,Signo,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}


	/**
	* Devuelve el contenido de la propiedad idSigno
	* @return int(11)
	*/
	function getIdSigno(){
		return $this->idSigno;
	...
	/**
	* Fija el contenido de la propiedad idSigno
	* @param idSigno
	* @return void
	*/
	function setIdSigno($sCadena){
		$this->idSigno = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idSignoHast
	* @return int(11)
	*/
	function getIdSignoHast(){
		return $this->idSignoHast;
	}
	/**
	* Fija el contenido de la propiedad idSignoHast
	* @param idSigno
	* @return void
	*/
	function setIdSignoHast($sCadena){
		$this->idSignoHast = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad signo
	* @return varchar(255)
	*/
	function getSigno(){
		return $this->signo;
	...
	/**
	* Fija el contenido de la propiedad signo
	* @param signo
	* @return void
	*/
	function setSigno($sCadena){
		$this->signo = $sCadena;
	}
	/**
...
}//Fin de la Clase ExportAptitudinalesB
?>
