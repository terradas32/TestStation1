...
class Consumos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idProceso,idCandidato,codIdiomaIso2,idPrueba,codIdiomaInforme,idTipoInforme,idBaremo,nomEmpresa,nomProceso,nomCandidato,apellido1,apellido2,dni,mail,codIso2PaisProcedencia,nomPrueba,nomInforme,nomBaremo,concepto,unidades,idSexo, descSexo,idEdad,descEdad,idFormacion,descFormacion,idNivel,descNivel,idArea,descArea,codIso2PaisProcedencia,descuentaMatriz,nomDescuentaMatriz,fecAlta,fecMod";
		$this->DESCListaExcel	=	"Empresa,Proceso,Candidato,Idioma Prueba,Prueba,Idioma Informe,Informe,Baremo,Nombre Empresa,Nombre Proceso,Nombre Candidato,Apellido1,Apellido2,DNI/ N. ID,Mail,Pais Procedencia,Prueba,Informe,Baremo,Concepto,Unidades,idSexo, Sexo,idEdad,Edad,idFormacion,Formacion,idNivel,Nivel,idArea,Area,País Procedencia,Id Empresa descuenta, Empresa a la que se le descuenta,Fecha de Alta,Fecha de Modificación";
	}
