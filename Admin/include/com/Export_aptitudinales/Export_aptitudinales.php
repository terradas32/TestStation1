...
* los valores de la entidad de clase Export_aptitudinales.
**/
class Export_aptitudinales
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,descEmpresa,idProceso,descProceso,idCandidato,nombre,apellido1,apellido2,email,dni,idPrueba,descPrueba,fecPrueba,idBaremo,descBaremo,fecAltaProceso,correctas,contestadas,percentil,ir,ip,por,estilo,idSexo,descSexo,idEdad,descEdad,idFormacion,descFormacion,idNivel,descNivel,idArea,descArea,codIso2PaisProcedencia";
		$this->DESCListaExcel	=	"Id Empresa,Empresa,Id Proceso,Proceso,Id Candidato,Nombre,Apellido1,Apellido2,Email,DNI / N. ID,Id Prueba,Prueba,Fecha de Prueba,Id Baremo,Baremo,Fecha de Alta Proceso,Correctas,Contestadas,Percentil,Ir,Ip,Por,Estilo,Id Sexo,Sexo,Id Edad,Edad,IdFormación,Formación,Id Nivel,Nivel,Id Area,Area,País Procedencia";
	}
...
}//Fin de la Clase Export_aptitudinales
?>