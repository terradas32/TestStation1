...
* los valores de la entidad de clase Emk_charsets.
**/
class Emk_charsets
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"codigo,descripcion,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Codigo,Descripción,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
