...
* los valores de la entidad de clase Empresas_pruebas.
**/
class Empresas_pruebas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,codIdiomaIso2,idPrueba,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Empresa,Idioma,Prueba,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Empresas_pruebas
?>