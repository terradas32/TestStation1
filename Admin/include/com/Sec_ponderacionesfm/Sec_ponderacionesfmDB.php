...
* la tabla sec_ponderaciones_fm
**/
class Sec_ponderacionesfmDB 
{
	...
	***********************************************************************/
	function insertar($cEntidad)
	{
		...
		$iCont = 0;
		$sql = "SELECT COUNT(IDPERFILPUESTO) AS Max FROM sec_ponderaciones_fm ";
		$sql .= "WHERE ";
		...
		$sql = "INSERT INTO sec_ponderaciones_fm (";
		$sql .= "IDPERFILPUESTO" . ",";
		$sql .= "IDCOMPETENCIA" . ",";
		$sql .= "IDTIPOPRUEBA" . ",";
	...
	*****************************************************************************************/
	function getSiguienteId($cEntidad)
	{
		...
		$sql = "SELECT MAX() AS Max FROM sec_ponderaciones_fm ";
	...
	************************************************************************/
	function modificar($cEntidad)
	{
		...
		$sql = "UPDATE sec_ponderaciones_fm SET ";
	...
	************************************************************************/
	function borrar($cEntidad)
	{
		...
		$retorno			= true;
			...
			$sql ="DELETE FROM sec_ponderaciones_fm ";
			$sql .=" WHERE ";
	...
	*************************************************************************/
	function consultar($cEntidad)
	{
		...
		$sql = "SELECT IDPERFILPUESTO,IDCOMPETENCIA,IDTIPOPRUEBA,DESCPERFILPUESTO,CODCOMPETENCIA,DESCCOMPETENCIA,PONDERACION," . "fecAlta" . "," . "fecMod" . ",usuAlta,usuMod FROM sec_ponderaciones_fm WHERE ";
		$sql .="IDPERFILPUESTO=" . $aux->qstr($cEntidad->getIDPERFILPUESTO(), false) . " AND IDCOMPETENCIA=" . $aux->qstr($cEntidad->getIDCOMPETENCIA(), false) . " AND IDTIPOPRUEBA=" . $aux->qstr($cEntidad->getIDTIPOPRUEBA(), false) . " ";
		$rs = $aux->Execute($sql);
		if ($rs){
			while ($arr = $rs->FetchRow()){
	...
	*************************************************************************/
	function readLista($cEntidad) 
	{
		...
		$sql="";
		$and = false;
		$sql.="SELECT * FROM sec_ponderaciones_fm ";
...
}//Fin de la Clase Sec_ponderacionesfmDB
?>