...
* los valores de la entidad de clase Sec_ponderacionesdimensiones.
**/
class Sec_ponderacionesdimensiones
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"IDPERFILPUESTO,IDCOMPETENCIA,IDTIPOPRUEBA,IDDIMENSION,DESCPERFILPUESTO,CODCOMPETENCIA,DESCCOMPETENCIA,CODDIMENSION,DESCDIMENSION,PONDERACION,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id perfilpruesto,Id competencia,Id tipoprueba,Id dimensi�n,Descperfilpuesto,Codcompetencia,Desccompetencia,Coddimensi�n,Descdimensi�n,Ponderaci�n,Fec. alta,Fec. mod,Usu. alta,Usu. mod";
	}
...
}//Fin de la Clase Sec_ponderacionesdimensiones
?>