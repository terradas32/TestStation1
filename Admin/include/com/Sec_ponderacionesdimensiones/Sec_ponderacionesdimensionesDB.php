...
* la tabla sec_ponderaciones_dimensiones
**/
class Sec_ponderacionesdimensionesDB 
{
	...
	***********************************************************************/
	function insertar($cEntidad) 
	{
		...
		$iCont = 0;
		$sql  = "SELECT COUNT(IDPERFILPUESTO) AS Max FROM sec_ponderaciones_dimensiones ";
		$sql .= "WHERE ";
		...
		$sql = "INSERT INTO sec_ponderaciones_dimensiones (";
		$sql .= "IDPERFILPUESTO" . ",";
		$sql .= "IDCOMPETENCIA" . ",";
		$sql .= "IDTIPOPRUEBA" . ",";
		$sql .= "IDDIMENSION" . ",";
		...
		$sql .= $aux->qstr($cEntidad->getPONDERACION(), false) . ",";
	...
	*****************************************************************************************/
	function getSiguienteId($cEntidad) 
	{
		...
		$sql  = "SELECT MAX() AS Max FROM sec_ponderaciones_dimensiones ";
		$sql  .=" WHERE IDPERFILPUESTO=" . $aux->qstr($cEntidad->getIDPERFILPUESTO(), false) . " AND IDCOMPETENCIA=" . $aux->qstr($cEntidad->getIDCOMPETENCIA(), false) . " AND IDTIPOPRUEBA=" . $aux->qstr($cEntidad->getIDTIPOPRUEBA(), false) . " AND IDDIMENSION=" . $aux->qstr($cEntidad->getIDDIMENSION(), false) . " ";
		$newId=0;
		$rs = $aux->Execute($sql);
		if ($rs){
			while ($arr = $rs->FetchRow()){
	...
	************************************************************************/
	function modificar($cEntidad)
	{
		...
		$sql = "UPDATE sec_ponderaciones_dimensiones SET ";
	...
	************************************************************************/
	function borrar($cEntidad)
	{
		...
		$retorno			= true;
			...
			$sql  ="DELETE FROM sec_ponderaciones_dimensiones ";
			$sql  .=" WHERE ";
	...
	*************************************************************************/
	function readEntidad($cEntidad) 
	{
		...
		$sql = "SELECT IDPERFILPUESTO,IDCOMPETENCIA,IDTIPOPRUEBA,IDDIMENSION,DESCPERFILPUESTO,CODCOMPETENCIA,DESCCOMPETENCIA,CODDIMENSION,DESCDIMENSION,PONDERACION," . "fecAlta" . "," . "fecMod" . ",usuAlta,usuMod FROM sec_ponderaciones_dimensiones WHERE ";
		$sql  .="IDPERFILPUESTO=" . $aux->qstr($cEntidad->getIDPERFILPUESTO(), false) . " AND IDCOMPETENCIA=" . $aux->qstr($cEntidad->getIDCOMPETENCIA(), false) . " AND IDTIPOPRUEBA=" . $aux->qstr($cEntidad->getIDTIPOPRUEBA(), false) . " AND IDDIMENSION=" . $aux->qstr($cEntidad->getIDDIMENSION(), false) . " ";
	...
	*************************************************************************/
	function readLista($cEntidad)
	{
		...
		$sql="";
		$and = false;
		$sql.="SELECT * FROM sec_ponderaciones_dimensiones ";
...
}//Fin de la Clase Sec_ponderacionesdimensionesDB
?>