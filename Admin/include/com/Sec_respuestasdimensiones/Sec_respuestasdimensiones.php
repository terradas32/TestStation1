...
* los valores de la entidad de clase Sec_respuestasdimensiones.
**/
class Sec_respuestasdimensiones
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"IDRESPUESTA,IDCANDIDATO,IDPROCESO,IDCOMPETENCIA,CODCOMPETENCIA,IDDIMENSION,CODDIMENSION,DESCDIMENSION,PUNTUACIONDIRECTA,PUNTSOBRE10,MEDIAPONDERADA,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id respuesta,Id candidato,Id proceso,Id competencia,Codcompetencia,Id dimensi�n,Coddimensi�n,Descdimensi�n,Puntuaciondirecta,Puntsobre10,Mediaponderada,Fec. alta,Fec. mod,Usu. alta,Usu. mod";
	}
...
}//Fin de la Clase Sec_respuestasdimensiones
?>