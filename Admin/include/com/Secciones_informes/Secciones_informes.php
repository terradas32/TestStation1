...
* los valores de la entidad de clase Secciones_informes.
**/
class Secciones_informes
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idSeccion,idTipoInforme,nombre,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"IdSección,Id Tipo Informe,Nombre,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
...
}//Fin de la Clase Secciones_informes
?>