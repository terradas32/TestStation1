...
* los valores de la entidad de clase Opciones.
**/
class Opciones
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"codIdiomaIso2,idPrueba,idItem,idOpcion,descripcion,pathOpcion,codigo,bajaLog,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Idioma,Prueba,Item,Id Opción,Descripción,pathOpcion,Codigo,Baja Log,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad pathOpcion
	* @return varchar(255)
	*/
	function getPathOpcion(){
		return $this->pathOpcion;
	}
	/**
	* Fija el contenido de la propiedad pathOpcion
	* @param pathOpcion
	* @return void
	*/
	function setPathOpcion($sCadena){
		$this->pathOpcion = $sCadena;
	}
	/**
