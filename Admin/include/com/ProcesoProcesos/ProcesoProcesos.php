...
class ProcesoProcesos
{
	...
	**/
	function __construct()
	{
		...
		$this->DESCListaExcel	=	"Id Proceso,Empresa,Nombre,Descripción,Observaciones,Fecha de Inicio,Fecha de Fin,Modo Realización,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
