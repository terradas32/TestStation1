...
* los valores de la entidad de clase Textos_secciones.
**/
class Textos_secciones
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"codIdiomaIso2,idPrueba,idTipoInforme,idSeccion,texto,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Idioma,Prueba,Tipo Informe,Sección,Texto,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad idSeccion
	* @return int(11)
	*/
	...
	/**
	* Fija el contenido de la propiedad idSeccion
	* @param idSeccion
	* @return void
	*/
	function setIdSeccion($sCadena){
		$this->idSeccion = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idSeccionHast
	* @return int(11)
	*/
	function getIdSeccionHast(){
		return $this->idSeccionHast;
	}
	/**
	* Fija el contenido de la propiedad idSeccionHast
	* @param idSeccion
	* @return void
	*/
	function setIdSeccionHast($sCadena){
		$this->idSeccionHast = $sCadena;
	}
	/**
...
}//Fin de la Clase Textos_secciones
?>