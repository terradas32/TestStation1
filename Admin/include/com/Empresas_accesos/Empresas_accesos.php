...
* los valores de la entidad de clase Empresas_accesos.
**/
class Empresas_accesos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idAcceso,IP,login,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Acceso,IP,Login,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}


	/**
	* Devuelve el contenido de la propiedad idAcceso
	* @return int(11)
	*/
	...
	/**
	* Fija el contenido de la propiedad idAcceso
	* @param idAcceso
	* @return void
	*/
	function setIdAcceso($sCadena){
		$this->idAcceso = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idAccesoHast
	* @return int(11)
	*/
	function getIdAccesoHast(){
		return $this->idAccesoHast;
	}
	/**
	* Fija el contenido de la propiedad idAccesoHast
	* @param idAcceso
	* @return void
	*/
	function setIdAccesoHast($sCadena){
		$this->idAccesoHast = $sCadena;
	}
	/**
...
}//Fin de la Clase Empresas_accesos
?>