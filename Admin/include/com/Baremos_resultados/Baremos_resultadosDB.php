...
* la tabla baremos_resultados
**/
class Baremos_resultadosDB
{
	...
	***********************************************************************/
	function insertar($cEntidad)
	{
		...
		$sql = "INSERT INTO baremos_resultados (";
		$sql .= "idResultado" . ",";
		$sql .= "idBaremo" . ",";
		$sql .= "idPrueba" . ",";
		$sql .= "idBloque" . ",";
		...
		$sql .= $aux->qstr($cEntidad->getIdBloque(), false) . ",";
		$sql .= $aux->qstr($cEntidad->getIdEscala(), false) . ",";
	...
	*****************************************************************************************/
	function getSiguienteId($cEntidad)
	{
		...
		$sql  = "SELECT MAX(idResultado) AS Max FROM baremos_resultados ";
		$sql  .="";
		$rs = $aux->Execute($sql);
		$newId=0;
		if ($rs){
	...
	************************************************************************/
	function modificar($cEntidad)
	{
		...
		$sql = "UPDATE baremos_resultados SET ";
	...
	*************************************************************************/
	function readEntidad($cEntidad)
	{
		...
		$sql = "SELECT *  FROM baremos_resultados WHERE ";
		$sql  .="idResultado=" . $aux->qstr($cEntidad->getIdResultado(), false) . " ";
		$rs = $aux->Execute($sql);
		if ($rs){
			while ($arr = $rs->FetchRow()){
					...
					$cEntidad->setIdBloque($arr['idBloque']);
					$cEntidad->setIdEscala($arr['idEscala']);					
