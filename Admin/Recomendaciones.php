...
include_once ('include/conexion.php');
	...
	$cEntidadDB	= new RecomendacionesDB($conn);  // Entidad DB
	$cEntidad	= new Recomendaciones();  // Entidad
	...
	switch ($_POST['MODO'])
	{
		case constant("MNT_ALTA"):
			...
			?><script language="javascript" type="text/javascript">alert("<?php echo constant("CONF_ALTA") . $newId;?>\n<?php echo $cEntidadDB->ver_errores();?>");</script><?php
				...
				{
					if (!empty($_POST['recomendaciones_next_page']) && $_POST['recomendaciones_next_page'] > 1 ){
						$bInit=false;
					...
					$pager = new ADODB_Pager($conn,$sql,'recomendaciones');
					...
					$lista=$pager->getRS();
					include('Template/Recomendaciones/mntrecomendacionesl.php');
				}else{
					$cEntidad	= new Recomendaciones();  // inicializamos la Entidad
					$_POST['MODO']    = constant("MNT_ALTA");
					include('Template/Recomendaciones/mntrecomendacionesa.php');
				}
			}else{
		...
		case constant("MNT_BUSCAR"):
			...
			include('Template/Recomendaciones/mntrecomendaciones.php');
			break;
	...
	*/
	function readEntidad($cEntidad){
		...
		global $cUtilidades;
		$cEntidad->setIdRecomendacion((isset($_POST["fIdRecomendacion"])) ? $_POST["fIdRecomendacion"] : "");
		$cEntidad->setCodIdiomaIso2((isset($_POST["fCodIdiomaIso2"])) ? $_POST["fCodIdiomaIso2"] : "");
		$cEntidad->setTitulo((isset($_POST["fTitulo"])) ? $_POST["fTitulo"] : "");
	...
	*/
	function readLista($cEntidad){
		global $conn;
		global $cUtilidades;
		$cEntidad->setIdRecomendacion((isset($_POST["LSTIdRecomendacion"]) && $_POST["LSTIdRecomendacion"] != "") ? $_POST["LSTIdRecomendacion"] : "");	$cEntidad->setBusqueda(constant("STR_ID"), (isset($_POST["LSTIdRecomendacion"]) && $_POST["LSTIdRecomendacion"] != "" ) ? $_POST["LSTIdRecomendacion"] : "");
		$cEntidad->setIdRecomendacionHast((isset($_POST["LSTIdRecomendacionHast"]) && $_POST["LSTIdRecomendacionHast"] != "") ? $_POST["LSTIdRecomendacionHast"] : "");	$cEntidad->setBusqueda(constant("STR_ID") . " " . constant("STR_HASTA"), (isset($_POST["LSTIdRecomendacionHast"]) && $_POST["LSTIdRecomendacionHast"] != "" ) ? $_POST["LSTIdRecomendacionHast"] : "");
		...
		$cEntidad->setTitulo((isset($_POST["LSTTitulo"]) && $_POST["LSTTitulo"] != "") ? $_POST["LSTTitulo"] : "");	$cEntidad->setBusqueda(constant("STR_TITULO"), (isset($_POST["LSTTitulo"]) && $_POST["LSTTitulo"] != "" ) ? $_POST["LSTTitulo"] : "");
