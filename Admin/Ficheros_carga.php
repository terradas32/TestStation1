...
include_once ('include/conexion.php');
	...
	$cEntidadDB	= new Ficheros_cargaDB($conn);  // Entidad DB
	$cEntidad	= new Ficheros_carga();  // Entidad
	...
	switch ($_POST['MODO'])
	{
		case constant("MNT_ALTA"):
			...
			?><script language="javascript" type="text/javascript">alert("<?php echo constant("CONF_ALTA") . $newId;?>\n<?php echo $cEntidadDB->ver_errores();?>");</script><?php 
				...
				{
					if (!empty($_POST['ficheros_carga_next_page']) && $_POST['ficheros_carga_next_page'] > 1 ){
						$bInit=false;
					...
					$pager = new ADODB_Pager($conn,$sql,'ficheros_carga');
					...
					$lista=$pager->getRS();
					include('Template/Ficheros_carga/mntficheros_cargal.php');
				}else{
					$cEntidad	= new Ficheros_carga();  // inicializamos la Entidad
					$_POST['MODO']    = constant("MNT_ALTA");
					include('Template/Ficheros_carga/mntficheros_cargaa.php');
				}
			}else{
		...
		case constant("MNT_BUSCAR"):
			...
			include('Template/Ficheros_carga/mntficheros_carga.php');
			break;
	...
	*/
	function readEntidad($cEntidad){
		...
		global $cUtilidades;
		$cEntidad->setIdFichero((isset($_POST["fIdFichero"])) ? $_POST["fIdFichero"] : "");
		$cEntidad->setFichero((isset($_POST["fFichero"])) ? $_POST["fFichero"] : "");
		$cEntidad->setTipo((isset($_POST["fTipo"])) ? $_POST["fTipo"] : "");
	...
	*/
	function readLista($cEntidad){
		global $conn;
		global $cUtilidades;
		$cEntidad->setIdFichero((isset($_POST["LSTIdFichero"]) && $_POST["LSTIdFichero"] != "") ? $_POST["LSTIdFichero"] : "");	$cEntidad->setBusqueda(constant("STR_ID"), (isset($_POST["LSTIdFichero"]) && $_POST["LSTIdFichero"] != "" ) ? $_POST["LSTIdFichero"] : "");
		$cEntidad->setIdFicheroHast((isset($_POST["LSTIdFicheroHast"]) && $_POST["LSTIdFicheroHast"] != "") ? $_POST["LSTIdFicheroHast"] : "");	$cEntidad->setBusqueda(constant("STR_ID") . " " . constant("STR_HASTA"), (isset($_POST["LSTIdFicheroHast"]) && $_POST["LSTIdFicheroHast"] != "" ) ? $_POST["LSTIdFicheroHast"] : "");
		...
		$cEntidad->setTipo((isset($_POST["LSTTipo"]) && $_POST["LSTTipo"] != "") ? $_POST["LSTTipo"] : "");	$cEntidad->setBusqueda(constant("STR_TIPO"), (isset($_POST["LSTTipo"]) && $_POST["LSTTipo"] != "" ) ? $_POST["LSTTipo"] : "");
