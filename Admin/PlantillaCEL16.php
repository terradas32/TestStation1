...
//				echo $cmdPost;exit;
	...
	*/
	function readEntidad($cEntidad){
		...
		$cProceso_baremos->setUsuAlta($_cEntidadUsuarioTK->getIdUsuario());
		$cProceso_baremos->setUsuMod($_cEntidadUsuarioTK->getIdUsuario());
		...
		$cRespuestas_pruebas->setUsuAlta($_cEntidadUsuarioTK->getIdUsuario());
		$cRespuestas_pruebas->setUsuMod($_cEntidadUsuarioTK->getIdUsuario());
