...
*/
		...
		//Parte común
		$sDESCListaExcel	= "CUENTA,PROCESO,PARTICIPANTE,APELLIDO1,APELLIDO2,EMAIL,FEC_PRUEBA,FEC_ALTA_PROCESO";
		$PKListaExcel		= "descEmpresa,descProceso,empleado,apellido1,apellido2,email,fecPrueba,fecAltaProceso";

		//Parte variable
		$apruebas = explode(",", $pruebas);
//		echo $pruebas;exit;
		$sDESCListaExcel	.= ",PRUEBA,CORRECTAS,CONTESTADAS,PERCENTIL,INDICE RAPIDEZ,INDICE PRECISION,PRODUCTO RENDIMIENTO";
		$PKListaExcel		.= ",prueba,correctas,contestadas,percentil,ir,ip,por";
