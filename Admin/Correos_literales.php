...
include_once ('include/conexion.php');
	...
	$cEntidadDB	= new Correos_literalesDB($conn);  // Entidad DB
	$cEntidad	= new Correos_literales();  // Entidad
	...
	switch ($_POST['MODO'])
	{
		case constant("MNT_ALTA"):
			...
			?><script language="javascript" type="text/javascript">alert("<?php echo constant("CONF_ALTA") . $newId;?>\n<?php echo $cEntidadDB->ver_errores();?>");</script><?php 
				...
				{
					if (!empty($_POST['correos_literales_next_page']) && $_POST['correos_literales_next_page'] > 1 ){
						$bInit=false;
					...
					$pager = new ADODB_Pager($conn,$sql,'correos_literales');
					...
					$lista=$pager->getRS();
					include('Template/Correos_literales/mntcorreos_literalesl.php');
				}else{
					$cEntidad	= new Correos_literales();  // inicializamos la Entidad
					$_POST['MODO']    = constant("MNT_ALTA");
					include('Template/Correos_literales/mntcorreos_literalesa.php');
				}
			}else{
		...
		case constant("MNT_BUSCAR"):
			...
			include('Template/Correos_literales/mntcorreos_literales.php');
			break;
	...
	*/
	function readEntidad($cEntidad){
		...
		global $cUtilidades;
		$cEntidad->setIdLiteral((isset($_POST["fIdLiteral"])) ? $_POST["fIdLiteral"] : "");
		$cEntidad->setCodIdiomaIso2((isset($_POST["fCodIdiomaIso2"])) ? $_POST["fCodIdiomaIso2"] : "");
		$cEntidad->setLiteral((isset($_POST["fLiteral"])) ? $_POST["fLiteral"] : "");
		$cEntidad->setDescripcion((isset($_POST["fDescripcion"])) ? $_POST["fDescripcion"] : "");
		$cEntidad->setSistema((isset($_POST["fSistema"])) ? $_POST["fSistema"] : "");
		$cEntidad->setVisible((isset($_POST["fVisible"])) ? $_POST["fVisible"] : "");
	...
	*/
	function readLista($cEntidad){
		global $conn;
		global $cUtilidades;
		$cEntidad->setIdLiteral((isset($_POST["LSTIdLiteral"]) && $_POST["LSTIdLiteral"] != "") ? $_POST["LSTIdLiteral"] : "");	$cEntidad->setBusqueda(constant("STR_ID"), (isset($_POST["LSTIdLiteral"]) && $_POST["LSTIdLiteral"] != "" ) ? $_POST["LSTIdLiteral"] : "");
		$cEntidad->setIdLiteralHast((isset($_POST["LSTIdLiteralHast"]) && $_POST["LSTIdLiteralHast"] != "") ? $_POST["LSTIdLiteralHast"] : "");	$cEntidad->setBusqueda(constant("STR_ID") . " " . constant("STR_HASTA"), (isset($_POST["LSTIdLiteralHast"]) && $_POST["LSTIdLiteralHast"] != "" ) ? $_POST["LSTIdLiteralHast"] : "");
		...
		$cEntidad->setLiteral((isset($_POST["LSTLiteral"]) && $_POST["LSTLiteral"] != "") ? $_POST["LSTLiteral"] : "");	$cEntidad->setBusqueda(constant("STR_LITERAL"), (isset($_POST["LSTLiteral"]) && $_POST["LSTLiteral"] != "" ) ? $_POST["LSTLiteral"] : "");
		...
		$cEntidad->setSistema((isset($_POST["LSTSistema"]) && $_POST["LSTSistema"] != "") ? $_POST["LSTSistema"] : "");	$cEntidad->setBusqueda(constant("STR_SISTEMA"), (isset($_POST["LSTSistema"]) && $_POST["LSTSistema"] != "" ) ? $_POST["LSTSistema"] : "");
		$cEntidad->setSistemaHast((isset($_POST["LSTSistemaHast"]) && $_POST["LSTSistemaHast"] != "") ? $_POST["LSTSistemaHast"] : "");	$cEntidad->setBusqueda(constant("STR_SISTEMA") . " " . constant("STR_HASTA"), (isset($_POST["LSTSistemaHast"]) && $_POST["LSTSistemaHast"] != "" ) ? $_POST["LSTSistemaHast"] : "");
		$cEntidad->setVisible((isset($_POST["LSTVisible"]) && $_POST["LSTVisible"] != "") ? $_POST["LSTVisible"] : "");	$cEntidad->setBusqueda(constant("STR_VISIBLE"), (isset($_POST["LSTVisible"]) && $_POST["LSTVisible"] != "" ) ? $_POST["LSTVisible"] : "");
		$cEntidad->setVisibleHast((isset($_POST["LSTVisibleHast"]) && $_POST["LSTVisibleHast"] != "") ? $_POST["LSTVisibleHast"] : "");	$cEntidad->setBusqueda(constant("STR_VISIBLE") . " " . constant("STR_HASTA"), (isset($_POST["LSTVisibleHast"]) && $_POST["LSTVisibleHast"] != "" ) ? $_POST["LSTVisibleHast"] : "");
