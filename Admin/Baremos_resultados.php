...
include_once ('include/conexion.php');
	...
	$cEntidadDB	= new Baremos_resultadosDB($conn);  // Entidad DB
	$cEntidad	= new Baremos_resultados();  // Entidad
	...
	switch ($_POST['MODO'])
	{
		case constant("MNT_ALTA"):
			...
			?><script language="javascript" type="text/javascript">alert("<?php echo constant("CONF_ALTA") . $newId;?>\n<?php echo $cEntidadDB->ver_errores();?>");</script><?php 
				...
				{
					if (!empty($_POST['baremos_resultados_next_page']) && $_POST['baremos_resultados_next_page'] > 1 ){
						$bInit=false;
					...
					$pager = new ADODB_Pager($conn,$sql,'baremos_resultados');
					...
					$lista=$pager->getRS();
					include('Template/Baremos_resultados/mntbaremos_resultadosl.php');
				}else{
					$cEntidad	= new Baremos_resultados();  // inicializamos la Entidad
					$_POST['MODO']    = constant("MNT_ALTA");
					include('Template/Baremos_resultados/mntbaremos_resultadosa.php');
				}
			}else{
		...
		case constant("MNT_BUSCAR"):
			...
			include('Template/Baremos_resultados/mntbaremos_resultados.php');
			break;
	...
	*/
	function readEntidad($cEntidad){
		...
		global $cUtilidades;
		$cEntidad->setIdResultado((isset($_POST["fIdResultado"])) ? $_POST["fIdResultado"] : "");
		$cEntidad->setIdBaremo((isset($_POST["fIdBaremo"])) ? $_POST["fIdBaremo"] : "");
		$cEntidad->setIdPrueba((isset($_POST["fIdPrueba"])) ? $_POST["fIdPrueba"] : "");
		$cEntidad->setPuntMin((isset($_POST["fPuntMin"])) ? $_POST["fPuntMin"] : "");
		$cEntidad->setPuntMax((isset($_POST["fPuntMax"])) ? $_POST["fPuntMax"] : "");
		$cEntidad->setPuntBaremada((isset($_POST["fPuntBaremada"])) ? $_POST["fPuntBaremada"] : "");
	...
	*/
	function readLista($cEntidad){
		global $conn;
		global $cUtilidades;
		$cEntidad->setIdResultado((isset($_POST["LSTIdResultado"]) && $_POST["LSTIdResultado"] != "") ? $_POST["LSTIdResultado"] : "");	$cEntidad->setBusqueda(constant("STR_ID_RESULTADO"), (isset($_POST["LSTIdResultado"]) && $_POST["LSTIdResultado"] != "" ) ? $_POST["LSTIdResultado"] : "");
		$cEntidad->setIdResultadoHast((isset($_POST["LSTIdResultadoHast"]) && $_POST["LSTIdResultadoHast"] != "") ? $_POST["LSTIdResultadoHast"] : "");	$cEntidad->setBusqueda(constant("STR_ID_RESULTADO") . " " . constant("STR_HASTA"), (isset($_POST["LSTIdResultadoHast"]) && $_POST["LSTIdResultadoHast"] != "" ) ? $_POST["LSTIdResultadoHast"] : "");
		global $comboBAREMOS;
		...
		$cEntidad->setPuntMin((isset($_POST["LSTPuntMin"]) && $_POST["LSTPuntMin"] != "") ? $_POST["LSTPuntMin"] : "");	$cEntidad->setBusqueda(constant("STR_PUNTUACION_MINIMA"), (isset($_POST["LSTPuntMin"]) && $_POST["LSTPuntMin"] != "" ) ? $_POST["LSTPuntMin"] : "");
		$cEntidad->setPuntMinHast((isset($_POST["LSTPuntMinHast"]) && $_POST["LSTPuntMinHast"] != "") ? $_POST["LSTPuntMinHast"] : "");	$cEntidad->setBusqueda(constant("STR_PUNTUACION_MINIMA") . " " . constant("STR_HASTA"), (isset($_POST["LSTPuntMinHast"]) && $_POST["LSTPuntMinHast"] != "" ) ? $_POST["LSTPuntMinHast"] : "");
		$cEntidad->setPuntMax((isset($_POST["LSTPuntMax"]) && $_POST["LSTPuntMax"] != "") ? $_POST["LSTPuntMax"] : "");	$cEntidad->setBusqueda(constant("STR_PUNTUACION_MAXIMA"), (isset($_POST["LSTPuntMax"]) && $_POST["LSTPuntMax"] != "" ) ? $_POST["LSTPuntMax"] : "");
		$cEntidad->setPuntMaxHast((isset($_POST["LSTPuntMaxHast"]) && $_POST["LSTPuntMaxHast"] != "") ? $_POST["LSTPuntMaxHast"] : "");	$cEntidad->setBusqueda(constant("STR_PUNTUACION_MAXIMA") . " " . constant("STR_HASTA"), (isset($_POST["LSTPuntMaxHast"]) && $_POST["LSTPuntMaxHast"] != "" ) ? $_POST["LSTPuntMaxHast"] : "");
		$cEntidad->setPuntBaremada((isset($_POST["LSTPuntBaremada"]) && $_POST["LSTPuntBaremada"] != "") ? $_POST["LSTPuntBaremada"] : "");	$cEntidad->setBusqueda(constant("STR_PUNTUACION_BAREMADA"), (isset($_POST["LSTPuntBaremada"]) && $_POST["LSTPuntBaremada"] != "" ) ? $_POST["LSTPuntBaremada"] : "");
		$cEntidad->setPuntBaremadaHast((isset($_POST["LSTPuntBaremadaHast"]) && $_POST["LSTPuntBaremadaHast"] != "") ? $_POST["LSTPuntBaremadaHast"] : "");	$cEntidad->setBusqueda(constant("STR_PUNTUACION_BAREMADA") . " " . constant("STR_HASTA"), (isset($_POST["LSTPuntBaremadaHast"]) && $_POST["LSTPuntBaremadaHast"] != "" ) ? $_POST["LSTPuntBaremadaHast"] : "");
