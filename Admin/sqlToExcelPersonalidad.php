		...
		if ($vCompetenciasCandidato->recordCount() > 0){
			while (!$vCompetenciasCandidato->EOF){
				...
				echo "<script>console.log(" . json_encode([
					'puntuacion'=>$vCompetenciasCandidato->fields['puntuacion'], 
					'idCompetencia'=>$vCompetenciasCandidato->fields['idCompetencia'], 
					'idTipoCompetencia'=>$vCompetenciasCandidato->fields['idTipoCompetencia'],
					'idCandidato'=>$vDatos->fields['idCandidato'],
					'idProceso'=>$vDatos->fields['idProceso'],
					'idEmpresa'=>$vDatos->fields['idEmpresa'],
					'idTipoInforme'=>$vDatos->fields['idTipoInforme']
				]) . ");</script>";
				//die();
				//var_dump(json_encode($vCompetenciasCandidato));
				//die();
