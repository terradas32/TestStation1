...
require '../vendor/autoload.php';// Import the IOFactory class
...
//	$DatosHeadCompetencias = getHTMLCompetencias($_IdPrueba);
	...
	/* Se sustituye el código comentado a partir entre las líneas 342 y 355
	   por una exportación con la librería phpspreadsheet
	   para evitar el aviso de excel al abrir el documento 
	   de error de concordancia entre formato y extensión.
	
	   Jairo López Jáñez - Xeridia S.L.
	   */
	
	
	// Lee el contenido del archivo XHTML
	$xhtmlContent = $buf . $DatosHeadInit . $datosHead . $datosComunes . $bufFin;
	...
	// Configura los encabezados para la descarga automática
	header('Content-Type: application/vnd.ms-excel');
	header('Content-Disposition: attachment;filename="tudocumento.xls"');
