	...
	switch ($sPaso)
	{
		case 1:
			...
			if ($rsRESPUESTAS_PRUEBAS->RecordCount() > 0 ){
				...
				$sMensaje .= '<script language="javascript" type="text/javascript">setTimeout(function(){enviar(); }, 11000);</script>';
			}else {
...
//		ini_set("max_execution_time","600");
			...
			while (!$rsRESPUESTAS_PRUEBAS->EOF)
			{
				...
				$sSQL .=", '" . $aRespuestas[3] . "', '" . $aRespuestas[4] . "', '" . $aRespuestas[5] . "', '" . addslashes($aRespuestas[6]) . "'";
				$sSQL .="),";
