...
include_once ('include/conexion.php');
	...
	$cEntidadDB	= new Ejemplos_ayudasDB($conn);  // Entidad DB
	$cEntidad	= new Ejemplos_ayudas();  // Entidad
	...
	switch ($_POST['MODO'])
	{
		case constant("MNT_ALTA"):
			...
			?><script language="javascript" type="text/javascript">alert("<?php echo constant("CONF_ALTA") . $newId;?>\n<?php echo $cEntidadDB->ver_errores();?>");</script><?php 
				...
				{
					if (!empty($_POST['ejemplos_ayudas_next_page']) && $_POST['ejemplos_ayudas_next_page'] > 1 ){
						$bInit=false;
					...
					$pager = new ADODB_Pager($conn,$sql,'ejemplos_ayudas');
					...
					$lista=$pager->getRS();
					include('Template/Ejemplos_ayudas/mntejemplos_ayudasl.php');
				}else{
					$cEntidad	= new Ejemplos_ayudas();  // inicializamos la Entidad
					$_POST['MODO']    = constant("MNT_ALTA");
					include('Template/Ejemplos_ayudas/mntejemplos_ayudasa.php');
				}
			}else{
		...
		case constant("MNT_BUSCAR"):
			...
			include('Template/Ejemplos_ayudas/mntejemplos_ayudas.php');
			break;
	...
	*/
	function readEntidad($cEntidad){
		...
		global $cUtilidades;
		$cEntidad->setIdAyuda((isset($_POST["fIdAyuda"])) ? $_POST["fIdAyuda"] : "");
	...
	*/
	function readLista($cEntidad){
		global $conn;
		global $cUtilidades;
		$cEntidad->setIdAyuda((isset($_POST["LSTIdAyuda"]) && $_POST["LSTIdAyuda"] != "") ? $_POST["LSTIdAyuda"] : "");	$cEntidad->setBusqueda(constant("STR_ID_AYUDA"), (isset($_POST["LSTIdAyuda"]) && $_POST["LSTIdAyuda"] != "" ) ? $_POST["LSTIdAyuda"] : "");
		$cEntidad->setIdAyudaHast((isset($_POST["LSTIdAyudaHast"]) && $_POST["LSTIdAyudaHast"] != "") ? $_POST["LSTIdAyudaHast"] : "");	$cEntidad->setBusqueda(constant("STR_ID_AYUDA") . " " . constant("STR_HASTA"), (isset($_POST["LSTIdAyudaHast"]) && $_POST["LSTIdAyudaHast"] != "" ) ? $_POST["LSTIdAyudaHast"] : "");
