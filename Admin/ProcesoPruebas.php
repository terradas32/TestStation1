...
include_once ('include/conexion.php');
	...
	$comboTIPOS_RAZONAMIENTOS	= new Combo($conn,"fIdTipoRazonamiento","idTipoRazonamiento","descripcion","Descripcion","tipos_razonamientos","",constant("SLC_OPCION"),"","","");
	$comboTIPOS_NIVELES	= new Combo($conn,"fIdTipoNivel","idTipoNivel","descripcion","Descripcion","tipos_niveles","",constant("SLC_OPCION"),"","","");
	...
	*/
	function readEntidad($cEntidad){
		...
		$cEntidad->setIdTipoRazonamiento((isset($_POST["fIdTipoRazonamiento"])) ? $_POST["fIdTipoRazonamiento"] : "");
		$cEntidad->setIdTipoNivel((isset($_POST["fIdTipoNivel"])) ? $_POST["fIdTipoNivel"] : "");
		...
		$cEntidad->setDuracion2((isset($_POST["fDuracion2"])) ? $_POST["fDuracion2"] : "");
	...
	*/
	function readLista($cEntidad){
		...
		global $comboTIPOS_RAZONAMIENTOS;
		$cEntidad->setIdTipoRazonamiento((isset($_POST["LSTIdTipoRazonamiento"]) && $_POST["LSTIdTipoRazonamiento"] != "") ? $_POST["LSTIdTipoRazonamiento"] : "");	$cEntidad->setBusqueda(constant("STR_TIPO_PRUEBA"), (isset($_POST["LSTIdTipoRazonamiento"]) && $_POST["LSTIdTipoRazonamiento"] != "" ) ? $comboTIPOS_RAZONAMIENTOS->getDescripcionCombo($_POST["LSTIdTipoRazonamiento"]) : "");
		global $comboTIPOS_NIVELES;
		$cEntidad->setIdTipoNivel((isset($_POST["LSTIdTipoNivel"]) && $_POST["LSTIdTipoNivel"] != "") ? $_POST["LSTIdTipoNivel"] : "");	$cEntidad->setBusqueda(constant("STR_TIPO_PRUEBA"), (isset($_POST["LSTIdTipoNivel"]) && $_POST["LSTIdTipoNivel"] != "" ) ? $comboTIPOS_NIVELES->getDescripcionCombo($_POST["LSTIdTipoNivel"]) : "");
		...
		$cEntidad->setDuracion2((isset($_POST["LSTDuracion2"]) && $_POST["LSTDuracion2"] != "") ? $_POST["LSTDuracion2"] : "");	$cEntidad->setBusqueda(constant("STR_DURACION2"), (isset($_POST["LSTDuracion2"]) && $_POST["LSTDuracion2"] != "" ) ? $_POST["LSTDuracion2"] : "");
	...
	*/
	function readEntidadItems(&$cItems){
		...
		$cItems->setUsuAlta($_cEntidadUsuarioTK->getIdUsuario());
		$cItems->setUsuMod($_cEntidadUsuarioTK->getIdUsuario());
		return $cItems;
	}
	/*
	* "Lee" los parametros recibidos en el request del buscador y los asocia a una determinada Entidad.
	...
	*/
	function readEntidadOpciones(&$cOpciones){
		...
		$cOpciones->setPathOpcion((isset($_POST["fPathOpcion"])) ? $_POST["fPathOpcion"] : "");
		...
		$cOpciones->setUsuAlta($_cEntidadUsuarioTK->getIdUsuario());
		$cOpciones->setUsuMod($_cEntidadUsuarioTK->getIdUsuario());
		return $cOpciones;
	}
	/*
	* "Lee" los parametros recibidos en el request del buscador y los asocia a una determinada Entidad.
	...
	*/
	function readEntidadEjemplos(&$cEjemplos){
		...
		$cEjemplos->setUsuAlta($_cEntidadUsuarioTK->getIdUsuario());
		$cEjemplos->setUsuMod($_cEntidadUsuarioTK->getIdUsuario());
		return $cEjemplos;
	}
	/*
	* "Lee" los parametros recibidos en el request del buscador y los asocia a una determinada Entidad.
	...
	*/
	function readEntidadOpcionesEjemplos(&$cOpcionesEjemplos){
		...
		$cOpcionesEjemplos->setPathOpcion((isset($_POST["fPathOpcion"])) ? $_POST["fPathOpcion"] : "");
		...
		$cOpcionesEjemplos->setUsuAlta($_cEntidadUsuarioTK->getIdUsuario());
		$cOpcionesEjemplos->setUsuMod($_cEntidadUsuarioTK->getIdUsuario());
