...
function enviar()
{
	...
	if (validaForm()){
		lon();
		f.LSTIdBaremo.value=f.elements['LSTIdBaremo'].value;
...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_RESULTADO");?>:", f.LSTIdResultado.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_RESULTADO");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdResultadoHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_BAREMO");?>:",f.elements['LSTIdBaremo'].value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PRUEBA");?>:", f.LSTIdPrueba.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MINIMA");?>:", f.LSTPuntMin.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MINIMA");?> <?php echo constant("STR_HASTA");?>:", f.LSTPuntMinHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MAXIMA");?>:", f.LSTPuntMax.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MAXIMA");?> <?php echo constant("STR_HASTA");?>:", f.LSTPuntMaxHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_BAREMADA");?>:", f.LSTPuntBaremada.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_BAREMADA");?> <?php echo constant("STR_HASTA");?>:", f.LSTPuntBaremadaHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdResultado"><?php echo constant("STR_ID_RESULTADO");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdResultado" name="LSTIdResultado" value="<?php echo $cEntidad->getIdResultado();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdResultadoHast" name="LSTIdResultadoHast" value="<?php echo $cEntidad->getIdResultadoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPuntMin"><?php echo constant("STR_PUNTUACION_MINIMA");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPuntMax"><?php echo constant("STR_PUNTUACION_MAXIMA");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPuntBaremada"><?php echo constant("STR_PUNTUACION_BAREMADA");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTPuntBaremada" name="LSTPuntBaremada" value="<?php echo $cEntidad->getPuntBaremada();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTPuntBaremadaHast" name="LSTPuntBaremadaHast" value="<?php echo $cEntidad->getPuntBaremadaHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idResultado' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idResultado') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_RESULTADO");?></option>
							<option style='color:#000000;' value='puntMin' <?php echo (!empty($sOrderBy) && $sOrderBy == 'puntMin') ? "selected='selected'" : "";?>><?php echo constant("STR_PUNTUACION_MINIMA");?></option>
							<option style='color:#000000;' value='puntMax' <?php echo (!empty($sOrderBy) && $sOrderBy == 'puntMax') ? "selected='selected'" : "";?>><?php echo constant("STR_PUNTUACION_MAXIMA");?></option>
							<option style='color:#000000;' value='puntBaremada' <?php echo (!empty($sOrderBy) && $sOrderBy == 'puntBaremada') ? "selected='selected'" : "";?>><?php echo constant("STR_PUNTUACION_BAREMADA");?></option>
	...
	<input type="hidden" name="baremos_resultados_next_page" value="1" />
