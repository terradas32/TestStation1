...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdEdad" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdEdad() : $_POST['fIdEdad'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="edades_next_page" value="<?php echo (isset($_POST['edades_next_page'])) ? $cUtilidades->validaXSS($_POST['edades_next_page']) : "1";?>" />