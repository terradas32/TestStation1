...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_EMPRESA");?>:",f.fIdEmpresa.value,11,true);
	msg +=vString("<?php echo constant("STR_EMPRESA");?>:",f.fDescEmpresa.value,500,true);
	msg +=vNumber("<?php echo constant("STR_ID_PROCESO");?>:",f.elements['fIdProceso'].value,11,true);
	msg +=vString("<?php echo constant("STR_PROCESO");?>:",f.fDescProceso.value,500,true);
	msg +=vNumber("<?php echo constant("STR_ID_CANDIDATO");?>:",f.elements['fIdCandidato'].value,11,true);
	...
	msg +=vNumber("<?php echo constant("STR_ID_PRUEBA");?>:",f.elements['fIdPrueba'].value,11,true);
	...
	msg +=vNumber("<?php echo constant("STR_ID_BAREMO");?>:",f.elements['fIdBaremo'].value,11,false);
	...
	msg +=vNumber("<?php echo constant("STR_ID_SEXO");?>:",f.fIdSexo.value,11,false);
	msg +=vString("<?php echo constant("STR_SEXO");?>:",f.fDescSexo.value,255,false);
	msg +=vNumber("<?php echo constant("STR_ID_EDAD");?>:",f.fIdEdad.value,11,false);
	msg +=vString("<?php echo constant("STR_EDAD");?>:",f.fDescEdad.value,255,false);
	msg +=vNumber("<?php echo constant("STR_IDFORMACION");?>:",f.fIdFormacion.value,11,false);
	msg +=vString("<?php echo constant("STR_FORMACION");?>:",f.fDescFormacion.value,255,false);
	msg +=vNumber("<?php echo constant("STR_ID_NIVEL");?>:",f.fIdNivel.value,11,false);
	msg +=vString("<?php echo constant("STR_NIVEL");?>:",f.fDescNivel.value,255,false);
	msg +=vNumber("<?php echo constant("STR_ID_AREA");?>:",f.fIdArea.value,11,false);
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdEmpresa"><?php echo constant("STR_ID_EMPRESA");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdProceso"><?php echo constant("STR_ID_PROCESO");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdCandidato"><?php echo constant("STR_ID_CANDIDATO");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdPrueba"><?php echo constant("STR_ID_PRUEBA");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdBaremo"><?php echo constant("STR_ID_BAREMO");?></label>&nbsp;</td>
						<td><div id="comboIdBaremo"><?php $comboBAREMOS->setNombre("fIdBaremo");?><?php echo $comboBAREMOS->getHTMLComboNull("1","cajatexto",$cEntidad->getIdBaremo(),"onchange=\"javascript:cambiaIdBaremo()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdSexo"><?php echo constant("STR_ID_SEXO");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdEdad"><?php echo constant("STR_ID_EDAD");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdFormacion"><?php echo constant("STR_IDFORMACION");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdNivel"><?php echo constant("STR_ID_NIVEL");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdArea"><?php echo constant("STR_ID_AREA");?></label>&nbsp;</td>
	...
	<input type="hidden" name="export_aptitudinales_next_page" value="<?php echo (isset($_POST['export_aptitudinales_next_page'])) ? $cUtilidades->validaXSS($_POST['export_aptitudinales_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdEmpresa(){
								var f= document.forms[0];
								$("#comboIdProceso").show().load("jQuery.php",{sPG:"comboprocesos",bBus:"0",multiple:"1",nLineas:"5",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdProceso",fJSProp:"cambiaIdProceso",fIdEmpresa:f.fIdEmpresa.value,vSelected:"<?php echo $cEntidad->getIdProceso();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdCandidato").show().load("jQuery.php",{sPG:"combocandidatos",bBus:"0",multiple:"1",nLineas:"5",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdCandidato",fJSProp:"cambiaIdCandidato",fIdEmpresa:f.fIdEmpresa.value,fIdProceso:f.fIdProceso.value,vSelected:"<?php echo $cEntidad->getIdCandidato();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdBaremo").show().load("jQuery.php",{sPG:"combobaremos",bBus:"0",multiple:"1",nLineas:"5",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdBaremo",fJSProp:"cambiaIdBaremo",fIdPrueba:f.fIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdBaremo();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdProceso(){
								var f= document.forms[0];
								$("#comboIdCandidato").show().load("jQuery.php",{sPG:"combocandidatos",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdCandidato",fJSProp:"cambiaIdCandidato",fIdEmpresa:f.fIdEmpresa.value,fIdProceso:f.fIdProceso.value,vSelected:"<?php echo $cEntidad->getIdCandidato();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdBaremo").show().load("jQuery.php",{sPG:"combobaremos",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdBaremo",fJSProp:"cambiaIdBaremo",fIdPrueba:f.fIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdBaremo();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdPrueba(){
								var f= document.forms[0];
								$("#comboIdBaremo").show().load("jQuery.php",{sPG:"combobaremos",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdBaremo",fJSProp:"cambiaIdBaremo",fIdPrueba:f.fIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdBaremo();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
