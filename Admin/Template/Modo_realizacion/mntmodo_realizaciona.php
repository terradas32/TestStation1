...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdModoRealizacion" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdModoRealizacion() : $_POST['fIdModoRealizacion'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="modo_realizacion_next_page" value="<?php echo (isset($_POST['modo_realizacion_next_page'])) ? $cUtilidades->validaXSS($_POST['modo_realizacion_next_page']) : "1";?>" />