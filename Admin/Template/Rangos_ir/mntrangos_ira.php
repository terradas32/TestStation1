...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdRangoIr" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdRangoIr() : $_POST['fIdRangoIr'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="rangos_ir_next_page" value="<?php echo (isset($_POST['rangos_ir_next_page'])) ? $cUtilidades->validaXSS($_POST['rangos_ir_next_page']) : "1";?>" />