...
<table cellspacing="2" cellpadding="0" width="100%" border="0">
	...
	<tr>
		...
		<td><textarea cols="1" data-id="fCuerpoNew" id="fCuerpoNew" name="fCuerpoNew" rows="6" class="obliga tinymce" onchange="javascript:trim(this);"><?php echo $cCorreosProceso->getCuerpo()?></textarea></td>
	</tr>
	<tr>
		<td colspan="3" width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="1" height="10" border="0" alt="" /></td></tr>
	...
	<tr>
		...
		<td><textarea cols="1" name="fDescripcionNew" rows="6" class="cajatexto"  onchange="javascript:trim(this);"><?php echo $cCorreosProceso->getDescripcion()?></textarea></td>
	</tr>
	<tr>
