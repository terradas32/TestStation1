...
<table cellspacing="2" cellpadding="0" width="100%" border="0">
	<tr>
		...
		<td><?php $comboTIPOS_CORREOS->setNombre("fIdTipoCorreoNew");?><?php echo $comboTIPOS_CORREOS->getHTMLCombo("1","obliga",""," ","");?></td>
	</tr>
	<tr>
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" class="negrob" valign="top"><?php echo constant("STR_NOMBRE");?>&nbsp;</td>
		<td><input type="text" name="fNombreNew" value="" class="obliga"  onchange="javascript:trim(this);" /></td>
	</tr>
	<tr>
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" class="negrob" valign="top"><?php echo constant("STR_ASUNTO");?>&nbsp;</td>
		<td><input type="text" name="fAsuntoNew" value="" class="obliga"  onchange="javascript:trim(this);" /></td>
	</tr>
	<tr>
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" class="negrob" valign="top"><?php echo constant("STR_CUERPO");?>&nbsp;</td>
		<td><textarea cols="1" data-id="fCuerpoNew" id="fCuerpoNew" name="fCuerpoNew" rows="6" class="obliga tinymce" onchange="javascript:trim(this);"></textarea></td>
	</tr>
	...
	<tr>
		...
		<td><textarea cols="1" name="fDescripcionNew" rows="6" class="cajatexto"  onchange="javascript:trim(this);"></textarea></td>
	</tr>
	<tr>
