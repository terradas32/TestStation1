		...
		<tr>
			...
			<td class="negro">
				<select name="fSeparadorCampos" size="1" class="obliga" onchange="javascript:cambiaCSV_lista();cambiaSeparador();">
					<option style="color:#000000;" value=";" <?php echo ($_POST["fSeparadorCamposSel"] == ";") ? "selected=\"selected\"" : ""; ?>>Punto y coma (;)</option>
					<option style="color:#000000;" value="," <?php echo ($_POST["fSeparadorCamposSel"] == ",") ? "selected=\"selected\"" : ""; ?>>Coma (,)</option>
				</select>
			</td>
		</tr>
		<tr>
