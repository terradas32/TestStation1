...
function cambiaidiomas(){
	...
	$("div#checkidiomas").load(paginacargada,{fIdPrueba: f.fIdPrueba.value,MODO:"<?php echo constant('MNT_LISTAIDIOMAS')?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken()?>" });
}
function listapruebas(){
	var f = document.forms[0];
	var paginacargada = "ProcesoProcesos.php";
	$("div#listadepruebas").hide().load(paginacargada,{fIdProceso: f.fIdProceso.value,fIdEmpresa: f.fIdEmpresa.value,MODO:"<?php echo constant('MNT_AGREGAPRUEBA')?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken()?>" }).fadeIn("slow");
}
...
function borraprueba(idPrueba,codIdioma){
	...
	if(confirm('<?php echo constant("DEL_GENERICO");?>')){
		var paginacargada = "ProcesoProcesos.php";
		$("div#listadepruebas").hide().load(paginacargada,{fIdProceso: f.fIdProceso.value,fIdEmpresa: f.fIdEmpresa.value,fIdPrueba: idPrueba,fIdioma: codIdioma,fIdBaremo: f.fIdBaremo.value,fBorra:"1",MODO:"<?php echo constant('MNT_AGREGAPRUEBA')?>", sTK:"<?php echo $_cEntidadUsuarioTK->getToken()?>" }).fadeIn("slow");
	}
				...
				<tr>
					<td colspan="2" width="100%" style="border-bottom: 1px solid #000000; height:35px">
						<ul class="listaProceso">
							...
							<li class="mArrow">&nbsp;</li>
							<li class="mActivo"><span><img src="./graf/iconsMenu/Folder.png" title="Pruebas" alt="Pruebas" /></span><b style="color:#FFB200">Pruebas</b></li>
							<li class="mArrow">&nbsp;</li>
							<li><span><img src="./graf/iconsMenu/User.png" title="Candidatos" alt="Candidatos" /></span>Candidatos</li>
							<li class="mArrow">&nbsp;</li>
					...
					<td width="80%">
								...
								<td colspan="3">
									<div id="prueba" >
										<table cellspacing="0" cellpadding="0" border="0" width="100%">
											<tr>
												<td width="1px"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="2px" height="20" border="0" alt="" /></td>
												<td width="137px" nowrap="nowrap" class="negrob" valign="top"><?php echo constant("STR_PRUEBA");?>&nbsp;</td>
												<!--[if lte IE 8 ]>
												<style>
													.anchoS{width:75%;}
												</style>
						...
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								...
								<td><input type="button" class="botones" <?php echo ($_bModificar) ? '' : 'disabled="disabled"';?> id="bid-ok" name="fBtnOk" value="Seguir" onclick="javascript:enviarNuevo(<?php echo constant('MNT_ANIADECANDIDATOS')?>)"/></td>
							</tr>
						</table>
					</td>
				</tr>
