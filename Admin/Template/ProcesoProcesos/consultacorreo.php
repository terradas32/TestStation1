...
<table cellspacing="2" cellpadding="0" width="100%" border="0" id="tablCorreo">
	<tr>
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" width="10" class="negrob" valign="top"><?php echo constant("STR_NOMBRE");?>&nbsp;</td>
		<td><input type="text" name="fNombreNew" value="<?php echo $cCorreos->getNombre()?>" class="obliga"  onchange="javascript:trim(this);" /></td>
	</tr>
	<tr>
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" width="10" class="negrob" valign="top"><?php echo constant("STR_ASUNTO");?>&nbsp;</td>
		<td><input type="text" name="fAsuntoNew" value="<?php echo $cCorreos->getAsunto();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
	</tr>
	<tr>
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" width="10" class="negrob" valign="top"><?php echo constant("STR_CUERPO");?>&nbsp;</td>
		<td><textarea cols="1" id="fCuerpoNew" data-id="fCuerpoNew" name="fCuerpoNew" rows="6" class="obliga tinymce" onchange="javascript:trim(this);"><?php echo $cCorreos->getCuerpo()?></textarea></td>
	</tr>
	...
	<tr>
		<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
		<td nowrap="nowrap" width="10" class="negrob" valign="top"><?php echo constant("STR_DESCRIPCION");?>&nbsp;</td>
		<td><textarea cols="1" name="fDescripcionNew" rows="6" class="cajatexto"  onchange="javascript:trim(this);"><?php echo $cCorreos->getDescripcion()?></textarea></td>
	</tr>
	<tr>
