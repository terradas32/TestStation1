				...
				<tr>
					<td colspan="2" width="100%" style="border-bottom: 1px solid #000000;">
						<ul class="listaProceso">
							<li class="mActivo"><span><img src="./graf/iconsMenu/Tools.png" title="Datos proceso" alt="Datos proceso" /></span><b style="color:#FFB200">Datos Proceso</b></li>
							<li class="mArrow">&nbsp;</li>
					...
					<td width="80%">
						<table cellspacing="0" cellpadding="0" width="100%" border="0">
							...
							<tr>
								...
								<td><textarea cols="1" name="fDescripcion" rows="6" class="cajatexto"  onchange="javascript:trim(this);"><?php echo $cEntidad->getDescripcion();?></textarea></td>
							</tr>
							<tr>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_OBSERVACIONES");?>&nbsp;</td>
                  <td><textarea cols="1" data-id="fObservaciones" id="fObservaciones" name="fObservaciones" rows="6" class="cajatexto" onchange="javascript:trim(this);"><?php echo $cEntidad->getObservaciones();?></textarea></td>
							</tr>
							<tr>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							...
							<tr>
								...
								<td colspan="2">
									<table cellspacing="0" cellpadding="0" width="100%" border="0">
										<tr>
											<td nowrap="nowrap" width="173" class="negrob" valign="top"><?php echo constant("STR_FECHA_DE_FIN");?>&nbsp;</td>
											<?php
											$sHoraFin="";
                ...
                <td colspan="2"><div id="requestProcesoConfidencial" style="display: none"></div>
                  <div id="ProcesoConfidencial" style="display: <?php echo $sDsiplayConfidencial; ?>;" >
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr>
          								<td nowrap="nowrap" width="173" class="negrob" valign="top"><?php echo constant("STR_PROCESO_CONFIDENCIAL");?>&nbsp;</td>
          								<td>
