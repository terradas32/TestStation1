...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID");?>:", f.LSTIdFichero.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdFicheroHast.value, 11, false);
	msg +=vString("<?php echo constant("STR_FICHERO");?>:",f.LSTFichero.value,255, false);
	msg +=vString("<?php echo constant("STR_TIPO");?>:",f.LSTTipo.value,255, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdFichero"><?php echo constant("STR_ID");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdFichero" name="LSTIdFichero" value="<?php echo $cEntidad->getIdFichero();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdFicheroHast" name="LSTIdFicheroHast" value="<?php echo $cEntidad->getIdFicheroHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTTipo"><?php echo constant("STR_TIPO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTTipo" name="LSTTipo" value="<?php echo $cEntidad->getTipo();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idFichero' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idFichero') ? "selected='selected'" : "";?>><?php echo constant("STR_ID");?></option>
							...
							<option style='color:#000000;' value='tipo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'tipo') ? "selected='selected'" : "";?>><?php echo constant("STR_TIPO");?></option>
	...
	<input type="hidden" name="ficheros_carga_next_page" value="1" />
