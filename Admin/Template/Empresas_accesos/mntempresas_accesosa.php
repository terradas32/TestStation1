...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdAcceso" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdAcceso() : $_POST['fIdAcceso'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="empresas_accesos_next_page" value="<?php echo (isset($_POST['empresas_accesos_next_page'])) ? $cUtilidades->validaXSS($_POST['empresas_accesos_next_page']) : "1";?>" />