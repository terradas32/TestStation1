...
function setPK(idTexto)
{
	var f=document.forms[0];
	f.fIdTexto.value=idTexto;
}
...
<?php ob_start();?>
	<table cellspacing="1" cellpadding="2" border="0" width="100%">
		<tr>
			...
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "idTexto"){
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo htmlentities(constant("STR_ID_TEXTO"), ENT_COMPAT, "UTF-8");?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='idTexto';document.forms[0].LSTOrder.value='<?php echo $sOrden;?>';enviar('<?php echo constant("MNT_LISTAR");?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo addslashes(constant("STR_ID_TEXTO"));?>';return true"><?php echo constant("STR_ID_TEXTO");?><?php echo $sPinta;?></a></td>
			<td class="tdnaranjab" align="center" valign="top"><?php echo constant("STR_ID_PRUEBA");?></td>
			<td class="tdnaranjab" align="center" valign="top"><?php echo constant("STR_ID_BLOQUE");?></td>
			<td class="tdnaranjab" align="center" valign="top"><?php echo constant("STR_ID_ESCALA");?></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "puntMin"){
				if ($cEntidad->getOrder() == "ASC"){
					$sOrden = "DESC";
					$sPinta = $strOrderASC;
				}else{
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo htmlentities(constant("STR_PUNT_MIN"), ENT_COMPAT, "UTF-8");?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='puntMin';document.forms[0].LSTOrder.value='<?php echo $sOrden;?>';enviar('<?php echo constant("MNT_LISTAR");?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo addslashes(constant("STR_PUNT_MIN"));?>';return true"><?php echo constant("STR_PUNT_MIN");?><?php echo $sPinta;?></a></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "puntMax"){
				if ($cEntidad->getOrder() == "ASC"){
					$sOrden = "DESC";
					$sPinta = $strOrderASC;
				}else{
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo htmlentities(constant("STR_PUNT_MAX"), ENT_COMPAT, "UTF-8");?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='puntMax';document.forms[0].LSTOrder.value='<?php echo $sOrden;?>';enviar('<?php echo constant("MNT_LISTAR");?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo addslashes(constant("STR_PUNT_MAX"));?>';return true"><?php echo constant("STR_PUNT_MAX");?><?php echo $sPinta;?></a></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "texto"){
				if ($cEntidad->getOrder() == "ASC"){
					$sOrden = "DESC";
					$sPinta = $strOrderASC;
				}else{
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo htmlentities(constant("STR_TEXTO"), ENT_COMPAT, "UTF-8");?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='texto';document.forms[0].LSTOrder.value='<?php echo $sOrden;?>';enviar('<?php echo constant("MNT_LISTAR");?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo addslashes(constant("STR_TEXTO"));?>';return true"><?php echo constant("STR_TEXTO");?><?php echo $sPinta;?></a></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
		...
		<tr onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER");?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT");?>'" bgcolor="<?php echo constant("ONMOUSEOUT");?>">
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idTexto']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idTexto']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['idTexto'], "<b><i><u><strong><br><br />")),0,11);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idTexto']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idPrueba']);?>"><?php echo $comboPRUEBAS->getDescripcionCombo($lista->fields['idPrueba']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idTexto']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idBloque']);?>"><?php echo $comboBLOQUES->getDescripcionCombo($lista->fields['idBloque']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idTexto']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idEscala']);?>"><?php echo $comboESCALAS->getDescripcionCombo($lista->fields['idEscala']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idTexto']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['puntMin']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['puntMin'], "<b><i><u><strong><br><br />")),0,11);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idTexto']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['puntMax']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['puntMax'], "<b><i><u><strong><br><br />")),0,11);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idTexto']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['texto']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['texto'], "<b><i><u><strong><br><br />")),0,16777215);?></td>
			<td class="tddatoslista" valign="top" align="center" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idTexto']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['fecAlta']);?>"><script language="javascript" type="text/javascript">document.write(formatThisDate('<?php echo $lista->fields['fecAlta'];?>'));</script></td>
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idTexto']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['usuAlta']);?>"><?php echo $comboWI_USUARIOS->getDescripcionCombo($lista->fields['usuAlta']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idTexto']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['usuMod']);?>"><?php echo $comboWI_USUARIOS->getDescripcionCombo($lista->fields['usuMod']);?></td>
			<td class="negro" align="center" valign="middle"><?php if($_bBorrar) {?><a href="#" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idTexto']);?>');confBorrar(<?php echo constant("MNT_BORRAR");?>,'<?php echo constant("DEL_GENERICO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>menos.gif" width="9" height="9" border="0" alt="<?php echo constant("STR_BORRAR");?>" /></a><?php } ?></td>
		</tr>
		<?php $i++;
		$lista->MoveNext();
		} ?>
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
			<td width="100%" colspan="2" class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"),str_replace('_', ' ', "TEXTOS_ESCALAS"));?><a href="#_" onclick="javascript:document.forms[0].action='sqlToExcel.php';document.forms[0].submit();document.forms[0].action='<?php echo $_SERVER['PHP_SELF'];?>';"><img src="<?php echo constant('DIR_WS_GRAF');?>excel.gif" width="34" height="35" align="right" border="0" alt="<?php echo constant("STR_EXPORTAR_A_EXCEL");?>" /></a></td>
		</tr>
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
	...
	<br />
	<input type="hidden" name="fIdTexto" value="" />
	<input type="hidden" name="ORIGEN" value="<?php echo constant("MNT_LISTAR");?>" />
	<input type="hidden" name="fReordenar" value="" />
	<input type="hidden" name="fSQLtoEXCEL" value="<?php echo base64_encode($sql . constant("CHAR_SEPARA") . "textos_escalas");?>" />
	<input type="hidden" name="LSTIdTextoHast" value="<?php echo (isset($_POST['LSTIdTextoHast'])) ? $cUtilidades->validaXSS($_POST['LSTIdTextoHast']) : "";?>" />
	<input type="hidden" name="LSTIdTexto" value="<?php echo (isset($_POST['LSTIdTexto'])) ? $cUtilidades->validaXSS($_POST['LSTIdTexto']) : "";?>" />
	...
	<input type="hidden" name="LSTIdBloqueHast" value="<?php echo (isset($_POST['LSTIdBloqueHast'])) ? $cUtilidades->validaXSS($_POST['LSTIdBloqueHast']) : "";?>" />
	<input type="hidden" name="LSTIdBloque" value="<?php echo (isset($_POST['LSTIdBloque'])) ? $cUtilidades->validaXSS($_POST['LSTIdBloque']) : "";?>" />
	<input type="hidden" name="LSTIdEscalaHast" value="<?php echo (isset($_POST['LSTIdEscalaHast'])) ? $cUtilidades->validaXSS($_POST['LSTIdEscalaHast']) : "";?>" />
	<input type="hidden" name="LSTIdEscala" value="<?php echo (isset($_POST['LSTIdEscala'])) ? $cUtilidades->validaXSS($_POST['LSTIdEscala']) : "";?>" />
	<input type="hidden" name="LSTPuntMinHast" value="<?php echo (isset($_POST['LSTPuntMinHast'])) ? $cUtilidades->validaXSS($_POST['LSTPuntMinHast']) : "";?>" />
	<input type="hidden" name="LSTPuntMin" value="<?php echo (isset($_POST['LSTPuntMin'])) ? $cUtilidades->validaXSS($_POST['LSTPuntMin']) : "";?>" />
	<input type="hidden" name="LSTPuntMaxHast" value="<?php echo (isset($_POST['LSTPuntMaxHast'])) ? $cUtilidades->validaXSS($_POST['LSTPuntMaxHast']) : "";?>" />
	<input type="hidden" name="LSTPuntMax" value="<?php echo (isset($_POST['LSTPuntMax'])) ? $cUtilidades->validaXSS($_POST['LSTPuntMax']) : "";?>" />
	...
	<input type="hidden" name="textos_escalas_next_page" value="<?php echo (isset($_POST['textos_escalas_next_page'])) ? $cUtilidades->validaXSS($_POST['textos_escalas_next_page']) : "1";?>" />
</div>
