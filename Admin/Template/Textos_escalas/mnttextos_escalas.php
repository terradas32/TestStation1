...
function enviar()
{
	...
	if (validaForm()){
		lon();
		f.LSTIdEscala.value=f.elements['LSTIdEscala'].value;
...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_TEXTO");?>:", f.LSTIdTexto.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_TEXTO");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdTextoHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_PRUEBA");?>:", f.LSTIdPrueba.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_BLOQUE");?>:", f.LSTIdBloque.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_ESCALA");?>:",f.elements['LSTIdEscala'].value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNT_MIN");?>:", f.LSTPuntMin.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNT_MIN");?> <?php echo constant("STR_HASTA");?>:", f.LSTPuntMinHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNT_MAX");?>:", f.LSTPuntMax.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNT_MAX");?> <?php echo constant("STR_HASTA");?>:", f.LSTPuntMaxHast.value, 11, false);
	msg +=vString("<?php echo constant("STR_TEXTO");?>:",f.LSTTexto.value,16777215, false);
	...
	msg +=vNumber("<?php echo constant("STR_USUARIO_DE_ALTA");?>:", f.LSTUsuAlta.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_USUARIO_DE_MODIFICACION");?>:", f.LSTUsuMod.value, 11, false);
	if (msg != "") {
...
<body onload="_body_onload();cambiaIdBloque();block('<?php echo ($_POST["_block"] != "") ? $_POST["_block"] : "-1";?>');setClicado('<?php echo $_POST["_clicado"];?>');" onunload="_body_onunload();">
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTexto"><?php echo constant("STR_ID_TEXTO");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdTexto" name="LSTIdTexto" value="<?php echo $cEntidad->getIdTexto();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdTextoHast" name="LSTIdTextoHast" value="<?php echo $cEntidad->getIdTextoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdPrueba"><?php echo constant("STR_ID_PRUEBA");?></label>&nbsp;</td>
					<td><?php $comboPRUEBAS->setNombre("LSTIdPrueba");?><?php echo $comboPRUEBAS->getHTMLCombo("1","cajatexto",$cEntidad->getIdPrueba()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdBloque"><?php echo constant("STR_ID_BLOQUE");?></label>&nbsp;</td>
					<td><?php $comboBLOQUES->setNombre("LSTIdBloque");?><?php echo $comboBLOQUES->getHTMLCombo("1","cajatexto",$cEntidad->getIdBloque()," onchange=\"javascript:cambiaIdBloque()\"","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdEscala"><?php echo constant("STR_ID_ESCALA");?></label>&nbsp;</td>
						<td><div id="comboIdEscala"><?php $comboESCALAS->setNombre("LSTIdEscala");?><?php echo $comboESCALAS->getHTMLComboNull("1","cajatexto",$cEntidad->getIdEscala(),"onchange=\"javascript:cambiaIdEscala()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPuntMin"><?php echo constant("STR_PUNT_MIN");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTPuntMin" name="LSTPuntMin" value="<?php echo $cEntidad->getPuntMin();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTPuntMinHast" name="LSTPuntMinHast" value="<?php echo $cEntidad->getPuntMinHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPuntMax"><?php echo constant("STR_PUNT_MAX");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTPuntMax" name="LSTPuntMax" value="<?php echo $cEntidad->getPuntMax();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTPuntMaxHast" name="LSTPuntMaxHast" value="<?php echo $cEntidad->getPuntMaxHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTTexto"><?php echo constant("STR_TEXTO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTTexto" name="LSTTexto" value="<?php echo $cEntidad->getTexto();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTUsuAlta"><?php echo constant("STR_USUARIO_DE_ALTA");?></label>&nbsp;</td>
					<td><?php $comboWI_USUARIOS->setNombre("LSTUsuAlta");?><?php echo $comboWI_USUARIOS->getHTMLCombo("1","cajatexto",$cEntidad->getUsuAlta()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idTexto' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idTexto') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_TEXTO");?></option>
							<option style='color:#000000;' value='puntMin' <?php echo (!empty($sOrderBy) && $sOrderBy == 'puntMin') ? "selected='selected'" : "";?>><?php echo constant("STR_PUNT_MIN");?></option>
							<option style='color:#000000;' value='puntMax' <?php echo (!empty($sOrderBy) && $sOrderBy == 'puntMax') ? "selected='selected'" : "";?>><?php echo constant("STR_PUNT_MAX");?></option>
							<option style='color:#000000;' value='texto' <?php echo (!empty($sOrderBy) && $sOrderBy == 'texto') ? "selected='selected'" : "";?>><?php echo constant("STR_TEXTO");?></option>
	...
	<input type="hidden" name="textos_escalas_next_page" value="1" />
	<input type="hidden" name="LSTCodIdiomaIso2" value="<?php echo constant("LENGUAJEDEFECTO");?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaIdBloque(){
								var f= document.forms[0];
								$("#comboIdEscala").show().load("jQuery.php",{sPG:"comboescalas",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdEscala",fJSProp:"cambiaIdEscala",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdBloque:f.LSTIdBloque.value,vSelected:"<?php echo $cEntidad->getIdEscala();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaIdEscala(){								
							}
							//]]>
						</script></div>
