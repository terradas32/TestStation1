...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<table cellspacing="0" cellpadding="0" border="0">
		<tr>
			...
			<td><input type="submit" class="botones" id="bid-ok" name="fBtnOk" value="<?php echo constant("STR_ACEPTAR");?>" /></td>
	...
	<input type="hidden" name="pruebas_empresas_next_page" value="<?php echo (isset($_POST['pruebas_empresas_next_page'])) ? $cUtilidades->validaXSS($_POST['pruebas_empresas_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
