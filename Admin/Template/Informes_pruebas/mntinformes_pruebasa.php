...
function validaForm()
{
	...
	msg +=vNumber("Precio:",f.fPrecio.value,11,true);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPrecio">Precio</label>&nbsp;</td>
	...
	<input type="hidden" name="informes_pruebas_next_page" value="<?php echo (isset($_POST['informes_pruebas_next_page'])) ? $cUtilidades->validaXSS($_POST['informes_pruebas_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
