...
<table cellpadding="10" cellspacing="10">
	...
	<tr>
		...
		<td>
			...
			<?php 
				if($bPinta){
					if($listaItemsInv->recordCount()>0){
					 
						while(!$listaItemsInv->EOF){
							
							$cItem = new Items();
							$cItem->setIdPrueba($listaItemsInv->fields['idPrueba']);
							$cItem->setIdItem($listaItemsInv->fields['idItem']);
