...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdPerfil" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdPerfil() : $_POST['fIdPerfil'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="emp_perfiles_next_page" value="<?php echo (isset($_POST['emp_perfiles_next_page'])) ? $cUtilidades->validaXSS($_POST['emp_perfiles_next_page']) : "1";?>" />