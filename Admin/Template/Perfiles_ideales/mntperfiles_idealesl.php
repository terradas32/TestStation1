...
function setPK(codIdiomaIso2,idPrueba,idTipoCompetencia,idCompetencia,idEmpresa)
{
	var f=document.forms[0];
...
<?php ob_start();?>
	<table cellspacing="1" cellpadding="2" border="0" width="100%">
		<tr>
			...
			<td class="tdnaranjab" align="center" valign="top"><?php echo constant("STR_TIPO_COMPETENCIA");?></td>
			<td class="tdnaranjab" align="center" valign="top"><?php echo constant("STR_COMPETENCIA");?></td>
			...
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "puntuacionMin"){
				if ($cEntidad->getOrder() == "ASC"){
					$sOrden = "DESC";
					$sPinta = $strOrderASC;
				}else{
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo htmlentities(constant("STR_PUNTUACION_MIN"), ENT_COMPAT, "UTF-8");?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='puntuacionMin';document.forms[0].LSTOrder.value='<?php echo $sOrden;?>';enviar('<?php echo constant("MNT_LISTAR");?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo addslashes(constant("STR_PUNTUACION_MIN"));?>';return true"><?php echo constant("STR_PUNTUACION_MIN");?><?php echo $sPinta;?></a></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "puntuacionMax"){
				if ($cEntidad->getOrder() == "ASC"){
					$sOrden = "DESC";
					$sPinta = $strOrderASC;
				}else{
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo htmlentities(constant("STR_PUNTUACION_MAX"), ENT_COMPAT, "UTF-8");?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='puntuacionMax';document.forms[0].LSTOrder.value='<?php echo $sOrden;?>';enviar('<?php echo constant("MNT_LISTAR");?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo addslashes(constant("STR_PUNTUACION_MAX"));?>';return true"><?php echo constant("STR_PUNTUACION_MAX");?><?php echo $sPinta;?></a></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
		...
		<tr onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER");?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT");?>'" bgcolor="<?php echo constant("ONMOUSEOUT");?>">
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoCompetencia']);?>','<?php echo addslashes($lista->fields['idCompetencia']);?>','<?php echo addslashes($lista->fields['idEmpresa']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['codIdiomaIso2']);?>"><?php echo $comboWI_IDIOMAS->getDescripcionCombo($lista->fields['codIdiomaIso2']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoCompetencia']);?>','<?php echo addslashes($lista->fields['idCompetencia']);?>','<?php echo addslashes($lista->fields['idEmpresa']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idPrueba']);?>"><?php echo $comboPRUEBAS->getDescripcionCombo($lista->fields['idPrueba']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoCompetencia']);?>','<?php echo addslashes($lista->fields['idCompetencia']);?>','<?php echo addslashes($lista->fields['idEmpresa']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idTipoCompetencia']);?>"><?php echo $comboTIPOS_COMPETENCIAS->getDescripcionCombo($lista->fields['idTipoCompetencia']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoCompetencia']);?>','<?php echo addslashes($lista->fields['idCompetencia']);?>','<?php echo addslashes($lista->fields['idEmpresa']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idCompetencia']);?>"><?php echo $comboCOMPETENCIAS->getDescripcionCombo($lista->fields['idCompetencia']);?></td>
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoCompetencia']);?>','<?php echo addslashes($lista->fields['idCompetencia']);?>','<?php echo addslashes($lista->fields['idEmpresa']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['puntuacionMin']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['puntuacionMin'], "<b><i><u><strong><br><br />")),0,11);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['codIdiomaIso2']);?>','<?php echo addslashes($lista->fields['idPrueba']);?>','<?php echo addslashes($lista->fields['idTipoCompetencia']);?>','<?php echo addslashes($lista->fields['idCompetencia']);?>','<?php echo addslashes($lista->fields['idEmpresa']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['puntuacionMax']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['puntuacionMax'], "<b><i><u><strong><br><br />")),0,11);?></td>
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
			<td width="100%" colspan="2" class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"),str_replace('_', ' ', constant("STR_PERFILESIDEALES")));?><a href="#_" onclick="javascript:document.forms[0].action='sqlToExcel.php';document.forms[0].submit();document.forms[0].action='<?php echo $_SERVER['PHP_SELF'];?>';"><img src="<?php echo constant('DIR_WS_GRAF');?>excel.gif" width="34" height="35" align="right" border="0" alt="<?php echo constant("STR_EXPORTAR_A_EXCEL");?>" /></a></td>
		</tr>
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
	...
	<input type="hidden" name="fIdTipoCompetencia" value="" />
	<input type="hidden" name="fIdCompetencia" value="" />
	...
	<input type="hidden" name="fSQLtoEXCEL" value="<?php echo base64_encode($sql . constant("CHAR_SEPARA") . "perfiles_ideales");?>" />
	...
	<input type="hidden" name="LSTPuntuacionMinHast" value="<?php echo (isset($_POST['LSTPuntuacionMinHast'])) ? $cUtilidades->validaXSS($_POST['LSTPuntuacionMinHast']) : "";?>" />
	<input type="hidden" name="LSTPuntuacionMin" value="<?php echo (isset($_POST['LSTPuntuacionMin'])) ? $cUtilidades->validaXSS($_POST['LSTPuntuacionMin']) : "";?>" />
	<input type="hidden" name="LSTPuntuacionMaxHast" value="<?php echo (isset($_POST['LSTPuntuacionMaxHast'])) ? $cUtilidades->validaXSS($_POST['LSTPuntuacionMaxHast']) : "";?>" />
	<input type="hidden" name="LSTPuntuacionMax" value="<?php echo (isset($_POST['LSTPuntuacionMax'])) ? $cUtilidades->validaXSS($_POST['LSTPuntuacionMax']) : "";?>" />
	...
	<input type="hidden" name="perfiles_ideales_next_page" value="<?php echo (isset($_POST['perfiles_ideales_next_page'])) ? $cUtilidades->validaXSS($_POST['perfiles_ideales_next_page']) : "1";?>" />
</div>
