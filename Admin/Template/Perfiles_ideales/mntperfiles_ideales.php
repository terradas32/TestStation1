...
function enviar()
{
	...
	if (validaForm()){
		...
		f.LSTIdCompetencia.value=f.elements['LSTIdCompetencia'].value;
...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_TIPO_COMPETENCIA");?>:",f.elements['LSTIdTipoCompetencia'].value, 11, false);
	msg +=vNumber("<?php echo constant("STR_COMPETENCIA");?>:",f.elements['LSTIdCompetencia'].value, 11, false);
	...
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MIN");?>:", f.LSTPuntuacionMin.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MIN");?> <?php echo constant("STR_HASTA");?>:", f.LSTPuntuacionMinHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MAX");?>:", f.LSTPuntuacionMax.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MAX");?> <?php echo constant("STR_HASTA");?>:", f.LSTPuntuacionMaxHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoCompetencia"><?php echo constant("STR_TIPO_COMPETENCIA");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdCompetencia"><?php echo constant("STR_COMPETENCIA");?></label>&nbsp;</td>
						<td><div id="comboIdCompetencia"><?php $comboCOMPETENCIAS->setNombre("LSTIdCompetencia");?><?php echo $comboCOMPETENCIAS->getHTMLComboNull("1","cajatexto",$cEntidad->getIdCompetencia(),"onchange=\"javascript:cambiaIdCompetencia()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdEmpresa"><?php echo constant("STR_EMPRESA");?></label>&nbsp;</td>
					<td><?php $comboEMPRESAS->setNombre("LSTIdEmpresa");?><?php echo $comboEMPRESAS->getHTMLCombo("1","cajatexto",$cEntidad->getIdEmpresa()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPuntuacionMin"><?php echo constant("STR_PUNTUACION_MIN");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTPuntuacionMin" name="LSTPuntuacionMin" value="<?php echo $cEntidad->getPuntuacionMin();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTPuntuacionMinHast" name="LSTPuntuacionMinHast" value="<?php echo $cEntidad->getPuntuacionMinHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPuntuacionMax"><?php echo constant("STR_PUNTUACION_MAX");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTPuntuacionMax" name="LSTPuntuacionMax" value="<?php echo $cEntidad->getPuntuacionMax();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTPuntuacionMaxHast" name="LSTPuntuacionMaxHast" value="<?php echo $cEntidad->getPuntuacionMaxHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='puntuacionMin' <?php echo (!empty($sOrderBy) && $sOrderBy == 'puntuacionMin') ? "selected='selected'" : "";?>><?php echo constant("STR_PUNTUACION_MIN");?></option>
							<option style='color:#000000;' value='puntuacionMax' <?php echo (!empty($sOrderBy) && $sOrderBy == 'puntuacionMax') ? "selected='selected'" : "";?>><?php echo constant("STR_PUNTUACION_MAX");?></option>
	...
	<input type="hidden" name="perfiles_ideales_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdPrueba").show().load("jQuery.php",{sPG:"combopruebas",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdPrueba",fJSProp:"cambiaIdPrueba",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdPrueba();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdTipoCompetencia").show().load("jQuery.php",{sPG:"combotipos_competencias",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdTipoCompetencia",fJSProp:"cambiaIdTipoCompetencia",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdPrueba:f.LSTIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdTipoCompetencia();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdCompetencia").show().load("jQuery.php",{sPG:"combocompetencias",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdCompetencia",fJSProp:"cambiaIdCompetencia",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdTipoCompetencia:f.LSTIdTipoCompetencia.value,LSTIdPrueba:f.LSTIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdCompetencia();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdTipoCompetencia(){
								var f= document.forms[0];
								$("#comboIdCompetencia").show().load("jQuery.php",{sPG:"combocompetencias",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdCompetencia",fJSProp:"cambiaIdCompetencia",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdTipoCompetencia:f.LSTIdTipoCompetencia.value,LSTIdPrueba:f.LSTIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdCompetencia();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
