...
function enviar()
{
	...
	if (validaForm()){
		...
		f.fIdTipoCompetencia.value=f.elements['fIdTipoCompetencia'].value;
...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_TIPO_COMPETENCIA");?>:",f.elements['fIdTipoCompetencia'].value,11,true);
	...
	msg +=vString("<?php echo constant("STR_NOMBRE");?>:",f.fNombre.value,255,false);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MIN");?>:",f.fPuntuacionMin.value,11,true);
	msg +=vNumber("<?php echo constant("STR_PUNTUACION_MAX");?>:",f.fPuntuacionMax.value,11,true);
if (msg != "") {
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdTipoCompetencia"><?php echo constant("STR_TIPO_COMPETENCIA");?></label>&nbsp;</td>
						<td><div id="comboIdTipoCompetencia"><?php $comboTIPOS_COMPETENCIAS->setNombre("fIdTipoCompetencia");?><?php echo $comboTIPOS_COMPETENCIAS->getHTMLComboNull("1","obliga",$cEntidad->getIdTipoCompetencia(),"onchange=\"javascript:cambiaIdTipoCompetencia()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><?php $comboEMPRESAS->setNombre("fIdEmpresa");?><?php echo $comboEMPRESAS->getHTMLCombo("1","cajatexto",$cEntidad->getIdEmpresa()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fNombre"><?php echo constant("STR_NOMBRE");?></label>&nbsp;</td>
					<td><input type="text" id="fNombre" name="fNombre" value="<?php echo $cEntidad->getNombre();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPuntuacionMin"><?php echo constant("STR_PUNTUACION_MIN");?></label>&nbsp;</td>
					<td><input type="text" id="fPuntuacionMin" name="fPuntuacionMin" value="<?php echo $cEntidad->getPuntuacionMin();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPuntuacionMax"><?php echo constant("STR_PUNTUACION_MAX");?></label>&nbsp;</td>
					<td><input type="text" id="fPuntuacionMax" name="fPuntuacionMax" value="<?php echo $cEntidad->getPuntuacionMax();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
	...
	<input type="hidden" name="perfiles_ideales_next_page" value="<?php echo (isset($_POST['perfiles_ideales_next_page'])) ? $cUtilidades->validaXSS($_POST['perfiles_ideales_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							...
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdPrueba").show().load("jQuery.php",{sPG:"combopruebas",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdPrueba",fJSProp:"cambiaIdPrueba",fCodIdiomaIso2:f.fCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdPrueba();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdTipoCompetencia").show().load("jQuery.php",{sPG:"combotipos_competencias",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdTipoCompetencia",fJSProp:"cambiaIdTipoCompetencia",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdPrueba:f.fIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdTipoCompetencia();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdCompetencia").show().load("jQuery.php",{sPG:"combocompetencias",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdCompetencia",fJSProp:"cambiaIdCompetencia",fCodIdiomaIso2:f.fCodIdiomaIso2.value,fIdTipoCompetencia:f.fIdTipoCompetencia.value,fIdPrueba:f.fIdPrueba.value,vSelected:"<?php echo $cEntidad->getIdCompetencia();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
