		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><?php $comboPRUEBAS->setNombre("LSTIdPrueba");?><?php echo $comboPRUEBAS->getHTMLCombo("1","obliga",$_POST['LSTIdPrueba']," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTSigno"><?php echo constant("STR_EMPRESA");?></label>&nbsp;</td>
					<td><?php $comboEMPRESAS->setNombre("LSTIdEmpresa");?><?php echo $comboEMPRESAS->getHTMLComboMenu("1","cajatexto",""," onchange=\"javascript:cambiaIdEmpresa()\"","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdProceso"><?php echo constant("STR_PROCESO");?></label>&nbsp;</td>
						<td><div id="comboIdProceso"><?php $comboPROCESOS->setNombre("LSTIdProceso");?><?php echo $comboPROCESOS->getHTMLComboNull("1","cajatexto","","onchange=\"javascript:cambiaIdProceso()\" ","");?></div></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
						...
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								...
								<?php 
									...
									$LSTFecDesde = $conn->UserDate($date,constant("USR_FECHA"),false);
								?>
								<td><input type="text" id="LSTFecDesde" name="LSTFecDesde" value="<?php echo $LSTFecDesde;?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
				...
				<tr>
					...
					<td>
						<select name='LSTFinalizado' size='1' class="cajatexto">
							<?php $sFinalizado = $_POST["LSTFinalizado"];?>
							<option style='color:#000000;' value='' <?php echo (empty($sFinalizado)) ? "selected='selected'" : "";?>>TODOS</option>
							<option style='color:#000000;' value='1' <?php echo (!empty($sFinalizado) && $sFinalizado == 'ASC') ? "selected='selected'" : "";?>>Sí</option>
							<option style='color:#000000;' value='0' <?php echo (!empty($sFinalizado) && $sFinalizado == 'DESC') ? "selected='selected'" : "";?>>No</option>
						</select>
					</td>
				</tr>
...
<!-- 				<td><?php echo constant("STR_PASSWORD");?>:&nbsp;<input type="password" class="obliga" id="pass" name="fPass" value="<?php echo (!empty($_REQUEST['fPass'])) ? $_REQUEST['fPass'] : "";?>" /></td> -->
			...
			<table cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					if ($bExportar){
					?>
						<a href="toExcelAptitudinal.php?fSQLtoEXCEL=<?php echo base64_encode("SELECT * FROM export_especial WHERE id=" . $newId . " " . constant("CHAR_SEPARA") . "export_especial". constant("CHAR_SEPARA") . $_POST['LSTIdPrueba']);?>"><img src="<?php echo constant('DIR_WS_GRAF');?>excel.gif" width="34" height="35" align="right" border="0" alt="<?php echo constant("STR_EXPORTAR_A_EXCEL");?>" /></a>
					<?php 
					}
					?>
					</td>
