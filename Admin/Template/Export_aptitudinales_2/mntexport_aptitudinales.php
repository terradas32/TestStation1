...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_PROCESO");?>:",f.LSTDescProceso.value,500, false);
	...
	msg +=vNumber("<?php echo constant("STR_PRUEBA");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdPruebaHast.value, 11, false);
	...
	msg +=vNumber("<?php echo constant("STR_BAREMO");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdBaremoHast.value, 11, false);
	msg +=vDate("Fecha de AltaProceso:",f.LSTFecAltaProceso.value,10,false);
	msg +=vDate("Fecha de AltaProceso <?php echo constant("STR_HASTA");?>:",f.LSTFecAltaProcesoHast.value,10,false);
	msg +=vNumber("<?php echo constant("STR_SEXO");?>:", f.LSTIdSexo.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_SEXO");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdSexoHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_EDAD");?>:", f.LSTIdEdad.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_EDAD");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdEdadHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_FORMACION");?>:", f.LSTIdFormacion.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_FORMACION");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdFormacionHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_NIVEL");?>:", f.LSTIdNivel.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_NIVEL");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdNivelHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_AREA");?>:", f.LSTIdArea.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_AREA");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdAreaHast.value, 11, false);
	if (msg != "") {
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><input type="text" id="LSTDescProceso" name="LSTDescProceso" value="<?php echo $cEntidad->getDescProceso();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								...
								<td><input type="text" id="LSTIdPrueba" name="LSTIdPrueba" value="<?php echo $cEntidad->getIdPrueba();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdPruebaHast" name="LSTIdPruebaHast" value="<?php echo $cEntidad->getIdPruebaHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdBaremo" name="LSTIdBaremo" value="<?php echo $cEntidad->getIdBaremo();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdBaremoHast" name="LSTIdBaremoHast" value="<?php echo $cEntidad->getIdBaremoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdSexo" name="LSTIdSexo" value="<?php echo $cEntidad->getIdSexo();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdSexoHast" name="LSTIdSexoHast" value="<?php echo $cEntidad->getIdSexoHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdEdad" name="LSTIdEdad" value="<?php echo $cEntidad->getIdEdad();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdEdadHast" name="LSTIdEdadHast" value="<?php echo $cEntidad->getIdEdadHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdFormacion" name="LSTIdFormacion" value="<?php echo $cEntidad->getIdFormacion();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdFormacionHast" name="LSTIdFormacionHast" value="<?php echo $cEntidad->getIdFormacionHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdNivel" name="LSTIdNivel" value="<?php echo $cEntidad->getIdNivel();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdNivelHast" name="LSTIdNivelHast" value="<?php echo $cEntidad->getIdNivelHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdArea" name="LSTIdArea" value="<?php echo $cEntidad->getIdArea();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdAreaHast" name="LSTIdAreaHast" value="<?php echo $cEntidad->getIdAreaHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idProceso' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idProceso') ? "selected='selected'" : "";?>><?php echo constant("STR_PROCESO");?></option>
							...
							<option style='color:#000000;' value='idCandidato' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idCandidato') ? "selected='selected'" : "";?>><?php echo constant("STR_CANDIDATO");?></option>
							...
							<option style='color:#000000;' value='idPrueba' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idPrueba') ? "selected='selected'" : "";?>><?php echo constant("STR_PRUEBA");?></option>
							...
							<option style='color:#000000;' value='idBaremo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idBaremo') ? "selected='selected'" : "";?>><?php echo constant("STR_BAREMO");?></option>
							...
							<option style='color:#000000;' value='idSexo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idSexo') ? "selected='selected'" : "";?>><?php echo constant("STR_SEXO");?></option>
							...
							<option style='color:#000000;' value='idEdad' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idEdad') ? "selected='selected'" : "";?>><?php echo constant("STR_EDAD");?></option>
							...
							<option style='color:#000000;' value='idFormacion' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idFormacion') ? "selected='selected'" : "";?>><?php echo constant("STR_FORMACION");?></option>
							...
							<option style='color:#000000;' value='idNivel' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idNivel') ? "selected='selected'" : "";?>><?php echo constant("STR_NIVEL");?></option>
							...
							<option style='color:#000000;' value='idArea' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idArea') ? "selected='selected'" : "";?>><?php echo constant("STR_AREA");?></option>
