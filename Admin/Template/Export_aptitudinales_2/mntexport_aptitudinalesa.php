...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_BAREMO");?>:",f.fIdBaremo.value,11,false);
	msg +=vString("<?php echo constant("STR_BAREMO");?>:",f.fDescBaremo.value,255,false);
	msg +=vDate("<?php echo constant("STR_FECHA_DE_ALTAPROCESO");?>:",f.fFecAltaProceso.value,10,true);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><input type="text" id="fIdPrueba" name="fIdPrueba" value="<?php echo $cEntidad->getIdPrueba();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><input type="text" id="fIdBaremo" name="fIdBaremo" value="<?php echo $cEntidad->getIdBaremo();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fFecAltaProceso"><?php echo constant("STR_FECHA_DE_ALTAPROCESO");?></label>&nbsp;</td>
				...
				<tr>
					...
					<td><input type="text" id="fIdSexo" name="fIdSexo" value="<?php echo $cEntidad->getIdSexo();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><input type="text" id="fIdEdad" name="fIdEdad" value="<?php echo $cEntidad->getIdEdad();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><input type="text" id="fIdFormacion" name="fIdFormacion" value="<?php echo $cEntidad->getIdFormacion();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><input type="text" id="fIdNivel" name="fIdNivel" value="<?php echo $cEntidad->getIdNivel();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><input type="text" id="fIdArea" name="fIdArea" value="<?php echo $cEntidad->getIdArea();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="export_aptitudinales_next_page" value="<?php echo (isset($_POST['export_aptitudinales_next_page'])) ? $cUtilidades->validaXSS($_POST['export_aptitudinales_next_page']) : "1";?>" /></div>
