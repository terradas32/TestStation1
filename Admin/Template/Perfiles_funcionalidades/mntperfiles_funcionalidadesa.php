...
function validaAniadir(nombre){
	...
	if (f.fIdPerfil.value !="" &&
		...
		if (validaRepe(nombre, f.fIdPerfil.value + f.fIdFuncionalidad.value)){
			...
			alert("<?php echo constant("STR_REPETIDO");?>")
		}
	}else{
		alert("<?php echo constant("SLC_PERFIL_FUNCIONALIDAD");?>.");
	}
}
				...
				<tr>
					<td colspan="3">
								<table cellspacing="0" cellpadding="0" width="95%" border="0" >
										...
										<td rowspan="8" valign="top">
											...
											<?php 
												...
												for ($i=0; $i < sizeof($aPerfilFuncionalidades); $i++){
													...
													echo "<option value=\"" . $aPsFs[0] . "|" . $aPsFs[1] . "|" . $aPsFs[2] . "|" . $aPsFs[3] . "\">" . $comboPERFILES->getDescripcionCombo($aPsFs[0]) . " - " . $comboFUNCIONALIDADES->getDescripcionCombo($aPsFs[1]) . " - " . constant("STR_MODIFICAR") . ": " . $aPsFs[2] . " - " . constant("STR_BORRAR") . ": " . $aPsFs[3] . "</option>";
												}
											?>
											</select>
											<br />
									...
									<tr>
										<td style="width:130" class="negrob"><?php $comboPERFILES->setNombre("fIdPerfil");?><?php echo $comboPERFILES->getHTMLCombo("1","cajatexto","","","");?></td>
									</tr>
									<tr>
