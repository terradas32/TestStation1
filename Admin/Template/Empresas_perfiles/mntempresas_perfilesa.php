...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="empresas_perfiles_next_page" value="<?php echo (isset($_POST['empresas_perfiles_next_page'])) ? $cUtilidades->validaXSS($_POST['empresas_perfiles_next_page']) : "1";?>" />