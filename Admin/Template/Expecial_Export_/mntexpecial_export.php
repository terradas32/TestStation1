					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								...
								<td><input readonly="readonly" type="text" id="LSTFecDesde" name="LSTFecDesde" value="01/01/2012" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
...
<!-- 				<td><?php echo constant("STR_PASSWORD");?>:&nbsp;<input type="password" class="obliga" id="pass" name="fPass" value="<?php echo (!empty($_REQUEST['fPass'])) ? $_REQUEST['fPass'] : "";?>" /></td> -->
	...
	<script language="javascript" type="text/javascript">
		...
		function cambiaIdEmpresa(){
			var f= document.forms[0];
			$("#comboIdProceso").show().load("jQuery_.php",{sPG:"comboprocesos_",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdProceso",fJSProp:"cambiaIdProceso",LSTIdEmpresa:f.LSTIdEmpresa.value,vSelected:"<?php echo (!empty($_REQUEST['LSTIdProceso'])) ? $_REQUEST['LSTIdProceso'] : "";?>"}).fadeIn("slow");
		}
		//]]>
	</script>
	<script language="javascript" type="text/javascript">
