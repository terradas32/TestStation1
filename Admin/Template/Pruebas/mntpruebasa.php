...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_CAPTURA_PANTALLA");?>:",f.fCapturaPantalla.value,255,false);
	msg +=vString("<?php echo constant("STR_CABECERA");?>:",f.fCabecera.value,255,false);
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><input type="text" id="fCodigo" name="fCodigo" value="<?php echo $cEntidad->getCodigo();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdTipoPrueba"><?php echo constant("STR_TIPO_PRUEBA");?></label>&nbsp;</td>
					<td><?php $comboTIPOS_PRUEBA->setNombre("fIdTipoPrueba");?><?php echo $comboTIPOS_PRUEBA->getHTMLCombo("1","obliga",$cEntidad->getIdTipoPrueba()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fObservaciones"><?php echo constant("STR_OBSERVACIONES");?></label>&nbsp;</td>
					<td><input type="text" id="fObservaciones" name="fObservaciones" value="<?php echo $cEntidad->getObservaciones();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fDuracion"><?php echo constant("STR_DURACION");?></label>&nbsp;</td>
					<td><input type="text" id="fDuracion" name="fDuracion" value="<?php echo $cEntidad->getDuracion();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fDuracion2"><?php echo constant("STR_DURACION2");?></label>&nbsp;</td>
					<td><input type="text" id="fDuracion2" name="fDuracion2" value="<?php echo $cEntidad->getDuracion();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fLogoPrueba"><?php echo constant("STR_LOGO_PRUEBA");?></label>&nbsp;</td>
					<td><input onkeydown="blur();" onkeypress="blur();" type="file" id="fLogoPrueba" name="fLogoPrueba" class="obliga"  /></td>
				</tr>
					...
					?>
						<tr>
							...
							<td>&nbsp;<a class="azul" href="#" onclick="javascript:abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cEntidad->getLogoPrueba());?>');"><?php echo str_replace("_","&nbsp;", basename($cEntidad->getLogoPrueba()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfLogoPrueba" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fCapturaPantalla"><?php echo constant("STR_CAPTURA_PANTALLA");?></label>&nbsp;</td>
					<td><input onkeydown="blur();" onkeypress="blur();" type="file" id="fCapturaPantalla" name="fCapturaPantalla" class="cajatexto"  /></td>
				</tr>
					...
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="javascript:abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cEntidad->getCapturaPantalla());?>');"><?php echo str_replace("_","&nbsp;", basename($cEntidad->getCapturaPantalla()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfCapturaPantalla" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fCabecera"><?php echo constant("STR_CABECERA");?></label>&nbsp;</td>
					<td><input onkeydown="blur();" onkeypress="blur();" type="file" id="fCabecera" name="fCabecera" class="cajatexto"  /></td>
				</tr>
					...
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="javascript:abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cEntidad->getCabecera());?>');"><?php echo str_replace("_","&nbsp;", basename($cEntidad->getCabecera()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfCabecera" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
