...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><input type="radio" name="LSTEstado" id="LSTEstado2" value="2"  <?php echo ($cEntidad->getEstado() != "" && strtoupper($cEntidad->getEstado()) == "2") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTEstado2">Rechazada</label>&nbsp;<input type="radio" name="LSTEstado" id="LSTEstado1" value="1"  <?php echo ($cEntidad->getEstado() != "" && strtoupper($cEntidad->getEstado()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTEstado1">Aceptada</label>&nbsp;<input type="radio" name="LSTEstado" id="LSTEstado0" value="0"  <?php echo ($cEntidad->getEstado() != "" && strtoupper($cEntidad->getEstado()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTEstado0">Pendiente</label>&nbsp;<input type="hidden" name="LSTEstadoHast" value="<?php echo $cEntidad->getEstado();?>" /></td>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="mover_dongles_next_page" value="1" />
