	...
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fFinalizado"><?php echo constant("STR_FINALIZADO");?></label>&nbsp;</td>
					<td><input type="radio" name="fFinalizado" id="fFinalizado1" value="1"  <?php echo ($cEntidad->getFinalizado() != "" && strtoupper($cEntidad->getFinalizado()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fFinalizado1">Sí</label>&nbsp;<input type="radio" name="fFinalizado" id="fFinalizado0" value="0"  <?php echo ($cEntidad->getFinalizado() != "" && strtoupper($cEntidad->getFinalizado()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fFinalizado0">No</label>&nbsp;<input type="hidden" name="fFinalizadoHast" value="<?php echo $cEntidad->getFinalizado();?>" /></td>
				</tr>
				
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fLeidoInstrucciones"><?php echo constant("STR_LEIDO_INSTRUCCIONES");?></label>&nbsp;</td>
					<td><input type="radio" name="fLeidoInstrucciones" id="fLeidoInstrucciones1" value="1"  <?php echo ($cEntidad->getLeidoInstrucciones() != "" && strtoupper($cEntidad->getLeidoInstrucciones()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fLeidoInstrucciones1">Sí</label>&nbsp;<input type="radio" name="fLeidoInstrucciones" id="fLeidoInstrucciones0" value="0"  <?php echo ($cEntidad->getLeidoInstrucciones() != "" && strtoupper($cEntidad->getLeidoInstrucciones()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fLeidoInstrucciones0">No</label>&nbsp;<input type="hidden" name="fLeidoInstruccionesHast" value="<?php echo $cEntidad->getLeidoInstrucciones();?>" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fLeidoEjemplos"><?php echo constant("STR_LEIDO_EJEMPLOS");?></label>&nbsp;</td>
					<td><input type="radio" name="fLeidoEjemplos" id="fLeidoEjemplos1" value="1"  <?php echo ($cEntidad->getLeidoEjemplos() != "" && strtoupper($cEntidad->getLeidoEjemplos()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fLeidoEjemplos1">Sí</label>&nbsp;<input type="radio" name="fLeidoEjemplos" id="fLeidoEjemplos0" value="0"  <?php echo ($cEntidad->getLeidoEjemplos() != "" && strtoupper($cEntidad->getLeidoEjemplos()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="fLeidoEjemplos0">No</label>&nbsp;<input type="hidden" name="fLeidoEjemplosHast" value="<?php echo $cEntidad->getLeidoEjemplos();?>" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fMinutos_test"><?php echo constant("STR_MINUTOS_TEST");?></label>&nbsp;</td>
					<td><input type="text" id="fMinutos_test" name="fMinutos_test" value="<?php echo $cEntidad->getMinutos_test();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fSegundos_test"><?php echo constant("STR_SEGUNDOS_TEST");?></label>&nbsp;</td>
					<td><input type="text" id="fSegundos_test" name="fSegundos_test" value="<?php echo $cEntidad->getSegundos_test();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
