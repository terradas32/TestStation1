...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdFormacion" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdFormacion() : $_POST['fIdFormacion'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="formaciones_next_page" value="<?php echo (isset($_POST['formaciones_next_page'])) ? $cUtilidades->validaXSS($_POST['formaciones_next_page']) : "1";?>" />