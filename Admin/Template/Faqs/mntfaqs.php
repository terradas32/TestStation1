...
function enviar()
{
	...
	if (validaForm()){
		lon();
		aZonaPublicacion = document.forms[0].LSTZonaPublicacion;
		sId = "";
		for(i=0; i < aZonaPublicacion.length; i++ ){
			if (aZonaPublicacion[i].type == "radio" && aZonaPublicacion[i].name == "LSTZonaPublicacion"){
				if (aZonaPublicacion[i].checked)
				{
					sId = aZonaPublicacion[i].value;
				}
			}
		}
		f.LSTZonaPublicacionHast.value=sId;
...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID");?>:", f.LSTIdFaq.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdFaqHast.value, 11, false);
	msg +=vString("<?php echo constant("STR_IDIOMA");?>:",f.LSTCodIdiomaIso2.value,2, false);
	msg +=vString("<?php echo constant("STR_PREGUNTA");?>:",f.LSTPregunta.value,16777215, false);
	msg +=vString("<?php echo constant("STR_RESPUESTA");?>:",f.LSTRespuesta.value,16777215, false);
	aZonaPublicacion = document.forms[0].LSTZonaPublicacion;
	sId = "";
	for(i=0; i < aZonaPublicacion.length; i++ ){
		if (aZonaPublicacion[i].type == "radio" && aZonaPublicacion[i].name == "LSTZonaPublicacion"){
	...
	msg +=vNumber("<?php echo constant("STR_ZONA_PUBLICACION");?>:",sId,11,false);
	...
	msg +=vNumber("<?php echo constant("STR_PUBLICAR");?>:", f.LSTPublicar.value, 1, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdFaq"><?php echo constant("STR_ID");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdFaq" name="LSTIdFaq" value="<?php echo $cEntidad->getIdFaq();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdFaqHast" name="LSTIdFaqHast" value="<?php echo $cEntidad->getIdFaqHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPregunta"><?php echo constant("STR_PREGUNTA");?></label>&nbsp;</td>
					<td><input type="text" id="LSTPregunta" name="LSTPregunta" value="<?php echo $cEntidad->getPregunta();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTRespuesta"><?php echo constant("STR_RESPUESTA");?></label>&nbsp;</td>
					<td><input type="text" id="LSTRespuesta" name="LSTRespuesta" value="<?php echo $cEntidad->getRespuesta();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTZonaPublicacion"><?php echo constant("STR_ZONA_PUBLICACION");?></label>&nbsp;</td>
					<td><input type="radio" name="LSTZonaPublicacion" id="LSTZonaPublicacion0" value="0"  <?php echo ($cEntidad->getZonaPublicacion() != "" && strtoupper($cEntidad->getZonaPublicacion()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTZonaPublicacion0">Empresa</label>&nbsp;<input type="radio" name="LSTZonaPublicacion" id="LSTZonaPublicacion1" value="1"  <?php echo ($cEntidad->getZonaPublicacion() != "" && strtoupper($cEntidad->getZonaPublicacion()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTZonaPublicacion1">Candidato</label>&nbsp;<input type="hidden" name="LSTZonaPublicacionHast" value="<?php echo $cEntidad->getZonaPublicacion();?>" /></td>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTPublicar"><?php echo constant("STR_PUBLICAR");?></label>&nbsp;</td>
					
				    <td>
					   <select id="LSTPublicar" name="LSTPublicar" size="1" class="cajatexto">
							<option value="" <?php echo ($cEntidad->getPublicar() == "") ? "selected=\"selected\"" : "";?>><?php echo constant("SLC_OPCION");?></option>
							<option value="0" <?php echo ($cEntidad->getPublicar() == "0") ? "selected=\"selected\"" : "";?>><?php echo constant("STR_ACTIVO");?></option>
							<option value="1" <?php echo ($cEntidad->getPublicar() == "1") ? "selected=\"selected\"" : "";?>><?php echo constant("STR_NO_ACTIVO");?></option>
					   </select>
				    </td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idFaq' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idFaq') ? "selected='selected'" : "";?>><?php echo constant("STR_ID");?></option>
							<option style='color:#000000;' value='pregunta' <?php echo (!empty($sOrderBy) && $sOrderBy == 'pregunta') ? "selected='selected'" : "";?>><?php echo constant("STR_PREGUNTA");?></option>
							<option style='color:#000000;' value='respuesta' <?php echo (!empty($sOrderBy) && $sOrderBy == 'respuesta') ? "selected='selected'" : "";?>><?php echo constant("STR_RESPUESTA");?></option>
							<option style='color:#000000;' value='zonaPublicacion' <?php echo (!empty($sOrderBy) && $sOrderBy == 'zonaPublicacion') ? "selected='selected'" : "";?>><?php echo constant("STR_ZONA_PUBLICACION");?></option>
							...
							<option style='color:#000000;' value='publicar' <?php echo (!empty($sOrderBy) && $sOrderBy == 'publicar') ? "selected='selected'" : "";?>><?php echo constant("STR_PUBLICAR");?></option>
	...
	<input type="hidden" name="faqs_next_page" value="1" /></div>
