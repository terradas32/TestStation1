...
function setPK(idUsuario,idEmpresa)
{
	var f=document.forms[0];
...
<?php ob_start();?>
	<table cellspacing="1" cellpadding="2" border="0" width="100%">
		...
		<tr onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER");?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT");?>'" bgcolor="<?php echo constant("ONMOUSEOUT");?>">
			...
			<td class="negro" valign="top" style="cursor:pointer;" onclick="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['idUsuario']));?>"><?php echo substr(str_replace("\n","<br />",strip_tags(html_entity_decode($lista->fields['idUsuario']), "<b><i><u><strong><br><br />")),0,11);?></td>
			<td class="negro" valign="top" style="cursor:pointer;" onclick="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['usuario']));?>"><?php echo substr(str_replace("\n","<br />",strip_tags(html_entity_decode($lista->fields['usuario']), "<b><i><u><strong><br><br />")),0,255);?></td>
			<td class="negro" valign="top" style="cursor:pointer;" onclick="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['nombre']));?>"><?php echo substr(str_replace("\n","<br />",strip_tags(html_entity_decode($lista->fields['nombre']), "<b><i><u><strong><br><br />")),0,255);?></td>
			<td class="negro" valign="top" style="cursor:pointer;" onclick="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['apellido1']));?>"><?php echo substr(str_replace("\n","<br />",strip_tags(html_entity_decode($lista->fields['apellido1']), "<b><i><u><strong><br><br />")),0,255);?></td>
			<td class="negro" valign="top" style="cursor:pointer;" onclick="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['apellido2']));?>"><?php echo substr(str_replace("\n","<br />",strip_tags(html_entity_decode($lista->fields['apellido2']), "<b><i><u><strong><br><br />")),0,255);?></td>
			<td class="negro" valign="top" style="cursor:pointer;" onclick="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['email']));?>"><?php echo substr(str_replace("\n","<br />",strip_tags(html_entity_decode($lista->fields['email']), "<b><i><u><strong><br><br />")),0,255);?></td>
			<td class="negro" valign="top" style="cursor:pointer;" onclick="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['fecAlta']));?>"><script language="javascript" type="text/javascript">document.write(formatThisDate('<?php echo $lista->fields['fecAlta'];?>'));</script></td>
			<td class="negro" valign="top" style="cursor:pointer;" onclick="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['fecMod']));?>"><script language="javascript" type="text/javascript">document.write(formatThisDate('<?php echo $lista->fields['fecMod'];?>'));</script></td>
			<td class="negro" valign="top" style="cursor:pointer;" onclick="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['fecBaja']));?>"><script language="javascript" type="text/javascript">document.write(formatThisDate('<?php echo $lista->fields['fecBaja'];?>'));</script></td>
			<td class="negro" align="center"><a href="#" onclick="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['bajaLog']));?>" class="negro"><?php echo (empty($lista->fields['bajaLog'])) ? "<img src=\"" . constant("DIR_WS_GRAF") . "boloverde.gif\" width='9' height='9' border='0' alt=\"" . constant("STR_ACTIVO") . "\" />" : "<img src=\"" . constant("DIR_WS_GRAF") . "bolorojo.gif\" width='9' height='9' border='0' alt=\"" . constant("STR_NO_ACTIVO") . "\" />";?></a></td>
			<td class="negro" valign="top" style="cursor:pointer;" onclick="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags(html_entity_decode($lista->fields['idEmpresa']));?>"><?php echo substr($comboEMPRESAS->getDescripcionCombo($lista->fields['idEmpresa']),0,11);?></td>
			<td class="negro" align="center"><?php if (!empty($lista->fields['idUsuario'])){;?><a href="javascript:setPK('<?php echo $lista->fields['idUsuario'];?>','<?php echo $lista->fields['idEmpresa'];?>');confBorrar(<?php echo constant("MNT_BORRAR");?>,'<?php echo constant("DEL_GENERICO");?>');"><?php echo ($_bBorrar) ? "<img src='" . constant("DIR_WS_GRAF") . "menos.gif' width='9' height='9' border='0' alt=\"" . constant("STR_BORRAR") . "\">" : "";?></a><?php }else{echo("&nbsp;");};?></td>
		</tr>
		<?php $i++;
		$lista->MoveNext();
		} ?>
...
<?php $aBuscador= $cEntidad->getBusqueda();?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width='10'><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width='10' height="1" border="0" alt="" /></td>
			<td width="100%" colspan="2" align='left' class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"),str_replace('_', ' ', 'usuarios_de_empresa'));?></td>
		</tr>
		<tr>
			<td width='10'><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width='10' height="1" border="0" alt="" /></td>
	...
	<input type="hidden" name="LSTUsuario" value="<?php echo (isset($_POST['LSTUsuario'])) ? $_POST['LSTUsuario'] : "";?>" />
