...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.fDescripcion.value,25000,false);
	msg +=vString("<?php echo constant("STR_IMAGEN_1");?>:",f.fPath1.value,255,false);
	msg +=vString("<?php echo constant("STR_IMAGEN_2");?>:",f.fPath2.value,255,false);
	msg +=vString("<?php echo constant("STR_IMAGEN_3");?>:",f.fPath3.value,255,false);
	msg +=vString("<?php echo constant("STR_IMAGEN_4");?>:",f.fPath4.value,255,false);
	...
	msg +=vNumber("<?php echo constant("STR_BAJA_LOGICA");?>:",f.fBajaLog.value,1,true);
if (msg != "") {
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fEnunciado"><?php echo constant("STR_ENUNCIADO");?></label>&nbsp;</td>
					<td><textarea id="fEnunciado" name="fEnunciado" rows="6" cols="1" class="cajatexto"  onchange="javascript:trim(this);"><?php echo $cEntidad->getEnunciado();?></textarea></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPath1"><?php echo constant("STR_IMAGEN_1");?></label>&nbsp;</td>
					<td><input onkeydown="blur();" onkeypress="blur();" type="file" id="fPath1" name="fPath1" class="cajatexto"  /></td>
				</tr>
					<?php if ($cEntidad->getPath1() != "")
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cEntidad->getPath1());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="javascript:abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cEntidad->getPath1());?>');"><?php echo str_replace("_","&nbsp;", basename($cEntidad->getPath1()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath1" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPath2"><?php echo constant("STR_IMAGEN_2");?></label>&nbsp;</td>
					<td><input onkeydown="blur();" onkeypress="blur();" type="file" id="fPath2" name="fPath2" class="cajatexto"  /></td>
				</tr>
					<?php if ($cEntidad->getPath2() != "")
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cEntidad->getPath2());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="javascript:abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cEntidad->getPath2());?>');"><?php echo str_replace("_","&nbsp;", basename($cEntidad->getPath2()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath2" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPath3"><?php echo constant("STR_IMAGEN_3");?></label>&nbsp;</td>
					<td><input onkeydown="blur();" onkeypress="blur();" type="file" id="fPath3" name="fPath3" class="cajatexto"  /></td>
				</tr>
					<?php if ($cEntidad->getPath3() != "")
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cEntidad->getPath3());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="javascript:abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cEntidad->getPath3());?>');"><?php echo str_replace("_","&nbsp;", basename($cEntidad->getPath3()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath3" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPath4"><?php echo constant("STR_IMAGEN_4");?></label>&nbsp;</td>
					<td><input onkeydown="blur();" onkeypress="blur();" type="file" id="fPath4" name="fPath4" class="cajatexto"  /></td>
				</tr>
					<?php if ($cEntidad->getPath4() != "")
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cEntidad->getPath4());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="javascript:abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cEntidad->getPath4());?>');"><?php echo str_replace("_","&nbsp;", basename($cEntidad->getPath4()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath4" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fCorrecto"><?php echo constant("STR_CORRECTO");?></label>&nbsp;</td>
					<td><input type="text" id="fCorrecto" name="fCorrecto" value="<?php echo $cEntidad->getCorrecto();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fOrden"><?php echo constant("STR_ORDEN");?></label>&nbsp;</td>
					<td><input type="text" id="fOrden" name="fOrden" value="<?php echo $cEntidad->getOrden();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fBajaLog"><?php echo constant("STR_BAJA_LOGICA");?></label>&nbsp;</td>
	...
	<input type="hidden" name="fIdEjemplo" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdEjemplo() : $_POST['fIdEjemplo'];?>" />
	...
	<input type="hidden" name="ejemplos_next_page" value="<?php echo (isset($_POST['ejemplos_next_page'])) ? $cUtilidades->validaXSS($_POST['ejemplos_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							...
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdPrueba").show().load("jQuery.php",{sPG:"combopruebas",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdPrueba",fJSProp:"cambiaIdPrueba",fCodIdiomaIso2:f.fCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdPrueba();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
