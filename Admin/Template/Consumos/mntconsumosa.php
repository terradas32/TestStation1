		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><?php $comboWI_IDIOMAS->setNombre("fCodIdiomaInforme");?><?php echo $comboWI_IDIOMAS->getHTMLCombo("1","obliga",$cEntidad->getCodIdiomaInforme()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdTipoInforme"><?php echo constant("STR_INFORME");?></label>&nbsp;</td>
					<td><?php $comboTIPOS_INFORMES->setNombre("fIdTipoInforme");?><?php echo $comboTIPOS_INFORMES->getHTMLCombo("1","obliga",$cEntidad->getIdTipoInforme()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdBaremo"><?php echo constant("STR_BAREMO");?></label>&nbsp;</td>
					<td><?php $comboBAREMOS->setNombre("fIdBaremo");?><?php echo $comboBAREMOS->getHTMLCombo("1","obliga",$cEntidad->getIdBaremo()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fNomEmpresa"><?php echo constant("STR_NOMBRE_EMPRESA");?></label>&nbsp;</td>
					<td><input type="text" id="fNomEmpresa" name="fNomEmpresa" value="<?php echo $cEntidad->getNomEmpresa();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fNomProceso"><?php echo constant("STR_NOMBRE_PROCESO");?></label>&nbsp;</td>
					<td><input type="text" id="fNomProceso" name="fNomProceso" value="<?php echo $cEntidad->getNomProceso();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					<td><input type="text" id="fNomCandidato" name="fNomCandidato" value="<?php echo $cEntidad->getNomCandidato();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><input type="text" id="fDni" name="fDni" value="<?php echo $cEntidad->getDni();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><input type="text" id="fNomPrueba" name="fNomPrueba" value="<?php echo $cEntidad->getNomPrueba();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fNomInforme"><?php echo constant("STR_INFORME");?></label>&nbsp;</td>
					<td><input type="text" id="fNomInforme" name="fNomInforme" value="<?php echo $cEntidad->getNomInforme();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fNomBaremo"><?php echo constant("STR_BAREMO");?></label>&nbsp;</td>
					<td><input type="text" id="fNomBaremo" name="fNomBaremo" value="<?php echo $cEntidad->getNomBaremo();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fConcepto"><?php echo constant("STR_CONCEPTO");?></label>&nbsp;</td>
					<td><input type="text" id="fConcepto" name="fConcepto" value="<?php echo $cEntidad->getConcepto();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fUnidades"><?php echo constant("STR_UNIDADES");?></label>&nbsp;</td>
					<td><input type="text" id="fUnidades" name="fUnidades" value="<?php echo $cEntidad->getUnidades();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
