...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_PATH1");?>:",f.LSTPath1.value,255, false);
	msg +=vString("<?php echo constant("STR_PATH2");?>:",f.LSTPath2.value,255, false);
	msg +=vString("<?php echo constant("STR_PATH3");?>:",f.LSTPath3.value,255, false);
	msg +=vString("<?php echo constant("STR_PATH4");?>:",f.LSTPath4.value,255, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_ID_EJEMPLO");?>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" name="LSTIdEjemplo" value="<?php echo $cEntidad->getIdEjemplo();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" name="LSTIdEjemploHast" value="<?php echo $cEntidad->getIdEjemploHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_PATH1");?>&nbsp;</td>
					<td><input type="text" name="LSTPath1" value="<?php echo $cEntidad->getPath1();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_PATH2");?>&nbsp;</td>
					<td><input type="text" name="LSTPath2" value="<?php echo $cEntidad->getPath2();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_PATH3");?>&nbsp;</td>
					<td><input type="text" name="LSTPath3" value="<?php echo $cEntidad->getPath3();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_PATH4");?>&nbsp;</td>
					<td><input type="text" name="LSTPath4" value="<?php echo $cEntidad->getPath4();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" name="LSTOrden" value="<?php echo $cEntidad->getOrden();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" name="LSTOrdenHast" value="<?php echo $cEntidad->getOrdenHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='path1' <?php echo (!empty($sOrderBy) && $sOrderBy == 'path1') ? "selected='selected'" : "";?>><?php echo constant("STR_PATH1");?></option>
							<option style='color:#000000;' value='path2' <?php echo (!empty($sOrderBy) && $sOrderBy == 'path2') ? "selected='selected'" : "";?>><?php echo constant("STR_PATH2");?></option>
							<option style='color:#000000;' value='path3' <?php echo (!empty($sOrderBy) && $sOrderBy == 'path3') ? "selected='selected'" : "";?>><?php echo constant("STR_PATH3");?></option>
							<option style='color:#000000;' value='path4' <?php echo (!empty($sOrderBy) && $sOrderBy == 'path4') ? "selected='selected'" : "";?>><?php echo constant("STR_PATH4");?></option>
	...
	<input type="hidden" name="ejemplos_next_page" value="1" /></div>
