...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_ENUNCIADO");?>:",f.fEnunciado.value,16700,false);
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.fDescripcionItem.value,16700,false);
		...
		<div style="width: 100%">
			<table cellspacing="2" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td>
						<textarea name="fEnunciado" cols="50" rows="5"><?php echo $cItems->getEnunciado();?></textarea>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					<td>
						<textarea name="fDescripcionItem" cols="50" rows="5"><?php echo $cItems->getDescripcion();?></textarea>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cItems->getPath1());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cItems->getPath1());?>');"><?php echo str_replace("_","&nbsp;", basename($cItems->getPath1()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath1" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cItems->getPath2());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cItems->getPath2());?>');"><?php echo str_replace("_","&nbsp;", basename($cItems->getPath2()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath2" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cItems->getPath3());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cItems->getPath3());?>');"><?php echo str_replace("_","&nbsp;", basename($cItems->getPath3()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath3" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cItems->getPath4());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cItems->getPath4());?>');"><?php echo str_replace("_","&nbsp;", basename($cItems->getPath4()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath4" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>				
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_CORRECTO");?>&nbsp;</td>
					<td><input type="text" name="fCorrecto" value="<?php echo $cItems->getCorrecto();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_ORDEN");?>&nbsp;</td>
					<td><input type="text" name="fOrden" value="<?php echo $cItems->getOrden();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				    ...
				    <td>
					   <select name="fBajaLog" size="1">
						  <option value="0" <?php echo ($cItems->getBajaLog() == "0") ? "selected" : "";?>><?php echo constant("STR_ACTIVO");?></option>
						  <option value="1" <?php echo ($cItems->getBajaLog() == "1") ? "selected" : "";?>><?php echo constant("STR_NO_ACTIVO");?></option>
					   </select>
				    </td>
	...
	<table cellspacing="0" cellpadding="0" border="0">
		<tr>
			...
			<?php if($_POST['MODO']== constant('MNT_MODIFICAR')){?>
				<td><input type="button" class="botonesgrandes" id="" name="btnGestionaOpciones" value="<?php echo constant("STR_GESTIONAR_OPCIONES");?>" onclick="document.forms[0].MODO.value=<?php echo constant('MNT_LISTAR')?>;document.forms[0].fOpcion.value=1;document.forms[0].submit();"/></td>
			<?php } ?>
		</tr>
	</table>
	</div>
