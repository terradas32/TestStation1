...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_CODIGO");?>:",f.LSTCodigo.value,255, false);
	...
	msg +=vNumber("<?php echo constant("STR_TIPO_PRUEBA");?>:", f.LSTIdTipoPrueba.value, 11, false);
	msg +=vNumber("Razonamiento:", f.LSTIdTipoRazonamiento.value, 11, false);
	msg +=vNumber("Nivel:", f.LSTIdTipoNivel.value, 11, false);
	msg +=vString("<?php echo constant("STR_OBSERVACIONES");?>:",f.LSTObservaciones.value,255, false);
	msg +=vString("<?php echo constant("STR_DURACION");?>:",f.LSTDuracion.value,255, false);
	msg +=vString("<?php echo constant("STR_LOGO_PRUEBA");?>:",f.LSTLogoPrueba.value,255, false);
	msg +=vString("<?php echo constant("STR_CAPTURA_PANTALLA");?>:",f.LSTCapturaPantalla.value,255, false);
	msg +=vString("<?php echo constant("STR_CABECERA");?>:",f.LSTCabecera.value,255, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTCodigo"><?php echo constant("STR_CODIGO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTCodigo" name="LSTCodigo" value="<?php echo $cEntidad->getCodigo();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoPrueba"><?php echo constant("STR_TIPO_PRUEBA");?></label>&nbsp;</td>
					<td><?php $comboTIPOS_PRUEBA->setNombre("LSTIdTipoPrueba");?><?php echo $comboTIPOS_PRUEBA->getHTMLCombo("1","cajatexto",$cEntidad->getIdTipoPrueba()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoRazonamiento">Razonamiento</label>&nbsp;</td>
					<td><?php $comboTIPOS_RAZONAMIENTOS->setNombre("LSTIdTipoRazonamiento");?><?php echo $comboTIPOS_RAZONAMIENTOS->getHTMLCombo("1","cajatexto",$cEntidad->getIdTipoRazonamiento()," ","");?></td>
				</tr>
				
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoNivel">Nivel</label>&nbsp;</td>
					<td><?php $comboTIPOS_NIVELES->setNombre("LSTIdTipoNivel");?><?php echo $comboTIPOS_NIVELES->getHTMLCombo("1","cajatexto",$cEntidad->getIdTipoNivel()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTDuracion"><?php echo constant("STR_DURACION");?></label>&nbsp;</td>
					<td><input type="text" id="LSTDuracion" name="LSTDuracion" value="<?php echo $cEntidad->getDuracion();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTDuracion2"><?php echo constant("STR_DURACION2");?></label>&nbsp;</td>
					<td><input type="text" id="LSTDuracion2" name="LSTDuracion2" value="<?php echo $cEntidad->getDuracion2();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTLogoPrueba"><?php echo constant("STR_LOGO_PRUEBA");?></label>&nbsp;</td>
					<td><input type="text" id="LSTLogoPrueba" name="LSTLogoPrueba" value="<?php echo $cEntidad->getLogoPrueba();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTCapturaPantalla"><?php echo constant("STR_CAPTURA_PANTALLA");?></label>&nbsp;</td>
					<td><input type="text" id="LSTCapturaPantalla" name="LSTCapturaPantalla" value="<?php echo $cEntidad->getCapturaPantalla();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idPrueba' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idPrueba') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_PRUEBA");?></option>
							<option style='color:#000000;' value='codigo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'codigo') ? "selected='selected'" : "";?>><?php echo constant("STR_CODIGO");?></option>
							...
							<option style='color:#000000;' value='duracion' <?php echo (!empty($sOrderBy) && $sOrderBy == 'duracion') ? "selected='selected'" : "";?>><?php echo constant("STR_DURACION");?></option>
							<option style='color:#000000;' value='duracion2' <?php echo (!empty($sOrderBy) && $sOrderBy == 'duracion2') ? "selected='selected'" : "";?>><?php echo constant("STR_DURACION2");?></option>
							<option style='color:#000000;' value='logoPrueba' <?php echo (!empty($sOrderBy) && $sOrderBy == 'logoPrueba') ? "selected='selected'" : "";?>><?php echo constant("STR_LOGO_PRUEBA");?></option>
							<option style='color:#000000;' value='capturaPantalla' <?php echo (!empty($sOrderBy) && $sOrderBy == 'capturaPantalla') ? "selected='selected'" : "";?>><?php echo constant("STR_CAPTURA_PANTALLA");?></option>
							<option style='color:#000000;' value='cabecera' <?php echo (!empty($sOrderBy) && $sOrderBy == 'cabecera') ? "selected='selected'" : "";?>><?php echo constant("STR_CABECERA");?></option>
	...
	<input type="hidden" name="pruebas_next_page" value="1" /></div>
