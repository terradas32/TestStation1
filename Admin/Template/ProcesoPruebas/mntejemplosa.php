...
<?php
	...
	$cPruebas->setIdPrueba($cEjemplos->getIdPrueba());
	$cPruebas->setCodIdiomaIso2($cEjemplos->getCodIdiomaIso2());
...
function enviar()
{
	...
	f.fEjemplo.value=1;
	f.fIdPrueba.disabled=false;
	f.fCodIdiomaIso2.disabled=false;
	if (validaForm()){
		lon();
		return true;
	}else	return false;
...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_ENUNCIADO");?>:",f.fEnunciado.value,25000,false);
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.fDescripcionItem.value,25000,false);
	msg +=vString("<?php echo constant("STR_CORRECTO");?>:",f.fCorrecto.value,255,false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="2" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td>
						<textarea name="fEnunciado" cols="50" rows="5"><?php echo $cEjemplos->getEnunciado();?></textarea>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					...
					<td>
						<textarea name="fDescripcionItem" cols="50" rows="5"><?php echo $cEjemplos->getDescripcion();?></textarea>
					</td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_IMAGEN");?>1&nbsp;</td>
					<td><input onkeydown="blur();" onkeypress="blur();" type="file" name="fPath1" class="cajatexto"  /></td>
				</tr>
					<?php if ($cEjemplos->getPath1() != "")
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cEjemplos->getPath1());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cEjemplos->getPath1());?>');"><?php echo str_replace("_","&nbsp;", basename($cEjemplos->getPath1()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath1" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_IMAGEN");?>2&nbsp;</td>
					<td><input onkeydown="blur();" onkeypress="blur();" type="file" name="fPath2" class="cajatexto"  /></td>
				</tr>
					<?php if ($cEjemplos->getPath2() != "")
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cEjemplos->getPath2());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cEjemplos->getPath2());?>');"><?php echo str_replace("_","&nbsp;", basename($cEjemplos->getPath2()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath2" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_IMAGEN");?>3&nbsp;</td>
					<td><input onkeydown="blur();" onkeypress="blur();" type="file" name="fPath3" class="cajatexto"  /></td>
				</tr>
					<?php if ($cEjemplos->getPath3() != "")
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cEjemplos->getPath3());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cEjemplos->getPath3());?>');"><?php echo str_replace("_","&nbsp;", basename($cEjemplos->getPath3()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath3" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_IMAGEN");?>4&nbsp;</td>
					<td><input onkeydown="blur();" onkeypress="blur();" type="file" name="fPath4" class="cajatexto"  /></td>
				</tr>
					<?php if ($cEjemplos->getPath4() != "")
					{
						$img=@getimagesize(constant("HTTP_SERVER") . $cEjemplos->getPath4());
						$bIimg = (empty($img)) ? 0 : 1;
					?>
						<tr>
							<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
							<td width="140" class="negrob" valign="top">&nbsp;</td>
							<td>&nbsp;<a class="azul" href="#" onclick="abrirVentana('<?php echo $bIimg;?>','<?php echo base64_encode(constant("HTTP_SERVER") . $cEjemplos->getPath4());?>');"><?php echo str_replace("_","&nbsp;", basename($cEjemplos->getPath4()));?></a>&nbsp;<input onmouseover="this.style.cursor='pointer'" type="checkbox" name="cfPath4" />&nbsp;<?php echo constant("STR_QUITAR");?></td>
						</tr>
					<?php } ?>				
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_CORRECTO");?>&nbsp;</td>
					<td><input type="text" name="fCorrecto" value="<?php echo $cEjemplos->getCorrecto();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_ORDEN");?>&nbsp;</td>
					<td><input type="text" name="fOrden" value="<?php echo $cEjemplos->getOrden();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				    ...
				    <td>
					   <select name="fBajaLog" size="1">
						  <option value="0" <?php echo ($cEjemplos->getBajaLog() == "0") ? "selected" : "";?>><?php echo constant("STR_ACTIVO");?></option>
						  <option value="1" <?php echo ($cEjemplos->getBajaLog() == "1") ? "selected" : "";?>><?php echo constant("STR_NO_ACTIVO");?></option>
					   </select>
				    </td>
	...
	<table cellspacing="0" cellpadding="0" border="0">
		<tr>
			<td><input type="button" class="botones" id="bid-volver" name="btnAdd" value="<?php echo constant("STR_VOLVER");?>" onclick="document.forms[0].MODO.value=document.forms[0].ORIGEN.value;document.forms[0].fEjemplo.value=1;document.forms[0].fCodIdiomaIso2.disabled=false;document.forms[0].submit();" /></td>
			...
			<?php if($_POST['MODO']== constant('MNT_MODIFICAR')){?>
				<td><input type="button" class="botonesgrandes" id="" name="btnGestionaOpciones" value="<?php echo constant("STR_GESTIONAR_OPCIONES");?>" onclick="document.forms[0].MODO.value=<?php echo constant('MNT_LISTAR')?>;document.forms[0].fOpcionEjemplo.value=1;document.forms[0].submit();"/></td>
			<?php } ?>
		</tr>
	</table>
	</div>
	...
	<input type="hidden" name="fIdEjemplo" value="<?php echo $cEjemplos->getIdEjemplo();?>" />
	<input type="hidden" name="fFecAlta" value="<?php echo $cEjemplos->getFecAlta();?>" />
	<input type="hidden" name="fFecMod" value="<?php echo $cEjemplos->getFecMod();?>" />
	<input type="hidden" name="fUsuAlta" value="<?php echo $cEjemplos->getUsuAlta();?>" />
	<input type="hidden" name="fUsuMod" value="<?php echo $cEjemplos->getUsuMod();?>" />
	...
	<input type="hidden" name="ejemplos_next_page" value="<?php echo (isset($_POST['ejemplos_next_page'])) ? $cUtilidades->validaXSS($_POST['ejemplos_next_page']) : "1";?>" />
	</div>
