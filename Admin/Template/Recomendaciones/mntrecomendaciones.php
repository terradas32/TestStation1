...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID");?>:", f.LSTIdRecomendacion.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdRecomendacionHast.value, 11, false);
	msg +=vString("<?php echo constant("STR_IDIOMA");?>:",f.LSTCodIdiomaIso2.value,2, false);
	msg +=vString("<?php echo constant("STR_TITULO");?>:",f.LSTTitulo.value,16777215, false);
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.LSTDescripcion.value,16777215, false);
	aZonaPublicacion = document.forms[0].LSTZonaPublicacion;
	sId = "";
	for(i=0; i < aZonaPublicacion.length; i++ ){
		if (aZonaPublicacion[i].type == "radio" && aZonaPublicacion[i].name == "LSTZonaPublicacion"){
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdRecomendacion"><?php echo constant("STR_ID");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdRecomendacion" name="LSTIdRecomendacion" value="<?php echo $cEntidad->getIdRecomendacion();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdRecomendacionHast" name="LSTIdRecomendacionHast" value="<?php echo $cEntidad->getIdRecomendacionHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTTitulo"><?php echo constant("STR_TITULO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTTitulo" name="LSTTitulo" value="<?php echo $cEntidad->getTitulo();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idRecomendacion' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idRecomendacion') ? "selected='selected'" : "";?>><?php echo constant("STR_ID");?></option>
							<option style='color:#000000;' value='titulo' <?php echo (!empty($sOrderBy) && $sOrderBy == 'titulo') ? "selected='selected'" : "";?>><?php echo constant("STR_TITULO");?></option>
	...
	<input type="hidden" name="recomendaciones_next_page" value="1" /></div>
