...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_TITULO");?>:",f.fTitulo.value,16777215,true);
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.fDescripcion.value,16777215,true);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fTitulo"><?php echo constant("STR_TITULO");?></label>&nbsp;</td>
					<td><textarea id="fTitulo" name="fTitulo" rows="6" cols="1" class="obliga"  onchange="javascript:trim(this);"><?php echo $cEntidad->getTitulo();?></textarea></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fDescripcion"><?php echo constant("STR_DESCRIPCION");?></label>&nbsp;</td>
					<td><textarea id="fDescripcion" name="fDescripcion" rows="6" cols="1" class="obliga"  onchange="javascript:trim(this);"><?php echo $cEntidad->getDescripcion();?></textarea></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="fIdRecomendacion" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdRecomendacion() : $_POST['fIdRecomendacion'];?>" />
	...
	<input type="hidden" name="recomendaciones_next_page" value="<?php echo (isset($_POST['recomendaciones_next_page'])) ? $cUtilidades->validaXSS($_POST['recomendaciones_next_page']) : "1";?>" /></div>
