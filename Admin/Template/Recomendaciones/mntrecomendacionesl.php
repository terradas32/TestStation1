...
function setPK(idRecomendacion,codIdiomaIso2)
{
	var f=document.forms[0];
	f.fIdRecomendacion.value=idRecomendacion;
...
<?php ob_start();?>
	<table cellspacing="1" cellpadding="2" border="0" width="100%">
		<tr>
			...
			$sPinta = "";
			$sOrden = "ASC";
			if ($cEntidad->getOrderBy() == "idRecomendacion"){
			...
			?>
			<td class="tdnaranjab" align="center"><a title="<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo htmlentities(constant("STR_TITULO"), ENT_COMPAT, "UTF-8");?>" href="#" class="tdnaranjab" style="color:#ffffff" onclick="javascript:document.forms[0].fReordenar.value=1;document.forms[0].LSTOrderBy.value='titulo';document.forms[0].LSTOrder.value='<?php echo $sOrden;?>';enviar('<?php echo constant("MNT_LISTAR");?>');" onmouseout="window.status='';return true" onmouseover="window.status='<?php echo constant("STR_ORDENAR_POR");?> >>> <?php echo addslashes(constant("STR_TITULO"));?>';return true"><?php echo constant("STR_TITULO");?><?php echo $sPinta;?></a></td>
			<?php 
			$sPinta = "";
			$sOrden = "ASC";
		...
		<tr onmouseover="this.bgColor='<?php echo constant("ONMOUSEOVER");?>'" onmouseout="this.bgColor='<?php echo constant("ONMOUSEOUT");?>'" bgcolor="<?php echo constant("ONMOUSEOUT");?>">
			...
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRecomendacion']);?>','<?php echo addslashes($lista->fields['codIdiomaIso2']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['idRecomendacion']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['idRecomendacion'], "<b><i><u><strong><br><br />")),0,11);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRecomendacion']);?>','<?php echo addslashes($lista->fields['codIdiomaIso2']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['codIdiomaIso2']);?>"><?php echo $comboWI_IDIOMAS->getDescripcionCombo($lista->fields['codIdiomaIso2']);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRecomendacion']);?>','<?php echo addslashes($lista->fields['codIdiomaIso2']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['titulo']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['titulo'], "<b><i><u><strong><br><br />")),0,16777215);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRecomendacion']);?>','<?php echo addslashes($lista->fields['codIdiomaIso2']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['descripcion']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['descripcion'], "<b><i><u><strong><br><br />")),0,16777215);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRecomendacion']);?>','<?php echo addslashes($lista->fields['codIdiomaIso2']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['zonaPublicacion']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['zonaPublicacion'], "<b><i><u><strong><br><br />")),0,11);?></td>
			<td class="tddatoslista" valign="top" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRecomendacion']);?>','<?php echo addslashes($lista->fields['codIdiomaIso2']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['orden']);?>"><?php echo substr(str_replace("\n","<br />",strip_tags($lista->fields['orden'], "<b><i><u><strong><br><br />")),0,11);?></td>
			<td class="tddatoslista" align="center" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRecomendacion']);?>','<?php echo addslashes($lista->fields['codIdiomaIso2']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['publicar']);?>"><?php echo (empty($lista->fields['publicar'])) ? "<img src='" . constant("DIR_WS_GRAF") . "boloverde.gif' width='9' height='9' border='0' alt='" . constant("STR_ACTIVO") . "'>" : "<img src='" . constant("DIR_WS_GRAF") . "bolorojo.gif' width='9' height='9' border='0' alt='" . constant("STR_NO_ACTIVO") . "'>";?></td>
			<td class="tddatoslista" valign="top" align="center" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRecomendacion']);?>','<?php echo addslashes($lista->fields['codIdiomaIso2']);?>');enviar(<?php echo constant("MNT_CONSULTAR");?>);" title="<?php echo strip_tags($lista->fields['fecAlta']);?>"><script language="javascript" type="text/javascript">document.write(formatThisDate('<?php echo $lista->fields['fecAlta'];?>'));</script></td>
			...
			<td class="negro" align="center" valign="middle"><?php if($_bBorrar) {?><a href="#" onclick="javascript:setPK('<?php echo addslashes($lista->fields['idRecomendacion']);?>','<?php echo addslashes($lista->fields['codIdiomaIso2']);?>');confBorrar(<?php echo constant("MNT_BORRAR");?>,'<?php echo constant("DEL_GENERICO");?>');"><img src="<?php echo constant('DIR_WS_GRAF');?>menos.gif" width="9" height="9" border="0" alt="<?php echo constant("STR_BORRAR");?>" /></a><?php }?></td>
		</tr>
		<?php $i++;
		$lista->MoveNext();
		} ?>
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
			<td width="100%" colspan="2" class="naranjab"><?php echo sprintf(constant("STR_LISTA_DE_"),str_replace('_', ' ', constant("STR_RECOMENDACIONES")));?><a href="#_" onclick="javascript:document.forms[0].action='sqlToExcel.php';document.forms[0].submit();document.forms[0].action='<?php echo $_SERVER['PHP_SELF'];?>';"><img src="<?php echo constant('DIR_WS_GRAF');?>excel.gif" width="34" height="35" align="right" border="0" alt="<?php echo constant("STR_EXPORTAR_A_EXCEL");?>" /></a></td>
		</tr>
		<tr>
			<td width="10"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="10" height="1" border="0" alt="" /></td>
	...
	<br />
	<input type="hidden" name="fIdRecomendacion" value="" />
	...
	<input type="hidden" name="fSQLtoEXCEL" value="<?php echo base64_encode($sql . constant("CHAR_SEPARA") . "recomendaciones");?>" />
	<input type="hidden" name="LSTIdRecomendacionHast" value="<?php echo (isset($_POST['LSTIdRecomendacionHast'])) ? $cUtilidades->validaXSS($_POST['LSTIdRecomendacionHast']) : "";?>" />
	<input type="hidden" name="LSTIdRecomendacion" value="<?php echo (isset($_POST['LSTIdRecomendacion'])) ? $cUtilidades->validaXSS($_POST['LSTIdRecomendacion']) : "";?>" />
	...
	<input type="hidden" name="LSTTitulo" value="<?php echo (isset($_POST['LSTTitulo'])) ? $cUtilidades->validaXSS($_POST['LSTTitulo']) : "";?>" />
	...
	<input type="hidden" name="recomendaciones_next_page" value="<?php echo (isset($_POST['recomendaciones_next_page'])) ? $cUtilidades->validaXSS($_POST['recomendaciones_next_page']) : "1";?>" />
</div>
