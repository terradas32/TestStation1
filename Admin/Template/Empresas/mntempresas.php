		...
		<div id="contenido">
			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0" >
				...
				<tr>
					...
					<td><input type="radio" name="LSTDistribuidor" id="LSTDistribuidor1" value="1"  <?php echo ($cEntidad->getDistribuidor() != "" && strtoupper($cEntidad->getDistribuidor()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTDistribuidor1">Sí</label>&nbsp;<input type="radio" name="LSTDistribuidor" id="LSTDistribuidor0" value="0"  <?php echo ($cEntidad->getDistribuidor() != "" && strtoupper($cEntidad->getDistribuidor()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTDistribuidor0">No</label>&nbsp;<input type="hidden" name="LSTDistribuidorHast" value="<?php echo $cEntidad->getDistribuidor();?>" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><?php echo constant("STR_PREPAGO");?>&nbsp;</td>
					<td><input type="radio" name="LSTPrepago" id="LSTPrepago1" value="1"  <?php echo ($cEntidad->getPrepago() != "" && strtoupper($cEntidad->getPrepago()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTPrepago1">Prepago</label>&nbsp;<input type="radio" name="LSTPrepago" id="LSTPrepago0" value="0"  <?php echo ($cEntidad->getPrepago() != "" && strtoupper($cEntidad->getPrepago()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTPrepago0">Contrato</label>&nbsp;<input type="hidden" name="LSTPrepagoHast" value="<?php echo $cEntidad->getPrepago();?>" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
