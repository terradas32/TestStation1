...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_TIPO_INFORME");?>:",f.fIdTipoInforme.value,11,true);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdSeccion" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdSeccion() : $_POST['fIdSeccion'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="secciones_informes_next_page" value="<?php echo (isset($_POST['secciones_informes_next_page'])) ? $cUtilidades->validaXSS($_POST['secciones_informes_next_page']) : "1";?>" />