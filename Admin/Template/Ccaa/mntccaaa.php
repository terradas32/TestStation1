...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vString("<?php echo constant("STR_ID_COMUNIDAD");?>:",f.fIdComunidad.value,2,true);
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdComunidad"><?php echo constant("STR_ID_COMUNIDAD");?></label>&nbsp;</td><td><input type="text" id="fIdComunidad" name="fIdComunidad" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdComunidad() : $_POST['fIdComunidad'];?>" class="obliga" onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="wi_ccaa_next_page" value="<?php echo (isset($_POST['wi_ccaa_next_page'])) ? $cUtilidades->validaXSS($_POST['wi_ccaa_next_page']) : "1";?>" />