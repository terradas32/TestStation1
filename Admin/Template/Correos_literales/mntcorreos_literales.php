...
function enviar()
{
	...
	if (validaForm()){
		lon();
		aSistema = document.forms[0].LSTSistema;
		sId = "";
		for(i=0; i < aSistema.length; i++ ){
			if (aSistema[i].type == "radio" && aSistema[i].name == "LSTSistema"){
		...
		f.LSTSistemaHast.value=sId;
		aVisible = document.forms[0].LSTVisible;
		sId = "";
		for(i=0; i < aVisible.length; i++ ){
			if (aVisible[i].type == "radio" && aVisible[i].name == "LSTVisible"){
...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID");?>:", f.LSTIdLiteral.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdLiteralHast.value, 11, false);
	msg +=vString("<?php echo constant("STR_IDIOMA");?>:",f.LSTCodIdiomaIso2.value,2, false);
	msg +=vString("<?php echo constant("STR_LITERAL");?>:",f.LSTLiteral.value,255, false);
	...
	msg +=vNumber("<?php echo constant("STR_SISTEMA");?>:",sId,1,false);
	aVisible = document.forms[0].LSTVisible;
	sId = "";
	for(i=0; i < aVisible.length; i++ ){
		if (aVisible[i].type == "radio" && aVisible[i].name == "LSTVisible"){
	...
	msg +=vNumber("<?php echo constant("STR_VISIBLE");?>:",sId,1,false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdLiteral"><?php echo constant("STR_ID");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdLiteral" name="LSTIdLiteral" value="<?php echo $cEntidad->getIdLiteral();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdLiteralHast" name="LSTIdLiteralHast" value="<?php echo $cEntidad->getIdLiteralHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTLiteral"><?php echo constant("STR_LITERAL");?></label>&nbsp;</td>
					<td><input type="text" id="LSTLiteral" name="LSTLiteral" value="<?php echo $cEntidad->getLiteral();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTSistema"><?php echo constant("STR_SISTEMA");?></label>&nbsp;</td>
					<td><input type="radio" name="LSTSistema" id="LSTSistema1" value="1"  <?php echo ($cEntidad->getSistema() != "" && strtoupper($cEntidad->getSistema()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTSistema1">Sí</label>&nbsp;<input type="radio" name="LSTSistema" id="LSTSistema0" value="0"  <?php echo ($cEntidad->getSistema() != "" && strtoupper($cEntidad->getSistema()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTSistema0">No</label>&nbsp;<input type="hidden" name="LSTSistemaHast" value="<?php echo $cEntidad->getSistema();?>" /></td>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTVisible"><?php echo constant("STR_VISIBLE");?></label>&nbsp;</td>
					<td><input type="radio" name="LSTVisible" id="LSTVisible1" value="1"  <?php echo ($cEntidad->getVisible() != "" && strtoupper($cEntidad->getVisible()) == "1") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTVisible1">Sí</label>&nbsp;<input type="radio" name="LSTVisible" id="LSTVisible0" value="0"  <?php echo ($cEntidad->getVisible() != "" && strtoupper($cEntidad->getVisible()) == "0") ? "checked=\"checked\"" : "";?> />&nbsp;<label for="LSTVisible0">No</label>&nbsp;<input type="hidden" name="LSTVisibleHast" value="<?php echo $cEntidad->getVisible();?>" /></td>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idLiteral' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idLiteral') ? "selected='selected'" : "";?>><?php echo constant("STR_ID");?></option>
							<option style='color:#000000;' value='literal' <?php echo (!empty($sOrderBy) && $sOrderBy == 'literal') ? "selected='selected'" : "";?>><?php echo constant("STR_LITERAL");?></option>
							...
							<option style='color:#000000;' value='sistema' <?php echo (!empty($sOrderBy) && $sOrderBy == 'sistema') ? "selected='selected'" : "";?>><?php echo constant("STR_SISTEMA");?></option>
							<option style='color:#000000;' value='visible' <?php echo (!empty($sOrderBy) && $sOrderBy == 'visible') ? "selected='selected'" : "";?>><?php echo constant("STR_VISIBLE");?></option>
	...
	<input type="hidden" name="correos_literales_next_page" value="1" /></div>
