...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTDescCandidato"><?php echo constant("STR_NOMBRE");?> o <?php echo constant("STR_EMAIL");?></label>&nbsp;</td>
					<td><input type="text" id="LSTDescCandidato" name="LSTDescCandidato" value="<?php echo $cEntidad->getDescCandidato();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
			...
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					<td>La generación total de los informes tardará entre 48 / 72 horas</td>
				</tr>
				<tr>
					<td><span class="rojob">NO ejecutes nuevamente esta solicitud hasta haber trancurrido el plazo de 72 horas.</span></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				</tr>
	...
	<input type="hidden" name="respuestas_pruebas_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
