...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_ID_TIPO_COMPETENCIA");?>:", f.LSTIdTipoCompetencia.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_TIPO_COMPETENCIA");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdTipoCompetenciaHast.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoCompetencia"><?php echo constant("STR_ID_TIPO_COMPETENCIA");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdTipoCompetencia" name="LSTIdTipoCompetencia" value="<?php echo $cEntidad->getIdTipoCompetencia();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdTipoCompetenciaHast" name="LSTIdTipoCompetenciaHast" value="<?php echo $cEntidad->getIdTipoCompetenciaHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idTipoCompetencia' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idTipoCompetencia') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_TIPO_COMPETENCIA");?></option>
	...
	<input type="hidden" name="tipos_competencias_next_page" value="1" /></div>
