...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	...
	<input type="hidden" name="fIdArea" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdArea() : $_POST['fIdArea'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="areas_next_page" value="<?php echo (isset($_POST['areas_next_page'])) ? $cUtilidades->validaXSS($_POST['areas_next_page']) : "1";?>" />