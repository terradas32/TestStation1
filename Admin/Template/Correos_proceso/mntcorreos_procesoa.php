...
function validaForm()
{
  ...
  var editorContent = $('#tinymce[data-id="fCuerpo"]', myf.contents()).html();
	...
	msg +=vString("<?php echo constant("STR_CUERPO");?>:",editorContent,16777215,true);
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.fDescripcion.value,2500,true);
if (msg != "") {
	...
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdCorreo"><?php echo constant("STR_CORREO");?></label>&nbsp;</td>
					<td><?php $comboCORREOS->setNombre("fIdCorreo");?><?php echo $comboCORREOS->getHTMLCombo("1","obliga",$cEntidad->getIdCorreo()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="correos_proceso_next_page" value="<?php echo (isset($_POST['correos_proceso_next_page'])) ? $cUtilidades->validaXSS($_POST['correos_proceso_next_page']) : "1";?>" />
