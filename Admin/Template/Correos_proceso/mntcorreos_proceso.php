...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_CORREO");?>:", f.LSTIdCorreo.value, 11, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdCorreo"><?php echo constant("STR_CORREO");?></label>&nbsp;</td>
					<td><?php $comboCORREOS->setNombre("LSTIdCorreo");?><?php echo $comboCORREOS->getHTMLCombo("1","cajatexto",$cEntidad->getIdCorreo()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="correos_proceso_next_page" value="1" />
