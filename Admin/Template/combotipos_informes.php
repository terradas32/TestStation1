...
if (!defined ("DIR_FS_DOCUMENT_ROOT")){
    ...
    if (!$bLogado){
  	...
  	require_once(constant("DIR_FS_DOCUMENT_ROOT") . constant("DIR_WS_COM") . "Combo.php");
		...
		if ($bJoin){
			//$comboTIPOS_INFORMES= new Combo($conn, $sPrefijo . "IdTipoInforme", "DISTINCT(s.idTipoInforme)", "s.nombre", "descripcion", "tipos_informes s, suscriptorestemasboletins stm", "", constant("SLC_OPCION"), $sWhere, "idTipoInforme", "fecMod");
		}else{
			$comboTIPOS_INFORMES= new Combo($conn, $sPrefijo . "IdTipoInforme","idTipoInforme","nombre","descripcion","tipos_informes","",constant("SLC_OPCION"),$sWhere, "idTipoInforme", "fecMod");
		}
