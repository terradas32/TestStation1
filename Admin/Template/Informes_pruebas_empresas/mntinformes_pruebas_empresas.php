	...
	<input type="hidden" name="informes_pruebas_empresas_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							...
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdTipoInforme").show().load("jQuery.php",{sPG:"combotipos_informes",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdTipoInforme",fJSProp:"cambiaIdTipoInforme",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdTipoInforme();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
