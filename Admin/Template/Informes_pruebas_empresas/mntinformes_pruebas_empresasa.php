...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_ID_TIPO_INFORME");?>:",f.elements['fIdTipoInforme'].value,11,true);
	msg +=vNumber("<?php echo constant("STR_TARIFA");?>:",f.fTarifa.value,11,true);
	msg +=vNumber("<?php echo "Precio";?>:",f.fPrecio.value,11,true);
	
	msg +=vNumber("<?php echo constant("STR_N_VECES_DESCARGADO");?>:",f.fNVecesDescargado.value,11,true);
if (msg != "") {
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdTipoInforme"><?php echo constant("STR_ID_TIPO_INFORME");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fTarifa"><?php echo constant("STR_TARIFA");?></label>&nbsp;</td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fPrecio"><?php echo "Precio";?></label>&nbsp;</td>
					<td><input type="text" id="fPrecio" name="fPrecio" value="<?php echo $cEntidad->getPrecio();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fNVecesDescargado"><?php echo constant("STR_N_VECES_DESCARGADO");?></label>&nbsp;</td>
					<td><input type="text" id="fNVecesDescargado" name="fNVecesDescargado" value="<?php echo $cEntidad->getNVecesDescargado();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
	...
	<input type="hidden" name="informes_pruebas_empresas_next_page" value="<?php echo (isset($_POST['informes_pruebas_empresas_next_page'])) ? $cUtilidades->validaXSS($_POST['informes_pruebas_empresas_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdTipoInforme").show().load("jQuery.php",{sPG:"combotipos_informes",bBus:"0",multiple:"0",nLineas:"1",bObliga:"1",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"fIdTipoInforme",fJSProp:"cambiaIdTipoInforme",fCodIdiomaIso2:f.fCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdTipoInforme();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
