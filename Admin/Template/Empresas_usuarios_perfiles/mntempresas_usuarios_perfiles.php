...
<div id="contenedor">
	  ...
	  <td>
			<table cellspacing="0" cellpadding="0" width="100%" border="0" >
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob"><?php echo constant("STR_EMPRESA");?>&nbsp;</td>
				...
				<tr>
					...
					<td ><?php $comboUSUARIOS->setNombre("LSTIdUsuario");?><?php echo $comboUSUARIOS->getHTMLCombo("1","cajatexto",$cEntidad->getIdUsuario()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="empresas_usuarios_perfiles_next_page" value="1" />
</div>
