	...
	<input type="hidden" name="textos_secciones_next_page" value="1" />
						<script language="javascript" type="text/javascript">
							...
							function cambiaCodIdiomaIso2(){
								var f= document.forms[0];
								$("#comboIdTipoInforme").show().load("jQuery.php",{sPG:"combotipos_informes",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdTipoInforme",fJSProp:"cambiaIdTipoInforme",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,vSelected:"<?php echo $cEntidad->getIdTipoInforme();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"},function(){$("#comboIdSeccion").show().load("jQuery.php",{sPG:"combosecciones_informes",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdSeccion",fJSProp:"cambiaIdSeccion",LSTIdTipoInforme:f.LSTIdTipoInforme.value,vSelected:"<?php echo $cEntidad->getIdSeccion();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdTipoInforme(){
								var f= document.forms[0];
								$("#comboIdSeccion").show().load("jQuery.php",{sPG:"combosecciones_informes",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdSeccion",fJSProp:"cambiaIdSeccion",LSTIdTipoInforme:f.LSTIdTipoInforme.value,vSelected:"<?php echo $cEntidad->getIdSeccion();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
