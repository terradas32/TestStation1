...
******************************************************************/
    ...
    $sHtml.= '
  		    <div class="desarrollo">
            <div class="caja">
            	<h2 class="tit_peque">' . constant("STR_CIP_AREAS_PROFESIONALES_PREFERENTES_CIP") . '</h2>
            	<p class="textos">' . constant("STR_CIP_AREAS_PROFESIONALES_PREFERENTES_CIP_TXT") . '</p>
      				<table align="center" border="0" width="100%" style="border: 2px solid #cccccc">
      					<tr>
      				    	<td width="81">&nbsp;</td>
      				    	<td width="9">&nbsp;</td>
      						<td style="padding:2px;font-size:13px;width:200px;"></td>
      						<td style="text-align:right;padding:2px;font-size:13px;width:50px;">' . constant("STR_CIP_ESCALA") . ':</td>
      						<td style="font-size:9px;"><span class="bPersonas" style="float:left;margin: 0;padding: 0;">0</span><span class="bPersonas">100</span></td>
      				    </tr>
      					<tr>
      				    	<td width="81" rowspan="12" bgcolor="#cc0066" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/CIP/' . $codIdiomaIso2 . '/personas.jpg" alt="" title="" /></td>
      				    	<td width="9">&nbsp;</td>
		...
		$sHtml.= '
      					...
      					<tr>
      				    	<td width="81" rowspan="5" bgcolor="#376092" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/CIP/' . $codIdiomaIso2 . '/personas_datos.jpg" alt="" title="" /></td>
      				    	<td width="9">&nbsp;</td>
		...
		$sHtml.= '
                <tr>
    					  ...
    					  <tr>
      						<td width="81" rowspan="12" bgcolor="#31859c" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/CIP/' . $codIdiomaIso2 . '/datos.jpg" alt="" title="" /></td>
      						<td width="9">&nbsp;</td>
		...
		$iPorcientoTipoCompetencia = getPuntuacionPorArea($listaCompetencias, $cCandidato, $cPruebas);
/* Mofificado último cambio solicitado por Cris correo 09/07/2014
		$sHtml.= '	<tr>
						<td width="9">&nbsp;</td>
						<td style="background-color:#b7dee8;padding:2px;font-size:13px;">' . mb_strtoupper($cTipos_competencias->getNombre(), 'UTF-8') . '</td>
						<td class="aPorciento" style="font-size:11px;color:#000000;background-color:#b7dee8;width:50px;">' . number_format($iPorcientoTipoCompetencia, 2, ',', '.') . '%</td>
...
*/
		$sHtml.= '
                <tr>
      						<td width="9">&nbsp;</td>
      						<td style="background-color:#b7dee8;padding:2px;font-size:13px;">' . mb_strtoupper($cTipos_competencias->getNombre(), 'UTF-8') . '</td>
      						<td class="aPorciento" style="font-size:11px;color:#000000;background-color:#b7dee8;width:50px;">&nbsp;</td>
...
/* Mofificado último cambio solicitado por Cris correo 09/07/2014 */
		...
		$sHtml.= '
              <tr>
  				    ...
  				    <tr>
  				    	<td width="81" rowspan="15" bgcolor="#604a7b" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/CIP/' . $codIdiomaIso2 . '/practica.jpg" alt="" title="" /></td>
  				    	<td width="9">&nbsp;</td>
		...
		$sHtml.= '
            ...
            <div class="caja">
            	...
            	<table align="center" border="0" width="100%" style="border: 1px solid;border-color:#376092;" >
					       <tr>
        						<td align="center" style="border: 1px solid #376092;background-color:#376092;color:#ffffff;font-size:15px;">' . constant("STR_CIP_AREA_DE_INTERES") . '</td>
...
if ($iHABILIDADES > 0)
{
    ...
    '. $sHtmlCab = getCabeceraCIP($cCandidato,0);
            ...
            <div class="caja">
            	...
            	<p class="textos">Esta sección del informe refleja las principales habilidades del alumno. El resultado debe ser considerado como un indicador orientativo de su perfil para determinar aquellos aspectos que pueden ayudarle a la hora de afrontar los retos que pueda abordar en su etapa de estudios.</p>
      				<table align="center" border="0" width="100%" style="border: 2px solid #cccccc">
      					...
      					<tr>
      						<td style="background-color:#d99694;padding:2px;font-size:13px;width:200px;">' . mb_strtoupper($cTipos_competencias->getNombre(), 'UTF-8') . '</td>
      						<td class="aPorciento" style="font-size:11px;color:#000000;background-color:#d99694;width:40px;">&nbsp;</td>
      						<td style="background-color:#d99694;font-size:9px;"><span class="aPersonas" style="width:' . ($iPorcientoTipoCompetencia) . '%;">&nbsp;</span></td>
      				  </tr>
					';
		$listaCompetencias->Move(0);
		...
		$sHtml.= '
                <tr>
      						<td style="background-color:#558ed5;padding:2px;font-size:13px;">' . mb_strtoupper($cTipos_competencias->getNombre(), 'UTF-8') . '</td>
      						<td class="aPorciento" style="font-size:11px;color:#000000;background-color:#558ed5;width:50px;">&nbsp;</td>
      						<td style="background-color:#558ed5;font-size:9px;"><span class="aPersonas" style="width:' . $iPorcientoTipoCompetencia . '%;">&nbsp;</span></td>
    				    </tr>
					';
		$listaCompetencias->Move(0);
		...
		$sHtml.= '
    					...
    					<tr>
    						<td style="background-color:#ccc1da;padding:2px;font-size:13px;">' . mb_strtoupper($cTipos_competencias->getNombre(), 'UTF-8') . '</td>
    						<td class="aPorciento" style="font-size:11px;color:#000000;background-color:#ccc1da;width:50px;">&nbsp;</td>
    						<td style="background-color:#ccc1da;font-size:9px;"><span class="aPersonas" style="width:' . $iPorcientoTipoCompetencia . '%;">&nbsp;</span></td>
    				  </tr>
					';
		$listaCompetencias->Move(0);
		...
		$sHtml.= '
              <tr>
    					...
    					<tr>
    						<td style="background-color:#83b027;padding:2px;font-size:13px;">' . mb_strtoupper($cTipos_competencias->getNombre(), 'UTF-8') . '</td>
    						<td class="aPorciento" style="font-size:11px;color:#000000;background-color:#83b027;width:50px;">&nbsp;</td>
    						<td style="background-color:#83b027;font-size:9px;"><span class="aPersonas" style="width:' . $iPorcientoTipoCompetencia . '%;">&nbsp;</span></td>
    				  </tr>
					';
...
//			echo "<br />" . $sCarrera . " sAptitud:: " . $sAptitud . " - iPorcentaje::" . $iPorcentaje;
	...
	*/
	function getPuntuacionPorArea($listaCompetencias, $cCandidato, $cPruebaCIP){
		global $conn;
		$iPorcentaje=0;
		$iSumador=0;
