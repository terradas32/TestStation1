	...
	******************************************************************/
	...
	//			 			echo "<br />" . mb_strtoupper($listaCompetencias->fields['nombre'], 'UTF-8') . $listaCompetencias->fields['idTipoCompetencia'] . "-" . $listaCompetencias->fields['idCompetencia'] . " -> punt: " .  $iPuntacion;
						$sHtml.='
							...
							if($iPuntacion==1){
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/lechepascual/graficasBajo.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPuntacion==2){
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/lechepascual/graficasMB.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPuntacion==3){
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/lechepascual/graficasMedio.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPuntacion==4){
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/lechepascual/graficasMA.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPuntacion==5){
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/lechepascual/graficasAlto.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
						$sHtml.='
			...
			if($nCompetencia > 0){
				while(!$listaCompetencias->EOF){
					...
					if ($idTipoCompetencia != $listaCompetencias->fields['idTipoCompetencia']){
						$sHtml.= '
						<tr>
							<td rowspan="' . ($nC+1) . '" style="width:89px; background:#D9D9D9; border-bottom:2px solid #475464;"><img src="' . $dirGestor . 'graf/lechepascual/' . $_POST['fCodIdiomaIso2']. '/' . $listaCompetencias->fields['idTipoCompetencia'] . '.jpg" alt="' . $listaCompetencias->fields['idTipoCompetencia'] . '" title="' . $listaCompetencias->fields['idTipoCompetencia'] . '" /></td>
						</tr>
						';
					}
					$sHtml.= '
		...
		$sHtmlInicio='
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/lechepascual/resetCSS.css"/>';
					if($_POST['fIdTipoInforme'] != 11){
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/lechepascual/style.css"/>';
					}else{
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/lechepascual/styleNarrativos.css"/>';
					}
		$sHtmlInicio.='
	...
	$sHtmlCab .='<div class="cabecera">
					<table width="100%" border="0">
						<tr>
						    ...
						    <td class="logo">
						    	<img src="'.$dirGestor.'estilosInformes/lechepascual/img/logo-pequenio.jpg" title="logo"/>
						    </td>
						    <td class="fecha">
		...
		$sHtml.= '
			<div class="pagina portada">
		    	<img src="' . $dirGestor . 'graf/lechepascual/portada.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />
		    	<h1 class="titulo"><img src="' . $dirGestor.'estilosInformes/lechepascual/img/logo.jpg" /></h1>';
			if($_POST['fIdTipoInforme']!=11){
