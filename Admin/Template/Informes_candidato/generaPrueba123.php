...
//tipo prisma CUESTIONARIO DE PERSONALIDAD COMERCIAL CPC (123) ->Lanza informe completo
		...
		$sHtmlInicio='
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="'.constant("DIR_WS_GESTOR").'estilosInformes/sercMazda/resetCSS.css"/>';
					if($_POST['fIdTipoInforme'] != 11){
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.constant("DIR_WS_GESTOR").'estilosInformes/sercMazda/style.css"/>';
					}else{
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.constant("DIR_WS_GESTOR").'estilosInformes/sercMazda/styleNarrativos.css"/>';
					}
		$sHtmlInicio.='
					<title>AC</title>
					<style type="text/css">
	...
	$sHtmlCab .='<div class="cabecera">
					<table width="100%" border="0">
						<tr>
						    ...
						    <td class="logo">
						    	<img src="'.constant("DIR_WS_GESTOR").'estilosInformes/sercMazda/img/sp.gif" title="logo"/>
						    </td>
						    <td class="fecha">
...
// 									<tr>
// 										<td rowspan="' . ($nTCompetencias+1) . '" class="blancob" style="text-align: center;background-color: #413D3E; width: 184px;">Competencias<br />Asesor Comercial Digital<br /></td>
// 									</tr>';
// 								$listaTipoCompetencia->Move(0);
// 								while(!$listaTipoCompetencia->EOF)
// 								{
// 									$sHtml.='			    <tr>
// 																			<td style="text-align: center;width: 50px;"><img src="'.constant("DIR_WS_GESTOR").'graf/sercMazda/flechita.jpg" title="Flecha" /></td>
				...
				$sHtml.='
      			<tr>';
						if ($iTC == 0){
							...
							$sHtml.='
							<td rowspan="' . $nCompetencias . '" class="cajaColor dato-informe" >' . $listaTipoCompetencia->fields['nombre'] . '<br /><p style="color:#fff;">' . number_format($iPromedioTipoCompetencia, 2, ",",".") . '</p></td>
							';
							$iTC++;
						}
							$sHtml.='
...
$sHtml.='
            ...
            <table border="0" width="100%" style="font-size: 14px;border-collapse: separate;border: 1px solid #ffff;">
					...
					<table id="caja_tit" border="0">
						<tr>
							<td>AJUSTE AL PERFIL DE ASESOR COMERCIAL DIGITAL</td>
						</tr>
					</table>
					<div class="caja">
						<p class="textos">Se considera que el grado de ajuste al perfil de Asesor Comercial Digital es adecuado cuando es igual o superior a 78%.</p>
					</div>
					<div class="cajaTextos-resultados">
            <table border="0" width="100%" style="font-size: 14px;border-collapse: separate;border: 1px solid #ffff;">
							<tr>
...
$sHtml.='
		...
		$sHtml.='
										<table width="100%" border="0">
											<tr>
												<td height="30" class="textos negrob" style="padding: 5px;border: 1px solid #000;border-right: 0;border-bottom: 0;"><b>Organización y Planificación</b></td>
												<td width="20%" class="textos negrob" style="white-space: nowrap;padding: 5px;background-color:' . $sColor . ';text-align: right;padding-right: 10px;border: 1px solid #000;border-left: 0;">' . textoPuntuacion($iPuntacion, $iPuntacionIdeal) . '</td>
											</tr>
											<tr>
												<td colspan="2" style="border: 1px solid #000;padding: 5px;line-height: 1.5;text-align: justify;"><p class="textos">' . $definiciónTC . '</p></td>
  ...
  $cEmpresas = $cEmpresasDB->readEntidad($cEmpresas);
	...
	$sHtml= '
			<div class="pagina portada">
		    	<img src="'.constant("DIR_WS_GESTOR").'graf/sercMazda/portada.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />
		    	<h1 class="titulo"></h1>';
	if($_POST['fIdTipoInforme']!=11){
		$sHtml.= 		'<div id="txt_infome"><p>Informe Selección<br />Asesor Comercial Digital</p></div>';
	}else{
		$sHtml.= 		'<div id="txt_infome_narrativo"><p>Informe Selección<br />Asesor Comercial Digital</p></div>';
	}
