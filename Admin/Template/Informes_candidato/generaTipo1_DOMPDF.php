    					...
    					<tr>
    						<td width="60%" align="center" >
    							<table class="resetTable" cellspacing="30" cellpadding="15" border="0" width="85%">
    								...
    								<tr>
    									<td width="90%" style="border:3px solid #6e6e6e;">
    										<font style="font-size: 18px;color: #cc3300;font-weight: bold;">'.constant("STR_NUM_PREGUNTAS_ACERTADAS").'</font>
    									</td>
    								...
    								<tr>
    									<td width="90%" style="border:3px solid #6e6e6e;">
    										<font style="font-size: 18px;color: #cc3300;font-weight: bold;">'.constant("STR_PUNTUACION_PERCENTIL").'</font>
    									</td>
