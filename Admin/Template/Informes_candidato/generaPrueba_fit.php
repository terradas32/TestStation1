...
if (!isset($counter) || $counter == 0) {
	...
	/* Comentamos función duplicada en generaPrueba24.php
...
foreach ($aPuntuacionesCompetenciasAUX as $aPuntuacionAUX) {
	//echo "estamos en foreach aPuntuacionesCompetenciasAUX";
...
// Llamamos a generaPrueba24 para el generado de informes físicos
require_once "generaPrueba24.php";
