		...
		$sHtmlInicio='
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/cel16/resetCSS.css"/>';
						$sHtmlInicio.= '<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/cel16/style.css"/>';
		$sHtmlInicio.='
					<title>cel16</title>
					<style type="text/css">
					<!--
					...
					<table width="100%" border="0">
						<tr>
							...
							if($_POST['fIdTipoInforme']!=71) {
								$sHtmlCab .=	'
						    	<img src="'.$dirGestor.'estilosInformes/cel16/img/logo-informe.jpg" title="logo"/>
								';
							}
	$sHtmlCab .='
						    </td>
		...
		if($_POST['fIdTipoInforme'] !=71) {
			$sHtml.= '<img src="' . $dirGestor . 'graf/cel16/portada.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />';
		}else{
		...
		if($_POST['fIdTipoInforme'] !=71) {
			$sHtml.= '<img src="' . $dirGestor . 'estilosInformes/cel16/img/logo.jpg" />';
		}
		else{
