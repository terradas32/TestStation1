		...
		$sHtmlInicio='
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="'.constant("DIR_WS_GESTOR").'estilosInformes/serc/resetCSS.css"/>';
					if($_POST['fIdTipoInforme'] != 11){
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.constant("DIR_WS_GESTOR").'estilosInformes/serc/style.css"/>';
					}else{
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.constant("DIR_WS_GESTOR").'estilosInformes/serc/styleNarrativos.css"/>';
					}
		$sHtmlInicio.='
					<title>SERC</title>
					<style type="text/css">
	...
	$sHtmlCab .='<div class="cabecera">
					<table width="100%" border="0">
						<tr>
						    ...
						    <td class="logo">
						    	<img src="'.constant("DIR_WS_GESTOR").'estilosInformes/serc/img/sp.gif" title="logo"/>
						    </td>
						    <td class="fecha">
								...
								<table width="564" cellspacing="0" cellpadding="0">
    								...
    								<tr>
    									...
    									<td width="81%" style="vertical-align:middle;">
    										<img src="'.constant('DIR_WS_GESTOR') . constant('DIR_WS_GRAF'). 'bodoque_gigante_OLD.jpg'.'" style="width:'.(($iPercentil*564)/100).'px;height:25px;">
    									</td>
    								</tr>
    							</table>
				...
				<div class="desarrollo">
        		    ...
        		    <div class="caja">
						...
						<p class="textos"><font style="font-weight: bold;">Ejemplo:<br /><br /></font>
							<img class="ejemCons" src="'.constant("DIR_WS_GESTOR").'graf/serc/' . $_POST['fCodIdiomaIso2']. '/ejemploConsistenciaMB.jpg" alt="Escala Consistencia" title="Escala Consistencia" />
						</p>
...
$sHtml.='
			...
			$sHtml.='
		        		<tr>
							...
							<td class="pl_img" align="center">' . '<img src="' . constant("DIR_WS_GESTOR") . 'graf/serc/cpc' . $iPBaremada . '.jpg" title="' . $iPBaremada . '" />' . '</td>
			...
			$sHtml.='
		        		<tr>
							...
							<td class="pl_img" align="center" style="border-style: solid;border-width: 2px 1px 2px 1px;">' . '<img src="' . constant("DIR_WS_GESTOR") . 'graf/serc/cpc' . $consistencia . '.jpg" title="' . $iPBaremada . '" />' . '</td>
	        			...
	        			<table border="0" style="margin-left: 5px;">
			        		<tr>
			        			<td rowspan="7" class="blancob" style="text-align: center;background-color: #000080; width: 184px;">COMPETENCIAS<br />IDEALES</td>
    								<td style="text-align: center;width: 50px;"><img src="'.constant("DIR_WS_GESTOR").'graf/serc/flechita.jpg" title="Flecha" /></td>
...
function getPortada()
{
	...
	$sHtml= '
			<div class="pagina portada">
		    	<img src="'.constant("DIR_WS_GESTOR").'graf/serc/portada.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />
		    	<h1 class="titulo"></h1>';
	if($_POST['fIdTipoInforme']!=11){
