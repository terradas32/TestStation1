		...
		$sHtmlInicio='
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="'.constant("DIR_WS_GESTOR").'estilosInformes/SOP/resetCSS.css"/>';
					if($_POST['fIdTipoInforme'] != 11){
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.constant("DIR_WS_GESTOR").'estilosInformes/SOP/style.css"/>';
					}else{
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.constant("DIR_WS_GESTOR").'estilosInformes/SOP/styleNarrativos.css"/>';
					}
		$sHtmlInicio.='
					<title>SOP</title>
					<style type="text/css">
...
$sHtmlFin .='
		...
		$sHtml.= '
			   <div class="pagina portada">
				    	<img src="' . constant("DIR_WS_GESTOR") . 'graf/SOP/portada.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />
				    	<h1 class="titulo"><img src="' . constant("DIR_WS_GESTOR") . 'estilosInformes/SOP/img/logo.jpg" /></h1>';
    ...
    $sHtml.= '
			<div class="pagina portada" id="contraportada">
    			<img src="'.constant("DIR_WS_GESTOR").'graf/SOP/siguientes.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />
...
******************************************************************/
    ...
    $sHtml.= '
            ...
            <div class="caja">
            	...
            	<p class="textos">A continuación se presentan los resultados obtenidos a partir de las respuestas dadas al  cuestionario de intereses profesionales realizado:</p>
      				<table align="center" border="0" width="100%" style="border-collapse:separate;border-spacing:0px;margin:auto;border: 2px solid #cccccc" cellpadding="5" cellspacing="5">
      					...
      					<tr>
      				    <td width="81" rowspan="11" bgcolor="#cc0066" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/SOP/' . $codIdiomaIso2 . '/personas.jpg" alt="" title="" /></td>
      				    <td width="9">&nbsp;</td>
		...
		$sHtml.= '
					...
					<tr>
				    	<td width="81" rowspan="4" bgcolor="#376092" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/SOP/' . $codIdiomaIso2 . '/personas_datos.jpg" alt="" title="" /></td>
				    	<td width="9">&nbsp;</td>
		...
		$sHtml.= '
					...
					<tr>
						<td width="81" rowspan="9" bgcolor="#31859c" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/SOP/' . $codIdiomaIso2 . '/datos.jpg" alt="" title="" /></td>
						<td width="9">&nbsp;</td>
		...
		$sHtml.= '
				  ...
				  <tr>
				    	<td width="81" rowspan="12" bgcolor="#604a7b" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/SOP/' . $codIdiomaIso2 . '/practica.jpg" alt="" title="" /></td>
				    	<td width="9">&nbsp;</td>
