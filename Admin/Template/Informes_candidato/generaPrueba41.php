						...
						while(!$listaBloques->EOF)
						{
							...
							if($nEscalas > 0){
								...
								while(!$listaEscalas->EOF){
									...
									if($bPrimeraVuelta){
										$sHtml.='
										<td rowspan="' . $nEscalas . '" style="border-bottom: 4px solid #000;" bgcolor="#ffffff"><img src="'.$dirGestor.'graf/JN36/' . $idIdioma. '/'.$aImagenesBloques[$iPosiImg].'" alt="'.$listaBloques->fields['nombre'].'" title="'.$listaBloques->fields['nombre'].'" /></td>
										';
									}
									...
									<div class="contenedorC_JN36_JN">
										...
										<div class="perfilC_JN36_JN">
											...
											<div class="galletaC_JN36_JN">
												...
												<p class="zonaC_JN36_JN">' . $listaTextos->fields['puntMin'] . '-' . $listaTextos->fields['puntMax'] . ' ' . constant("STR_JN36_PUNTOS") . '</p>
		...
		$sHtmlInicio='
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/JN36/resetCSS.css"/>';
					if($_POST['fIdTipoInforme'] != 11){
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/JN36/style.css"/>';
					}else{
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/JN36/styleNarrativos.css"/>';
					}
		$sHtmlInicio.='
					<title>JN36</title>
					<style type="text/css">
	...
	$sHtmlCab .='<div class="cabecera">
		...
		$sHtml.= '
			<div class="pagina portada">
		    	<img src="'.$dirGestor.'graf/JN36/portada.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />
		    	';
//		    	<h1 class="titulo"><img src="'.$dirGestor.'estilosInformes/JN36/img/logo.jpg" /></h1>';
			if($_POST['fIdTipoInforme']!=11){
