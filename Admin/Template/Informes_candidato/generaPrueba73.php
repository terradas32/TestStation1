...
$sDescInforme = $comboTIPOS_INFORMES->getDescripcionCombo($_POST['fIdTipoInforme']);
	...
	$sqlRespuestas_pruebas_items = $cRespuestas_pruebas_itemsBD->readLista($cRespuestas_pruebas_items);
//	echo  $sqlRespuestas_pruebas_items;
	...
	while(!$listaItemsPrueba->EOF){
		$sTitulo = $listaItemsPrueba->fields['descripcion'];
		$sEnunciado = $listaItemsPrueba->fields['enunciado'];
	...
	';
		...
		$sHtml.='				<p style="text-align:center;background:#004080;height:25px;padding:5px;">
    								<font style="font-size: 21px;color:#FFFFFF;font-weight: bold;">' . strtoupper($sTitulo) . '</font>
    							</p><br /><br />';
		$sHtml.=nl2br(stripcslashes($sEnunciado));
    	...
    	$sHtml.='				<p style="text-align:center;background:#004080;height:25px;padding:5px;">
    								<font style="font-size: 21px;color:#FFFFFF;font-weight: bold;">'.strtoupper(html_entity_decode($cRespuestas_pruebas_items->getDescOpcion(),ENT_QUOTES,"UTF-8")).'</font>
    							</p><br /><br />';
    	$sHtml.=nl2br(stripcslashes($cRespuestas_pruebas_items->getValor()));
	    $sHtml.='			</td>
    					</tr>';
	    $sHtml.='			</td>
    					</tr>
