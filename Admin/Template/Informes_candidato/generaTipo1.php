    						...
    						<td width="60%" align="center" >
    							<table class="resetTable" width="95%" style="" cellspacing="30" align="center" cellpadding="15" border="0">
    								<tr>
    									...
    									<td width="10%" style="border:3px solid #6e6e6e;" align="center"><font style="font-size: 14px;color: #6e6e6e;font-weight: bold;">'. $listaItemsPrueba->recordCount().'</font>
    									</td>
    								</tr>
    								<tr>
    									<td width="90%" style="border:3px solid #6e6e6e;">
...
//		$sNombre = $cCandidato->getMail() . "_" . $_POST['fIdEmpresa']. "_" .$_POST['fIdProceso'] . "_" . $cPruebas->getNombre();
		...
		$utf8String = mb_convert_encoding($sHtmlInicio . $sHtml . $sHtmlFin, 'ISO-8859-1', 'UTF-8');

		error_log($utf8String, 3, $_fichero);
	}
