		...
		$sHtmlInicio='
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="' . constant("DIR_WS_GESTOR") . 'estilosInformes/cel16_106/resetCSS.css"/>';
		$sHtmlInicio.= '<link rel="stylesheet" type="text/css" href="'.constant("DIR_WS_GESTOR").'estilosInformes/cel16_106/style.css"/>';
		$sHtmlInicio.='
					<title>Cel16 BH</title>
					<style type="text/css">
					<!--
					-->
					</style>
	...
	$sHtmlCab .='<div class="cabecera">
					<table>
						<tr>
						    ...
						    <td class="logo">
						    	<img src="'.constant("DIR_WS_GESTOR").'estilosInformes/cel16_106/img/logo-informe.jpg" title="logo"/>
						    </td>
						    <td class="fecha">
		...
		$sHtml.= '
			<div class="pagina portada">
		    	<img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/portada.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />
		    	<h1 class="titulo"><!-- <img src="'.constant("DIR_WS_GESTOR").'estilosInformes/cel16_106/img/logo.jpg" /> --></h1>';
...
//		echo "LLEGO PDF";exit;
		...
		$footer_html    = '
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td align="left">PEOPLE EXPERTS</td>
					<td align="right">©CEL16 Psicólogos Empresariales y Asociados SA.</td>
				</tr>
			</table>
			';
		...
		$sHtml.='
				<div class="desarrollo">
        			...
        			<div class="caja" style="margin-bottom:40px;">
		            	...
		            	<p class="textos">' . constant("STR_PRISMA_SINTESIS_DEL_PERFIL_DE_COMPETENCIAS_106_INTRO_P1") . '</p>
						<p class="textos">' . constant("STR_PRISMA_SINTESIS_DEL_PERFIL_DE_COMPETENCIAS_106_INTRO_P2") . '</p>
						<p class="textos">' . constant("STR_PRISMA_SINTESIS_DEL_PERFIL_DE_COMPETENCIAS_106_INTRO_P3") . '</p>
			          </div><!--FIN DIV CAJA-->
					...
					{	//Solo pintamos las competencias que son especificas de Banco Hipotecario
				        ...
				        $sHtml.='
					        <tr>
			 				...
			 				if($iPBloque1to5==1){
								//$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasBajo.JPG" alt="' . getEscala_1to5($iPBloque) . '" title="' . getEscala_1to5($iPBloque) . '" /></td>';
			 					$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasBajo.JPG" alt="' . $iPBloque1to5 . '" title="' . $iPBloque1to5 . '" /></td>';
					       	}else{
					       		$sHtml.='<td class="celS">&nbsp;</td>';
					       	}
					       	//if($iPBloque==3 || $iPBloque==4){
					       	if($iPBloque1to5==2){
								//$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasMB.JPG" alt="' . getEscala_1to5($iPBloque) . '" title="' . getEscala_1to5($iPBloque) . '" /></td>';
					       		$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasMB.JPG" alt="' . $iPBloque1to5 . '" title="' . $iPBloque1to5 . '" /></td>';
					       	}else{
					       		$sHtml.='<td class="celS">&nbsp;</td>';
					       	}
					       	//if($iPBloque==5 || $iPBloque==6){
					       	if($iPBloque1to5==3){
								//$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasMedio.JPG" alt="' . getEscala_1to5($iPBloque) . '" title="' . getEscala_1to5($iPBloque) . '" /></td>';
								$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasMedio.JPG" alt="' . $iPBloque1to5 . '" title="' . $iPBloque1to5 . '" /></td>';
					       	}else{
					       		$sHtml.='<td class="celS">&nbsp;</td>';
					       	}
					       	//if($iPBloque==7 || $iPBloque==8){
					       	if($iPBloque1to5==4){
								//$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasMA.JPG" alt="' . getEscala_1to5($iPBloque) . '" title="' . getEscala_1to5($iPBloque) . '" /></td>';
					       		$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasMA.JPG" alt="' . $iPBloque1to5 . '" title="' . $iPBloque1to5 . '" /></td>';
					       	}else{
					       		$sHtml.='<td class="celS">&nbsp;</td>';
					       	}
					       	//if($iPBloque==9 || $iPBloque==10){
				       		if($iPBloque1to5==5){
								//$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasAlto.JPG" alt="' . getEscala_1to5($iPBloque) . '" title="' . getEscala_1to5($iPBloque) . '" /></td>';
								$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasAlto.JPG" alt="' . $iPBloque1to5 . '" title="' . $iPBloque1to5 . '" /></td>';
					       	}else{
					       		$sHtml.='<td class="celS">&nbsp;</td>';
					       	}
		               	$sHtml.='
					...
					{	//Solo pintamos las competencias que son especificas de Banco Hipotecario
						...
						while(!$listaEscalas->EOF)
						{
							...
							if($iPEscala==1 || $iPEscala==2){
								$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasBajo.JPG" alt="' . getEscala_1to5($iPEscala) . '" title="' . getEscala_1to5($iPEscala) . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPEscala==3 || $iPEscala==4){
								$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasMB.JPG" alt="' . getEscala_1to5($iPEscala) . '" title="' . getEscala_1to5($iPEscala) . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPEscala==5 || $iPEscala==6){
								$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasMedio.JPG" alt="' . getEscala_1to5($iPEscala) . '" title="' . getEscala_1to5($iPEscala) . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPEscala==7 || $iPEscala==8){
								$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasMA.JPG" alt="' . getEscala_1to5($iPEscala) . '" title="' . getEscala_1to5($iPEscala) . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPEscala==9 || $iPEscala==10){
								$sHtml.='<td class="celS"><img src="'.constant("DIR_WS_GESTOR").'graf/cel16_106/graficasAlto.JPG" alt="' . getEscala_1to5($iPEscala) . '" title="' . getEscala_1to5($iPEscala) . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							$sHtml.='
