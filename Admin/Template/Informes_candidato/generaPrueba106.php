...
//		echo "LLEGO PDF";exit;
    ...
    $footer_html    =  mb_strtoupper("PEOPLE EXPERTS", 'UTF-8') . str_repeat(" ", 90) . "©CEL16 Psicólogos Empresariales y Asociados SA.";
						...
						$sHtml.='
								<tr>
									<td colspan="2" style="background:#fff;">
										<h2 class="subtitulo" style="border-right: 0 #fff; color:#475464">' . mb_strtoupper($listaBloques->fields['nombre'], 'UTF-8') . '</h2>
									</td>
						...
						while(!$listaEscalas->EOF)
						{
							...
							$sHtml.='
							        <tr>
					                  ...
					                  <td class="descripcion" ><p>' . $listaEscalas->fields['descripcion'] . '</p></td>';
