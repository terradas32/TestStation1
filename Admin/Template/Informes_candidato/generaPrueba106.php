	...
	//				 			echo "<br />iPGlobal::($iEscala - 5.5) * ($iEscala - 5.5)" . $iPGlobal;
					...
					{	//Solo pintamos las competencias que son especificas de Banco Hipotecario
						...
						$sHtml.='
							...
							if($iPBloque1to5==1){
								//$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasBajo.JPG" alt="' . getEscala_1to5($iPBloque) . '" title="' . getEscala_1to5($iPBloque) . '" /></td>';
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasBajo.JPG" alt="' . $iPBloque1to5 . '" title="' . $iPBloque1to5 . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							//if($iPBloque==3 || $iPBloque==4){
							if($iPBloque1to5==2){
								//$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasMB.JPG" alt="' . getEscala_1to5($iPBloque) . '" title="' . getEscala_1to5($iPBloque) . '" /></td>';
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasMB.JPG" alt="' . $iPBloque1to5 . '" title="' . $iPBloque1to5 . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							//if($iPBloque==5 || $iPBloque==6){
							if($iPBloque1to5==3){
								//$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasMedio.JPG" alt="' . getEscala_1to5($iPBloque) . '" title="' . getEscala_1to5($iPBloque) . '" /></td>';
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasMedio.JPG" alt="' . $iPBloque1to5 . '" title="' . $iPBloque1to5 . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							//if($iPBloque==7 || $iPBloque==8){
							if($iPBloque1to5==4){
								//$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasMA.JPG" alt="' . getEscala_1to5($iPBloque) . '" title="' . getEscala_1to5($iPBloque) . '" /></td>';
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasMA.JPG" alt="' . $iPBloque1to5 . '" title="' . $iPBloque1to5 . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							//if($iPBloque==9 || $iPBloque==10){
							if($iPBloque1to5==5){
								//$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasAlto.JPG" alt="' . getEscala_1to5($iPBloque) . '" title="' . getEscala_1to5($iPBloque) . '" /></td>';
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasAlto.JPG" alt="' . $iPBloque1to5 . '" title="' . $iPBloque1to5 . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
						$sHtml.='
					...
					{	//Solo pintamos las competencias que son especificas de Banco Hipotecario
						...
						while(!$listaEscalas->EOF)
						{
							...
							if($iPEscala==1 || $iPEscala==2){
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasBajo.JPG" alt="' . getEscala_1to5($iPEscala) . '" title="' . getEscala_1to5($iPEscala) . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPEscala==3 || $iPEscala==4){
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasMB.JPG" alt="' . getEscala_1to5($iPEscala) . '" title="' . getEscala_1to5($iPEscala) . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPEscala==5 || $iPEscala==6){
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasMedio.JPG" alt="' . getEscala_1to5($iPEscala) . '" title="' . getEscala_1to5($iPEscala) . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPEscala==7 || $iPEscala==8){
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasMA.JPG" alt="' . getEscala_1to5($iPEscala) . '" title="' . getEscala_1to5($iPEscala) . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							if($iPEscala==9 || $iPEscala==10){
								$sHtml.='<td class="celS"><img src="'.$dirGestor.'graf/cel16_106/graficasAlto.JPG" alt="' . getEscala_1to5($iPEscala) . '" title="' . getEscala_1to5($iPEscala) . '" /></td>';
							}else{
								$sHtml.='<td class="celS">&nbsp;</td>';
							}
							$sHtml.='
		...
		$sHtmlInicio='
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/cel16_106/resetCSS.css"/>';
						$sHtmlInicio.= '<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/cel16_106/style.css"/>';
		$sHtmlInicio.='
	...
	$sHtmlCab .='<div class="cabecera">
					<table width="100%" border="0">
						<tr>
						    ...
						    <td class="logo">
						    	<img src="'.$dirGestor.'estilosInformes/cel16_106/img/logo-informe.jpg" title="logo"/>
						    </td>
						    <td class="fecha">
		...
		$sHtml.= '
			<div class="pagina portada">
		    	<img src="' . $dirGestor . 'graf/cel16_106/portada.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />
		    	<h1 class="titulo"><!-- <img src="' . $dirGestor . 'estilosInformes/cel16_106/img/logo.jpg" /> --></h1>';
