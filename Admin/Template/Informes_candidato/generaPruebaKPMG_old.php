	...
	$sHtmlCab .='<div class="cabecera">
					<table>
						<tr>
						    ...
						    <td class="logo"><img src="'.constant("DIR_WS_GESTOR").'estilosInformes/pruebaKPMG/img/logo-pequenio.jpg" title="logo"/></td>
						    <td class="fecha">
    ...
    {	while(!$listaProcesosPruebas->EOF)
		{
			...
			{
				$iVERBAL = getPDPrueba($cCandidato, $cPruebas);
			...
			{
				$iNUMERICO = getPDPrueba($cCandidato, $cPruebas);
				generaPrueba($listaProcesosPruebas->fields['codIdiomaIso2'], $listaProcesosPruebas->fields['idPrueba']);
			}
			if (in_array($listaProcesosPruebas->fields['idPrueba'], $aAleatoriasL))
			{
				$iLOGICO = getPDPrueba($cCandidato, $cPruebas);
				generaPrueba($listaProcesosPruebas->fields['codIdiomaIso2'], $listaProcesosPruebas->fields['idPrueba']);
			}
...
function generaPortada($sCodIdiomaIso2, $sIdPrueba){
		...
		$sHtml.= 		'<div id="txt_infome"><p>PRUEBAS PROCESO DE SELECCIÓN</p></div>';
		$sHtml.='
				<div id="informe">
		    	...
		    	<h2 id="copy">Copyright 2014, PSICÓLOGOS EMPRESARIALES S.A.</h2>
			</div>
			<!--FIN DIV PAGINA-->
			';
								...
								<p align="left">
									<ul>
										<li style="list-style: square;padding:10px;">
    										<font style="font-size: 18px;color: #004080;font-weight: bold;">'.constant("STR_PUNTUACION_DIRECTA").':</font><br /><br />
    										<font style="font-size: 18px;color: #000000;">'.constant("STR_EXP_PUNT_DIRECTA").'</font>
	    								</li>
	    								<li style="list-style: square;padding:10px;">
    										<font style="font-size: 18px;color: #004080;font-weight: bold;">'.constant("STR_PUNTUACION_PERCENTIL").':</font><br /><br />
    										<font style="font-size: 18px;color: #000000;">'.constant("STR_EXP_PUNT_PECENTIL").'</font>
	    								</li>
	    								<li style="list-style: square;padding:10px;">
    										<font style="font-size: 18px;color: #004080;font-weight: bold;">'.constant("STR_INDICE_RAPIDEZ").':</font><br /><br />
    										<font style="font-size: 18px;color: #000000;">'.constant("STR_EXP_INDICE_RAPIDEZ").'</font>
	    								</li>
	    								<li style="list-style: square;padding:10px;">
    										<font style="font-size: 18px;color: #004080;font-weight: bold;">'.constant("STR_INDICE_PRECISION").':</font><br /><br />
    										<font style="font-size: 18px;color: #000000;">'.constant("STR_EXP_INDICE_PRECISION").'</font>
	    								</li>
	    								<li style="list-style: square;padding:10px;">
    										<font style="font-size: 18px;color: #004080;font-weight: bold;">'.constant("STR_PRODUCTO_RENDIMIENTO").':</font><br /><br />
    										<font style="font-size: 18px;color: #000000;">'.constant("STR_EXP_PRODUCTO_RENDIMIENTO").'</font>
	    								</li>
	    								<li style="list-style: square;padding:10px;">
    										<font style="font-size: 18px;color: #004080;font-weight: bold;">'.constant("STR_ESTILO_PROCESAMIENTO_MENTAL").':</font><br /><br />
...
//										echo "<br />O::" . $IP . " es : >= que " . $sPuntSupIp . " y >= que " . $sPuntInfIp . "<br />";
	...
	//		echo "<br />idRango::" . $idRango . " idRangoIp::" . $idRangoIp;
		...
		if (in_array($sIdPrueba, $aAleatoriasI))
		{

			$sImg = "KPMG" . $sNombre . ".png";
		    $_PathImg = $spath . $sDirImg;
		    $sCadena = "RESUMEN RESULTADOS";
			grafResumen(400, 300, $sCadena, $_PathImg, $sImg, $iVERBAL, $iLOGICO, $iNUMERICO, $iINGLES);
...
//		ini_set("display_errors","1");
		...
		$footer_html    = '
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td width="100%" align="center"><p style="font-size:10px;"> © Psicólogos Empresariales, 2014</p></td>
				</tr>
			</table>
			';
	...
	function grafResumen($width, $height, $sCadena, $_PathImgInforme, $sImg, $iVERBAL=0, $iLOGICO=0, $iNUMERICO=0, $iINGLES=0)
	{
		$bIdeal=false;
