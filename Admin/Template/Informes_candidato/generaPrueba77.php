		...
		$sHtml.= '
				<div class="desarrollo">
					...
					<div class="caja">
						...
						<img src="'.$dirGestor.'graf/game/' . $_POST['fCodIdiomaIso2']. '/ejemploConsistencia.jpg" alt="Escala Consistencia" title="Escala Consistencia" />
						...
						while(!$listaBloques->EOF)
						{
							...
							if($nEscalas > 0){
								...
								while(!$listaEscalas->EOF){
									...
									if($bPrimeraVuelta){
										$sHtml.='
										<td rowspan="'.$nEscalas.'" style="width:58px;border-bottom: 4px solid #8796AA;" bgcolor="#d9d9d9"><img src="'.$dirGestor.'graf/game/' . $idIdioma. '/'.$aImagenesBloques[$iPosiImg].'" alt="'.$listaBloques->fields['nombre'].'" title="'.$listaBloques->fields['nombre'].'" /></td>
										';
									}
									$sSeparador = '';
