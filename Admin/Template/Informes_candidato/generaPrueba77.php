		...
		$sHtml.= '
				<div class="desarrollo">
        		    ...
        		    <div class="caja">
						...
						<img src="'.constant("DIR_WS_GESTOR").'graf/game/' . $_POST['fCodIdiomaIso2']. '/ejemploConsistencia.jpg" alt="Escala Consistencia" title="Escala Consistencia" />
				...
				<div class="desarrollo">
			        <table id="personalidad" border="1" width="730">
			          <tr>
			            ...
			            <td class="celS" width="43"><p>1</p></td>
			            <td class="celS" width="43"><p>2</p></td>
			            <td class="celS" width="43"><p>3</p></td>
			            <td class="celS" width="43"><p>4</p></td>
			            <td class="celS last" width="43"><p>5</p></td>
			          </tr>
			          <tr>
							...
							$cEscalas = new Escalas();
						 	...
						 	if($nEscalas > 0){
						 		...
						 		while(!$listaEscalas->EOF){
							        ...
							        if($bPrimeraVuelta){
							        	$sHtml.='
							        	<td rowspan="'.$nEscalas.'" style="width:58px;border-bottom: 4px solid #8796AA;" bgcolor="#d9d9d9"><img src="'.constant("DIR_WS_GESTOR").'graf/game/' . $idIdioma. '/'.$aImagenesBloques[$iPosiImg].'" alt="'.$listaBloques->fields['nombre'].'" title="'.$listaBloques->fields['nombre'].'" /></td>
							        	';
							        }
							        $sSeparador = '';
