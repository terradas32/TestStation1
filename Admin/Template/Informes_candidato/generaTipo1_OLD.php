	...
	';
		...
		$sHtml.= '<br /><br /><br /><br /><br /><br /><br /><br />
			<table width="100%" border="0" cellspacing="20" cellpadding="20">
    				...
    				<tr>';
		if ($cPruebas->getIdPrueba() == 26 || $cPruebas->getIdPrueba() == 16 || $cPruebas->getIdPrueba() == 40){
			//Para VIPS, NIPS y DIPS
			$sHtml.= '
    							...
    							<table width="90%" cellspacing="0" cellpadding="0" style="background:#c0c0c0;border-left:3px solid #004080;border-right:3px solid #004080;">
    								<tr>
    									...
    									<td width="27%" align="center" style="height:60px;border:2px solid #004080;">
    										<font style="font-size: 22px;color: #004080;font-weight: bold;">' . mb_strtoupper(constant("STR_BAJO_POTENCIAL"), 'UTF-8').'</font>
    									<td>
    									<td width="27%" align="center" style="height:60px;border:2px solid #004080;">
    										<font style="font-size: 22px;color: #004080;font-weight: bold;">' . mb_strtoupper(constant("STR_MEDIO_POTENCIAL"), 'UTF-8').'</font>
    									<td>
    									<td width="27%" align="center" style="height:60px;border:2px solid #004080;">
    										<font style="font-size: 22px;color: #004080;font-weight: bold;">' . mb_strtoupper(constant("STR_ALTO_POTENCIAL"), 'UTF-8').'</font>
    									<td>
    								</tr>
    							</table>
