...
if(!isset($counter) || $counter==0){
	...
	*/
	...
	//					echo "<br />1111-->sBloques::" . $sBloques;
					...
					if($nBloques>0){
						...
						<img src="'.$dirGestor.'graf/prisma/' . $idIdioma. '/'.$aImagenesBloques[$iPosiImg].'" alt="'.$listaBloques->fields['nombre'].'" title="'.$listaBloques->fields['nombre'].'" />
						</td>
										';
									}
									$sSeparador = '';
		...
		$sHtml.= '
				<div class="desarrollo">
					...
					<table class="definiciones" border="1" cellspacing="0" cellpadding="0">
						<tr>
							<td rowspan="4" style="width:89px; background:#D9D9D9; border-bottom:2px solid #555;"><img src="'.$dirGestor.'graf/prisma/' . $_POST['fCodIdiomaIso2']. '/compeGestion.jpg" alt="Competencias para la gestión" title="Competencias para la gestión" /></td>
						...
						<tr>
							<td rowspan="4" style="width:89px; background:#D9D9D9; border-bottom:2px solid #555;"><img src="'.$dirGestor.'graf/prisma/' . $_POST['fCodIdiomaIso2']. '/compeTecnicas.jpg" alt="Competencias tecnicas" title="Competencias tecnicas" /></td>
						...
						<tr>
							<td rowspan="4" style="width:89px; background:#D9D9D9; border-bottom:2px solid #555;"><img src="'.$dirGestor.'graf/prisma/' . $_POST['fCodIdiomaIso2']. '/compePromocion.jpg"
						...
						<tr>
							<td rowspan="4" style="width:89px; background:#D9D9D9; border-bottom:2px solid #555;"><img src="'.$dirGestor.'graf/prisma/' . $_POST['fCodIdiomaIso2']. '/compeInterper.jpg"
	...
	*/
		...
		$sHtml.='
			<div class="desarrollo">
				...
				<table class="definicionesEstresores" border="1" cellspacing="0" cellpadding="0">
					<tr>
						<td rowspan="4" style="width:55px; border-bottom:2px solid #b4dbdb;"><img src="'.$dirGestor.'graf/prisma/' . $_POST['fCodIdiomaIso2']. '/estresores1.jpg" alt="Factores organizativos"
					...
					<tr>
						<td rowspan="4" style="width:55px; border-bottom:2px solid #b4dbdb;"><img src="'.$dirGestor.'graf/prisma/' . $_POST['fCodIdiomaIso2']. '/estresores2.jpg" alt="Factores relacionales"
					...
					<tr>
						<td rowspan="6" style="width:55px; border-bottom:2px solid #b4dbdb;"><img src="'.$dirGestor.'graf/prisma/' . $_POST['fCodIdiomaIso2']. '/estresores3.jpg" alt="Factores motivacionales"
					...
					<tr>
						<td rowspan="5" style="width:55px; border-bottom:2px solid #b4dbdb;"><img src="'.$dirGestor.'graf/prisma/' . $_POST['fCodIdiomaIso2']. '/estresores4.jpg" alt="" title="" /></td>
	...
	function calculaResultados($conn, $idProceso, $idEmpresa)
	{
		global $dirGestor;
		global $documentRoot;
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_competencias/Sec_competenciasDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_competencias/Sec_competencias.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_dimensiones/Sec_dimensionesDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_dimensiones/Sec_dimensiones.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_ponderacionesdimensiones/Sec_ponderacionesdimensionesDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_ponderacionesdimensiones/Sec_ponderacionesdimensiones.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_ponderaciones/Sec_ponderacionesDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_ponderaciones/Sec_ponderaciones.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_ponderacionesfa/Sec_ponderacionesfaDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_ponderacionesfa/Sec_ponderacionesfa.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_ponderacionescompetencias/Sec_ponderacionescompetenciasDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_ponderacionescompetencias/Sec_ponderacionescompetencias.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_ponderacionesfm/Sec_ponderacionesfmDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_ponderacionesfm/Sec_ponderacionesfm.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_respuestasfa/Sec_respuestasfaDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_respuestasfa/Sec_respuestasfa.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_respuestasfm/Sec_respuestasfmDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_respuestasfm/Sec_respuestasfm.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_respuestascompetencias/Sec_respuestascompetenciasDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_respuestascompetencias/Sec_respuestascompetencias.php");
		...
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_perfilesprocesos/Sec_perfilesprocesosDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_perfilesprocesos/Sec_perfilesprocesos.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_factoresactitudinales/Sec_factoresactitudinalesDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_factoresactitudinales/Sec_factoresactitudinales.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_factoresmotivacionales/Sec_factoresmotivacionalesDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_factoresmotivacionales/Sec_factoresmotivacionales.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_factorescompetencias/Sec_factorescompetenciasDB.php");
		require_once($documentRoot . constant("DIR_WS_COM") . "Sec_factorescompetencias/Sec_factorescompetencias.php");
