...
//		echo "<br />" . $sqlInversos;
		...
		$comboTIPOS_INFORMES	= new Combo($conn,"fIdTipoInforme","idTipoInforme","nombre","Descripcion","tipos_informes","",constant("SLC_OPCION"),"codIdiomaIso2=" . $conn->qstr($_POST['fCodIdiomaIso2'], get_magic_quotes_gpc()),"","fecMod");
		...
		$sHtml.= '
				<div class="desarrollo">
        		    ...
        		    <div class="caja">
						...
						<img src="'.constant("DIR_WS_GESTOR").'graf/prisma/' . $_POST['fCodIdiomaIso2']. '/ejemploConsistencia.jpg" alt="Escala Consistencia" title="Escala Consistencia" />
				...
				<div class="desarrollo">
			        <table id="personalidad" border="1" width="730">
			          <tr>
			            ...
			            <td class="celS" width="43"><p>1-2</p></td>
			            <td class="celS" width="43"><p>3-4</p></td>
			            <td class="celS" width="43"><p>5-6</p></td>
			            <td class="celS" width="43"><p>7-8</p></td>
			            <td class="celS last" width="43"><p>9-10</p></td>
			          </tr>
			          <tr>
							...
							$cEscalas = new Escalas();
						 	...
						 	if($nEscalas > 0){
						 		...
						 		while(!$listaEscalas->EOF){
							        ...
							        if($bPrimeraVuelta){
							        	$sHtml.='
							        	<td rowspan="'.$nEscalas.'" style="width:58px;border-bottom: 4px solid #8796AA;" bgcolor="#d9d9d9"><img src="'.constant("DIR_WS_GESTOR").'graf/prisma/' . $idIdioma. '/'.$aImagenesBloques[$iPosiImg].'" alt="'.$listaBloques->fields['nombre'].'" title="'.$listaBloques->fields['nombre'].'" /></td>
							        	';
							        }
							        $sSeparador = '';
							        if ($nVueltas == $nEscalas){
							        	$nVueltas = 1;
							        	$sSeparador = ' style="border-bottom: 4px solid #8796AA;" ';	
							        }
...
//					echo "<br />iPuntacion:: " . $iPuntacion;
        ...
        $sHtml.= '</table>
                 ...
                 <table class="indicadores" width="730" border="1" cellspacing="0" cellpadding="0">
                      <tr>
...
//			 			echo "<br />" . mb_strtoupper($listaCompetencias->fields['nombre'], 'UTF-8') . $listaCompetencias->fields['idTipoCompetencia'] . "-" . $listaCompetencias->fields['idCompetencia'] . " -> punt: " .  $iPuntacion;
	...
	function generaPerfilEstilos($aPuntuaciones , $sHtmlCab){
		...
		$sHtml.='
				<div class="desarrollo">
		        	<table id="liderazgo" class="liderazgo" width="730" border="1" cellspacing="0" cellpadding="0">
	 ...
	 */ 
		...
		$sHtml.='
				<div class="desarrollo">
		          ...
		          <table class="estresores" width="730" border="0" cellspacing="0" cellpadding="0">
		              <tr>
		...
		$sHtml.='
			<div class="desarrollo">
		        ...
		        <table class="definicionesEstresores" width="730" border="1" cellspacing="0" cellpadding="0">
		              <tr>
...
$listaBloques->MoveNext();
 ...
 $sHtml.=' 
	...
	function getPuntuacionPerfilPersonalidadLaboral($aPuntuaciones,$idIdioma)
	{
			...
			while(!$listaBloques->EOF)
			{
				...
				if($nEscalas > 0){
					while(!$listaEscalas->EOF){
						...
						$sSQLExport = "INSERT INTO export_personalidad_laboral (idEmpresa, idProceso, descProceso, idCandidato, idPrueba, descPrueba, fecPrueba, idBloque, nomBloque, idEscala, nomEscala, descEscala, puntuacion, fecAlta) VALUES ";
						$sSQLExport .= "(" . $conn->qstr($cRespPruebas->getIdEmpresa(), false) . "," . $conn->qstr($cRespPruebas->getIdProceso(), false) . "," . $conn->qstr($cRespPruebas->getDescProceso(), false) . "," . $conn->qstr($cRespPruebas->getIdCandidato(), false) . "," . $conn->qstr($cRespPruebas->getIdPrueba(), false) . "," . $conn->qstr($cRespPruebas->getDescPrueba(), false) . "," . $conn->qstr($cRespPruebas->getFecAlta(), false) . "," . $conn->qstr($listaBloques->fields['idBloque'], false) . "," . $conn->qstr($listaBloques->fields['nombre'], false) . "," . $conn->qstr($listaEscalas->fields['idEscala'], false) . "," . $conn->qstr($listaEscalas->fields['nombre'], false) . "," . $conn->qstr($listaEscalas->fields['descripcion'], false) . "," . $conn->qstr($iPBaremada, false) . ",now());\n";
		...
		$sSQLExport = "INSERT INTO export_personalidad_laboral (idEmpresa, idProceso, descProceso, idCandidato, idPrueba, descPrueba, fecPrueba, idBloque, nomBloque, idEscala, nomEscala, descEscala, puntuacion, fecAlta) VALUES ";
		$sSQLExport .= "(" . $conn->qstr($cRespPruebas->getIdEmpresa(), false) . "," . $conn->qstr($cRespPruebas->getIdProceso(), false) . "," . $conn->qstr($cRespPruebas->getDescProceso(), false) . "," . $conn->qstr($cRespPruebas->getIdCandidato(), false) . "," . $conn->qstr($cRespPruebas->getIdPrueba(), false) . "," . $conn->qstr($cRespPruebas->getDescPrueba(), false) . "," . $conn->qstr($cRespPruebas->getFecAlta(), false) . "," . $conn->qstr(0, false) . "," . $conn->qstr(constant("STR_PRISMA_G_C"), false) . "," . $conn->qstr(0, false) . "," . $conn->qstr(constant("STR_PRISMA_G_C"), false) . "," . $conn->qstr(constant("STR_PRISMA_STR_PRISMA_G_C_TXT"), false) . "," . $conn->qstr($consistencia, false) . ",now());\n";
		$aSQLPuntuacionesPPL[] = $sSQLExport;
	...
	function getPuntuacionSintesisCompetencias($aPuntuaciones , $idIdioma){
			...
			while(!$listaTipoCompetencia->EOF){
				...
				if($nCompetencias >0){
					while(!$listaCompetencias->EOF){
						...
						$sSQLExport = "INSERT INTO export_personalidad_competencias (idEmpresa, idProceso, descProceso, idCandidato, idPrueba, descPrueba, fecPrueba, idTipoCompetencia, nomTipoCompetencia, idCompetencia, nomCompetencia, descCompetencia, puntuacion, fecAlta) VALUES ";
						$sSQLExport .= "(" . $conn->qstr($cRespPruebas->getIdEmpresa(), false) . "," . $conn->qstr($cRespPruebas->getIdProceso(), false) . "," . $conn->qstr($cRespPruebas->getDescProceso(), false) . "," . $conn->qstr($cRespPruebas->getIdCandidato(), false) . "," . $conn->qstr($cRespPruebas->getIdPrueba(), false) . "," . $conn->qstr($cRespPruebas->getDescPrueba(), false) . "," . $conn->qstr($cRespPruebas->getFecAlta(), false) . "," . $conn->qstr($listaCompetencias->fields['idTipoCompetencia'], false) . "," . $conn->qstr($listaTipoCompetencia->fields['nombre'], false) . "," . $conn->qstr($listaCompetencias->fields['idCompetencia'], false) . "," . $conn->qstr($listaCompetencias->fields['nombre'], false) . "," . $conn->qstr($listaCompetencias->fields['descripcion'], false) . "," . $conn->qstr($iPuntacion, false) . ",now());\n";
		...
		$sSQLExport = "INSERT INTO export_personalidad_competencias (idEmpresa, idProceso, descProceso, idCandidato, idPrueba, descPrueba, fecPrueba, idTipoCompetencia, nomTipoCompetencia, idCompetencia, nomCompetencia, descCompetencia, puntuacion, fecAlta) VALUES ";
		$sSQLExport .= "(" . $conn->qstr($cRespPruebas->getIdEmpresa(), false) . "," . $conn->qstr($cRespPruebas->getIdProceso(), false) . "," . $conn->qstr($cRespPruebas->getDescProceso(), false) . "," . $conn->qstr($cRespPruebas->getIdCandidato(), false) . "," . $conn->qstr($cRespPruebas->getIdPrueba(), false) . "," . $conn->qstr($cRespPruebas->getDescPrueba(), false) . "," . $conn->qstr($cRespPruebas->getFecAlta(), false) . "," . $conn->qstr(0, false) . "," . $conn->qstr(constant("STR_PRISMA_STR_PRISMA_G_C_TXT"), false) . "," . $conn->qstr(0, false) . "," . $conn->qstr(constant("STR_PRISMA_STR_PRISMA_G_C_TXT"), false) . "," . $conn->qstr(constant("STR_PRISMA_STR_PRISMA_G_C_TXT"), false) . "," . $conn->qstr($consistencia, false) . ",now());\n";
		$aSQLPuntuacionesC[] = $sSQLExport;
