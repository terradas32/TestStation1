...
if(!isset($counter) || $counter==0){
	...
	*/
	...
	// 								{
	// 									$sHtml.='			    <tr>
	// 																			<td style="text-align: center;width: 50px;"><img src="'.$dirGestor.'graf/seasMazda/flechita.jpg" title="Flecha" /></td>
	...
	*/
	...
	$sHtml= '
			<div class="pagina portada">
				<img src="'.$dirGestor.'graf/seasMazda/portada.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />
				<h1 class="titulo"></h1>';
		...
		$sHtmlInicio='
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/seasMazda/resetCSS.css"/>';
					if($_POST['fIdTipoInforme'] != 11){
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/seasMazda/style.css"/>';
					}else{
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/seasMazda/styleNarrativos.css"/>';
					}
		$sHtmlInicio.='
					<title>AS</title>
					<style type="text/css">
	...
	$sHtmlCab .='<div class="cabecera">
					<table width="100%" border="0">
						<tr>
						    ...
						    <td class="logo">
						    	<img src="'.$dirGestor.'estilosInformes/seasMazda/img/sp.gif" title="logo"/>
						    </td>
						    <td class="fecha">
