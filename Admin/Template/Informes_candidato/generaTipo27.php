    ...
    $sHtml.= '
            ...
            <div class="caja">
            	...
            	<p class="textos" style="line-height: 12px;">' . constant("STR_CIP_AREAS_PROFESIONALES_PREFERENTES_CIP_TXT") . '</p>
      					...
      					<tr>
      				    <td width="35" rowspan="12" bgcolor="#cc0066" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/CIP/' . $codIdiomaIso2 . '/personas.jpg" alt="" title="" /></td>
      				    <td width="6">&nbsp;</td>
		...
		$sHtml.= '
      					...
      					<tr>
      				    	<td width="35" rowspan="4" bgcolor="#376092" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/CIP/' . $codIdiomaIso2 . '/personas_datos.jpg" alt="" title="" /></td>
      				    	<td width="6">&nbsp;</td>
		...
		$sHtml.= '
                <tr>
    					  ...
    					  <tr>
      						<td width="35" rowspan="11" bgcolor="#31859c" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/CIP/' . $codIdiomaIso2 . '/datos.jpg" alt="" title="" /></td>
      						<td width="6">&nbsp;</td>
...
/* Mofificado último cambio solicitado por Cris correo 09/07/2014 */
		...
		$sHtml.= '
              <tr>
  				    ...
  				    <tr>
  				    	<td width="35" rowspan="15" bgcolor="#604a7b" align="center"><img src="' . constant("DIR_WS_GESTOR") . 'graf/CIP/' . $codIdiomaIso2 . '/practica.jpg" alt="" title="" /></td>
  				    	<td width="6">&nbsp;</td>
	...
	*/
	function getPuntuacionPorArea($listaCompetencias, $cCandidato, $cPruebaCIP){
		...
		while(!$listaCompetencias->EOF){
			...
			$contCompetencias++;
			//echo "<br>idTipo::" . $listaCompetencias->fields['idTipoCompetencia'] . " Competencia::" . $listaCompetencias->fields['nombre'] . " Número competencias::" . $nAreas;
			//echo "<br>Nº items de ::" . $listaCompetencias->fields['nombre'] . " -> " . $nCompetencias_items;
		...
		//echo "<br>Nº items total ::" . $contItems . " -> puntuación:: " . $iSumador;
		return $iPorcentaje;
	}
...
//		echo "<br />" . $sqlInversos;
	...
	function getPuntuacionPorCarrera($rsCompetencia, $cCandidato, $cPruebaCIP){
		...
		//echo "<br>***Nº items de ::" . $rsCompetencia->fields['nombre'] . " -> " . $nCompetencias_items;
		...
		$iPorcentaje = (($iSumador*100)/($nCompetencias_items*2)); //puntuación máxima == 2 * nº items de la competencia
		//echo "<br>***Nº items total ::" . $nCompetencias_items . " -> puntuación:: " . $iSumador;
		return $iPorcentaje;
