...
if(!isset($counter) || $counter==0){
	...
	//var_dump('<script>console.log("'.$dirGestor.'");</script>');
	...
	function perfilPersonalidadLaboral($aPuntuaciones, $sHtmlCab, $idIdioma)
	{
		...
		$sHtml .= '
					<div class="desarrollo">
						...
						<div class="caja">
							...
							<img style="width: 666px;" src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/ejemploConsistencia.jpg" alt="Escala Consistencia" title="Escala Consistencia" />
				...
				if ($nEscalas > 0) {
					...
					while (!$listaEscalas->EOF) {
						...
						if ($bPrimeraVuelta) {
							...
							<img style="max-height:' . $aMaxHeighImagenesBloques[$iPosiImg] . ';" src="' . $dirGestor . 'graf/prisma/' . $idIdioma . '/' . $aImagenesBloques[$iPosiImg] . '" alt="' . $listaBloques->fields['nombre'] . '" title="' . $listaBloques->fields['nombre'] . '" />
							</td>
											';
						}
						$sSeparador = '';
						...
						if ($iPBaremada == 1 || $iPBaremada == 2) {
							$sHtml .= '
											<td class="simbol" ' . $sSeparador . '><img src="' . $dirGestor . 'graf/prisma/graficasBajo.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>
											';
						} else {
							$sHtml .= '
						...
						if ($iPBaremada == 3 || $iPBaremada == 4) {
							$sHtml .= '
											<td class="simbol" ' . $sSeparador . '><img src="' . $dirGestor . 'graf/prisma/graficasMB.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>
											';
						} else {
							$sHtml .= '
											<td class="simbol" ' . $sSeparador . '>&nbsp;</td>
						...
						if ($iPBaremada == 5 || $iPBaremada == 6) {
							$sHtml .= '
											<td class="simbol" ' . $sSeparador . '><img src="' . $dirGestor . 'graf/prisma/graficasMedio.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>
											';
						} else {
							$sHtml .= '
											<td class="simbol" ' . $sSeparador . '>&nbsp;</td>
						...
						if ($iPBaremada == 7 || $iPBaremada == 8) {
							$sHtml .= '
											<td class="simbol" ' . $sSeparador . '><img src="' . $dirGestor . 'graf/prisma/graficasMA.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>
											';
						} else {
							$sHtml .= '
											<td class="simbol" ' . $sSeparador . '>&nbsp;</td>
						...
						if ($iPBaremada == 9 || $iPBaremada == 10) {
							$sHtml .= '
											<td class="simbol" ' . $sSeparador . '><img src="' . $dirGestor . 'graf/prisma/graficasAlto.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>
											';
						} else {
							$sHtml .= '
											<td class="simbol" ' . $sSeparador . '>&nbsp;</td>
		...
		if ($consistencia == 1 || $consistencia == 2) {
			$sHtml .= '<td class="simbol"><img style="height:12px;" src="' . $dirGestor . 'graf/prisma/graficasBajo.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td class="simbol">&nbsp;</td>';
		}
		if ($consistencia == 3 || $consistencia == 4) {
			$sHtml .= '<td class="simbol"><img style="height:12px;" src="' . $dirGestor . 'graf/prisma/graficasMB.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td class="simbol">&nbsp;</td>';
		}
		if ($consistencia == 5 || $consistencia == 6) {
			$sHtml .= '<td class="simbol"><img style="height:12px;" src="' . $dirGestor . 'graf/prisma/graficasMedio.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td class="simbol">&nbsp;</td>';
		}
		if ($consistencia == 7 || $consistencia == 8) {
			$sHtml .= '<td class="simbol"><img style="height:12px;" src="' . $dirGestor . 'graf/prisma/graficasMA.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td class="simbol">&nbsp;</td>';
		}
		if ($consistencia == 9 || $consistencia == 10) {
			$sHtml .= '<td class="simbol"><img style="height:12px;" src="' . $dirGestor . 'graf/prisma/graficasAlto.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td class="simbol">&nbsp;</td>';
		}
		$sHtml .= '
	...
	function perfilGeneralPersonalidadLaboral($aPuntuaciones, $sHtmlCab)
	{
		...
		if ($GEM == 1 || $GEM == 2) {
			$sHtml .= '
						<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasBajo.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '
						<td>&nbsp;</td>';
		}
		if ($GEM == 3 || $GEM == 4) {
			$sHtml .= '<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasMB.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td>&nbsp;</td>';
		}
		if ($GEM == 5 || $GEM == 6) {
			$sHtml .= '<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasMedio.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td>&nbsp;</td>';
		}
		if ($GEM == 7 || $GEM == 8) {
			$sHtml .= '<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasMA.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td>&nbsp;</td>';
		}
		if ($GEM == 9 || $GEM == 10) {
			$sHtml .= '<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasAlto.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td>&nbsp;</td>';
		}
		$sHtml .= '
		...
		if ($GIE == 3 || $GIE == 4) {
			$sHtml .= '
						<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasMB.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td>&nbsp;</td>';
		}
		if ($GIE == 5 || $GIE == 6) {
		...
		if ($GOC == 1 || $GOC == 2) {
			$sHtml .= '<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasBajo.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td>&nbsp;</td>';
		}
		if ($GOC == 3 || $GOC == 4) {
		...
		if ($nCompetencia > 0) {
			while (!$listaCompetencias->EOF) {
				...
				if ($iPuntacion == 1 || $iPuntacion == 2) {
					$sHtml .= '<td class="cel"><img src="' . $dirGestor . 'graf/prisma/graficasBajo.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
				} else {
					$sHtml .= '<td class="cel">&nbsp;</td>';
				}
				if ($iPuntacion == 3 || $iPuntacion == 4) {
					$sHtml .= '<td class="cel"><img src="' . $dirGestor . 'graf/prisma/graficasMB.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
				} else {
					$sHtml .= '<td class="cel">&nbsp;</td>';
				}
				if ($iPuntacion == 5 || $iPuntacion == 6) {
					$sHtml .= '<td class="cel"><img src="' . $dirGestor . 'graf/prisma/graficasMedio.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
				} else {
					$sHtml .= '<td class="cel">&nbsp;</td>';
				}
				if ($iPuntacion == 7 || $iPuntacion == 8) {
					$sHtml .= '<td class="cel"><img src="' . $dirGestor . 'graf/prisma/graficasMA.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
				} else {
					$sHtml .= '<td class="cel">&nbsp;</td>';
				}
				if ($iPuntacion == 9 || $iPuntacion == 10) {
					$sHtml .= '<td class="cel"><img src="' . $dirGestor . 'graf/prisma/graficasAlto.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
				} else {
					$sHtml .= '<td class="cel">&nbsp;</td>';
				}
				$sHtml .= '</tr>
		...
		$sHtml .= '</table>
					...
					<table class="indicadores" border="1" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasBajo.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>
							<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasMB.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>
							<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasMedio.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>
							<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasMA.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>
							<td class="simbol"><img src="' . $dirGestor . 'graf/prisma/graficasAlto.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>
						</tr>
		...
		$sHtml .= '
					<div class="desarrollo">
						...
						<table class="definiciones" border="1" cellspacing="0" cellpadding="0">
							<tr>
								<td rowspan="4" style="width:89px; background:#D9D9D9; border-bottom:2px solid #475464;"><img src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/compeGestion.jpg" alt="Competencias para la gestión" title="Competencias para la gestión" /></td>
							...
							<tr>
								<td rowspan="4" style="width:89px; background:#D9D9D9; border-bottom:2px solid #475464;"><img src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/compeTecnicas.jpg" alt="Competencias tecnicas" title="Competencias tecnicas" /></td>
							...
							<tr>
								<td rowspan="4" style="width:89px; background:#D9D9D9; border-bottom:2px solid #475464;"><img src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/compePromocion.jpg"
							...
							<tr>
								<td rowspan="4" style="width:89px; background:#D9D9D9; border-bottom:2px solid #475464;"><img src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/compeInterper.jpg"
			...
			while (!$listaTipoCompetencia->EOF) {
				...
				if ($nCompetencias > 0) {
					while (!$listaCompetencias->EOF) {
						...
						if ($iPuntacion == 1 || $iPuntacion == 2) {
							$sHtml .= '<td class="celS"><img src="' . $dirGestor . 'graf/prisma/graficasBajo.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
						} else {
							$sHtml .= '<td class="celS">&nbsp;</td>';
						}
						if ($iPuntacion == 3 || $iPuntacion == 4) {
							$sHtml .= '<td class="celS"><img src="' . $dirGestor . 'graf/prisma/graficasMB.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
						} else {
							$sHtml .= '<td class="celS">&nbsp;</td>';
						}
						if ($iPuntacion == 5 || $iPuntacion == 6) {
							$sHtml .= '<td class="celS"><img src="' . $dirGestor . 'graf/prisma/graficasMedio.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
						} else {
							$sHtml .= '<td class="celS">&nbsp;</td>';
						}
						if ($iPuntacion == 7 || $iPuntacion == 8) {
							$sHtml .= '<td class="celS"><img src="' . $dirGestor . 'graf/prisma/graficasMA.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
						} else {
							$sHtml .= '<td class="celS">&nbsp;</td>';
						}
						if ($iPuntacion == 9 || $iPuntacion == 10) {
							$sHtml .= '<td class="celS"><img src="' . $dirGestor . 'graf/prisma/graficasAlto.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
						} else {
							$sHtml .= '<td class="celS">&nbsp;</td>';
						}
						$sHtml .= '
	...
	function generaPerfilEstilos($aPuntuaciones, $sHtmlCab)
	{
		...
		$sHtml .= '
					<div class="desarrollo">
						<table id="liderazgo" class="liderazgo" border="1" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td rowspan="5" style="background:#D9D9D9;width:32px;"><img src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/liderazgo1.jpg" alt="Estilos" title="Estilos" /></td>
		...
		$sHtml .= '
							...
							<tr>
								<td rowspan="5" style="background:#D9D9D9;"><img src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/liderazgo1.jpg" alt="Estilos" title="Estilos" /></td>
		...
		$sHtml .= '
							...
							<tr>
								<td rowspan="8" style="background:#D9D9D9;"><img src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/liderazgo1.jpg" alt="Liderazgo" title="Liderazgo" /></td>
		...
		*/
		...
		$sHtml .= '
					...
					<table class="estresores" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td class="number" align="center"><p>' . $iPuntuacion . '</p></td>
		...
		if ($iPuntuacion == 1 || $iPuntuacion == 2) {
			$sHtml .= '<td class="simbol" align="center"><img src="' . $dirGestor . 'graf/prisma/graficasBajo.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td class="simbol" align="center">&nbsp;</td>';
		}
		if ($iPuntuacion == 3 || $iPuntuacion == 4) {
			$sHtml .= '<td class="simbol" align="center"><img src="' . $dirGestor . 'graf/prisma/graficasMB.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td class="simbol" align="center">&nbsp;</td>';
		}
		if ($iPuntuacion == 5 || $iPuntuacion == 6) {
			$sHtml .= '<td class="simbol" align="center"><img src="' . $dirGestor . 'graf/prisma/graficasMedio.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td class="simbol" align="center">&nbsp;</td>';
		}
		if ($iPuntuacion == 7 || $iPuntuacion == 8) {
			$sHtml .= '<td class="simbol" align="center"><img src="' . $dirGestor . 'graf/prisma/graficasMA.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td class="simbol" align="center">&nbsp;</td>';
		}
		if ($iPuntuacion == 9 || $iPuntuacion == 10) {
			$sHtml .= '<td class="simbol" align="center"><img src="' . $dirGestor . 'graf/prisma/graficasAlto.JPG" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" /></td>';
		} else {
			$sHtml .= '<td class="simbol" align="center">&nbsp;</td>';
		}
		//M7  --> 8-1 -->inversa
		$iPuntuacion = 11 - $aPuntuaciones["8-1"];
		$sHtml .= '</tr>
						<tr>
							<td class="number" align="center"><p>' . $iPuntuacion . '</p></td>
		...
		//S3  --> 3-3 -->inversa
		$iPuntuacion = 11 - $aPuntuaciones["3-3"];
		$sHtml .= '</tr>
						<tr>
		...
		//S7  --> 5-1 -->inversa
		$iPuntuacion = 11 - $aPuntuaciones["5-1"];
		$sHtml .= '</tr>
						<tr>
							<td class="number" align="center"><p>' . $iPuntuacion . '</p></td>
		...
		//S5  --> 4-2 -->inversa
		$iPuntuacion = 11 - $aPuntuaciones["4-2"];
		$sHtml .= '</tr>
						<tr>
							<td class="number" align="center"><p>' . $iPuntuacion . '</p></td>
		...
		//E5  --> 1-5 -->inversa
		$iPuntuacion = 11 - $aPuntuaciones["1-5"];
		$sHtml .= '</tr>
						<tr>
							<td colspan="8" style="background:#93b1d3; height:6px;" align="center">&nbsp;</td>
						</tr>
		...
		//M1  --> 6-1 -->inversa
		$iPuntuacion = 11 - $aPuntuaciones["6-1"];
		$sHtml .= '</tr>
						<tr>
							<td class="number" align="center"><p>' . $iPuntuacion . '</p></td>
		...
		//E4  --> 1-4 -->inversa
		$iPuntuacion = 11 - $aPuntuaciones["1-4"];
		$sHtml .= '</tr>
						<tr>
							<td class="number" align="center"><p>' . $iPuntuacion . '</p></td>
		...
		//S8  --> 5-2 -->inversa
		$iPuntuacion = 11 - $aPuntuaciones["5-2"];
		$sHtml .= '</tr>
						<tr>
							<td class="number" align="center"><p>' . $iPuntuacion . '</p></td>
		...
		$sHtml .= '
				<div class="desarrollo">
					...
					<table class="definicionesEstresores" border="1" cellspacing="0" cellpadding="0">
						<tr>
							<td rowspan="4" style="width:55px; border-bottom:2px solid #b4dbdb;background-color: #d9d9d9;"><img src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/estresores1.jpg" alt="Factores organizativos"
						...
						<tr>
							<td rowspan="4" style="width:55px; border-bottom:2px solid #b4dbdb;background-color: #d9d9d9;"><img src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/estresores2.jpg" alt="Factores relacionales"
						...
						<tr>
							<td rowspan="6" style="width:55px; border-bottom:2px solid #b4dbdb;background-color: #d9d9d9;"><img src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/estresores3.jpg" alt="Factores motivacionales"
						...
						<tr>
							<td rowspan="5" style="width:55px; border-bottom:2px solid #b4dbdb;background-color: #d9d9d9;"><img src="' . $dirGestor . 'graf/prisma/' . $_POST['fCodIdiomaIso2'] . '/estresores4.jpg" alt="" title="" /></td>
	...
	function generaNarrativoPrisma($aPuntuaciones, $sHtmlCab, $idIdioma, $cCandidato)
	{
		...
		if ($nEscalas > 0) {
			...
			while (!$listaEscalas->EOF) {
				...
				$cTexto->setCodIdiomaIso2($_POST['fCodIdiomaIso2']);
	...
	';
		...
		$sHtml .= '<div class="caja">
					<div style="width:80%;padding-left:50px;"><img src="' . $dirGestor . constant("DIR_WS_GRAF") . 'prisma/' . $idIdioma . '/graficoNarrativos.jpg" title="gráfico" align="center"/></div>
	...
	function informeCompetencias_FIT($aPuntuaciones, $sHtmlCab, $idIdioma)
	{
		...
		if($_POST['fIdEmpresa'] == 5897 && $_POST['fIdTipoInforme'] == 71){
			$pcTxt = '<p class="textos">Este perfil permite tener información sobre los comportamientos que caracterizan a una persona en su ámbito de trabajo, relacionándolos con las competencias comportamentales del Diccionario de la DIAN.</p>
				<p class="textos">Los resultados obtenidos en el perfil son una puntuación global, y por tanto deben ser considerados como un indicador orientativo de los aspectos más destacados y de las áreas de desarrollo, con base en las respuestas que se han dado en el cuestionario.</p>
				<p class="textos">En el informe encontrará los resultados de la evaluación de la totalidad de las competencias que conforman el Diccionario de la DIAN, en niveles de desarrollo del 1 al 4, siendo 1 el mínimo nivel y 4 el máximo.</p>';
			$titCompetencias = 'COMPETENCIAS COMPORTAMENTALES';
		}else{
			$pcTxt = '<p class="textos">Este Perfil describe cómo se ha definido la persona que ha respondido al cuestionario Prism@ con respecto a los comportamientos del Cuestionario Prisma asociados a la definición de las Competencias de ' . $cEmpresaDng->getNombre() . '.</p>
		...
		$sHtml .= '<tr>
							<td colspan="3" bgcolor="#ffffff" style="border-bottom:3px solid #93b1d3;">
							<h2 class="subtitulo" style="line-height:32px; color:#475464">'.$titCompetencias.'</h2></td>
						</tr>	';
		$sHtml .= '<tr>
							<td colspan="2" bgcolor="#949398">&nbsp;</td>
							<td bgcolor="#949398"><h2 class="subtitulo" style="color:#fff">Nivel Alcanzado</h2></td>
						</tr>	';
		...
		if ($nCompetencia > 0) {
			...
			$i = 0;
			while (!$listaCompetencias->EOF) {
				$SQL  = " SELECT * FROM export_personalidad_fit 
							WHERE idEmpresa = " . $_POST['fIdEmpresa'] .
					" AND idProceso = " . $_POST['fIdProceso'] .
					" AND idCandidato = " . $_POST['fIdCandidato'] .
					" AND idPrueba = " . $_POST['fIdPrueba'] .
					" AND idBaremo = " . $_POST['fIdBaremo'] .
					" AND idTipoInforme = " . $_POST['fIdTipoInforme'] .
					" AND nomMatching = '" .  $listaCompetencias->fields['nomMatching'] . "'; ";
				$competenciaFIT = $conn->Execute($SQL);
				$nContestadoFIT = $competenciaFIT->recordCount();

				array_push($arrayNomMatching, '\'' . $listaCompetencias->fields['nomMatching'] . '\'');
				...
				if ($nContestadoFIT > 0) {
					if($_POST['fIdEmpresa'] == 5897 && $_POST['fIdTipoInforme'] == 71){
						if($competenciaFIT->fields['puntuacion'] <= 3){
							$puntuacion = "1.00";
						}else if($competenciaFIT->fields['puntuacion'] > 3 && $competenciaFIT->fields['puntuacion'] <= 6){
							$puntuacion = "2.00";
						}else if($competenciaFIT->fields['puntuacion'] > 6 && $competenciaFIT->fields['puntuacion'] <= 8){
							$puntuacion = "3.00";
						}else{
							$puntuacion = "4.00";
						}

						//$puntuacion = round($competenciaFIT->fields['puntuacion']) . ".00";
					}else{
				...
				$sHtml .= ' <tr class="pLinea">
									<td class="tablaTitu"><p style="font-size: 12px;">' . $nomMatching . '</p></td>
									<td class="descripcion" valign="top">
										<p class="textos">' . $descMatching . '</p>
									</td>
									<td class="subTabla">
										<table border="0" style="border-collapse: separate;border: 0;" cellspacing="0" cellpadding="0">
											<tr>
												<td colspan="5" style="font-weight: bold;font-size: 12pt;">' . $puntuacion . '</td>
											</tr>
										</table>
									</td>
								</tr>';
				// Ajuste de bloques de competencias para DIAN
				if($_POST['fIdEmpresa'] == 5897 && $_POST['fIdTipoInforme'] == 71){
					if ($i % 8 == 0) {
						$pageBreak = true;
					} else {
				...
				}else if($_POST['fIdEmpresa'] == 6101 && $_POST['fIdTipoInforme'] == 71){
					if ($i % 12 == 0) {
						$pageBreak = true;
					} else {
						$pageBreak = false;
		...
		if ($_POST['fIdTipoInforme'] == 71) {
			...
			// Texto de introduccion DESGLOSE DE COMPETENCIAS para DIAN
			if($_POST['fIdEmpresa'] == 5897 && $_POST['fIdTipoInforme'] == 71){
				$sHtml .= '<h2 class="subtitulo">DESGLOSE DE COMPETENCIAS</h2>
					<div class="caja" style="margin-bottom:20px;">
						<h3 class="encabezado">' . mb_strtoupper(constant("STR_INTRODUCCION"), 'UTF-8') . '</h3>
							<p class="textos">A continuación, se presenta información complementaria sobre sus resultados con base en las escalas originales de la prueba aplicada, que sirvieron de insumo para la homologación de las competencias comportamentales incluidas en el Diccionario DIAN, estos se definen en puntaje de 1 a 10, siendo 1 el mínimo y 10 el máximo. Las escalas originales definen características típicas o estables que hacen que una persona se comporte o tienda a comportarse, en la vida laboral, de una determinada manera. Encontrará para cada competencia DIAN, el nombre, la definición y su puntuación en decatipos de las escalas originales utilizadas.</p>
					</div>';
			}
				
			$sHtml .= '
				<table class="competencias" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif !important">';

			$sHtml .= '<tr>
						<td colspan="4" bgcolor="#ffffff" style="border-bottom:3px solid #93b1d3; border-top: 3px solid #93b1d3;">
						<h2 class="subtitulo" style="line-height:32px; color:#475464">DESGLOSE DE COMPETENCIAS</h2></td>
					</tr>	';
			$sHtml .= '<tr>
						<td bgcolor="#949398" class=""><p style="font-size: 11px;background-color: #949398;text-align:center;padding: 2px 0px;">Escalas/Competencias</p></td>
						<td bgcolor="#949398" class=""><p style="font-size: 11px;background-color: #949398;text-align:center;padding: 2px 0px;">Descripción</p></td>
						<td bgcolor="#949398" class=""><p style="font-size: 11px;background-color: #949398;text-align:center;padding: 2px 0px;">Porcentaje</p></td>
						<td bgcolor="#949398" class=""><p style="font-size: 11px;background-color: #949398;text-align:center;padding: 2px 0px;">Puntuación</p></td>
					</tr>	';

			// Nuevos campos de tabla competencias / escalas
			$arrBloqItem = array();

			// Nueva SQL de fit_competencial
			$arrayNomMatching = '(' . implode(',', $arrayNomMatching) . ')';
			$SQL  = " SELECT * FROM fit_competencial 
				WHERE idEmpresa = " . $_POST['fIdEmpresa'] .
				" AND idPrueba = " . $_POST['fIdPrueba'] .
				" AND nomMatching IN " .  $arrayNomMatching . ";";
			$competenciaFITLaboral = $conn->Execute($SQL);
			$nCompetenciaFITLaboral = $competenciaFITLaboral->recordCount();

			if ($nCompetenciaFITLaboral > 0) {
				$count = 0;
				while (!$competenciaFITLaboral->EOF) {
					$SQL  = " SELECT * FROM export_personalidad_fit 
						WHERE idEmpresa = " . $_POST['fIdEmpresa'] .
						" AND idProceso = " . $_POST['fIdProceso'] .
						" AND idCandidato = " . $_POST['fIdCandidato'] .
						...
						" AND idBaremo = " . $_POST['fIdBaremo'] .
						" AND idTipoInforme = " . $_POST['fIdTipoInforme'] .
						" AND nomMatching = '" .  $competenciaFITLaboral->fields['nomMatching'] . "'; ";
					$competenciaFITPunt = $conn->Execute($SQL);

					//Diferenciamos entre escalas y competencias
					if ($competenciaFITLaboral->fields['idBloque'] != NULL) {
						$competencia = 0;
					} else {
						$competencia = 1;
					}

					if (!isset($arrBloqItem[$count])) {
						$arrBloqItem[$count] = [
							'nomMatchingId' => $competenciaFITLaboral->fields['id'],
							'nomMatching' => $competenciaFITLaboral->fields['nomMatching'],
							'punMatching' => $competenciaFITPunt->fields['puntuacion'],
							'competencia' => $competencia,
							'idBloque' => [$competencia == 0 ? $competenciaFITLaboral->fields['idBloque'] : $competenciaFITLaboral->fields['idTipoCompetencia']],
							'idEscala' => [$competencia == 0 ? $competenciaFITLaboral->fields['idEscala'] : $competenciaFITLaboral->fields['idCompetencia']]
						];
					} else {
						if ($arrBloqItem[$count]['nomMatching'] != $competenciaFITLaboral->fields['nomMatching']) {
							$count++;
							$arrBloqItem[$count] = [
								'nomMatchingId' => $competenciaFITLaboral->fields['id'],
								'nomMatching' => $competenciaFITLaboral->fields['nomMatching'],
							...
							if (!in_array($competenciaFITLaboral->fields['idBloque'], $arrBloqItem[$count]['idBloque'])) {
								array_push($arrBloqItem[$count]['idBloque'], $competencia == 0 ? $competenciaFITLaboral->fields['idBloque'] : $competenciaFITLaboral->fields['idTipoCompetencia']);
							}
							if (!in_array($competenciaFITLaboral->fields['idEscala'], $arrBloqItem[$count]['idEscala'])) {
								array_push($arrBloqItem[$count]['idEscala'], $competencia == 0 ? $competenciaFITLaboral->fields['idEscala'] : $competenciaFITLaboral->fields['idCompetencia']);
							}
						}
					}

					// Recoger escalas_items de prueba
					if ($competencia == 0) {
						$SQL  = " SELECT * FROM escalas_items 
							WHERE idPrueba = " . $_POST['fIdPrueba'] .
							" AND idBloque = " . $competenciaFITLaboral->fields['idBloque'] .
							" AND idEscala = " . $competenciaFITLaboral->fields['idEscala'] .
							";";
						$arrItems = $conn->Execute($SQL);
					} else {
						$SQL  = " SELECT * FROM competencias_items 
							WHERE idPrueba = " . $_POST['fIdPrueba'] .
							" AND idTipoCompetencia = " . $competenciaFITLaboral->fields['idTipoCompetencia'] .
							" AND idCompetencia = " . $competenciaFITLaboral->fields['idCompetencia'] .
							";";
						$arrItems = $conn->Execute($SQL);
					}

					while (!$arrItems->EOF) {
						if (!isset($arrBloqItem[$count]['idItem'])) {
							$arrBloqItem[$count]['idItem'] = [];
							array_push($arrBloqItem[$count]['idItem'], $arrItems->fields['idItem']);
						} else {
							array_push($arrBloqItem[$count]['idItem'], $arrItems->fields['idItem']);
						}

						// Recoger las respuestas_pruebas_items				
						$SQL  = " SELECT * FROM respuestas_pruebas_items 
							WHERE idEmpresa = " . $_POST['fIdEmpresa'] .
							" AND idProceso = " . $_POST['fIdProceso'] .
							" AND idCandidato = " . $_POST['fIdCandidato'] .
							" AND idPrueba = " . $_POST['fIdPrueba'] .
							" AND idItem = " . $arrItems->fields['idItem'] .
							";";
						$respPruebItems = $conn->Execute($SQL);

						while (!$respPruebItems->EOF) {

							$SQL  = " SELECT * FROM items_inversos 
								WHERE idPrueba = " . $_POST['fIdPrueba'] .
								" AND idItem = " . $respPruebItems->fields['idItem'] .
								";";
							$itemsInversos = $conn->Execute($SQL);
							$nItemsInversos = $itemsInversos->recordCount();
							...
							if (!isset($arrBloqItem[$count]['respPruebItems'])) {
								$arrBloqItem[$count]['respPruebItems'] = [];
								array_push($arrBloqItem[$count]['respPruebItems'], [
									'bloque' 	=> $competencia == 0 ? $competenciaFITLaboral->fields['idBloque'] : $competenciaFITLaboral->fields['idTipoCompetencia'],
									'escala' 	=> $competencia == 0 ? $competenciaFITLaboral->fields['idEscala'] : $competenciaFITLaboral->fields['idCompetencia'],
									'valor' 	=> $respPruebItems->fields['valor'],
									'idOpcion' 	=> $respPruebItems->fields['idOpcion'],
									'inverso' 	=> $inverso,
								]);
							} else {
								array_push($arrBloqItem[$count]['respPruebItems'], [
							...
							//Pasamos al siguiente registro de la query
							$respPruebItems->MoveNext();
						}
						//Pasamos al siguiente registro de la query
						$arrItems->MoveNext();
					}
					//Pasamos al siguiente registro de la query
					$competenciaFITLaboral->MoveNext();
				}


				//Sumar todos los resultados
				foreach ($arrBloqItem as $key => $bloqItem) {
					$total = 0;
					foreach ($bloqItem['respPruebItems'] as $respPruebItem) {
						if (!isset($arrBloqItem[$key]['total'][$respPruebItem['bloque'] . "-" . $respPruebItem['escala']])) {
							$total = 0;
						}
						switch ($respPruebItem['inverso']) {
								// Sumamos para no inversos
							case 0:
								switch ($respPruebItem['idOpcion']) {
									case '0':
										$total = $total + 1;
										break;
						...
						$arrBloqItem[$key]['total'][$respPruebItem['bloque'] . "-" . $respPruebItem['escala']] = $total;
					}

					if ($key === count($arrBloqItem) - 1) {
						// Aplicar el baremo a las puntuaciones
						foreach ($arrBloqItem as $key => $bloqItem) {
							$arrBloqItem[$key]['viewInfo'] = [];
							foreach ($bloqItem['total'] as $bloqItemKey => $value) {
								$bloqAndItem = explode('-', $bloqItemKey);
								$bloque = $bloqAndItem[0];
								$escala = $bloqAndItem[1];
								$competencia = $bloqItem['competencia'];

								if ($competencia == 0) {
									// Recoger el baremo seleccionado
									$SQL  = " SELECT * FROM baremos_resultados 
										WHERE idPrueba = " . $_POST['fIdPrueba'] .
										" AND idBaremo = " . $_POST['fIdBaremo'] .
										" AND idBloque = " . $bloque .
										" AND idEscala = " . $escala .
										";";
									$baremosResult = $conn->Execute($SQL);

									// Recoger info de escala
									$SQL  = " SELECT * FROM escalas 
										WHERE codIdiomaIso2 = '" . $_POST['fCodIdiomaIso2'] .
										"' AND idBloque = " . $bloque .
										" AND idEscala = " . $escala .
										";";
									$escalasResult = $conn->Execute($SQL);

									// Nueva SQL de fit_competencial
									$SQL  = " SELECT * FROM fit_competencial 
										WHERE idEmpresa = " . $_POST['fIdEmpresa'] .
										" AND idPrueba = " . $_POST['fIdPrueba'] .
										" AND nomMatching = '" . $bloqItem['nomMatching'] . "'" .
										" AND idBloque = " . $bloque .
										" AND idEscala = " . $escala .
										";";
									$competenciaFITLaboral = $conn->Execute($SQL);
									...
									// Recoger el baremo seleccionado
									$SQL  = " SELECT * FROM baremos_resultados_competencias
										WHERE idPrueba = " . $_POST['fIdPrueba'] .
										" AND idBaremo = " . $_POST['fIdBaremo'] .
										" AND idTipoCompetencia = " . $bloque .
										" AND idCompetencia = " . $escala .
										";";
									$baremosResult = $conn->Execute($SQL);

									// Recoger info de competencias
								...
								while (!$baremosResult->EOF) {
									if (
										$value >= $baremosResult->fields['puntMin']
										&& $value <= $baremosResult->fields['puntMax']
									) {
										$totalBaremado = $baremosResult->fields['puntBaremada'];
										$porcentaje = $competenciaFITLaboral->fields['porcentaje'];
										//líneas de texto por descripción
										$nCaracteres = strlen($escalasResult->fields['descripcion']);
										$nDeBr = substr_count($escalasResult->fields['descripcion'], "<br />");
										$lineas = ($nCaracteres / 55) + $nDeBr;

										array_push($arrBloqItem[$key]['viewInfo'], [
											'nombre' 		=> $escalasResult->fields['nombre'],
											'descripcion' 	=> $escalasResult->fields['descripcion'],
											'lineas'		=> $lineas,
											'totalBaremado' => $totalBaremado,
											'porcentaje' 	=> $porcentaje
										]);
									}
									$baremosResult->MoveNext();
								}
							}
						}
					}
			...
			//echo "<script>console.log(JSON.parse('" . json_encode($arrBloqItem) . "'));</script>";

			// Imprimir el contenido en la tabla de competencias
			if (count($arrBloqItem) > 0) {
				$totalLineas = 0;
				foreach ($arrBloqItem as $key => $arr) {
					//Cálculo de líneas para decidir si saltamos de página o no
					foreach ($arr['viewInfo'] as $viewInfo) {
						$totalLineas = $totalLineas + $viewInfo['lineas'];
					}

					//echo "<script>console.log(".$totalLineas.");</script>";
					if($_POST['fIdEmpresa'] == 5897 && $_POST['fIdTipoInforme'] == 71){
						$lineasMax = 27.5;
					}else if($_POST['fIdEmpresa'] == 6101 && $_POST['fIdTipoInforme'] == 71){
						$lineasMax = 55;
					...
					if ($key != 0 && $totalLineas >= $lineasMax) {
						$totalLineas = 0;
						$sHtml .= '</table>
								</div><!--FIN DIV DESARROLLO-->
							</div>
					...
					if($_POST['fIdEmpresa'] == 5897 && $_POST['fIdTipoInforme'] == 71){
						if($arr['punMatching'] <= 3){
							$arrPunMatching = "1.00";
						}else if($arr['punMatching'] > 3 && $arr['punMatching'] <= 6){
							$arrPunMatching = "2.00";
						}else if($arr['punMatching'] > 6 && $arr['punMatching'] <= 8){
							$arrPunMatching = "3.00";
						}else{
							$arrPunMatching = "4.00";
						}
							//$arrPunMatching = round($arr['punMatching']).".00";
					}else{
					$arrPunMatching = $arr['punMatching'];
					}	
					$sHtml .= '<tr class="desgloseTit">
						<td colspan="3" class="tablaTitu" style="background: #475464; text-align: left; padding: 8px 0px 8px 5px; font-size: 15px; font-weight: 600;">
							<p>' . $arr['nomMatching'] . '</p>
						</td>
						<td class="desgloseTitTdPunt">
							<p>' . $arrPunMatching . '</p>
						</td>
					</tr>';
					...
					foreach ($arr['viewInfo'] as $viewInfo) {
						...
						$descripcion = $viewInfo['descripcion'];
						$porcentaje = $viewInfo['porcentaje'];
						$totalBaremado = $viewInfo['totalBaremado'];

						$sHtml .= ' 
						<tr>
							<td class="desgloseNom" valign="top">
								<p class="">' . $nombre . '</p>
							</td>
							<td class="desgloseDes" valign="top">
								<p class="">' . $descripcion . '</p>
							</td>
							<td class="desglosePor" valign="top">
								<p class="">' . $porcentaje . '</p>
							</td>
							<td class="desglosePun">
								<p class="">' . $totalBaremado . '</p>
							</td>
						</tr>';
					}
				}
...
// Este condicional nos indica que la llamada viene del archivo Informes_candidato_zip.php
// Al ser un archivo que está en la carpeta de /Empresa necesitamos cambiar la ruta con la
// constante DIR_FS_DOCUMENT_ROOT_ADMIN (es una chapuza pero funciona ;P)
...
if($_POST['fIdEmpresa'] == 5897 && $_POST['fIdTipoInforme'] == 71){
	$sDescInforme = 'Reporte Individual Competencias Comportamentales';
}else{
...
$sHtmlInicio = '
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="' . $dirGestor . 'estilosInformes/prisma/resetCSS.css"/>
					';
/* if ($_POST['fIdTipoInforme'] != 11 && $_POST['fIdTipoInforme'] != 71 || $_POST['fIdTipoInforme'] == 3) {
	$sHtmlInicio .= 		'<link rel="stylesheet" type="text/css" href="' . $dirGestor . 'estilosInformes/prisma/style_old.css"/>';
} else if ($_POST['fIdTipoInforme'] == 11) {
	$sHtmlInicio .= 		'<link rel="stylesheet" type="text/css" href="' . $dirGestor . 'estilosInformes/prisma/styleNarrativos.css"/>';
} else {
	$sHtmlInicio .= 		'<link rel="stylesheet" type="text/css" href="' . $dirGestor . 'estilosInformes/prisma/style.css"/>';
} */

if ($_POST['fIdTipoInforme'] == 11) {
	$sHtmlInicio .= 		'<link rel="stylesheet" type="text/css" href="' . $dirGestor . 'estilosInformes/prisma/styleNarrativos.css"/>';
} else if ($_POST['fIdTipoInforme'] == 71) {
	$sHtmlInicio .= 		'<link rel="stylesheet" type="text/css" href="' . $dirGestor . 'estilosInformes/prisma/style.css"/>';
} else {
	$sHtmlInicio .= 		'<link rel="stylesheet" type="text/css" href="' . $dirGestor . 'estilosInformes/prisma/style_old.css"/>';
}

//var_dump($sHtmlInicio);
//die;
...
if ($_POST['fIdTipoInforme'] != 71) {
	$sHtmlCab .=	'
									<img src="' . $dirGestor . 'estilosInformes/prisma/img/logo-pequenio.jpg" title="logo"/>
									';
}
$sHtmlCab .=				'</td>
						    <td class="fecha">
...
$sHtml .= '
			...
			';
			//<img src="https://test-station.com/estilosInformes/prisma/img/logo.jpg" />
...
if ($_POST['fIdTipoInforme'] != 71) {
	...
	//$imagePath = "https://test-station.com/Admin/estilosInformes/prisma/img/logo-pequenio.jpg";
	//$imagePath = $dirGestor . 'estilosInformes/prisma/img/logo.jpg';
	...
	// Crear la URL en base64
	//$base64ImageUrl = 'data:' . $imageType . ';base64,' . $base64Image;

	// Imprimir la URL de la imagen en base64
	//echo $base64ImageUrl;




	/* <img src="data:image/jpeg;base64,{{LA_CADENA_BASE64_GENERADA}}" alt="Descripción de la imagen"> */

	/******************************************************** */
	//$sHtml .= '    	<img src="' . $dirGestor . 'graf/prisma/portada.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />';
	$sHtml .= '			<img src="' . $dirGestor . 'estilosInformes/prisma/img/logo.jpg" />';
	//$sHtml .= '			<img src="'.$base64ImageUrl.'"/>';
} else {
	//$sHtml.= '    	<img src="' . $dirGestor . 'graf/portada_blank_fit.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />';
}
/* $sHtml.= '    	<h1 class="titulo">';
		if($_POST['fIdTipoInforme'] !=71) {
			...
			if (!empty($sPathLogo)){
				$sHtml.= '			<img src="' . $dirGestor . $sPathLogo . '" style="max-height: 90px;" />';
			}
		} */
/* $sHtml.= '		</h1>'; */
if ($_POST['fIdTipoInforme'] != 11) {
...
if ($_POST['fIdTipoInforme'] == 71) {
	$sPathLogo = $cEmpresaDng->getPathLogo();
	if (!empty($sPathLogo) && $_POST['fIdTipoInforme'] != 3) {
		$sHtml .= '<center><img id="logo_empresa" src="' . $dirGestor . $sPathLogo . '" /></center>';
	}
}

/* if($_POST['fIdEmpresa'] == 5897 && $cCandidato->getNombre()=="Joshua"){
			

	echo "Test de DIAN :: " . $cCandidato ;
} */

if($_POST['fIdEmpresa'] == 5897 && $_POST['fIdTipoInforme'] == 71){
	$bloqueDian = '<p class="textos"><strong>' . constant("STR_IDENTIFICADOR") . ':</strong> ' . $cCandidato->getMail() . '</p>';
	$copyId = 'copyDian';

	$SQLFecha  = " SELECT * FROM export_personalidad_fit 
			WHERE idEmpresa = " . $_POST['fIdEmpresa'] .
		" AND idProceso = " . $_POST['fIdProceso'] .
		" AND idCandidato = " . $_POST['fIdCandidato'] .
		" AND idPrueba = " . $_POST['fIdPrueba'] .
		" AND idBaremo = " . $_POST['fIdBaremo'] .
		" AND idTipoInforme = " . $_POST['fIdTipoInforme'] . " LIMIT 1; ";
	
	$regCompFIT = $conn->Execute($SQLFecha);
	$txtFecha = constant("STR_FECHA_INFORME_DIAN");
	$fecAlta = date("d/m/Y", strtotime($regCompFIT->fields['fecAlta']));

	//echo "Test :::: " . $fecAlta . $regCompFIT . $SQLFecha;
}else{
	$bloqueDian = ''; 
	$copyId = 'copy';
	$txtFecha = constant("STR_FECHA_INFORME");
	$fecAlta = date("d/m/Y");
}
...
$sHtml .= '
				<div id="informe">
					...
					<p class="textos"><strong>' . $txtFecha . ':</strong> ' . $fecAlta . '</p>
					' . $bloqueDian . '
				</div>
				</br>
				<div id="'.$copyId.'">
					<h2>Copyright 2024, PSICÓLOGOS EMPRESARIALES S.A.</h2>
				</div>
			</div>
			<!--FIN DIV PAGINA-->
      <hr>
...
switch ($_POST['fIdTipoInforme']) {
	...
	case (71); //Dashboard Fit competencial
		...
		if ($nContestadosFIT <= 0) {
			...
			$sHtml .= informeCompetencias_FIT($aPuntuacionesCompetencias, $sHtmlCab, $_POST['fCodIdiomaIso2']);
		}
...
$sHtml .= '
			<div class="pagina portada_fin" id="contraportada">
...
if (!isset($NOGenerarFICHERO_INFORME)) {
	...
	if ($_POST['MODO'] != constant("MNT_EXPORTA_HTML")) {
		...
		//include($documentRoot . "Template/Informes_candidato/generaDOMPDF.php");
