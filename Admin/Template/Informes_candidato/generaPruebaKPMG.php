...
if(!isset($counter) || $counter==0){
	...
	function setPuntuacionTipoTipoItem($ti, $resultado){
		...
		global $comprensionHabladaOK;
		global $comprensionHabladaERROR;
		global $comprensionHabladaBLANCO;
...
<br />', '<br><br>',$cTextos_secciones->getTexto());
		...
		$s_test = str_replace('font-size: 18px;', 'font-size:16px;',$s_test);
		$s_test = str_replace('font-size: 19.2667px;', 'font-size:16px;',$s_test);
...
//		$IP = number_format($iPDirecta/$listaRespItems->recordCount() ,2);
    					...
    					<tr>
    						<td width="60%" align="center" >
    							<table class="resetTable" cellspacing="15" cellpadding="10" border="0" width="95%">
    								<tr>
    									...
    									<td width="10%" style="border:3px solid #004080;" align="center"><font style="font-size: 14px;color: #6e6e6e;font-weight: bold;">' . $iTotalItemsPruebas . '</font>
    									</td>
    								</tr>
    								<tr>
    									<td width="90%" style="border:3px solid #004080;">
							...
							$sHtml.='<tr>
				    						<td width="100%" align="center">
													<table class="resetTable" style="margin-bottom: 20px;" cellspacing="15" cellpadding="10" border="0" width="100%">
														<tr>
															<td width="100%" style="border:3px solid #c61111;">
																<font style="font-size: 14px;color: #000;font-weight: bold;">'.constant("STR_RESULTADOS_ELT_ESCRITO").'</font>
															</td>
														</tr>
													</table>
												</td>
    							...
    							<table width="474" cellspacing="0" cellpadding="0" style="margin-left: 13px;background:#c0c0c0;border-left:3px solid #004080;border-right:3px solid #004080;">
    								<tr>
    									...
    									<td width="24%" align="center" style="height:40px;border-top:2px solid #004080;border-bottom:2px solid #004080;">
    										<font style="font-size: 14px;color: #c0c0c0;font-weight: bold;">' . mb_strtoupper(constant("STR_BAJO_POTENCIAL"), 'UTF-8').'</font>
    									</td>
    									<td width="25%" align="center" style="height:40px;border:2px solid #004080;border-left:2px solid #c0c0c0;">
    										<font style="font-size: 14px;color: #c0c0c0;font-weight: bold;">' . mb_strtoupper(constant("STR_MEDIO_POTENCIAL"), 'UTF-8').'</font>
    									</td>
    									<td width="32%" align="center" style="height:40px;border:2px solid #004080;">
    										<font style="font-size: 14px;color: #004080;font-weight: bold;">Advanced Certificate Level</font>
    									</td>
    								</tr>
    							</table>
    							<table width="90%" cellspacing="0" cellpadding="0" style="margin-left: 13px;border-left:4px solid #004080;border-bottom:3px solid #004080;border-right:4px solid #004080;">
    								<tr>
    									<td width="19%" style="height:45px;border-right:2px solid #004080;">
    										<br />
    										<font style="font-size: 14px;padding-left:20px;color: #000000;font-weight: bold;">' . constant("STR_PD") . ' = ';
												if ($bPruebaRealizada48){
												 $sHtml.= $puntuacion48;
											  }
												 $sHtml.='</font>
    										<br />
    										<font style="font-size: 14px;padding-left:20px;color: #000000;font-weight: bold;">' . constant("STR_PC") . ' = ';
												if ($bPruebaRealizada48){
													$sHtml.=($iWhidth * $factor48) . '%';
												}
												$sHtml.='</font>
    									</td>
    ...
    $sHtml.='<tr>
  						<td width="100%" align="center">
								<table class="resetTable" style="margin-bottom: 20px;" cellspacing="15" cellpadding="10" border="0" width="100%">
									<tr>
										<td width="100%" style="border:3px solid #c61111;">
											<font style="font-size: 14px;color: #000;font-weight: bold;">'.constant("STR_RESULTADOS_ELT_HABLADA").'</font>
										</td>
									</tr>
								</table>
							</td>
    	...
    	$sHtml.='
					...
					$sHtml.='
						...
						$cTextos_secciones = $cTextos_seccionesDB->readEntidad($cTextos_secciones);
							...
							$sHtml.='				<p style="text-align:center;background:#004080;height:25px;padding:5px;margin-bottom: 40px;">
    							...
    							<table class="resetTable" cellspacing="13" cellpadding="8" border="0" width="90%">
    								...
    								<tr>
    									...
    									<td style="border:3px solid #004080;" align="center">
    										<font style="font-size: 14px;color: #6e6e6e;font-weight: bold;">';
												if ($bPruebaRealizada48){
													 $sHtml.=$iTotalVocabulario;
												}
												$sHtml.='</font>
    									</td>
    								</tr>
    								<tr>
    									...
    									<td style="border:3px solid #004080;" align="center"><font style="font-size: 14px;color: #6e6e6e;font-weight: bold;">';
											if ($bPruebaRealizada48){
												 $sHtml.=$vocabularioOK;
											}
											$sHtml.='</font>
	...
	$sHtml.='<tr>
						<td width="80%" align="center">
							<table class="resetTable" cellspacing="13" cellpadding="8" border="0" width="90%">
							<tr>
								<td width="90%" class="puntuacionTipo">' . constant("STR_COMPRENSION_ESCRITA") . ':
								</td>
								<td width="1px">
								</td>
								<td width="10%">
							...
							<tr>
								<td colspan="2" style="border:3px solid #004080;">
									<font style="font-size: 14px;color: #004080;font-weight: bold;">' . constant("STR_NUMERO_TOTAL_DE_PREGUNTAS_REFERENTES_A_COMPRENSION_ESCRITA") . '</font>
								</td>
								<td style="border:3px solid #004080;" align="center">
									<font style="font-size: 14px;color: #6e6e6e;font-weight: bold;">';
									if ($bPruebaRealizada48){
										 $sHtml.=$iTotalComprension;
									}
									$sHtml.='</font>
								</td>
							</tr>
							...
							<tr>
								...
								<td style="border:3px solid #004080;" align="center"><font style="font-size: 14px;color: #6e6e6e;font-weight: bold;">';
								if ($bPruebaRealizada48){
									 $sHtml.=$comprensionBLANCO;
								}
								$sHtml.='</font>
								</td>
							</tr>
								<tr>
									<td width="90%" class="puntuacionTipo">' . constant("STR_COMPRENSION_HABLADA") . ':
									</td>
									<td width="1px">
									</td>
									<td width="10%">
								...
								<tr>
									<td colspan="2" style="border:3px solid #004080;">
										<font style="font-size: 14px;color: #004080;font-weight: bold;">' . constant("STR_NUMERO_TOTAL_DE_PREGUNTAS_REFERENTES_A_COMPRENSION_HABLADA") . '</font>
									</td>
									<td style="border:3px solid #004080;" align="center">
										<font style="font-size: 14px;color: #6e6e6e;font-weight: bold;">';
										if ($bPruebaRealizada58){
											$sHtml.= $iTotalComprensionHablada;
										}
										$sHtml.= '</font>
									</td>
								</tr>
								...
								<tr>
									...
									<td style="border:3px solid #004080;" align="center"><font style="font-size: 14px;color: #6e6e6e;font-weight: bold;">';
									if ($bPruebaRealizada58){
										 $sHtml.=$comprensionHabladaBLANCO;
									}
									$sHtml.='</font>
									</td>
								</tr>
...
//		echo "LLEGO PDF";exit;
    ...
    $footer_html    =  mb_strtoupper(str_ireplace(" LISTENING", "", $cPruebas->getNombre()), 'UTF-8') . str_repeat(" ", 70) . constant("STR_PIE_INFORMES");
