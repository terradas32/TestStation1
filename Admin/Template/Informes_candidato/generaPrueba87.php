								...
								<table width="100%" cellspacing="0" cellpadding="0">
									<tr>
										<td style="height:45px;">
											<img src="'. $dirGestor . constant('DIR_WS_GRAF') . 'numeritosEstandar.jpg'.'" style="width:100%;">
										</td>
									</tr>
									<tr>
										<td width="81%" style="vertical-align:middle;">
											<img src="'. $dirGestor . constant('DIR_WS_GRAF'). 'bodoque_gigante.jpg'.'" style="width:'.$iWhidth*$iAutoevaluacionX.'%;height:25px;">
										</td>
									</tr>
								</table>
							</td>
						...
						<tr>
							<td class="puntos_num"><span class="pdOut">P.D.</span><br /><br /> ' . $iPDirecta . '</td>
									<td class="puntos_escala">
										...
										<tr>
											<td width="81%" style="vertical-align:middle;">
												<img src="'.$dirGestor . constant('DIR_WS_GRAF'). 'bodoque_gigante.jpg'.'" style="width:'.(($iPDirectaX*564)/100).'px;height:25px;">
											</td>
										</tr>
									</table>
									</td>
							...
							<td class="puntos_num"><span class="pdOut">P.D</span>&nbsp;&nbsp;' . $iPDirecta . '<br /><br /><span class="pdOut">P.C</span>&nbsp;&nbsp;' . $iPercentil . '</td>
									<td class="puntos_escala">
										<table width="564" cellspacing="0" cellpadding="0">
											...
											<tr>
												<td width="81%" style="vertical-align:middle;">
													<img src="'. $dirGestor . constant('DIR_WS_GRAF'). 'bodoque_gigante.jpg'.'" style="width:'.(($iPercentil*564)/100).'px;height:25px;">
												</td>
											</tr>
									</table>
				...
				<div class="desarrollo">
					...
					<div class="caja">
						...
						<p class="textos"><font style="font-weight: bold;">Ejemplo:<br /><br /></font>
							<img class="ejemCons" src="'.$dirGestor.'graf/seas/' . $_POST['fCodIdiomaIso2']. '/ejemploConsistenciaMB.jpg" alt="Escala Consistencia" title="Escala Consistencia" />
						</p>
	...
	$sHtml.='
			...
			$sHtml.='
						<tr>
							...
							<td class="pl_img" align="center">' . '<img src="' . $dirGestor . 'graf/seas/cpc' . $iPBaremada . '.jpg" title="' . $iPBaremada . '" />' . '</td>
			...
			$sHtml.='
						<tr>
							...
							<td class="pl_img" align="center" style="border-style: solid;border-width: 2px 1px 2px 1px;">' . '<img src="' . $dirGestor . 'graf/seas/cpc' . $consistencia . '.jpg" title="' . $consistencia . '" />' . '</td>
					...
					<div class="caja" style="margin-top:20px !important;">
						<table border="0" style="margin-left: 117px;">
							<tr>
								...
								<td style="text-align: center;width: 50px;"><img src="'.$dirGestor.'graf/seas/flechita.jpg" title="Flecha" /></td>
	...
	*/
	...
	$sHtml= '
			<div class="pagina portada">
				<img src="'.$dirGestor.'graf/seas/portada.jpg" alt="Psicólogos Empresariales" title="Psicólogos Empresariales" />
				<h1 class="titulo"></h1>';
		...
		$sHtmlInicio='
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/seas/resetCSS.css"/>';
					if($_POST['fIdTipoInforme'] != 11){
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/seas/style.css"/>';
					}else{
						$sHtmlInicio.= 		'<link rel="stylesheet" type="text/css" href="'.$dirGestor.'estilosInformes/seas/styleNarrativos.css"/>';
					}
		$sHtmlInicio.='
					<title>SEAS</title>
					<style type="text/css">
	...
	$sHtmlCab .='<div class="cabecera">
					<table width="100%" border="0">
						<tr>
						    ...
						    <td class="logo">
						    	<img src="'.$dirGestor.'estilosInformes/seas/img/sp.gif" title="logo"/>
						    </td>
						    <td class="fecha">
