	...
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTFecMod"><?php echo constant("STR_FECHA_DE_FINALIZACION");?></label>&nbsp;</td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='fecMod' <?php echo (!empty($sOrderBy) && $sOrderBy == 'fecMod') ? "selected='selected'" : "";?>><?php echo constant("STR_FECHA_DE_FINALIZACION");?></option>

							<option style='color:#000000;' value='idEmpresa,idProceso,codIdiomaIso2,idPrueba,idCandidato,orden' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idEmpresa,idProceso,codIdiomaIso2,idPrueba,idCandidato,orden') ? "selected='selected'" : "";?>>Varios</option>
	...
	<input type="hidden" name="respuestas_pruebas_items_next_page" value="1" />
						...
						<script language="javascript" type="text/javascript">
							...
							function cambiaIdItem(){
								var f= document.forms[0];
								$("#comboIdOpcion").show().load("jQuery.php",{sPG:"comboopciones",bBus:"1",multiple:"0",nLineas:"1",bObliga:"0",bgColor:"<?php echo constant("BG_COLOR")?>",fNombreCampo:"LSTIdOpcion",fJSProp:"cambiaIdOpcion",LSTCodIdiomaIso2:f.LSTCodIdiomaIso2.value,LSTIdPrueba:f.LSTIdPrueba.value,LSTIdItem:f.LSTIdItem.value,vSelected:"<?php echo $cEntidad->getIdOpcion();?>",sTK:"<?php echo $_cEntidadUsuarioTK->getToken();?>"}).fadeIn("slow");
							}
							//]]>
						</script>
						<script language="javascript" type="text/javascript">
