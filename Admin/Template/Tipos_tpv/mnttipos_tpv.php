...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_TIPO_TPV");?>:", f.LSTIdTipoTpv.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_TIPO_TPV");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdTipoTpvHast.value, 11, false);
	msg +=vString("<?php echo constant("STR_DESCRIPCION");?>:",f.LSTDescripcion.value,255, false);
	msg +=vString("<?php echo constant("STR_TERMINAL_TYPE");?>:",f.LSTTERMINAL_TYPE.value,3, false);
	msg +=vString("<?php echo constant("STR_OPERATION_TYPE");?>:",f.LSTOPERATION_TYPE.value,3, false);
	msg +=vString("<?php echo constant("STR_URL_NOTIFY");?>:",f.LSTURL_NOTIFY.value,2500, false);
	msg +=vString("<?php echo constant("STR_URL_OK");?>:",f.LSTURL_OK.value,2500, false);
	msg +=vString("<?php echo constant("STR_URL_KO");?>:",f.LSTURL_NOOK.value,2500, false);
	msg +=vString("<?php echo constant("STR_SERVICE_ACTION");?>:",f.LSTSERVICE_ACTION.value,2500, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoTpv"><?php echo constant("STR_ID_TIPO_TPV");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdTipoTpv" name="LSTIdTipoTpv" value="<?php echo $cEntidad->getIdTipoTpv();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdTipoTpvHast" name="LSTIdTipoTpvHast" value="<?php echo $cEntidad->getIdTipoTpvHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTTERMINAL_TYPE"><?php echo constant("STR_TERMINAL_TYPE");?></label>&nbsp;</td>
					<td><input type="text" id="LSTTERMINAL_TYPE" name="LSTTERMINAL_TYPE" value="<?php echo $cEntidad->getTERMINAL_TYPE();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTOPERATION_TYPE"><?php echo constant("STR_OPERATION_TYPE");?></label>&nbsp;</td>
					<td><input type="text" id="LSTOPERATION_TYPE" name="LSTOPERATION_TYPE" value="<?php echo $cEntidad->getOPERATION_TYPE();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTURL_NOTIFY"><?php echo constant("STR_URL_NOTIFY");?></label>&nbsp;</td>
					<td><input type="text" id="LSTURL_NOTIFY" name="LSTURL_NOTIFY" value="<?php echo $cEntidad->getURL_NOTIFY();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTURL_OK"><?php echo constant("STR_URL_OK");?></label>&nbsp;</td>
					<td><input type="text" id="LSTURL_OK" name="LSTURL_OK" value="<?php echo $cEntidad->getURL_OK();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTURL_NOOK"><?php echo constant("STR_URL_KO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTURL_NOOK" name="LSTURL_NOOK" value="<?php echo $cEntidad->getURL_NOOK();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTSERVICE_ACTION"><?php echo constant("STR_SERVICE_ACTION");?></label>&nbsp;</td>
					<td><input type="text" id="LSTSERVICE_ACTION" name="LSTSERVICE_ACTION" value="<?php echo $cEntidad->getSERVICE_ACTION();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idTipoTpv' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idTipoTpv') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_TIPO_TPV");?></option>
							...
							<option style='color:#000000;' value='TERMINAL_TYPE' <?php echo (!empty($sOrderBy) && $sOrderBy == 'TERMINAL_TYPE') ? "selected='selected'" : "";?>><?php echo constant("STR_TERMINAL_TYPE");?></option>
							<option style='color:#000000;' value='OPERATION_TYPE' <?php echo (!empty($sOrderBy) && $sOrderBy == 'OPERATION_TYPE') ? "selected='selected'" : "";?>><?php echo constant("STR_OPERATION_TYPE");?></option>
							<option style='color:#000000;' value='URL_NOTIFY' <?php echo (!empty($sOrderBy) && $sOrderBy == 'URL_NOTIFY') ? "selected='selected'" : "";?>><?php echo constant("STR_URL_NOTIFY");?></option>
							<option style='color:#000000;' value='URL_OK' <?php echo (!empty($sOrderBy) && $sOrderBy == 'URL_OK') ? "selected='selected'" : "";?>><?php echo constant("STR_URL_OK");?></option>
							<option style='color:#000000;' value='URL_NOOK' <?php echo (!empty($sOrderBy) && $sOrderBy == 'URL_NOOK') ? "selected='selected'" : "";?>><?php echo constant("STR_URL_KO");?></option>
							<option style='color:#000000;' value='SERVICE_ACTION' <?php echo (!empty($sOrderBy) && $sOrderBy == 'SERVICE_ACTION') ? "selected='selected'" : "";?>><?php echo constant("STR_SERVICE_ACTION");?></option>
	...
	<input type="hidden" name="tipos_tpv_next_page" value="1" />
