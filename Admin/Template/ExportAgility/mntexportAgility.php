...
function validaForm()
{
	...
	msg +=vString("Proceso:",f.LSTIdProceso.value,255,true);
	//msg +=vString("Pruebas:",f.LSTIdPrueba.value,255,false);
...
<!-- 
				<tr>
					...
					<td><?php $comboPRUEBAS->setNombre("LSTIdPrueba");?><?php echo $comboPRUEBAS->getHTMLCombo("1","cajatexto",$_POST['LSTIdPrueba']," ","");?></td>
				</tr>
