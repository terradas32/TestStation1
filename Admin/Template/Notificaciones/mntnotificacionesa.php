...
function validaForm()
{
	...
	var msg="";
  var myf = $('#fCuerpo_ifr');
  var editorContent = $('#tinymce[data-id="fCuerpo"]', myf.contents()).html();
	msg +=vNumber("<?php echo constant("STR_TIPO_DE_NOTIFICACION");?>:",f.fIdTipoNotificacion.value,11,true);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdTipoNotificacion"><?php echo constant("STR_TIPO_DE_NOTIFICACION");?></label>&nbsp;</td>
					<td><?php $comboNOTIFICACIONES_TIPOS->setNombre("fIdTipoNotificacion");?><?php echo $comboNOTIFICACIONES_TIPOS->getHTMLCombo("1","obliga",$cEntidad->getIdTipoNotificacion()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td><textarea class="tinymce" data-id="fCuerpo" id="fCuerpo" name="fCuerpo"><?php echo  $cEntidad->getCuerpo();?></textarea>
				...
				<?php
				$sVisible="";
				include_once('include/literales_correos.php');
				?>
				<tr><td colspan="3" width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="1" height="10" border="0" alt="" /></td></tr>
	...
	<input type="hidden" name="fIdNotificacion" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdNotificacion() : $_POST['fIdNotificacion'];?>" />
...
<?php include (constant("DIR_WS_INCLUDE") . "pie.php");?>
	...
	<input type="hidden" name="notificaciones_next_page" value="<?php echo (isset($_POST['notificaciones_next_page'])) ? $cUtilidades->validaXSS($_POST['notificaciones_next_page']) : "1";?>" />
