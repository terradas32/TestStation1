...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_TIPO_TPV");?>:", f.LSTIdTipoTpv.value, 11, false);
	msg +=vString("<?php echo constant("STR_BUSINESS_NAME");?>:",f.LSTBUSINESS_NAME.value,500, false);
	msg +=vString("<?php echo constant("STR_BUSINESS_CODE");?>:",f.LSTBUSINESS_CODE.value,255, false);
	msg +=vString("<?php echo constant("STR_BUSINESS_PASS");?>:",f.LSTBUSINESS_PASS.value,255, false);
	msg +=vString("<?php echo constant("STR_BUSINESS_COINC");?>:",f.LSTBUSINESS_COINC.value,4, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdTipoTpv"><?php echo constant("STR_TIPO_TPV");?></label>&nbsp;</td>
					<td><?php $comboTIPOS_TPV->setNombre("LSTIdTipoTpv");?><?php echo $comboTIPOS_TPV->getHTMLCombo("1","cajatexto",$cEntidad->getIdTipoTpv()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTBUSINESS_NAME"><?php echo constant("STR_BUSINESS_NAME");?></label>&nbsp;</td>
					<td><input type="text" id="LSTBUSINESS_NAME" name="LSTBUSINESS_NAME" value="<?php echo $cEntidad->getBUSINESS_NAME();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTBUSINESS_CODE"><?php echo constant("STR_BUSINESS_CODE");?></label>&nbsp;</td>
					<td><input type="text" id="LSTBUSINESS_CODE" name="LSTBUSINESS_CODE" value="<?php echo $cEntidad->getBUSINESS_CODE();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTBUSINESS_PASS"><?php echo constant("STR_BUSINESS_PASS");?></label>&nbsp;</td>
					<td><input type="text" id="LSTBUSINESS_PASS" name="LSTBUSINESS_PASS" value="<?php echo $cEntidad->getBUSINESS_PASS();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTBUSINESS_COINC"><?php echo constant("STR_BUSINESS_COINC");?></label>&nbsp;</td>
					<td><input type="text" id="LSTBUSINESS_COINC" name="LSTBUSINESS_COINC" value="<?php echo $cEntidad->getBUSINESS_COINC();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='BUSINESS_NAME' <?php echo (!empty($sOrderBy) && $sOrderBy == 'BUSINESS_NAME') ? "selected='selected'" : "";?>><?php echo constant("STR_BUSINESS_NAME");?></option>
							<option style='color:#000000;' value='BUSINESS_CODE' <?php echo (!empty($sOrderBy) && $sOrderBy == 'BUSINESS_CODE') ? "selected='selected'" : "";?>><?php echo constant("STR_BUSINESS_CODE");?></option>
							<option style='color:#000000;' value='BUSINESS_PASS' <?php echo (!empty($sOrderBy) && $sOrderBy == 'BUSINESS_PASS') ? "selected='selected'" : "";?>><?php echo constant("STR_BUSINESS_PASS");?></option>
							<option style='color:#000000;' value='BUSINESS_COINC' <?php echo (!empty($sOrderBy) && $sOrderBy == 'BUSINESS_COINC') ? "selected='selected'" : "";?>><?php echo constant("STR_BUSINESS_COINC");?></option>
	...
	<input type="hidden" name="empresas_conf_tpv_next_page" value="1" />
