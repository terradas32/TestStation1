...
function validaForm()
{
	...
	msg +=vNumber("<?php echo constant("STR_TIPO_TPV");?>:",f.fIdTipoTpv.value,11,true);
	msg +=vString("<?php echo constant("STR_BUSINESS_NAME");?>:",f.fBUSINESS_NAME.value,500,true);
	msg +=vString("<?php echo constant("STR_BUSINESS_CODE");?>:",f.fBUSINESS_CODE.value,255,true);
	msg +=vString("<?php echo constant("STR_BUSINESS_PASS");?>:",f.fBUSINESS_PASS.value,255,true);
	msg +=vString("<?php echo constant("STR_BUSINESS_COINC");?>:",f.fBUSINESS_COINC.value,4,true);
if (msg != "") {
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td><?php $comboEMPRESAS->setNombre("fIdEmpresa");?><?php echo $comboEMPRESAS->getHTMLCombo("1","obliga",$cEntidad->getIdEmpresa()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdTipoTpv"><?php echo constant("STR_TIPO_TPV");?></label>&nbsp;</td>
					<td><?php $comboTIPOS_TPV->setNombre("fIdTipoTpv");?><?php echo $comboTIPOS_TPV->getHTMLCombo("1","obliga",$cEntidad->getIdTipoTpv()," ","");?></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fBUSINESS_NAME"><?php echo constant("STR_BUSINESS_NAME");?></label>&nbsp;</td>
					<td><input type="text" id="fBUSINESS_NAME" name="fBUSINESS_NAME" value="<?php echo $cEntidad->getBUSINESS_NAME();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fBUSINESS_CODE"><?php echo constant("STR_BUSINESS_CODE");?></label>&nbsp;</td>
					<td><input type="text" id="fBUSINESS_CODE" name="fBUSINESS_CODE" value="<?php echo $cEntidad->getBUSINESS_CODE();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fBUSINESS_PASS"><?php echo constant("STR_BUSINESS_PASS");?></label>&nbsp;</td>
					<td><input type="text" id="fBUSINESS_PASS" name="fBUSINESS_PASS" value="<?php echo $cEntidad->getBUSINESS_PASS();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fBUSINESS_COINC"><?php echo constant("STR_BUSINESS_COINC");?></label>&nbsp;</td>
					<td><input type="text" id="fBUSINESS_COINC" name="fBUSINESS_COINC" value="<?php echo $cEntidad->getBUSINESS_COINC();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
	...
	<input type="hidden" name="empresas_conf_tpv_next_page" value="<?php echo (isset($_POST['empresas_conf_tpv_next_page'])) ? $cUtilidades->validaXSS($_POST['empresas_conf_tpv_next_page']) : "1";?>" /></div>
