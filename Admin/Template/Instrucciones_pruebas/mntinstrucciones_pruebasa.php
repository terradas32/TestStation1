...
<!-- 				<td><div id="comboIdPrueba"><?php $comboPRUEBAS->setNombre("fIdPrueba");?><?php echo $comboPRUEBAS->getHTMLComboNull("1","obliga",$cEntidad->getIdPrueba(),"onchange=\"javascript:cambiaIdPrueba()\" ","");?></div></td> -->
				...
				<tr>
					...
					<td><textarea class="tinymce" name="fTexto" data-id="fTexto" id="fTexto"><?php echo  $cEntidad->getTexto();?></textarea>
	...
	<input type="hidden" name="fIdInstruccion" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdInstruccion() : $_POST['fIdInstruccion'];?>" />
	...
	<input type="hidden" name="instrucciones_pruebas_next_page" value="<?php echo (isset($_POST['instrucciones_pruebas_next_page'])) ? $cUtilidades->validaXSS($_POST['instrucciones_pruebas_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
