...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vNumber("<?php echo constant("STR_ID_FICHERO_SABANA");?>:", f.LSTIdFicheroSabana.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_ID_FICHERO_SABANA");?> <?php echo constant("STR_HASTA");?>:", f.LSTIdFicheroSabanaHast.value, 11, false);
	msg +=vNumber("<?php echo constant("STR_PRUEBA");?>:", f.LSTIdPrueba.value, 11, false);
	msg +=vString("<?php echo constant("STR_FICHERO");?>:",f.LSTFichero.value,255, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdFicheroSabana"><?php echo constant("STR_ID_FICHERO_SABANA");?></label>&nbsp;</td>
					<td>
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_DESDE");?>&nbsp;</td>
								<td><input type="text" id="LSTIdFicheroSabana" name="LSTIdFicheroSabana" value="<?php echo $cEntidad->getIdFicheroSabana();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
								<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
								<td nowrap="nowrap" class="negrob"><?php echo constant("STR_HASTA");?>&nbsp;</td>
								<td><input type="text" id="LSTIdFicheroSabanaHast" name="LSTIdFicheroSabanaHast" value="<?php echo $cEntidad->getIdFicheroSabanaHast();?>" class="cajatexto" style="width:75px;" onchange="javascript:trim(this);" /></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTFichero"><?php echo constant("STR_FICHERO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTFichero" name="LSTFichero" value="<?php echo $cEntidad->getFichero();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idFicheroSabana' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idFicheroSabana') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_FICHERO_SABANA");?></option>
							<option style='color:#000000;' value='fichero' <?php echo (!empty($sOrderBy) && $sOrderBy == 'fichero') ? "selected='selected'" : "";?>><?php echo constant("STR_FICHERO");?></option>
	...
	<input type="hidden" name="imp_pruebas_papel_next_page" value="1" />
