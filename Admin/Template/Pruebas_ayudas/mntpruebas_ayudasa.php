...
function validaForm()
{
  ...
  var editorContent = $('#tinymce[data-id="fTexto"]', myf.contents()).html();
	...
	msg +=vString("<?php echo constant("STR_TEXTO");?>:",editorContent,16777215,true);
...
<!-- 				<td><div id="comboIdPrueba"><?php $comboPRUEBAS->setNombre("fIdPrueba");?><?php echo $comboPRUEBAS->getHTMLComboNull("1","obliga",$cEntidad->getIdPrueba(),"onchange=\"javascript:cambiaIdPrueba()\" ","");?></div></td> -->
	...
	<input type="hidden" name="fIdAyuda" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdAyuda() : $_POST['fIdAyuda'];?>" />
	...
	<input type="hidden" name="pruebas_ayudas_next_page" value="<?php echo (isset($_POST['pruebas_ayudas_next_page'])) ? $cUtilidades->validaXSS($_POST['pruebas_ayudas_next_page']) : "1";?>" />
						<script language="javascript" type="text/javascript">
							//<![CDATA[
