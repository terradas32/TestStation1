...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vString("<?php echo constant("STR_ID_PAIS");?>:",f.LSTIdPais.value,3, false);
	msg +=vString("<?php echo constant("STR_IDIOMA");?>:",f.LSTCodIdiomaIso2.value,2, false);
	msg +=vString("<?php echo constant("STR_CODIGO_PAIS_ISO3");?>:",f.LSTCodPaisIso3.value,3, false);
	msg +=vString("<?php echo constant("STR_CODIGO_PAIS_ISO2");?>:",f.LSTCodPaisIso2.value,2, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTIdPais"><?php echo constant("STR_ID_PAIS");?></label>&nbsp;</td>
					<td><input type="text" id="LSTIdPais" name="LSTIdPais" value="<?php echo $cEntidad->getIdPais();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTCodPaisIso3"><?php echo constant("STR_CODIGO_PAIS_ISO3");?></label>&nbsp;</td>
					<td><input type="text" id="LSTCodPaisIso3" name="LSTCodPaisIso3" value="<?php echo $cEntidad->getCodPaisIso3();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTCodPaisIso2"><?php echo constant("STR_CODIGO_PAIS_ISO2");?></label>&nbsp;</td>
					<td><input type="text" id="LSTCodPaisIso2" name="LSTCodPaisIso2" value="<?php echo $cEntidad->getCodPaisIso2();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='idPais' <?php echo (!empty($sOrderBy) && $sOrderBy == 'idPais') ? "selected='selected'" : "";?>><?php echo constant("STR_ID_PAIS");?></option>
							<option style='color:#000000;' value='codPaisIso3' <?php echo (!empty($sOrderBy) && $sOrderBy == 'codPaisIso3') ? "selected='selected'" : "";?>><?php echo constant("STR_CODIGO_PAIS_ISO3");?></option>
							<option style='color:#000000;' value='codPaisIso2' <?php echo (!empty($sOrderBy) && $sOrderBy == 'codPaisIso2') ? "selected='selected'" : "";?>><?php echo constant("STR_CODIGO_PAIS_ISO2");?></option>
	...
	<input type="hidden" name="wi_paises_next_page" value="1" /></div>
  <input type="hidden" name="paises_next_page" value="1" /></div>
