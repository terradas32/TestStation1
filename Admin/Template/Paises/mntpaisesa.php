...
function validaForm()
{
	var f=document.forms[0];
	var msg="";
	msg +=vString("<?php echo constant("STR_ID_PAIS");?>:",f.fIdPais.value,3,true);
	msg +=vString("<?php echo constant("STR_IDIOMA");?>:",f.fCodIdiomaIso2.value,2,true);
	msg +=vString("<?php echo constant("STR_CODIGO_PAIS_ISO3");?>:",f.fCodPaisIso3.value,3,true);
	msg +=vString("<?php echo constant("STR_CODIGO_PAIS_ISO2");?>:",f.fCodPaisIso2.value,2,true);
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					...
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fIdPais"><?php echo constant("STR_ID_PAIS");?></label>&nbsp;</td><td><input type="text" id="fIdPais" name="fIdPais" value="<?php echo (empty($_POST['AddIdioma'])) ? $cEntidad->getIdPais() : $_POST['fIdPais'];?>" class="obliga" onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fCodPaisIso3"><?php echo constant("STR_CODIGO_PAIS_ISO3");?></label>&nbsp;</td>
					<td><input type="text" id="fCodPaisIso3" name="fCodPaisIso3" value="<?php echo $cEntidad->getCodPaisIso3();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fCodPaisIso2"><?php echo constant("STR_CODIGO_PAIS_ISO2");?></label>&nbsp;</td>
					<td><input type="text" id="fCodPaisIso2" name="fCodPaisIso2" value="<?php echo $cEntidad->getCodPaisIso2();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fDescripcion"><?php echo constant("STR_DESCRIPCION");?></label>&nbsp;</td>
					<td><input type="text" id="fDescripcion" name="fDescripcion" value="<?php echo $cEntidad->getDescripcion();?>" class="obliga" /></td>
				</tr>
