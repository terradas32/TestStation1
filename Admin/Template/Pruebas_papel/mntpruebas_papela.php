...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_EDAD");?>:",f.fEDAD.value,255,false);
	msg +=vString("<?php echo constant("STR_SEXO");?>:",f.fSEXO.value,255,false);
	msg +=vString("<?php echo constant("STR_NOMBRE");?>:",f.fNOMBRE.value,255,false);
	msg +=vString("<?php echo constant("STR_APELLIDO_1");?>:",f.fAPELLIDO1.value,255,false);
	msg +=vString("<?php echo constant("STR_APELLIDO_2");?>:",f.fAPELLIDO2.value,255,false);
	msg +=vString("<?php echo constant("STR_RESULTADO");?>:",f.fRESULTADO.value,2500,true);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fEDAD"><?php echo constant("STR_EDAD");?></label>&nbsp;</td>
					<td><input type="text" id="fEDAD" name="fEDAD" value="<?php echo $cEntidad->getEDAD();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fSEXO"><?php echo constant("STR_SEXO");?></label>&nbsp;</td>
					<td><input type="text" id="fSEXO" name="fSEXO" value="<?php echo $cEntidad->getSEXO();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="fRESULTADO"><?php echo constant("STR_RESULTADO");?></label>&nbsp;</td>
					<td><input type="text" id="fRESULTADO" name="fRESULTADO" value="<?php echo $cEntidad->getRESULTADO();?>" class="obliga"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
	...
	<input type="hidden" name="pruebas_papel_next_page" value="<?php echo (isset($_POST['pruebas_papel_next_page'])) ? $cUtilidades->validaXSS($_POST['pruebas_papel_next_page']) : "1";?>" /></div>
