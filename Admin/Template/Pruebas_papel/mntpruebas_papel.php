...
function validaForm()
{
	...
	msg +=vString("<?php echo constant("STR_EDAD");?>:",f.LSTEDAD.value,255, false);
	msg +=vString("<?php echo constant("STR_SEXO");?>:",f.LSTSEXO.value,255, false);
	...
	msg +=vString("<?php echo constant("STR_RESULTADO");?>:",f.LSTRESULTADO.value,2500, false);
...
<?php include (constant("DIR_WS_INCLUDE") . "cabecera.php");?>
	<div id="envoltura">
		...
		<div style="width: 100%">
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTEDAD"><?php echo constant("STR_EDAD");?></label>&nbsp;</td>
					<td><input type="text" id="LSTEDAD" name="LSTEDAD" value="<?php echo $cEntidad->getEDAD();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTSEXO"><?php echo constant("STR_SEXO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTSEXO" name="LSTSEXO" value="<?php echo $cEntidad->getSEXO();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
					<td nowrap="nowrap" width="140" class="negrob" valign="top"><label for="LSTRESULTADO"><?php echo constant("STR_RESULTADO");?></label>&nbsp;</td>
					<td><input type="text" id="LSTRESULTADO" name="LSTRESULTADO" value="<?php echo $cEntidad->getRESULTADO();?>" class="cajatexto"  onchange="javascript:trim(this);" /></td>
				</tr>
				<tr>
					<td width="5"><img src="<?php echo constant('DIR_WS_GRAF');?>sp.gif" width="5" height="20" border="0" alt="" /></td>
				...
				<tr>
					...
					<td>
						<select id="LSTOrderBy" name="LSTOrderBy" size="1" class="cajatexto">
							...
							<option style='color:#000000;' value='EDAD' <?php echo (!empty($sOrderBy) && $sOrderBy == 'EDAD') ? "selected='selected'" : "";?>><?php echo constant("STR_EDAD");?></option>
							<option style='color:#000000;' value='SEXO' <?php echo (!empty($sOrderBy) && $sOrderBy == 'SEXO') ? "selected='selected'" : "";?>><?php echo constant("STR_SEXO");?></option>
							...
							<option style='color:#000000;' value='RESULTADO' <?php echo (!empty($sOrderBy) && $sOrderBy == 'RESULTADO') ? "selected='selected'" : "";?>><?php echo constant("STR_RESULTADO");?></option>
	...
	<input type="hidden" name="pruebas_papel_next_page" value="1" />
