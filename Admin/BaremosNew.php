...
include_once ('include/conexion.php');
	...
	*/
	function readLista($cEntidad){
		global $conn;
		global $cUtilidades;
		$cEntidad->setIdBaremo((isset($_POST["LSTIdBaremo"]) && $_POST["LSTIdBaremo"] != "") ? $_POST["LSTIdBaremo"] : "");	$cEntidad->setBusqueda(constant("STR_ID_BAREMO"), (isset($_POST["LSTIdBaremo"]) && $_POST["LSTIdBaremo"] != "" ) ? $_POST["LSTIdBaremo"] : "");
		$cEntidad->setIdBaremoHast((isset($_POST["LSTIdBaremoHast"]) && $_POST["LSTIdBaremoHast"] != "") ? $_POST["LSTIdBaremoHast"] : "");	$cEntidad->setBusqueda(constant("STR_ID_BAREMO") . " " . constant("STR_HASTA"), (isset($_POST["LSTIdBaremoHast"]) && $_POST["LSTIdBaremoHast"] != "" ) ? $_POST["LSTIdBaremoHast"] : "");
		global $comboPRUEBAS;
