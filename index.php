...
<div id="pagina">
    <div id="head" class="portada">
        ...
        <div class="logo">
            <a href="https://www.people-experts.com/" target="_blank" title="<?php echo constant("STR_INICIO");?>"><img src="graf/logo.jpg" alt="<?php echo constant("NOMBRE_EMPRESA");?> <?php echo constant("STR_INICIO");?>" title="<?php echo constant("NOMBRE_EMPRESA");?> <?php echo constant("STR_INICIO");?>" /></a>
<!--        <a href="index.php?fLang=<?php // echo $sLang;?>" title="<?php //echo constant("STR_INICIO");?>"><img src="graf/logo.jpg" alt="<?php // echo constant("NOMBRE_EMPRESA");?> <?php // echo constant("STR_INICIO");?>" title="<?php // echo constant("NOMBRE_EMPRESA");?> <?php // echo constant("STR_INICIO");?>" /></a> -->
        </div><!-- Fin de logo -->
    <h1>Test Station</h1>
