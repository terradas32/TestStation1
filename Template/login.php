				...
				<tr>
					<td>
						<table cellspacing="0" cellpadding="0" align="center" border="0">
							...
							<tr><td><img src="<?php echo constant("DIR_WS_GRAF");?>sp.gif" width="1" height="10" border="0" alt="" /></td></tr>
							<tr>
								<td class="negro" align="center" valign="middle"><a href="http://www.negociainternet.com" target="_blank" title="Diseño Web"><img src="<?php echo constant("DIR_WS_GRAF");?>logoPeque.png" width="100" height="20" alt="Powered By Negocia Internet ©2003-<?php echo date('Y');?>" title="Diseño Web" border="0" /></a></td>
							</tr>
						</table>
					</td>
				</tr>
