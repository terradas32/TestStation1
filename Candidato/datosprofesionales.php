...
//}
    ...
    $cProceso_pruebas->setIdPrueba("87");	//SEAS
    ...
    $comboAREAS			= new Combo($conn,"fIdArea","idArea","nombre","Descripcion","areas","",constant("SLC_OPCION"),"codIdiomaIso2=" . $conn->qstr($sLang, false),"","orden","");
    $comboEDADES		= new Combo($conn,"fIdEdad","idEdad","nombre","Descripcion","edades","",constant("SLC_OPCION"),"codIdiomaIso2=" . $conn->qstr($sLang, false),"","orden","");
    $comboNIVELES		= new Combo($conn,"fIdNivel","idNivel","nombre","Descripcion","nivelesjerarquicos","",constant("SLC_OPCION"),"codIdiomaIso2=" . $conn->qstr($sLang, false),"","orden","");
    $comboFORMACIONES 	= new Combo($conn,"fIdFormacion","idFormacion","nombre","Descripcion","formaciones","",constant("SLC_OPCION"),"codIdiomaIso2=" . $conn->qstr($sLang, false),"","orden","");
    ...
    $CATEGORIASPROFESIONALES	= new Combo($conn,"fCategoriaForjanor","idCategoria","descripcion","Descripcion","categoriasProfesionales","","","","","","");
    $comboWI_PAISES	= new Combo($conn,"fCodIso2PaisProcedencia","codPaisIso2","descripcion","Descripcion","wi_paises","",constant("SLC_OPCION"),"codIdiomaIso2=" . $conn->qstr($sLang, false),"","descripcion");
...
function validaForm()
{
	...
	if ($cEmpresas->getMailCan() == 'on'){echo "\n" . 'msg +=vEmail("' . constant("STR_MAIL") . ':",f.fMailCan.value,255,true);';}
	...
	if ($cEmpresas->getCodIso2PaisProcedencia() == 'on'){echo "\n" . 'msg +=vString("' . constant("STR_PAIS_DE_PROCEDENCIA") . ':",f.fCodIso2PaisProcedencia.value,20,true);';}
		        	...
		        	<tr>
		        		<td valign="top" colspan="2">
					        ...
					        <?php 
								...
								if ($cEmpresas->getCodIso2PaisProcedencia() == 'on'){ ?>
					        	<tr>
					        		<td class="negrob"><?php if ($cEmpresas->getCodIso2PaisProcedencia() == 'on'){echo constant('STR_PAIS_DE_PROCEDENCIA')?>:<br /><br /><?php $comboWI_PAISES->setNombre("fCodIso2PaisProcedencia");?><?php echo $comboWI_PAISES->getHTMLCombo("1","obliga",$cCandidato->getCodIso2PaisProcedencia()," ","");}?></td>
					        	</tr>
								<?php 
								}
...
//					        		echo "<br />sDefaultSECTORESMB::" . $sDefaultSECTORESMB;
					...
					?>
								...
								?>
					        	<tr>
					        		<td class="negrob" onclick="javascript:zoomWindow('avisoLegal.php?fLang=<?php echo $sLang;?>', '<?php echo constant("STR_AVISO_LEGAL");?>');document.forms[0].fAcepta.checked=true;">
					        			<?php
					        			$sCheckedCOND="";
					        			$sCheckDISPLAY="";
					        			...
					        			$sCodIso2PaisProcedencia=$cCandidato->getCodIso2PaisProcedencia();
					        			...
					        			if ($cEmpresas->getCodIso2PaisProcedencia() == 'on'){
					        				$iCondiciones ++;
					        				if (!empty($sCodIso2PaisProcedencia)){
					        					$iOK ++;
					        				}
					        			}
										...
										?>
			        					<input <?php echo $sCheckDISPLAY;?> type="checkbox" id="fAcepta" <?php echo $sCheckedCOND;?> /> &nbsp;<a href="#_" <?php echo $sCheckDISPLAY;?>><?php echo constant("STR_CONDICIONES_LEGALES");?></a>
				        			</td>
					        	</tr>
					        	<tr>
					        		<td>&nbsp;</td>
		        	...
		        	<tr>
		        		...
		        		<input type="submit" name="btnDp" id="btnDp" value="<?php echo constant("STR_CONTINUAR");?>" class="botones" />
		        		</td>
		        	</tr>
		        </table>
		    </div>
