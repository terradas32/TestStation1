...
ob_start();
	...
	include(constant("DIR_ADODB") . 'adodb-errorpear.inc.php');
...
//        			    	$iListaPruebas = $listaProcesosPruebas->recordCount();
        			    	if($iListaPruebas > 0)
        			    	{
				        		...
				        		while(!$listaProcesosPruebas->EOF){
									...
									<div>
							        	<ul>
								        	<li style="margin-top:10px;"><img style="min-width: 60px;" title="<?php echo $cPruebas->getDescripcion()?>" src="<?php echo constant("DIR_WS_GESTOR") . $cPruebas->getlogoPrueba()?>"  border="0" alt="" rel="#photo<?php echo $i?>" />
							        	<?php
