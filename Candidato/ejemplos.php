...
ob_start();
    ...
    $cEjemplos->setCodIdiomaIso2($_POST['fCodIdiomaIso2']);
		$cEjemplos->setBajaLog("0");
		$cEjemplos->setBajaLogHast("0");
...
function comenzar(){
	var sMsg = "<?php echo constant("MSG_ESTAS_SEGURO_DE_COMENZAR_LA_PRUEBA_AUDIO");?>";
...
function cargaListening(){
	var aListening=['58','59','60'];	//LISTENING
	if(aListening.in_array(<?php echo $cPruebas->getIdPrueba();?>)){
		var f = document.forms[0];
