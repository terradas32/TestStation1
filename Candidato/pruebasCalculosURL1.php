...
/*
* SELECT count(*) FROM `respuestas_pruebas_resultados2` WHERE veces=0 
...
*/
	...
	$sSQL = "SELECT * FROM respuestas_pruebas_resultados2 ORDER BY veces ASC , fecAlta ASC LIMIT 0,18";
	echo "<br />" . $sSQL;
	...
	//		echo "<br />" . $sqlRespItems;
	    	...
	    	if ($bSinFinalizar == false)
	    	{
                ...
                $sSQL = "UPDATE respuestas_pruebas_resultados2 SET veces=veces+1 WHERE idEmpresa=" . $rsRespuestas_pruebasApti->fields['idEmpresa'] . " AND ";
          			$sSQL .= "idProceso=" . $rsRespuestas_pruebasApti->fields['idProceso'] . " AND ";
          			$sSQL .= "idCandidato=" . $rsRespuestas_pruebasApti->fields['idCandidato'] . " AND ";
          			$sSQL .= "idPrueba=" . $rsRespuestas_pruebasApti->fields['idPrueba'] . " ";
          			$conn->Execute($sSQL);

								sleep(1); //Retrasamos la llamada al siguiente 2 segundos
			...
			$sSQL = "DELETE FROM respuestas_pruebas_resultados2 WHERE idEmpresa=" . $rsRespuestas_pruebasApti->fields['idEmpresa'] . " AND ";
			$sSQL .= "idProceso=" . $rsRespuestas_pruebasApti->fields['idProceso'] . " AND ";
			$sSQL .= "idCandidato=" . $rsRespuestas_pruebasApti->fields['idCandidato'] . " AND ";
			$sSQL .= "idPrueba=" . $rsRespuestas_pruebasApti->fields['idPrueba'] . " ";
			$conn->Execute($sSQL);
