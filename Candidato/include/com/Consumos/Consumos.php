...
class Consumos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idProceso,idCandidato,codIdiomaIso2,idPrueba,codIdiomaInforme,idTipoInforme,idBaremo,nomEmpresa,nomProceso,nomCandidato,apellido1,apellido2,dni,mail,nomPrueba,nomInforme,nomBaremo,concepto,unidades,fecAlta,fecMod";
		$this->DESCListaExcel	=	"Empresa,Proceso,Candidato,Idioma Prueba,Prueba,Idioma Informe,Informe,Baremo,Nombre Empresa,Nombre Proceso,Nombre Candidato,Apellido1,Apellido2,DNI/ N. ID,Mail,Prueba,Informe,Baremo,Concepto,Unidades,Fecha de Alta,Fecha de Modificación";
	}
