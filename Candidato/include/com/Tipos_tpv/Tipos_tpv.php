...
class Tipos_tpv
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idTipoTpv,descripcion,TERMINAL_TYPE,OPERATION_TYPE,URL_NOTIFY,URL_OK,URL_NOOK,SERVICE_ACTION,bajaLog";
		$this->DESCListaExcel	=	"Tipo Tpv,Descripción,TERMINAL TYPE,OPERATION TYPE,URL NOTIFY,URL OK,URL NOOK,SERVICE ACTION,Baja Log";
	}
