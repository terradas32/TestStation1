...
* los valores de la entidad de clase Instrucciones_pruebas.
**/
class Instrucciones_pruebas
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idInstruccion,codIdiomaIso2,idPrueba,texto,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"IdInstrucción,Idioma,Prueba,Texto,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}


	/**
	* Devuelve el contenido de la propiedad idInstruccion
	* @return int(11)
	*/
	...
	/**
	* Fija el contenido de la propiedad idInstruccion
	* @param idInstruccion
	* @return void
	*/
	function setIdInstruccion($sCadena){
		$this->idInstruccion = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad idInstruccionHast
	* @return int(11)
	*/
	function getIdInstruccionHast(){
		return $this->idInstruccionHast;
	}
	/**
	* Fija el contenido de la propiedad idInstruccionHast
	* @param idInstruccion
	* @return void
	*/
	function setIdInstruccionHast($sCadena){
		$this->idInstruccionHast = $sCadena;
	}
	/**
...
}//Fin de la Clase Instrucciones_pruebas
?>