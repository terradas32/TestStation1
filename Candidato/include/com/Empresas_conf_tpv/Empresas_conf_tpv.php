...
* los valores de la entidad de clase Empresas_conf_tpv.
**/
class Empresas_conf_tpv
{
	...
	**/
		...
		var $sGroupBy; //Campo group de la query de búsqueda.
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idEmpresa,idTipoTpv,BUSINESS_NAME,BUSINESS_CODE,BUSINESS_PASS,BUSINESS_COINC";
		$this->DESCListaExcel	=	"Empresa,Tipo Tpv,BUSINESS NAME,BUSINESS CODE,BUSINESS PASS,BUSINESS COINC";
	}
	...
	*/
	...
	/**
	* Devuelve el contenido de la propiedad BUSINESS_NAME
	* @return varchar(500)
	*/
	...
	/**
	* Fija el contenido de la propiedad BUSINESS_NAME
	* @param BUSINESS_NAME
	* @return void
	*/
	function setBUSINESS_NAME($sCadena){
		$this->BUSINESS_NAME = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad BUSINESS_CODE
	* @return varchar(255)
	*/
	function getBUSINESS_CODE(){
		return $this->BUSINESS_CODE;
	}
	/**
	* Fija el contenido de la propiedad BUSINESS_CODE
	* @param BUSINESS_CODE
	* @return void
	*/
	function setBUSINESS_CODE($sCadena){
		$this->BUSINESS_CODE = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad BUSINESS_PASS
	* @return varchar(255)
	*/
	function getBUSINESS_PASS(){
		return $this->BUSINESS_PASS;
	}
	/**
	* Fija el contenido de la propiedad BUSINESS_PASS
	* @param BUSINESS_PASS
	* @return void
	*/
	function setBUSINESS_PASS($sCadena){
		$this->BUSINESS_PASS = $sCadena;
	}
	/**
	* Devuelve el contenido de la propiedad BUSINESS_COINC
	* @return varchar(4)
	*/
	function getBUSINESS_COINC(){
		return $this->BUSINESS_COINC;
	}
	/**
	* Fija el contenido de la propiedad BUSINESS_COINC
	* @param BUSINESS_COINC
	* @return void
	*/
	function setBUSINESS_COINC($sCadena){
		$this->BUSINESS_COINC = $sCadena;
	}
	/**
...
}//Fin de la Clase Empresas_conf_tpv
?>