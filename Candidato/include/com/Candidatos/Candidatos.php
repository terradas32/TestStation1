...
class Candidatos
{
	...
	**/
	function __construct()
	{
		...
		$this->ultimaAcc			= "";
		$this->ultimaAccHast			= "";
		$this->PKListaExcel		=	"idCandidato,idEmpresa,idProceso,nombre,apellido1,apellido2,dni,mail,idTratamiento,idSexo,idEdad,fechaNacimiento,idPais,idProvincia,idMunicipio,idZona,direccion,codPostal,idFormacion,idNivel,idArea,telefono,codIso2PaisProcedencia,estadoCivil,nacionalidad,informado,finalizado,fechaFinalizado,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Candidato,Empresa,Proceso,Nombre,Apellido 1,Apellido 2,DNI/ N. ID,EMail,Tratamiento,Sexo,Edad,Fecha de Nacimiento,País,Provincía,Municipio,Zona,Dirección,Código Postal,Formación,Nivel,Área,Teléfono,País Procedencia,Estado Civil,Nacionalidad,Informado,Finalizado,Fecha de Finalizado,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
