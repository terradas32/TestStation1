...
class Procesos
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idProceso,idEmpresa,nombre,descripcion,observaciones,fechaInicio,fechaFin,idModoRealizacion,fecAlta,fecMod,usuAlta,usuMod";
		$this->DESCListaExcel	=	"Id Proceso,Empresa,Nombre,Descripción,Observaciones,Fecha de Inicio,Fecha de Fin,Modo Realización Pruebas,Fecha de Alta,Fecha de Modificación,Usuario de Alta,Usuario de Modificación";
	}
