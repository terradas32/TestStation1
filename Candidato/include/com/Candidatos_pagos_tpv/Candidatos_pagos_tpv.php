...
class Candidatos_pagos_tpv
{
	...
	**/
	function __construct()
	{
		...
		$this->usuMod			= "";
		$this->usuModHast			= "";
		$this->PKListaExcel		=	"idRecarga,idEmpresa,idProceso,idCandidato,localizador,descripcion,impBase,impImpuestos,impBaseImpuestos,email,nombre,apellidos,direccion,codPostal,ciudad,telefono1,codEstado,codAutorizacion,codError,desError,fecAlta";
		$this->DESCListaExcel	=	"Recarga,Empresa,Proceso,Candidato,Localizador,Descripción,Imp. Base,Imp. Impuestos,Imp. Base Impuestos,Email,Nombre,Apellidos,Dirección,Cód. Postal,Ciudad,Teléfono,Cód. Estado,Cód. Autorización,Cód. Error,Desc. Error,Fecha de Alta";
