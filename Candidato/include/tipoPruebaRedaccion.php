...
//						}
					...
					-->
						<label style="font-weight: bold;" for="opcion<?php echo $listaOpciones->fields['codigo']. "@" . $listItems->fields['idItem'];?>"><?php echo $sOpcion;?></label>
						<br /><br />
						<a href="#_" title="Guardar"><img width="40px" src="graf/save.gif" title="Guardar" alt="Guardar" /></a>
						<textarea onchange="javascript:guardarespuestaRedaccion(<?php echo $listItems->fields['idItem'];?>,<?php echo $listaOpciones->fields['idOpcion'];?>,<?php echo $listItems->fields['orden'];?>,1,this);" rows="20" cols="110%" name="fIdOpcion<?php echo $listItems->fields['idItem'];?>" id="opcion<?php echo $listaOpciones->fields['codigo']. "@" . $listItems->fields['idItem'];?>" ><?php echo $cRespuestasPruebasItems->getValor();?></textarea>				
