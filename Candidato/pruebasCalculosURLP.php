...
**/
	...
	$sSQL = "SELECT * FROM respuestas_pruebas_resultados_p ORDER BY veces, fecAlta ASC LIMIT 0,8";
	echo "<br />" . $sSQL;
...
//		    		$cBaremos = $cBaremosDB->readEntidad($cBaremos);
                	...
                	$sSQL = "UPDATE respuestas_pruebas_resultados_p SET veces=veces+1 WHERE idEmpresa=" . $rsRespuestas_pruebasApti->fields['idEmpresa'] . " AND ";
          			$sSQL .= "idProceso=" . $rsRespuestas_pruebasApti->fields['idProceso'] . " AND ";
          			$sSQL .= "idCandidato=" . $rsRespuestas_pruebasApti->fields['idCandidato'] . " AND ";
          			$sSQL .= "idPrueba=" . $rsRespuestas_pruebasApti->fields['idPrueba'] . " ";
          			$conn->Execute($sSQL);
