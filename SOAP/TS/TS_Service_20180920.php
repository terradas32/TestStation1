										...
										while (!$rs->EOF)
										{
											if ($rs->fields['idTipoPrueba'] == "17")
											{
												...
												if ($rsCeCases->NumRows() > 0)
												{
													...
													VALUES (\'3\', \'' . $_iCaseCliente . '\', \'1\', \'' . $cCandidatos->getNombre() . '\', \'' . $cCandidatos->getApellido1() . " " . $cCandidatos->getApellido2() . '\', \'' . $sPass .'\', \'' . $cCandidatos->getMail() . '\', \'1\', \'1\', now(), now(), NULL, \'0\', \'0\', \'0\', \'' . $sTK . '\', \'0\');';
